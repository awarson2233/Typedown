...
public class Phase10CoreContractsBoundaryTests
{
    ...
    public void WinUIPhase11_PackagesEditorStaticBundleForMsix()
    {
        ...
        AssertHasTypeReference(projectSource, "BeforeTargets=\"GetCopyToOutputDirectoryItems;GetPackagingOutputs\"");
        ...
        AssertHasTypeReference(editorProjectSource, "<ShouldRunNpmInstall>false</ShouldRunNpmInstall>");
