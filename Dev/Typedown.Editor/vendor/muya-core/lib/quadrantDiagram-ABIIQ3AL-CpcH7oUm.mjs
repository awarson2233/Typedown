...
import { D as r, H as i, K as a, U as o, a as s, c, f as l, v as u, w as d, x as f, y as p, z as m } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { t as h } from "./linear-DYBBcbeN.mjs";
...
var ee = {
	...
	renderer: { draw: /* @__PURE__ */ e((r, i, a, o) => {
		...
		c(x, w, C, (p = (m = v.quadrantChart) == null ? void 0 : m.useMaxWidth) == null || p), x.attr("viewBox", "0 0 " + C + " " + w), o.db.setHeight(w), o.db.setWidth(C);
