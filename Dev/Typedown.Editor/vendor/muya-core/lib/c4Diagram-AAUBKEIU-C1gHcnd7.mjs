...
import { H as r, U as i, c as a, r as o, s, v as l, x as u, y as d, z as f } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { _ as p, n as m, r as h } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as g } from "./dist-8HXMFWtc.mjs";
import { a as _, s as v } from "./chunk-ND2GUHAM-N7r7v8wk.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/c4Diagram-AAUBKEIU.mjs
var y = g(), b, x, S = (function() {
	var e = /* @__PURE__ */ t(function(e, t, n, r) {
		for (n = n || {}, r = e.length; r--; n[e[r]] = t);
		return n;
	}, "o"), n = [1, 24], r = [1, 25], i = [1, 26], a = [1, 27], o = [1, 28], s = [1, 63], l = [1, 64], u = [1, 65], d = [1, 66], f = [1, 67], p = [1, 68], m = [1, 69], h = [1, 29], g = [1, 30], _ = [1, 31], v = [1, 32], y = [1, 33], b = [1, 34], x = [1, 35], S = [1, 36], C = [1, 37], w = [1, 38], T = [1, 39], E = [1, 40], D = [1, 41], O = [1, 42], k = [1, 43], A = [1, 44], j = [1, 45], M = [1, 46], N = [1, 47], P = [1, 48], F = [1, 50], I = [1, 51], L = [1, 52], R = [1, 53], z = [1, 54], B = [1, 55], V = [1, 56], H = [1, 57], U = [1, 58], ee = [1, 59], te = [1, 60], ne = [14, 42], re = [
		14,
		34,
		36,
		37,
		...
		parse: /* @__PURE__ */ t(function(e) {
			...
			for (var C, w, T, E, D, O = {}, k, A, j, M;;) {
				if (T = r[r.length - 1], this.defaultActions[T] ? E = this.defaultActions[T] : (C == null && (C = S()), E = s[T] && s[T][C]), E === void 0 || !E.length || !E[0]) {
					var N = "";
...
var C = S, w = [], T = [""], E = "global", D = "", O = [{
	...
	link: null,
	parentBoundary: ""
}], k = [], A = "", j = !1, M = 4, N = 2, P, F = /* @__PURE__ */ t(function() {
	return P;
}, "getC4Type"), I = /* @__PURE__ */ t(function(e) {
	P = f(e, u());
}, "setC4Type"), L = /* @__PURE__ */ t(function(e, t, n, r, i, a, o, s, l) {
	if (e == null || t == null || n == null || r == null) return;
	let u = {}, d = k.find((e) => e.from === t && e.to === n);
	if (d ? u = d : k.push(u), u.type = e, u.from = t, u.to = n, u.label = { text: r }, i == null) u.techn = { text: "" };
	...
	u.wrap = de();
}, "addRel"), R = /* @__PURE__ */ t(function(e, t, n, r, i, a, o) {
	if (t === null || n === null) return;
	let s = {}, l = w.find((e) => e.alias === t);
	if (l && t === l.alias ? s = l : (s.alias = t, w.push(s)), n == null ? s.label = { text: "" } : s.label = { text: n }, r == null) s.descr = { text: "" };
	...
	s.typeC4Shape = { text: e }, s.parentBoundary = E, s.wrap = de();
}, "addPersonOrSystem"), z = /* @__PURE__ */ t(function(e, t, n, r, i, a, o, s) {
	if (t === null || n === null) return;
	let l = {}, u = w.find((e) => e.alias === t);
	if (u && t === u.alias ? l = u : (l.alias = t, w.push(l)), n == null ? l.label = { text: "" } : l.label = { text: n }, r == null) l.techn = { text: "" };
	else if (typeof r == "object") {
		let [e, t] = Object.entries(r)[0];
		l[e] = { text: t };
	} else l.techn = { text: r };
	...
	l.wrap = de(), l.typeC4Shape = { text: e }, l.parentBoundary = E;
}, "addContainer"), B = /* @__PURE__ */ t(function(e, t, n, r, i, a, o, s) {
	if (t === null || n === null) return;
	let l = {}, u = w.find((e) => e.alias === t);
	if (u && t === u.alias ? l = u : (l.alias = t, w.push(l)), n == null ? l.label = { text: "" } : l.label = { text: n }, r == null) l.techn = { text: "" };
	else if (typeof r == "object") {
	...
	l.wrap = de(), l.typeC4Shape = { text: e }, l.parentBoundary = E;
}, "addComponent"), V = /* @__PURE__ */ t(function(e, t, n, r, i) {
	if (e === null || t === null) return;
	let a = {}, o = O.find((t) => t.alias === e);
	if (o && e === o.alias ? a = o : (a.alias = e, O.push(a)), t == null ? a.label = { text: "" } : a.label = { text: t }, n == null) a.type = { text: "system" };
	...
	a.parentBoundary = E, a.wrap = de(), D = E, E = e, T.push(D);
}, "addPersonOrSystemBoundary"), H = /* @__PURE__ */ t(function(e, t, n, r, i) {
	if (e === null || t === null) return;
	let a = {}, o = O.find((t) => t.alias === e);
	if (o && e === o.alias ? a = o : (a.alias = e, O.push(a)), t == null ? a.label = { text: "" } : a.label = { text: t }, n == null) a.type = { text: "container" };
	else if (typeof n == "object") {
		let [e, t] = Object.entries(n)[0];
		a[e] = { text: t };
	} else a.type = { text: n };
	...
	a.parentBoundary = E, a.wrap = de(), D = E, E = e, T.push(D);
}, "addContainerBoundary"), U = /* @__PURE__ */ t(function(e, t, n, r, i, a, o, s) {
	if (t === null || n === null) return;
	let l = {}, u = O.find((e) => e.alias === t);
	if (u && t === u.alias ? l = u : (l.alias = t, O.push(l)), n == null ? l.label = { text: "" } : l.label = { text: n }, r == null) l.type = { text: "node" };
	else if (typeof r == "object") {
		let [e, t] = Object.entries(r)[0];
		l[e] = { text: t };
	} else l.type = { text: r };
	...
	l.nodeType = e, l.parentBoundary = E, l.wrap = de(), D = E, E = t, T.push(D);
}, "addDeploymentNode"), ee = /* @__PURE__ */ t(function() {
	E = D, T.pop(), D = T.pop(), T.push(D);
}, "popBoundaryParseStack"), te = /* @__PURE__ */ t(function(e, t, n, r, i, a, o, s, l, u, d) {
	let f = w.find((e) => e.alias === t);
	if (!(f === void 0 && (f = O.find((e) => e.alias === t), f === void 0))) {
...
}, "updateElStyle"), ne = /* @__PURE__ */ t(function(e, t, n, r, i, a, o) {
	let s = k.find((e) => e.from === t && e.to === n);
	if (s !== void 0) {
		if (r != null) if (typeof r == "object") {
			let [e, t] = Object.entries(r)[0];
			s[e] = t;
...
}, "updateRelStyle"), re = /* @__PURE__ */ t(function(e, t, n) {
	let r = M, i = N;
	if (typeof t == "object") {
	...
	r >= 1 && (M = r), i >= 1 && (N = i);
}, "updateLayoutConfig"), ie = /* @__PURE__ */ t(function() {
	return M;
}, "getC4ShapeInRow"), W = /* @__PURE__ */ t(function() {
	return N;
}, "getC4BoundaryInRow"), G = /* @__PURE__ */ t(function() {
	return E;
}, "getCurrentBoundaryParse"), K = /* @__PURE__ */ t(function() {
	return D;
}, "getParentBoundaryParse"), q = /* @__PURE__ */ t(function(e) {
	return e == null ? w : w.filter((t) => t.parentBoundary === e);
}, "getC4ShapeArray"), J = /* @__PURE__ */ t(function(e) {
	return w.find((t) => t.alias === e);
}, "getC4Shape"), ae = /* @__PURE__ */ t(function(e) {
	return Object.keys(q(e));
}, "getC4ShapeKeys"), oe = /* @__PURE__ */ t(function(e) {
	return e == null ? O : O.filter((t) => t.parentBoundary === e);
}, "getBoundaries"), se = oe, ce = /* @__PURE__ */ t(function() {
	return k;
}, "getRels"), le = /* @__PURE__ */ t(function() {
	return A;
}, "getTitle"), ue = /* @__PURE__ */ t(function(e) {
	j = e;
}, "setWrap"), de = /* @__PURE__ */ t(function() {
	return j;
}, "autoWrap"), fe = {
	addPersonOrSystem: R,
	addPersonOrSystemBoundary: V,
	addContainer: z,
	addContainerBoundary: H,
	addComponent: B,
	addDeploymentNode: U,
	popBoundaryParseStack: ee,
	addRel: L,
	updateElStyle: te,
	updateRelStyle: ne,
	updateLayoutConfig: re,
	autoWrap: de,
	setWrap: ue,
	getC4ShapeArray: q,
	getC4Shape: J,
	...
	getBoundaries: oe,
	getBoundarys: se,
	getCurrentBoundaryParse: G,
	getParentBoundaryParse: K,
	getRels: ce,
	getTitle: le,
	getC4Type: F,
	getC4ShapeInRow: ie,
	getC4BoundaryInRow: W,
	setAccTitle: i,
	getAccTitle: d,
	getAccDescription: l,
	setAccDescription: r,
	getConfig: /* @__PURE__ */ t(() => u().c4, "getConfig"),
	clear: /* @__PURE__ */ t(function() {
		w = [], O = [{
			...
			link: null,
			parentBoundary: ""
		}], D = "", E = "global", T = [""], k = [], T = [""], A = "", j = !1, M = 4, N = 2;
	}, "clear"),
	LINETYPE: {
		SOLID: 0,
		DOTTED: 1,
	...
	setC4Type: I
}, pe = /* @__PURE__ */ t(function(e, t) {
	return _(e, t);
}, "drawRect"), me = /* @__PURE__ */ t(function(e, t, n, r, i, a) {
	...
	o.attr("xlink:href", s);
}, "drawImage"), he = /* @__PURE__ */ t((e, t, n, r) => {
...
}, "drawRels"), ge = /* @__PURE__ */ t(function(e, t, n) {
	...
	t.nodeType && (s = { "stroke-width": 1 }), pe(r, {
		x: t.x,
		y: t.y,
		fill: i,
		stroke: a,
...
}, "drawBoundary"), _e = /* @__PURE__ */ t(function(e, t, n) {
	var r;
	...
	switch (t.typeC4Shape.text) {
		...
		case "external_component":
			u.x = t.x, u.y = t.y, u.fill = i, u.width = t.width, u.height = t.height, u.stroke = a, u.rx = 2.5, u.ry = 2.5, u.attrs = { "stroke-width": .5 }, pe(l, u);
			break;
		case "system_db":
		...
		case "external_component_db":
			l.append("path").attr("fill", i).attr("stroke-width", "0.5").attr("stroke", a).attr("d", "Mstartx,startyc0,-10 half,-10 half,-10c0,0 half,0 half,10l0,heightc0,10 -half,10 -half,10c0,0 -half,0 -half,-10l0,-height".replaceAll("startx", t.x).replaceAll("starty", t.y).replaceAll("half", t.width / 2).replaceAll("height", t.height)), l.append("path").attr("fill", "none").attr("stroke-width", "0.5").attr("stroke", a).attr("d", "Mstartx,startyc0,10 half,10 half,10c0,0 half,0 half,-10".replaceAll("startx", t.x).replaceAll("starty", t.y).replaceAll("half", t.width / 2));
			break;
		case "system_queue":
		...
		case "external_component_queue":
			l.append("path").attr("fill", i).attr("stroke-width", "0.5").attr("stroke", a).attr("d", "Mstartx,startylwidth,0c5,0 5,half 5,halfc0,0 0,half -5,halfl-width,0c-5,0 -5,-half -5,-halfc0,0 0,-half 5,-half".replaceAll("startx", t.x).replaceAll("starty", t.y).replaceAll("width", t.width).replaceAll("half", t.height / 2)), l.append("path").attr("fill", "none").attr("stroke-width", "0.5").attr("stroke", a).attr("d", "Mstartx,startyc-5,0 -5,half -5,halfc0,half 5,half 5,half".replaceAll("startx", t.x + t.width).replaceAll("starty", t.y).replaceAll("half", t.height / 2));
			break;
	}
	let d = Te(n, t.typeC4Shape.text);
	switch (l.append("text").attr("fill", o).attr("font-family", d.fontFamily).attr("font-size", d.fontSize - 2).attr("font-style", "italic").attr("lengthAdjust", "spacing").attr("textLength", t.typeC4Shape.width).attr("x", t.x + t.width / 2 - t.typeC4Shape.width / 2).attr("y", t.y + t.typeC4Shape.Y).text("<<" + t.typeC4Shape.text + ">>"), t.typeC4Shape.text) {
		case "person":
		case "external_person":
			me(l, 48, 48, t.x + t.width / 2 - 24, t.y + t.image.Y, s);
			break;
	}
	let f = n[t.typeC4Shape.text + "Font"]();
	return f.fontWeight = "bold", f.fontSize += 2, f.fontColor = o, Y(n)(t.label.text, l, t.x, t.y + t.label.Y, t.width, t.height, { fill: o }, f), f = n[t.typeC4Shape.text + "Font"](), f.fontColor = o, t.techn && ((r = t.techn) == null ? void 0 : r.text) !== "" ? Y(n)(t.techn.text, l, t.x, t.y + t.techn.Y, t.width, t.height, {
		fill: o,
		"font-style": "italic"
	}, f) : t.type && t.type.text !== "" && Y(n)(t.type.text, l, t.x, t.y + t.type.Y, t.width, t.height, {
		fill: o,
		"font-style": "italic"
	}, f), t.descr && t.descr.text !== "" && (f = n.personFont(), f.fontColor = o, Y(n)(t.descr.text, l, t.x, t.y + t.descr.Y, t.width, t.height, { fill: o }, f)), t.height;
}, "drawC4Shape"), ve = /* @__PURE__ */ t(function(e, t) {
...
}, "insertDatabaseIcon"), ye = /* @__PURE__ */ t(function(e, t) {
...
}, "insertComputerIcon"), be = /* @__PURE__ */ t(function(e, t) {
...
}, "insertClockIcon"), xe = /* @__PURE__ */ t(function(e, t) {
...
}, "insertArrowHead"), Se = /* @__PURE__ */ t(function(e, t) {
...
}, "insertArrowEnd"), Ce = /* @__PURE__ */ t(function(e, t) {
...
}, "insertArrowFilledHead"), we = /* @__PURE__ */ t(function(e, t) {
...
}, "insertArrowCrossHead"), Te = /* @__PURE__ */ t((e, t) => ({
	...
	insertArrowHead: xe,
	insertArrowEnd: Se,
	insertArrowFilledHead: Ce,
	insertArrowCrossHead: we,
	insertDatabaseIcon: ve,
	insertComputerIcon: ye,
	insertClockIcon: be
}, Ee = 0, De = 0, Oe = 4, ke = 2;
S.yy = fe;
var Z = {}, Ae = (b = class {
	constructor(e) {
		this.name = "", this.data = {}, this.data.startx = void 0, this.data.stopx = void 0, this.data.starty = void 0, this.data.stopy = void 0, this.data.widthLimit = void 0, this.nextData = {}, this.nextData.startx = void 0, this.nextData.stopx = void 0, this.nextData.starty = void 0, this.nextData.stopy = void 0, this.nextData.cnt = 0, je(e.db.getConfig());
	}
	setData(e, t, n, r) {
...
}, t(b, "Bounds"), b), je = /* @__PURE__ */ t(function(e) {
	o(Z, e), e.fontFamily && (Z.personFontFamily = Z.systemFontFamily = Z.messageFontFamily = e.fontFamily), e.fontSize && (Z.personFontSize = Z.systemFontSize = Z.messageFontSize = e.fontSize), e.fontWeight && (Z.personFontWeight = Z.systemFontWeight = Z.messageFontWeight = e.fontWeight);
}, "setConf"), Me = /* @__PURE__ */ t((e, t) => ({
	fontFamily: e[t + "FontFamily"],
	fontSize: e[t + "FontSize"],
	fontWeight: e[t + "FontWeight"]
}), "c4ShapeFont"), Ne = /* @__PURE__ */ t((e) => ({
	fontFamily: e.boundaryFontFamily,
	fontSize: e.boundaryFontSize,
	fontWeight: e.boundaryFontWeight
}), "boundaryFont"), Pe = /* @__PURE__ */ t((e) => ({
	fontFamily: e.messageFontFamily,
	fontSize: e.messageFontSize,
	fontWeight: e.messageFontWeight
}), "messageFont");
function Q(e, t, n, r, i) {
	if (!t[e].width) if (n) t[e].text = p(t[e].text, i, r), t[e].textLines = t[e].text.split(s.lineBreakRegex).length, t[e].width = i, t[e].height = m(t[e].text, r);
	else {
		let n = t[e].text.split(s.lineBreakRegex);
		t[e].textLines = n.length;
		let i = 0;
		t[e].height = 0, t[e].width = 0;
		for (let a of n) t[e].width = Math.max(h(a, r), t[e].width), i = m(a, r), t[e].height = t[e].height + i;
	}
}
t(Q, "calcC4ShapeTextWH");
var Fe = /* @__PURE__ */ t(function(e, t, n) {
	...
	let r = t.wrap && Z.wrap, i = Ne(Z);
	i.fontSize += 2, i.fontWeight = "bold", Q("label", t, r, i, h(t.label.text, i)), X.drawBoundary(e, t, Z);
}, "drawBoundary"), Ie = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = 0;
	for (let a of r) {
		i = 0;
		let r = n[a], o = Me(Z, r.typeC4Shape.text);
		...
		let s = r.wrap && Z.wrap, l = Z.width - Z.c4ShapePadding * 2, u = Me(Z, r.typeC4Shape.text);
		u.fontSize += 2, u.fontWeight = "bold", Q("label", r, s, u, l), r.label.Y = i + 8, i = r.label.Y + r.label.height, r.type && r.type.text !== "" ? (r.type.text = "[" + r.type.text + "]", Q("type", r, s, Me(Z, r.typeC4Shape.text), l), r.type.Y = i + 5, i = r.type.Y + r.type.height) : r.techn && r.techn.text !== "" && (r.techn.text = "[" + r.techn.text + "]", Q("techn", r, s, Me(Z, r.techn.text), l), r.techn.Y = i + 5, i = r.techn.Y + r.techn.height);
		let d = i, f = r.label.width;
		r.descr && r.descr.text !== "" && (Q("descr", r, s, Me(Z, r.typeC4Shape.text), l), r.descr.Y = i + 20, i = r.descr.Y + r.descr.height, f = Math.max(r.label.width, r.descr.width), d = i - r.descr.textLines * 5), f += Z.c4ShapePadding, r.width = Math.max(r.width || Z.width, f, Z.width), r.height = Math.max(r.height || Z.height, d, Z.height), r.margin = r.margin || Z.c4ShapeMargin, e.insert(r), X.drawC4Shape(t, r, Z);
	}
	e.bumpLastMargin(Z.c4ShapeMargin);
}, "drawC4ShapeArray"), $ = (x = class {
	constructor(e, t) {
		this.x = e, this.y = t;
	}
}, t(x, "Point"), x), Le = /* @__PURE__ */ t(function(e, t) {
...
}, "getIntersectPoint"), Re = /* @__PURE__ */ t(function(e, t) {
	let n = {
		x: 0,
		y: 0
	};
...
}, "getIntersectPoints"), ze = /* @__PURE__ */ t(function(e, t, n, r, i) {
	let a = 0;
	for (let e of t) {
		a += 1;
		let t = e.wrap && Z.wrap, i = Pe(Z);
...
function Be(e, t, n, r, i) {
	let a = new Ae(i);
	a.data.widthLimit = n.data.widthLimit / Math.min(ke, r.length);
	for (let [o, s] of r.entries()) {
		...
		let l = s.wrap && Z.wrap, u = Ne(Z);
		if (u.fontSize += 2, u.fontWeight = "bold", Q("label", s, l, u, a.data.widthLimit), s.label.Y = r + 8, r = s.label.Y + s.label.height, s.type && s.type.text !== "" && (s.type.text = "[" + s.type.text + "]", Q("type", s, l, Ne(Z), a.data.widthLimit), s.type.Y = r + 5, r = s.type.Y + s.type.height), s.descr && s.descr.text !== "") {
			let e = Ne(Z);
		...
		f.length > 0 && Ie(a, e, d, f), t = s.alias;
		let p = i.db.getBoundaries(t);
		p.length > 0 && Be(e, t, a, p, i), s.alias !== "global" && Fe(e, s, a), n.data.stopy = Math.max(a.data.stopy + Z.c4ShapeMargin, n.data.stopy), n.data.stopx = Math.max(a.data.stopx + Z.c4ShapeMargin, n.data.stopx), Ee = Math.max(Ee, n.data.stopx), De = Math.max(De, n.data.stopy);
	}
}
t(Be, "drawInsideBoundary");
var Ve = {
	drawPersonOrSystemArray: Ie,
	drawBoundary: Fe,
	setConf: je,
	draw: /* @__PURE__ */ t(function(t, r, i, o) {
		Z = u().c4;
		let s = u().securityLevel, l;
		s === "sandbox" && (l = n("#i" + r));
		let d = n(s === "sandbox" ? l.nodes()[0].contentDocument.body : "body"), f = o.db;
		o.db.setWrap(Z.wrap), Oe = f.getC4ShapeInRow(), ke = f.getC4BoundaryInRow(), e.debug(`C:${JSON.stringify(Z, null, 2)}`);
		let p = s === "sandbox" ? d.select(`[id="${r}"]`) : n(`[id="${r}"]`);
		X.insertComputerIcon(p, r), X.insertDatabaseIcon(p, r), X.insertClockIcon(p, r);
		let m = new Ae(o);
		m.setData(Z.diagramMarginX, Z.diagramMarginX, Z.diagramMarginY, Z.diagramMarginY), m.data.widthLimit = screen.availWidth, Ee = Z.diagramMarginX, De = Z.diagramMarginY;
		let h = o.db.getTitle();
		Be(p, "", m, o.db.getBoundaries(""), o), X.insertArrowHead(p, r), X.insertArrowEnd(p, r), X.insertArrowCrossHead(p, r), X.insertArrowFilledHead(p, r), ze(p, o.db.getRels(), o.db.getC4Shape, o, r), m.data.stopx = Ee, m.data.stopy = De;
		let g = m.data, _ = g.stopy - g.starty + 2 * Z.diagramMarginY, v = g.stopx - g.startx + 2 * Z.diagramMarginX;
		h && p.append("text").text(h).attr("x", (g.stopx - g.startx) / 2 - 4 * Z.diagramMarginX).attr("y", g.starty + Z.diagramMarginY), a(p, _, v, Z.useMaxWidth);
		let y = h ? 60 : 0;
