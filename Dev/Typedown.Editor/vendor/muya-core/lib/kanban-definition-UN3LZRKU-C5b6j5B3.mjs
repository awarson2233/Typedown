...
import { $ as n, J as r, et as i, f as a, nt as o, x as s, z as c } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as l } from "./chunk-WU5MYG2G-CWOh8Nru.mjs";
import "./chunk-O5CBEL6O-DN64hWSU.mjs";
import { t as u } from "./chunk-FMBD7UC4-DiPYrba8.mjs";
import "./chunk-L5ZTLDWV-EfUVro68.mjs";
import "./chunk-NZK2D7GU-BP4KY081.mjs";
import { a as d, c as f, i as p } from "./chunk-3OPIFGDE-Al6MeL3x.mjs";
import { n as m, t as h } from "./chunk-XPW4576I-oigDzoPt.mjs";
...
var _ = g, v = [], y = [], b = 0, x = {}, S = /* @__PURE__ */ t(() => {
	...
	for (let e of n) {
		...
		t.push(n);
		let o = v.filter((t) => t.parentId === e.id);
		for (let n of o) {
			var a;
			let i = {
				id: n.id,
				parentId: e.id,
				label: c((a = n.label) == null ? "" : a, r),
				labelType: "markdown",
				isGroup: !1,
...
}, "getData"), E = /* @__PURE__ */ t((e, t, n, r, i) => {
	var o, l, u, d;
	let f = s(), p = (o = (l = f.mindmap) == null ? void 0 : l.padding) == null ? a.mindmap.padding : o;
	switch (r) {
		case D.ROUNDED_RECT:
		case D.RECT:
		case D.HEXAGON: p *= 2;
	...
	let g = {
		...
		level: e,
		label: c(n, f),
		width: (u = (d = f.mindmap) == null ? void 0 : d.maxNodeWidth) == null ? a.mindmap.maxNodeWidth : u,
		padding: p,
		isGroup: !1
	};
	if (i !== void 0) {
	...
	let _ = C(e);
	_ ? g.parentId = _.id || "kbn" + b++ : y.push(g), v.push(g);
}, "addNode"), D = {
	DEFAULT: 0,
	NO_BORDER: 0,
	ROUNDED_RECT: 1,
...
}, k = { draw: /* @__PURE__ */ t(async (t, n, i, o) => {
	var c, u, m, h;
	e.debug("Rendering kanban diagram\n" + t);
	let g = o.db.getData(), _ = s();
	_.htmlLabels = !1;
	let v = l(n);
	for (let e of g.nodes) e.domId = `${n}-${e.id}`;
	let y = v.append("g");
	y.attr("class", "sections");
	let b = v.append("g");
	b.attr("class", "items");
	let x = g.nodes.filter((e) => e.isGroup), S = 0, C = [], w = 25;
	for (let e of x) {
		var T, E;
	...
	for (let e of x) {
		...
		let t = C[D];
		D += 1;
		let n = (_ == null || (O = _.kanban) == null ? void 0 : O.sectionWidth) || 200, r = -n * 3 / 2 + w, i = r, a = g.nodes.filter((t) => t.parentId === e.id);
		for (let t of a) {
			if (t.isGroup) throw Error("Groups within groups are not allowed in Kanban diagrams");
			t.x = e.x, t.width = n - 1.5 * 10;
			let r = (await d(b, t, { config: _ })).node().getBBox();
			t.y = i + r.height / 2, await f(t), i = t.y + r.height / 2 + 10 / 2;
		}
		let o = t.cluster.select("rect"), s = Math.max(i - r + 30, 50) + (w - 25);
		o.attr("height", s);
	}
	r(void 0, v, (c = (u = _.mindmap) == null ? void 0 : u.padding) == null ? a.kanban.padding : c, (m = (h = _.mindmap) == null ? void 0 : h.useMaxWidth) == null ? a.kanban.useMaxWidth : m);
}, "draw") }, A = /* @__PURE__ */ t((e) => {
	let r = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) e["lineColor" + t] = e["lineColor" + t] || e["cScaleInv" + t], o(e["lineColor" + t]) ? e["lineColor" + t] = i(e["lineColor" + t], 20) : e["lineColor" + t] = n(e["lineColor" + t], 20);
	let a = /* @__PURE__ */ t((t, r) => e.darkMode ? n(t, r) : i(t, r), "adjuster");
