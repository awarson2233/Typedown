import { t as e } from "./defineProperty-DiFpLzd2.mjs";
...
sn(ji, {
	...
	AbstractCstNode: () => EN,
	AbstractLangiumParser: () => FN,
	AbstractParserErrorMessageProvider: () => LN,
	AbstractThreadedAsyncParser: () => aI,
	AstUtils: () => Ji,
	BiMap: () => HP,
	Cancellation: () => Q,
	CompositeCstNodeImpl: () => ON,
	ContextCache: () => XP,
	CstNodeBuilder: () => TN,
	CstUtils: () => Mi,
	DEFAULT_TOKENIZE_OPTIONS: () => wF,
	DONE_RESULT: () => Gi,
	DatatypeSymbol: () => jN,
	DefaultAstNodeDescriptionProvider: () => pF,
	DefaultAstNodeLocator: () => hF,
	DefaultAsyncParser: () => iI,
	DefaultCommentProvider: () => rI,
	DefaultConfigurationProvider: () => _F,
	DefaultDocumentBuilder: () => bF,
	DefaultDocumentValidator: () => cF,
	DefaultHydrator: () => cI,
	DefaultIndexManager: () => xF,
	DefaultJsonSerializer: () => nF,
	DefaultLangiumDocumentFactory: () => PP,
	DefaultLangiumDocuments: () => FP,
	DefaultLangiumProfiler: () => AI,
	DefaultLexer: () => TF,
	DefaultLexerErrorMessageProvider: () => CF,
	DefaultLinker: () => LP,
	DefaultNameProvider: () => zP,
	DefaultReferenceDescriptionProvider: () => mF,
	DefaultReferences: () => BP,
	DefaultScopeComputation: () => UP,
	DefaultScopeProvider: () => $P,
	DefaultServiceRegistry: () => rF,
	DefaultTokenBuilder: () => uP,
	DefaultValueConverter: () => dP,
	DefaultWorkspaceLock: () => sI,
	DefaultWorkspaceManager: () => SF,
	Deferred: () => xP,
	Disposable: () => yF,
	DisposableCache: () => JP,
	DocumentCache: () => ZP,
	DocumentState: () => $,
	DocumentValidator: () => fF,
	EMPTY_SCOPE: () => qP,
	EMPTY_STREAM: () => Wi,
	EmptyFileSystem: () => TI,
	...
	JSDocDocumentationProvider: () => nI,
	LangiumCompletionParser: () => zN,
	LangiumParser: () => IN,
	LangiumParserErrorMessageProvider: () => RN,
	LeafCstNodeImpl: () => DN,
	LexingMode: () => bI,
	MapScope: () => GP,
	Module: () => dI,
	...
	UriTrie: () => NP,
	UriUtils: () => MP,
	VALIDATE_EACH_NODE: () => sF,
	ValidationCategory: () => aF,
	ValidationRegistry: () => oF,
	ValueConverter: () => fP,
	WorkspaceCache: () => QP,
	assertCondition: () => Ms,
	assertUnreachable: () => js,
	createCompletionParser: () => sP,
	createDefaultCoreModule: () => lI,
	createDefaultSharedCoreModule: () => uI,
	createGrammarConfig: () => Hc,
	createLangiumParser: () => cP,
	createParser: () => UN,
	delayNextTick: () => pP,
	diagnosticData: () => iF,
	eagerLoad: () => mI,
	getDiagnosticRange: () => lF,
	indentationBuilderDefaultOptions: () => yI,
	inject: () => fI,
	interruptAndCheck: () => bP,
	isAstNode: () => F,
	isAstNodeDescription: () => Fi,
	isAstNodeWithComment: () => eF,
	isCompositeCstNode: () => Ri,
	isIMultiModeLexerDefinition: () => DF,
	isJSDoc: () => AF,
	isLeafCstNode: () => zi,
	isLinkingError: () => Ii,
	isMultiReference: () => Pi,
	isNamed: () => RP,
	isOperationCancelled: () => yP,
	isReference: () => Ni,
	isRootCstNode: () => Bi,
	isTokenTypeArray: () => EF,
	...
	parseJSDoc: () => kF,
	prepareLangiumParser: () => lP,
	setInterruptionPeriod: () => _P,
	startCancelableOperation: () => gP,
	stream: () => I,
	toDiagnosticData: () => dF,
	toDiagnosticSeverity: () => uF
});
var Mi = {};
sn(Mi, {
...
var Li = (t = class {
	...
	isInstance(e, t) {
		return F(e) && this.isSubtype(e.$type, t);
	}
	isSubtype(e, t) {
		if (e === t) return !0;
...
k(Bi, "isRootCstNode");
var Vi = (Zt = Symbol.iterator, n = class e {
	constructor(e, t) {
	...
	flat(t) {
		...
		return new e(() => ({ this: n.startFn() }), (e) => {
			do {
				...
				if (!t) if (Ui(r)) e.iterator = r[Symbol.iterator]();
				else return {
					done: !1,
					value: r
				};
...
function Yi(e, t = {}) {
	for (let [n, r] of Object.entries(e)) n.startsWith("$") || (Array.isArray(r) ? r.forEach((r, i) => {
		F(r) && (r.$container = e, r.$containerProperty = n, r.$containerIndex = i, t.deep && Yi(r, t));
	}) : F(r) && (r.$container = e, r.$containerProperty = n, t.deep && Yi(r, t)));
}
k(Yi, "linkContentToContainer");
function Xi(e, t) {
	let n = e;
	for (; n;) {
		if (t(n)) return n;
...
k(na, "streamAllContents");
function ra(e, t) {
	if (!e) throw Error("Root node must be an AstNode.");
	return t != null && t.range && !ia(e, t.range) ? new Ki(e, () => []) : new Ki(e, (e) => ta(e, t), { includeRoot: !0 });
}
k(ra, "streamAst");
function ia(e, t) {
	var n;
...
k(oa, "assignMandatoryProperties");
function sa(e) {
	return Array.isArray(e) ? [...e.map(sa)] : e;
}
k(sa, "copyDefaultValue");
function ca(e, t, n) {
	let r = { $type: e.$type };
	n && (n.set(e, r), n.set(r, e));
	for (let [i, a] of Object.entries(e)) if (!i.startsWith("$")) if (F(a)) r[i] = ca(a, t, n);
	else if (Ni(a)) r[i] = t(r, i, a.$refNode, a.$refText, a);
	else if (Array.isArray(a)) {
		let e = [];
		for (let o of a) F(o) ? e.push(ca(o, t, n)) : Ni(o) ? e.push(t(r, i, o.$refNode, o.$refText, o)) : e.push(o);
		r[i] = e;
	} else r[i] = a;
...
}, k(i, "LangiumGrammarAstReflection"), i), L = new os();
function ss(e) {
	let t = e, n = !1;
	for (; t;) {
...
k(_s, "findDeclarationNodeAtOffset");
function vs(e, t) {
	if (e) {
		let n = Cs(e, !0);
...
k(Ts, "getStartlineNode");
function Es(e, t) {
	let n = Ds(e, t);
	return n ? n.parent.content.slice(n.a + 1, n.b) : [];
}
k(Es, "getInteriorNodes");
function Ds(e, t) {
	let n = Os(e), r = Os(t), i;
...
k(sc, "getAllRulesUsedForCrossReferences");
function cc(e) {
...
k(fc, "findNodesForPropertyInternal");
function pc(e, t) {
	return e ? hc(e, t, e == null ? void 0 : e.astNode) : [];
}
k(pc, "findNodesForKeyword");
function mc(e, t, n) {
	if (!e) return;
	let r = hc(e, t, e == null ? void 0 : e.astNode);
	if (r.length !== 0) return n = n === void 0 ? 0 : Math.max(0, Math.min(n, r.length - 1)), r[n];
}
k(mc, "findNodeForKeyword");
function hc(e, t, n) {
...
k(hc, "findNodesForKeywordInternal");
function gc(e) {
	var t;
	let n = e.astNode;
...
function vc(e, t, n) {
	...
	for (let a of na(t)) {
		var i;
		if (Oa(a) && a.feature.toLowerCase() === "name") return n.set(e, a), a;
		if (ko(a) && xo(a.rule.ref)) return r(a, a.rule.ref);
		if (jo(a) && (i = a.typeRef) != null && i.ref) return r(a, a.typeRef.ref);
	}
}
k(vc, "findNameAssignmentInternal");
function yc(e) {
	let t = e.$container;
	if (Ja(t)) {
...
k(yc, "getActionAtElement");
function bc(e, t) {
	return e === "?" || e === "*" || Ja(t) && !!t.guardCondition;
}
k(bc, "isOptionalCardinality");
function xc(e) {
	return e === "*" || e === "+";
}
k(xc, "isArrayCardinality");
function Sc(e) {
	return e === "+=";
}
k(Sc, "isArrayOperator");
function Cc(e) {
...
k(Dc, "getExplicitRuleType");
function Oc(e) {
	if (ma(e)) {
		var t;
		return xo(e) && Cc(e) || (t = Dc(e)) == null ? e.name : t;
	} else if (io(e) || Go(e) || Do(e)) return e.name;
	else if (ba(e)) {
		let t = kc(e);
		if (t) return t;
...
function kc(e) {
	var t;
	if (e.inferredType) return e.inferredType.name;
	if ((t = e.type) != null && t.ref) return Oc(e.type.ref);
}
k(kc, "getActionType");
function Ac(e) {
	if (Vo(e)) {
		...
		var r;
		return xo(e) && Cc(e) || (r = Dc(e)) == null ? e.name : r;
	}
}
k(Ac, "getRuleTypeName");
function jc(e) {
	if (Vo(e)) {
		var t, n;
		return (t = (n = e.type) == null ? void 0 : n.name) == null ? "string" : t;
...
function Pc(e, t) {
	...
	} else if (uo(e)) return Rc(e);
	else if (ts(e)) return Lc(e);
	else if (To(e)) {
...
k(Fc, "terminalAlternativesToRegex");
function Ic(e) {
	return Vc(e.elements.map((e) => Pc(e)).join(""), {
		cardinality: e.cardinality,
		lookahead: e.lookahead,
...
k(fl, "arrayMap");
var pl = fl, z = Array.isArray, ml = Infinity, hl = Kc ? Kc.prototype : void 0, gl = hl ? hl.toString : void 0;
function _l(e) {
...
k(Ml, "toNumber");
var Nl = Ml, Pl = Infinity, Fl = 17976931348623157e292;
function Il(e) {
...
function Ku(e, t) {
	var n = typeof e;
	return t = t == null ? Wu : t, !!t && (n == "number" || n != "symbol" && Gu.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
k(Ku, "isIndex");
var qu = Ku;
function Ju(e, t, n) {
...
k(tp, "Hash"), tp.prototype.clear = Hf, tp.prototype.delete = Wf, tp.prototype.get = Jf, tp.prototype.has = Zf, tp.prototype.set = ep;
var np = tp;
function rp() {
...
k(gp, "ListCache"), gp.prototype.clear = ip, gp.prototype.delete = lp, gp.prototype.get = dp, gp.prototype.has = pp, gp.prototype.set = hp;
...
k(Np, "MapCache"), Np.prototype.clear = bp, Np.prototype.delete = Ep, Np.prototype.get = Op, Np.prototype.has = Ap, Np.prototype.set = Mp;
...
k(Em, "Stack"), Em.prototype.clear = gm, Em.prototype.delete = vm, Em.prototype.get = bm, Em.prototype.has = Sm, Em.prototype.set = Tm;
var Dm = Em;
function Om(e, t) {
...
(nh && gh(new nh(/* @__PURE__ */ new ArrayBuffer(1))) != uh || vp && gh(new vp()) != ah || rh && gh(rh.resolve()) != sh || ih && gh(new ih()) != ch || mu && gh(new mu()) != lh) && (gh = /* @__PURE__ */ k(function(e) {
...
k(t_, "SetCache"), t_.prototype.add = t_.prototype.push = Qg, t_.prototype.has = e_;
var n_ = t_;
function r_(e, t) {
...
function ly(e) {
	return function(t, n, r) {
		...
		if (!fd(t)) {
			var a = bv(n, 3);
			t = Ef(t), n = /* @__PURE__ */ k(function(e) {
				return a(i[e], e, i);
			}, "predicate");
		}
		var o = e(t, n, r);
...
k(mb, "some");
var hb = mb, gb = ih && 1 / m_(new ih([, -0]))[1] == Infinity ? function(e) {
	return new ih(e);
} : bu, _b = 200;
function vb(e, t, n) {
...
}, k(l, "AbstractProduction"), l), kb = (u = class extends Ob {
	constructor(e) {
...
}, k(u, "NonTerminal"), u), Ab = (d = class extends Ob {
	constructor(e) {
		super(e.definition), this.orgText = "", Of(this, ab(e, (e) => e !== void 0));
	}
}, k(d, "Rule"), d), jb = (f = class extends Ob {
	constructor(e) {
		super(e.definition), this.ignoreAmbiguities = !1, Of(this, ab(e, (e) => e !== void 0));
	}
}, k(f, "Alternative"), f), Mb = (p = class extends Ob {
	constructor(e) {
		super(e.definition), this.idx = 1, Of(this, ab(e, (e) => e !== void 0));
	}
}, k(p, "Option"), p), Nb = (m = class extends Ob {
	constructor(e) {
		super(e.definition), this.idx = 1, Of(this, ab(e, (e) => e !== void 0));
	}
}, k(m, "RepetitionMandatory"), m), Pb = (h = class extends Ob {
	constructor(e) {
		super(e.definition), this.idx = 1, Of(this, ab(e, (e) => e !== void 0));
	}
}, k(h, "RepetitionMandatoryWithSeparator"), h), K = (g = class extends Ob {
	constructor(e) {
		super(e.definition), this.idx = 1, Of(this, ab(e, (e) => e !== void 0));
	}
}, k(g, "Repetition"), g), Fb = (_ = class extends Ob {
	constructor(e) {
		super(e.definition), this.idx = 1, Of(this, ab(e, (e) => e !== void 0));
	}
}, k(_, "RepetitionWithSeparator"), _), Ib = (v = class extends Ob {
	get definition() {
		return this._definition;
	}
	set definition(e) {
...
k(Lb, "serializeGrammar");
function Rb(e) {
	function t(e) {
		return U(e, Rb);
	}
	if (k(t, "convertDefinition"), e instanceof kb) {
		let t = {
			type: "NonTerminal",
	...
	} else if (e instanceof Ab) return {
		type: "Rule",
		name: e.name,
		orgText: e.orgText,
		definition: t(e.definition)
...
k(Bb, "isSequenceProd");
function Vb(e, t = []) {
	return e instanceof Mb || e instanceof K || e instanceof Fb ? !0 : e instanceof Ib ? hb(e.definition, (e) => Vb(e, t)) : e instanceof kb && Iy(t, e) ? !1 : e instanceof Ob ? (e instanceof kb && t.push(e), iy(e.definition, (e) => Vb(e, t))) : !1;
}
k(Vb, "isOptionalProd");
function Hb(e) {
	return e instanceof Ib;
}
k(Hb, "isBranchingProd");
function Ub(e) {
...
k(Gb, "restForRepetitionWithSeparator");
function Kb(e) {
...
k(qb, "firstForSequence");
function Jb(e) {
	return xb(lm(U(e.definition, (e) => Kb(e))));
}
k(Jb, "firstForBranching");
function Yb(e) {
	return [e.terminalType];
}
k(Yb, "firstForTerminal");
var Xb = "_~IN~_", Zb = (x = class extends Wb {
	constructor(e) {
...
function Qb(e) {
	let t = {};
	return H(e, (e) => {
		Of(t, new Zb(e).startWalking());
	}), t;
}
k(Qb, "computeAllProdsFollows");
function $b(e, t) {
	return e.name + t + Xb;
}
k($b, "buildBetweenProdsFollowPrefix");
var ex = {}, tx = new Gs();
function nx(e) {
	let t = e.toString();
...
k(ox, "getOptimizedStartCodesIndices");
function sx(e, t, n) {
	switch (e.type) {
		case "Disjunction":
						...
						H(a.value, (e) => {
							if (typeof e == "number") cx(e, t, n);
								...
								if (n === !0) for (let e = r.from; e <= r.to; e++) cx(e, t, n);
									...
									for (let e = r.from; e <= r.to && e < Jx; e++) cx(e, t, n);
									if (r.to >= Jx) {
										let e = r.from >= Jx ? r.from : Jx, n = r.to, i = Xx(e), a = Xx(n);
...
k(sx, "firstCharOptimizedIndices");
function cx(e, t, n) {
	let r = Xx(e);
	t[r] = r, n === !0 && lx(e, t);
}
k(cx, "addOptimizedIdxToResult");
function lx(e, t) {
	let n = String.fromCharCode(e), r = n.toUpperCase();
	if (r !== n) {
		let e = Xx(r.charCodeAt(0));
		t[e] = e;
	} else {
		let e = n.toLowerCase();
		if (e !== n) {
			let n = Xx(e.charCodeAt(0));
			t[n] = n;
		}
	}
}
k(lx, "handleIgnoreCase");
function ux(e, t) {
	return py(e.value, (e) => {
...
k(dx, "isWholeOptional");
var fx = (S = class extends Ks {
	constructor(e) {
...
function px(e, t) {
	...
	} else return py(t, (t) => Iy(e, t.charCodeAt(0))) !== void 0;
}
k(px, "canMatchCharCode");
var mx = "PATTERN", hx = "defaultMode", gx = "modes", _x = typeof (/* @__PURE__ */ RegExp("(?:)")).sticky == "boolean";
function vx(e, t) {
	t = Fv(t, {
		useSticky: _x,
		debug: !1,
	...
	n("Transform Patterns", () => {
		i = !1, a = U(r, (e) => {
			...
			if (Jy(n)) {
				let e = n.source;
				return e.length === 1 && e !== "^" && e !== "$" && e !== "." && !n.ignoreCase ? e : e.length === 2 && e[0] === "\\" && !Iy([
					"d",
					"D",
					"s",
					"S",
					...
					"w",
					"W"
				], e[1]) ? e[1] : t.useSticky ? Lx(n) : Ix(n);
			} else if (ql(n)) return i = !0, { exec: n };
			else if (typeof n == "object") return i = !0, n;
			else if (typeof n == "string") {
				if (n.length === 1) return n;
				{
					let e = n.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"), r = new RegExp(e);
					return t.useSticky ? Lx(r) : Ix(r);
				}
			} else throw Error("non exhaustive match");
		});
	});
	...
	n("Line Terminator Handling", () => {
		let e = Kx(t.lineTerminatorCharacters);
		d = U(r, (e) => !1), t.positionTracking !== "onlyOffset" && (d = U(r, (t) => W(t, "LINE_BREAKS") ? !!t.LINE_BREAKS : Wx(t, e) === !1 && px(e, t.PATTERN)));
	});
	let f, p, m, h;
	n("Misc Mapping #2", () => {
		f = U(r, Vx), p = U(a, Hx), m = lb(r, (e, t) => {
			let n = t.GROUP;
			return ky(n) && n !== hS.SKIPPED && (e[n] = []), e;
		}, {}), h = U(a, (e, t) => ({
			pattern: a[t],
			longerAlt: c[t],
	...
	return t.safeMode || n("First Char Optimization", () => {
		_ = lb(r, (e, n, r) => {
			if (typeof n.PATTERN == "string") qx(e, Xx(n.PATTERN.charCodeAt(0)), h[r]);
			else if (z(n.START_CHARS_HINT)) {
				let t;
				H(n.START_CHARS_HINT, (n) => {
					let i = Xx(typeof n == "string" ? n.charCodeAt(0) : n);
					t !== i && (t = i, qx(e, i, h[r]));
				});
			} else if (Jy(n.PATTERN)) if (n.PATTERN.unicode) g = !1, t.ensureOptimizations && Sb(`${ax}	Unable to analyze < ${n.PATTERN.toString()} > pattern.
...
k(vx, "analyzeTokenTypes");
function yx(e, t) {
	let n = [], r = xx(e);
	n = n.concat(r.errors);
	let i = Sx(r.valid), a = i.valid;
	return n = n.concat(i.errors), n = n.concat(bx(a)), n = n.concat(Ax(a)), n = n.concat(jx(a, t)), n = n.concat(Mx(a)), n;
}
k(yx, "validatePatterns");
function bx(e) {
	let t = [], n = cy(e, (e) => Jy(e[mx]));
	return t = t.concat(wx(n)), t = t.concat(Dx(n)), t = t.concat(Ox(n)), t = t.concat(kx(n)), t = t.concat(Tx(n)), t;
}
k(bx, "validateRegExpPattern");
function xx(e) {
	let t = cy(e, (e) => !W(e, mx));
	return {
		errors: U(t, (e) => ({
...
function wx(e) {
	...
	return t = n, k(t, "EndAnchorFinder"), U(cy(e, (e) => {
		let t = e.PATTERN;
		try {
			let e = nx(t), r = new n();
			return r.visit(e), r.found;
		} catch {
			return Cx.test(t.source);
		}
	}), (e) => ({
...
function Dx(e) {
	...
	return t = n, k(t, "StartAnchorFinder"), U(cy(e, (e) => {
		let t = e.PATTERN;
		try {
			let e = nx(t), r = new n();
			return r.visit(e), r.found;
		} catch {
			return Ex.test(t.source);
		}
	}), (e) => ({
...
k(Ox, "findUnsupportedFlags");
function kx(e) {
	let t = [], n = U(e, (n) => lb(e, (e, r) => n.PATTERN.source === r.PATTERN.source && !Iy(t, r) && r.PATTERN !== hS.NA ? (t.push(r), e.push(r), e) : e, []));
...
k(kx, "findDuplicatePatterns");
function Ax(e) {
	return U(cy(e, (e) => {
		if (!W(e, "GROUP")) return !1;
		let t = e.GROUP;
		return t !== hS.SKIPPED && t !== hS.NA && !ky(t);
	}), (e) => ({
...
k(jx, "findModesThatDoNotExist");
function Mx(e) {
	let t = [], n = lb(e, (e, t, n) => {
		let r = t.PATTERN;
		return r === hS.NA || (ky(r) ? e.push({
			str: r,
			idx: n,
			tokenType: t
		}) : Jy(r) && Px(r) && e.push({
...
k(Mx, "findUnreachablePatterns");
function Nx(e, t) {
	if (Jy(t)) {
		if (Fx(t)) return !1;
		let n = t.exec(e);
		return n !== null && n.index === 0;
	} else if (ql(t)) return t(e, 0, [], {});
	else if (W(t, "exec")) return t.exec(e, 0, [], {});
	else if (typeof t == "string") return t === e;
	else throw Error("non exhaustive match");
}
k(Nx, "tryToMatchStrToPattern");
function Px(e) {
	return py([
		".",
		"\\",
...
k(Fx, "usesLookAheadOrBehind");
function Ix(e) {
	let t = e.ignoreCase ? "i" : "";
	return RegExp(`^(?:${e.source})`, t);
}
k(Ix, "addStartOfInput");
function Lx(e) {
...
k(Rx, "performRuntimeChecks");
function zx(e, t, n) {
	let r = [], i = !1, a = db(Yg(lm(Ny(e.modes))), (e) => e[mx] === hS.NA), o = Kx(n);
	return t && H(a, (e) => {
		let t = Wx(e, o);
		if (t !== !1) {
			let n = {
...
k(zx, "performWarningRuntimeChecks");
function Bx(e) {
	let t = {};
	return H(Ef(e), (n) => {
		let r = e[n];
...
function Wx(e, t) {
	...
	if (Jy(e.PATTERN)) {
		...
		return !1;
	} else if (ky(e.PATTERN)) return !1;
	else if (Vx(e)) return { issue: J.CUSTOM_LINE_BREAK };
	else throw Error("non exhaustive match");
}
k(Wx, "checkLineBreaksIssues");
function Gx(e, t) {
...
k(Gx, "buildLineBreakIssueMessage");
function Kx(e) {
...
k(qx, "addToMapOfArrays");
var Jx = 256, Yx = [];
function Xx(e) {
	return e < Jx ? e : Yx[e];
}
k(Xx, "charCodeToOptimizedIndex");
function Zx() {
	if (G(Yx)) {
		Yx = Array(65536);
		for (let e = 0; e < 65536; e++) Yx[e] = e > 255 ? 255 + ~~(e / 255) : e;
	}
}
k(Zx, "initCharCodeToOptimizedIndexMap");
function Qx(e, t) {
	let n = e.tokenTypeIdx;
	return n === t.tokenTypeIdx ? !0 : t.isParent === !0 && t.categoryMatchesMap[n] === !0;
}
k(Qx, "tokenStructuredMatcher");
function $x(e, t) {
	return e.tokenTypeIdx === t.tokenTypeIdx;
}
k($x, "tokenStructuredMatcherNoCategories");
var eS = 1, tS = {};
function nS(e) {
	let t = rS(e);
	iS(t), oS(t), aS(t), H(t, (e) => {
		e.isParent = e.categoryMatches.length > 0;
	});
}
k(nS, "augmentTokenTypes");
function rS(e) {
	let t = qg(e), n = e, r = !0;
	for (; r;) {
...
k(rS, "expandCategories");
function iS(e) {
	H(e, (e) => {
		cS(e) || (tS[eS] = e, e.tokenTypeIdx = eS++), lS(e) && !z(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), lS(e) || (e.CATEGORIES = []), uS(e) || (e.categoryMatches = []), dS(e) || (e.categoryMatchesMap = {});
	});
}
k(iS, "assignTokenDefaultProps");
function aS(e) {
	H(e, (e) => {
		e.categoryMatches = [], H(e.categoryMatchesMap, (t, n) => {
			e.categoryMatches.push(tS[n].tokenTypeIdx);
		});
	});
}
k(aS, "assignCategoriesTokensProp");
function oS(e) {
	H(e, (e) => {
		sS([], e);
	});
}
k(oS, "assignCategoriesMapProp");
function sS(e, t) {
	H(e, (e) => {
...
k(sS, "singleAssignCategoriesToksMap");
function cS(e) {
	return W(e, "tokenTypeIdx");
}
k(cS, "hasShortKeyProperty");
function lS(e) {
	return W(e, "CATEGORIES");
}
k(lS, "hasCategoriesProperty");
function uS(e) {
	return W(e, "categoryMatches");
}
k(uS, "hasExtendingTokensTypesProperty");
function dS(e) {
	return W(e, "categoryMatchesMap");
}
k(dS, "hasExtendingTokensTypesMapProperty");
function fS(e) {
	return W(e, "tokenTypeIdx");
}
k(fS, "isTokenType");
...
var hS = (te = class {
	constructor(e, t = mS) {
		...
		n === !0 ? (this.traceInitMaxIdent = Infinity, this.traceInitPerf = !0) : typeof n == "number" && (this.traceInitMaxIdent = n, this.traceInitPerf = !0), this.traceInitIndent = -1, this.TRACE_INIT("Lexer Constructor", () => {
			...
			this.TRACE_INIT("Lexer Config handling", () => {
				if (this.config.lineTerminatorsPattern === mS.lineTerminatorsPattern) this.config.lineTerminatorsPattern = Ux;
				else if (this.config.lineTerminatorCharacters === mS.lineTerminatorCharacters) throw Error("Error: Missing <lineTerminatorCharacters> property on the Lexer config.\n	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS");
				...
				this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Rx(n, this.trackStartLines, this.config.lineTerminatorCharacters));
			}), this.TRACE_INIT("performWarningRuntimeChecks", () => {
				this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(zx(n, this.trackStartLines, this.config.lineTerminatorCharacters));
			...
			if (H(n.modes, (e, n) => {
				this.TRACE_INIT(`Mode: <${n}> processing`, () => {
					if (this.modes.push(n), this.config.skipValidations === !1 && this.TRACE_INIT("validatePatterns", () => {
						this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(yx(e, i));
			...
			H(this.lexerDefinitionWarning, (e) => {
				...
				if (_x ? (this.chopInput = Vl, this.match = this.matchWithTest) : (this.updateLastIndex = bu, this.match = this.matchWithExec), r && (this.handleModes = bu), this.trackStartLines === !1 && (this.computeNewColumn = Vl), this.trackEndLines === !1 && (this.updateTokenEndLineColumnLocation = bu), /full/i.test(this.config.positionTracking)) this.createTokenInstance = this.createFullToken;
	...
	tokenizeInternal(e, t) {
		let n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _ = e, v = _.length, y = 0, b = 0, ee = this.hasCustom ? 0 : Math.floor(e.length / 10), x = Array(ee), S = [], te = this.trackStartLines ? 1 : void 0, C = this.trackStartLines ? 1 : void 0, w = Bx(this.emptyGroups), ne = this.trackStartLines, T = this.config.lineTerminatorsPattern, E = 0, re = [], ie = [], ae = [], oe = [];
		Object.freeze(oe);
		let se;
		function ce() {
			return re;
		...
		for (; y < v;) {
			...
			if (s !== null) {
				...
				if (m = y - t, C = this.computeNewColumn(C, m), h = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(_, t, m, n, i, Gv(ae)), S.push({
					offset: t,
					line: n,
					column: i,
					length: m,
...
hS.SKIPPED = "This marks a skipped Token pattern, this means each token identified by it will be consumed and then thrown into oblivion, this can be used to for example to completely ignore whitespace.", hS.NA = /NOT_APPLICABLE/;
function gS(e) {
	return _S(e) ? e.LABEL : e.name;
}
k(gS, "tokenLabel");
function _S(e) {
	return ky(e.LABEL) && e.LABEL !== "";
...
k(_S, "hasTokenLabel");
var vS = "parent", yS = "categories", bS = "label", xS = "group", SS = "push_mode", CS = "pop_mode", wS = "longer_alt", TS = "line_breaks", ES = "start_chars_hint";
function DS(e) {
	return OS(e);
}
k(DS, "createToken");
function OS(e) {
	let t = e.pattern, n = {};
	if (n.name = e.name, Xy(t) || (n.PATTERN = t), W(e, vS)) throw "The parent property is no longer supported.\nSee: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.";
	return W(e, yS) && (n.CATEGORIES = e[yS]), nS([n]), W(e, bS) && (n.LABEL = e[bS]), W(e, xS) && (n.GROUP = e[xS]), W(e, CS) && (n.POP_MODE = e[CS]), W(e, SS) && (n.PUSH_MODE = e[SS]), W(e, wS) && (n.LONGER_ALT = e[wS]), W(e, TS) && (n.LINE_BREAKS = e[TS]), W(e, ES) && (n.START_CHARS_HINT = e[ES]), n;
}
k(OS, "createTokenInternal");
var kS = DS({
	name: "EOF",
	pattern: hS.NA
});
...
var MS = {
	buildMismatchTokenMessage({ expected: e, actual: t, previous: n, ruleName: r }) {
		return `Expecting ${_S(e) ? `--> ${gS(e)} <--` : `token of type --> ${e.name} <--`} but found --> '${t.image}' <--`;
	},
...
${U(U(lb(e, (e, t) => e.concat(t), []), (e) => `[${U(e, (e) => gS(e)).join(", ")}]`), (e, t) => `  ${t + 1}. ${e}`).join("\n")}` + a;
	},
  ...
  <${U(e, (e) => `[${U(e, (e) => gS(e)).join(",")}]`).join(" ,")}>` + i;
	}
};
Object.freeze(MS);
var NS = { buildRuleNotFoundError(e, t) {
...
and Non-Terminal names start with a lower case letter.`;
	...
	buildAlternationPrefixAmbiguityError(e) {
		let t = U(e.prefixPath, (e) => gS(e)).join(", "), n = e.alternation.idx === 0 ? "" : e.alternation.idx;
...
For Further details.`;
	...
	buildAlternationAmbiguityError(e) {
		let t = U(e.prefixPath, (e) => gS(e)).join(", "), n = e.alternation.idx === 0 ? "" : e.alternation.idx, r = `Ambiguous Alternatives Detected: <${e.ambiguityIndices.join(" ,")}> in <OR${n}> inside <${e.topLevelRule.name}> Rule,
<${t}> may appears as a prefix path in all these alternatives.
`;
...
var IS = (C = class extends zb {
	...
	visitNonTerminal(e) {
		...
		if (t) e.referencedRule = t;
			...
			this.errors.push({
				message: t,
				type: Vw.UNRESOLVED_SUBRULE_REF,
				ruleName: this.currTopLevel.name,
				unresolvedRefName: e.nonTerminalName
			});
		}
	}
}, k(C, "GastRefResolverVisitor"), C), LS = (w = class extends Wb {
	constructor(e, t) {
...
}, k(w, "AbstractNextPossibleTokensWalker"), w), RS = (ne = class extends LS {
	constructor(e, t) {
...
}, k(ne, "NextAfterTokenWalker"), ne), zS = (T = class extends Wb {
	constructor(e, t) {
...
}, k(T, "AbstractNextTerminalAfterProductionWalker"), T), BS = (E = class extends zS {
	walkMany(e, t, n) {
...
}, k(E, "NextTerminalAfterManyWalker"), E), VS = (re = class extends zS {
	walkManySep(e, t, n) {
		if (e.idx === this.occurrence) {
			let e = hy(t.concat(n));
			this.result.isEndOfRule = e === void 0, e instanceof q && (this.result.token = e.terminalType, this.result.occurrence = e.idx);
...
}, k(re, "NextTerminalAfterManySepWalker"), re), HS = (ie = class extends zS {
	walkAtLeastOne(e, t, n) {
		if (e.idx === this.occurrence) {
			let e = hy(t.concat(n));
			this.result.isEndOfRule = e === void 0, e instanceof q && (this.result.token = e.terminalType, this.result.occurrence = e.idx);
...
}, k(ie, "NextTerminalAfterAtLeastOneWalker"), ie), US = (ae = class extends zS {
	walkAtLeastOneSep(e, t, n) {
		if (e.idx === this.occurrence) {
			let e = hy(t.concat(n));
			this.result.isEndOfRule = e === void 0, e instanceof q && (this.result.token = e.terminalType, this.result.occurrence = e.idx);
...
function GS(e, t, n, r) {
	...
	for (d.push({
		...
		if (h === i) {
			...
			d.push(e);
		} else if (h instanceof q) if (f < c - 1) {
			let e = f + 1, i = t[e];
		...
		else if (h instanceof Ab) d.push(KS(h, f, p, m));
		else throw Error("non exhaustive match");
	}
	return u;
}
k(GS, "nextPossibleTokensAfter");
function KS(e, t, n, r) {
	let i = qg(n);
	i.push(e.name);
	let a = qg(r);
...
k(qS, "getProdType");
function JS(e) {
	let { occurrence: t, rule: n, prodType: r, maxLookahead: i } = e, a = qS(r);
	return a === Y.ALTERNATION ? aC(t, n, i) : oC(t, n, a, i);
}
k(JS, "getLookaheadPaths");
function YS(e, t, n, r, i, a) {
	let o = aC(e, t, n);
	return a(o, r, lC(o) ? $x : Qx, i);
}
k(YS, "buildLookaheadFuncForOr");
function XS(e, t, n, r, i, a) {
	let o = oC(e, t, i, n), s = lC(o) ? $x : Qx;
	return a(o[0], s, r);
}
k(XS, "buildLookaheadFuncForOptionalProd");
function ZS(e, t, n, r) {
...
k(ZS, "buildAlternativesLookAheadFunc");
function QS(e, t, n) {
...
k(QS, "buildSingleAlternativeLookaheadFunction");
var $S = (oe = class extends Wb {
	constructor(e, t, n) {
...
}, k(oe, "RestDefinitionFinderWalker"), oe), eC = (se = class extends zb {
	constructor(e, t, n) {
...
k(rC, "isUniquePrefixHash");
function iC(e, t) {
	let n = U(e, (e) => WS([e], 1)), r = tC(n.length), i = U(n, (e) => {
		let t = {};
		return H(e, (e) => {
			H(nC(e.partialPath), (e) => {
				t[e] = !0;
			});
		}), t;
	}), a = n;
	for (let e = 1; e <= t; e++) {
		...
		for (let o = 0; o < n.length; o++) {
			...
			for (let n = 0; n < s.length; n++) {
				let c = s[n].partialPath, l = s[n].suffixDef, u = nC(c);
				if (rC(i, u, o) || G(l) || c.length === t) {
					let e = r[o];
					if (sC(e, c) === !1) {
						e.push(c);
...
k(iC, "lookAheadSequenceFromAlternatives");
function aC(e, t, n, r) {
	let i = new eC(e, Y.ALTERNATION, r);
	return t.accept(i), iC(i.result, n);
}
k(aC, "getLookaheadPathsForOr");
function oC(e, t, n, r) {
	let i = new eC(e, n);
	t.accept(i);
	let a = i.result, o = new $S(t, e, n).startWalking();
	return iC([new jb({ definition: a }), new jb({ definition: o })], r);
}
k(oC, "getLookaheadPathsForOptionalProd");
function sC(e, t) {
...
k(cC, "isStrictPrefixOfPath");
function lC(e) {
	return iy(e, (e) => iy(e, (e) => iy(e, (e) => G(e.categoryMatches))));
}
k(lC, "areTokenCategoriesNotUsed");
function uC(e) {
	return U(e.lookaheadStrategy.validate({
		rules: e.rules,
		tokenTypes: e.tokenTypes,
		grammarName: e.grammarName
	}), (e) => Object.assign({ type: Vw.CUSTOM_LOOKAHEAD_VALIDATION }, e));
}
k(uC, "validateLookahead");
function dC(e, t, n, r) {
	let i = by(e, (e) => fC(e, n)), a = OC(e, t, n), o = by(e, (e) => wC(e, n)), s = by(e, (t) => gC(t, e, r, n));
	return i.concat(a, o, s);
}
k(dC, "validateGrammar");
function fC(e, t) {
	let n = new hC();
	e.accept(n);
	let r = n.allProductions;
	return U(Ny(ab(Sy(r, pC), (e) => e.length > 1)), (n) => {
		let r = hy(n), i = t.buildDuplicateFoundError(e, n), a = Ub(r), o = {
			message: i,
			type: Vw.DUPLICATE_PRODUCTIONS,
			ruleName: e.name,
			dslName: a,
			occurrence: r.idx
		}, s = mC(r);
...
k(fC, "validateDuplicateProductions");
function pC(e) {
	return `${Ub(e)}_#_${e.idx}_#_${mC(e)}`;
}
k(pC, "identifyProductionForDuplicates");
function mC(e) {
	return e instanceof q ? e.terminalType.name : e instanceof kb ? e.nonTerminalName : "";
}
k(mC, "getExtraProductionArgument");
var hC = (ce = class extends zb {
	constructor() {
...
function gC(e, t, n, r) {
	...
	if (lb(t, (t, n) => n.name === e.name ? t + 1 : t, 0) > 1) {
		...
		i.push({
			message: t,
			type: Vw.DUPLICATE_RULE_NAME,
			ruleName: e.name
		});
	}
	return i;
}
k(gC, "validateRuleDoesNotAlreadyExist");
function _C(e, t, n) {
	let r = [], i;
	return Iy(t, e) || (i = `Invalid rule override, rule: ->${e}<- cannot be overridden in the grammar: ->${n}<-as it is not defined in any of the super grammars `, r.push({
		message: i,
		type: Vw.INVALID_RULE_OVERRIDE,
		ruleName: e
	})), r;
}
k(_C, "validateRuleIsOverridden");
function vC(e, t, n, r = []) {
	let i = [], a = yC(t.definition);
	if (G(a)) return [];
	{
		let t = e.name;
		Iy(a, e) && i.push({
			...
			type: Vw.LEFT_RECURSION,
			ruleName: t
		});
		let o = by(Uv(a, r.concat([e])), (t) => {
			let i = qg(r);
			return i.push(t), vC(e, t, n, i);
		});
		return i.concat(o);
	}
}
k(vC, "validateNoLeftRecursion");
function yC(e) {
	let t = [];
	if (G(e)) return t;
	let n = hy(e);
	if (n instanceof kb) t.push(n.referencedRule);
	else if (n instanceof jb || n instanceof Mb || n instanceof Nb || n instanceof Pb || n instanceof Fb || n instanceof K) t = t.concat(yC(n.definition));
	else if (n instanceof Ib) t = lm(U(n.definition, (e) => yC(e.definition)));
	else if (!(n instanceof q)) throw Error("non exhaustive match");
	let r = Vb(n), i = e.length > 1;
	if (r && i) {
		let n = qv(e);
		return t.concat(yC(n));
	} else return t;
}
k(yC, "getFirstNoneTerminal");
var bC = (le = class extends zb {
	constructor() {
...
function xC(e, t) {
	...
	return by(r, (n) => by(Yv(n.definition), (r, i) => G(GS([r], [], Qx, 1)) ? [{
		message: t.buildEmptyAlternationError({
			topLevelRule: e,
			alternation: n,
			emptyChoiceIdx: i
		}),
		type: Vw.NONE_LAST_EMPTY_ALT,
		ruleName: e.name,
		occurrence: n.idx,
		alternative: i + 1
	}] : []));
}
k(xC, "validateEmptyOrAlternative");
function SC(e, t, n) {
	let r = new bC();
	e.accept(r);
	let i = r.alternations;
	return i = db(i, (e) => e.ignoreAmbiguities === !0), by(i, (r) => {
		let i = r.idx, a = aC(i, e, r.maxLookahead || t, r), o = EC(a, r, e, n), s = DC(a, r, e, n);
		return o.concat(s);
	});
}
k(SC, "validateAmbiguousAlternationAlternatives");
var CC = (ue = class extends zb {
	constructor() {
		super(...arguments), this.allProductions = [];
	}
	visitRepetitionWithSeparator(e) {
...
function wC(e, t) {
	...
	return by(r, (n) => n.definition.length > 255 ? [{
		...
		type: Vw.TOO_MANY_ALTS,
		ruleName: e.name,
		occurrence: n.idx
	}] : []);
}
k(wC, "validateTooManyAlts");
function TC(e, t, n) {
	let r = [];
	return H(e, (e) => {
		let i = new CC();
		...
		H(a, (i) => {
			let a = qS(i), o = i.maxLookahead || t, s = i.idx, c = oC(s, e, a, o)[0];
			if (G(lm(c))) {
				...
				r.push({
					message: t,
					type: Vw.NO_NON_EMPTY_LOOKAHEAD,
					ruleName: e.name
				});
			}
		});
...
k(TC, "validateSomeNonEmptyLookaheadPath");
function EC(e, t, n, r) {
	let i = [];
	return U(lb(e, (n, r, a) => (t.definition[a].ignoreAmbiguities === !0 || H(r, (r) => {
		let o = [a];
		H(e, (e, n) => {
			a !== n && sC(e, r) && t.definition[n].ignoreAmbiguities !== !0 && o.push(n);
		}), o.length > 1 && !sC(i, r) && (i.push(r), n.push({
			alts: o,
			path: r
		}));
	}), n), []), (e) => {
...
k(EC, "checkAlternativesAmbiguities");
function DC(e, t, n, r) {
	let i = lb(e, (e, t, n) => {
		let r = U(t, (e) => ({
			idx: n,
	...
	return Yg(by(i, (e) => {
		...
		return U(cy(i, (e) => t.definition[e.idx].ignoreAmbiguities !== !0 && e.idx < a && cC(e.path, o)), (e) => {
...
k(DC, "checkPrefixAlternativesAmbiguities");
function OC(e, t, n) {
	...
	return H(e, (e) => {
		...
		if (Iy(i, t)) {
			...
			r.push({
				message: i,
				type: Vw.CONFLICT_TOKENS_RULES_NAMESPACE,
				ruleName: t
			});
		}
	}), r;
}
k(OC, "checkTerminalAndNoneTerminalsNameSpace");
function kC(e) {
	let t = Fv(e, { errMsgProvider: NS }), n = {};
	return H(e.rules, (e) => {
		n[e.name] = e;
	}), FS(n, t.errMsgProvider);
}
k(kC, "resolveGrammar");
function AC(e) {
	return e = Fv(e, { errMsgProvider: PS }), dC(e.rules, e.tokenTypes, e.errMsgProvider, e.grammarName);
}
k(AC, "validateGrammar");
var jC = "MismatchedTokenException", MC = "NoViableAltException", NC = "EarlyExitException", PC = "NotAllInputParsedException", FC = [
	jC,
	MC,
	NC,
	PC
...
k(IC, "isRecognitionException");
var LC = (de = class extends Error {
	constructor(e, t) {
...
}, k(de, "RecognitionException"), de), RC = (D = class extends LC {
	constructor(e, t, n) {
		super(e, t), this.previousToken = n, this.name = jC;
	}
}, k(D, "MismatchedTokenException"), D), zC = (fe = class extends LC {
	constructor(e, t, n) {
		super(e, t), this.previousToken = n, this.name = MC;
	}
}, k(fe, "NoViableAltException"), fe), BC = (O = class extends LC {
	constructor(e, t) {
		super(e, t), this.name = PC;
	}
}, k(O, "NotAllInputParsedException"), O), VC = (pe = class extends LC {
	constructor(e, t, n) {
		super(e, t), this.previousToken = n, this.name = NC;
	}
}, k(pe, "EarlyExitException"), pe), HC = {}, UC = "InRuleRecoveryException", WC = (me = class extends Error {
	constructor(e) {
		super(e), this.name = UC;
	}
}, k(me, "InRuleRecoveryException"), me), GC = (he = class {
	initRecoverable(e) {
		this.firstAfterRepMap = {}, this.resyncFollows = {}, this.recoveryEnabled = W(e, "recoveryEnabled") ? e.recoveryEnabled : zw.recoveryEnabled, this.recoveryEnabled && (this.attemptInRepetitionRecovery = KC);
	}
	getTokenToInsert(e) {
		let t = AS(e, "", NaN, NaN, NaN, NaN, NaN, NaN);
	...
	tryInRepetitionRecovery(e, t, n, r) {
		let i = this.findReSyncTokenType(), a = this.exportLexerState(), o = [], s = !1, c = this.LA(1), l = this.LA(1), u = /* @__PURE__ */ k(() => {
			let e = this.LA(0), t = new RC(this.errorMessageProvider.buildMismatchTokenMessage({
				expected: r,
				actual: c,
				previous: e,
	...
	getCurrFollowKey() {
		if (this.RULE_STACK.length === 1) return HC;
	...
	addToResyncTokens(e, t) {
		return this.tokenMatcher(e, kS) || t.push(e), t;
	}
	reSyncTo(e) {
		let t = [], n = this.LA(1);
...
function KC(e, t, n, r, i, a, o) {
	...
	this.RULE_STACK.length === 1 && d && l === void 0 && (l = kS, u = 1), !(l === void 0 || u === void 0) && this.shouldInRepetitionRecoveryBeTried(l, u, o) && this.tryInRepetitionRecovery(e, t, n, l);
}
k(KC, "attemptInRepetitionRecovery");
var qC = 4, JC = 8, YC = 8, XC = 1 << JC, ZC = 2 << JC, QC = 3 << JC, $C = 4 << JC, ew = 5 << JC, tw = 6 << JC;
function nw(e, t, n) {
	return n | t | e;
}
k(nw, "getKeyForAutomaticLookahead"), 32 - YC;
var rw = (ge = class {
	constructor(e) {
		var t;
		this.maxLookahead = (t = e == null ? void 0 : e.maxLookahead) == null ? zw.maxLookahead : t;
	}
	validate(e) {
	...
	validateNoLeftRecursion(e) {
		return by(e, (e) => vC(e, e, PS));
	}
	validateEmptyOrAlternatives(e) {
		return by(e, (e) => xC(e, PS));
	}
	validateAmbiguousAlternationAlternatives(e, t) {
		return by(e, (e) => SC(e, t, PS));
	}
	validateSomeNonEmptyLookaheadPath(e, t) {
		return TC(e, t, PS);
	}
	buildLookaheadForAlternation(e) {
		return YS(e.prodOccurrence, e.rule, e.maxLookahead, e.hasPredicates, e.dynamicTokensEnabled, ZS);
	}
	buildLookaheadForOptional(e) {
		return XS(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, qS(e.prodType), QS);
	}
}, k(ge, "LLkLookaheadStrategy"), ge), iw = (_e = class {
	initLooksAhead(e) {
		this.dynamicTokensEnabled = W(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : zw.dynamicTokensEnabled, this.maxLookahead = W(e, "maxLookahead") ? e.maxLookahead : zw.maxLookahead, this.lookaheadStrategy = W(e, "lookaheadStrategy") ? e.lookaheadStrategy : new rw({ maxLookahead: this.maxLookahead }), this.lookAheadFuncsCache = /* @__PURE__ */ new Map();
	}
	preComputeLookaheadFunctions(e) {
		H(e, (e) => {
			this.TRACE_INIT(`${e.name} Rule Lookahead`, () => {
				let { alternation: t, repetition: n, option: r, repetitionMandatory: i, repetitionMandatoryWithSeparator: a, repetitionWithSeparator: o } = ow(e);
				H(t, (t) => {
					let n = t.idx === 0 ? "" : t.idx;
					this.TRACE_INIT(`${Ub(t)}${n}`, () => {
						...
						}), r = nw(this.fullRuleNameToShort[e.name], XC, t.idx);
						this.setLaFuncCache(r, n);
					});
				}), H(n, (t) => {
					this.computeLookaheadFunc(e, t.idx, QC, "Repetition", t.maxLookahead, Ub(t));
				}), H(r, (t) => {
					this.computeLookaheadFunc(e, t.idx, ZC, "Option", t.maxLookahead, Ub(t));
				}), H(i, (t) => {
					this.computeLookaheadFunc(e, t.idx, $C, "RepetitionMandatory", t.maxLookahead, Ub(t));
				}), H(a, (t) => {
					this.computeLookaheadFunc(e, t.idx, tw, "RepetitionMandatoryWithSeparator", t.maxLookahead, Ub(t));
				}), H(o, (t) => {
					this.computeLookaheadFunc(e, t.idx, ew, "RepetitionWithSeparator", t.maxLookahead, Ub(t));
				});
			});
		});
	}
	computeLookaheadFunc(e, t, n, r, i, a) {
		this.TRACE_INIT(`${a}${t === 0 ? "" : t}`, () => {
			let a = this.lookaheadStrategy.buildLookaheadForOptional({
				...
				dynamicTokensEnabled: this.dynamicTokensEnabled,
				prodType: r
			}), o = nw(this.fullRuleNameToShort[e.name], n, t);
			this.setLaFuncCache(o, a);
		});
	}
	getKeyForAutomaticLookahead(e, t) {
		return nw(this.getLastExplicitRuleShortName(), e, t);
	}
...
}, k(_e, "LooksAhead"), _e), aw = new (ve = class extends zb {
	constructor() {
...
k(sw, "setNodeLocationOnlyOffset");
function cw(e, t) {
...
function mw(e, t) {
	...
	return fw(n, e + "BaseSemantics"), n.prototype = {
...
k(mw, "createBaseSemanticVisitorConstructor");
function hw(e, t, n) {
	let r = /* @__PURE__ */ k(function() {}, "derivedConstructor");
	fw(r, e + "BaseSemanticsWithDefaults");
	let i = Object.create(n.prototype);
	return H(t, (e) => {
		i[e] = pw;
	}), r.prototype = i, r.prototype.constructor = r, r;
}
k(hw, "createBaseVisitorConstructorWithDefaults");
var gw;
(function(e) {
...
k(_w, "validateVisitor");
function vw(e, t) {
	return Yg(U(cy(t, (t) => ql(e[t]) === !1), (t) => ({
		msg: `Missing visitor method: <${t}> on ${e.constructor.name} CST Visitor.`,
		type: gw.MISSING_METHOD,
		methodName: t
	})));
}
k(vw, "validateMissingCstMethods");
var yw = (ye = class {
	initTreeBuilder(e) {
		if (this.CST_STACK = [], this.outputCst = e.outputCst, this.nodeLocationTracking = W(e, "nodeLocationTracking") ? e.nodeLocationTracking : zw.nodeLocationTracking, !this.outputCst) this.cstInvocationStateUpdate = bu, this.cstFinallyStateUpdate = bu, this.cstPostTerminal = bu, this.cstPostNonTerminal = bu, this.cstPostRule = bu;
		else if (/full/i.test(this.nodeLocationTracking)) this.recoveryEnabled ? (this.setNodeLocationFromToken = cw, this.setNodeLocationFromNode = cw, this.cstPostRule = bu, this.setInitialNodeLocation = this.setInitialNodeLocationFullRecovery) : (this.setNodeLocationFromToken = bu, this.setNodeLocationFromNode = bu, this.cstPostRule = this.cstPostRuleFull, this.setInitialNodeLocation = this.setInitialNodeLocationFullRegular);
	...
	cstPostTerminal(e, t) {
		...
		lw(n, t, e), this.setNodeLocationFromToken(n.location, t);
	}
	cstPostNonTerminal(e, t) {
		let n = this.CST_STACK[this.CST_STACK.length - 1];
		uw(n, t, e), this.setNodeLocationFromNode(n.location, e.location);
	}
	getBaseCstVisitorConstructor() {
		if (Xy(this.baseCstVisitorConstructor)) {
			let e = mw(this.className, Ef(this.gastProductionsCache));
	...
	getBaseCstVisitorConstructorWithDefaults() {
		if (Xy(this.baseCstVisitorWithDefaultsConstructor)) {
			let e = hw(this.className, Ef(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
}, k(ye, "TreeBuilder"), ye), bw = (be = class {
	initLexerAdapter() {
	...
	SKIP_TOKEN() {
		return this.currIdx <= this.tokVector.length - 2 ? (this.consumeToken(), this.LA(1)) : Rw;
	}
	LA(e) {
		let t = this.currIdx + e;
		return t < 0 || this.tokVectorLength <= t ? Rw : this.tokVector[t];
	}
	consumeToken() {
		this.currIdx++;
	}
...
}, k(be, "LexerAdapter"), be), xw = (xe = class {
	ACTION(e) {
		return e.call(this);
	}
	consume(e, t, n) {
	...
	RULE(e, t, n = Bw) {
		if (Iy(this.definedRulesNames, e)) {
			let t = {
				message: PS.buildDuplicateRuleNameError({
					topLevelRule: e,
	...
	OVERRIDE_RULE(e, t, n = Bw) {
		let r = _C(e, this.definedRulesNames, this.className);
	...
	initRecognizerEngine(e, t) {
		...
		else if (W(e, "modes") && iy(lm(Ny(e.modes)), fS)) {
		...
		this.tokensMap.EOF = kS;
		let n = iy(W(e, "modes") ? lm(Ny(e.modes)) : Ny(e), (e) => G(e.categoryMatches));
		this.tokenMatcher = n ? $x : Qx, nS(Ny(this.tokensMap));
	}
	defineRule(e, t, n) {
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
		let r = W(n, "resyncEnabled") ? n.resyncEnabled : Bw.resyncEnabled, i = W(n, "recoveryValueFunc") ? n.recoveryValueFunc : Bw.recoveryValueFunc, a = this.ruleShortNameIdx << qC + JC;
	...
	optionInternal(e, t) {
		let n = this.getKeyForAutomaticLookahead(ZC, t);
	...
	atLeastOneInternalLogic(e, t, n) {
		...
		this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, t], r, $C, e, HS);
	}
	...
	manyInternalLogic(e, t, n) {
		...
		this.attemptInRepetitionRecovery(this.manyInternal, [e, t], r, QC, e, BS, a);
	}
	...
	orInternal(e, t) {
		let n = this.getKeyForAutomaticLookahead(XC, t), r = z(e) ? e : e.DEF, i = this.getLaFuncFromCache(n).call(this, r);
	...
	subruleInternalError(e, t, n) {
		throw IC(e) && e.partialCstResult !== void 0 && (this.cstPostNonTerminal(e.partialCstResult, t !== void 0 && t.LABEL !== void 0 ? t.LABEL : n), delete e.partialCstResult), e;
	}
	...
	isAtEndOfInput() {
		return this.tokenMatcher(this.LA(1), kS);
	}
	reset() {
		this.resetLexerState(), this.subruleIdx = 0, this.isBackTrackingStack = [], this.errors = [], this.RULE_STACK = [], this.CST_STACK = [], this.RULE_OCCURRENCE_STACK = [];
	}
}, k(Se, "RecognizerEngine"), Se), Cw = (Ce = class {
	initErrorHandler(e) {
		this._errors = [], this.errorMessageProvider = W(e, "errorMessageProvider") ? e.errorMessageProvider : zw.errorMessageProvider;
	}
	SAVE_ERROR(e) {
		if (IC(e)) return e.context = {
			ruleStack: this.getHumanReadableRuleStack(),
	...
	raiseEarlyExitException(e, t, n) {
		let r = this.getCurrRuleFullName(), i = this.getGAstProductions()[r], a = oC(e, i, t, this.maxLookahead)[0], o = [];
		...
		throw this.SAVE_ERROR(new VC(s, this.LA(1), this.LA(0)));
	}
	raiseNoAltException(e, t) {
		let n = this.getCurrRuleFullName(), r = this.getGAstProductions()[n], i = aC(e, r, this.maxLookahead), a = [];
		...
		throw this.SAVE_ERROR(new zC(s, this.LA(1), o));
	}
}, k(Ce, "ErrorHandler"), Ce), ww = (we = class {
	initContentAssist() {}
	computeContentAssist(e, t) {
		let n = this.gastProductionsCache[e];
		if (Xy(n)) throw Error(`Rule ->${e}<- does not exist in this grammar.`);
		return GS([n], t, this.tokenMatcher, this.maxLookahead);
	}
	getNextPossibleTokenTypes(e) {
		let t = hy(e.ruleStack), n = this.getGAstProductions()[t];
		return new RS(n, e).startWalking();
	}
}, k(we, "ContentAssist"), we), Tw = { description: "This Object indicates the Parser is during Recording Phase" };
Object.freeze(Tw);
var Ew = !0, Dw = 2 ** JC - 1, Ow = DS({
	name: "RECORDING_PHASE_TOKEN",
	pattern: hS.NA
});
nS([Ow]);
var kw = AS(Ow, "This IToken indicates the Parser is in Recording Phase\n	See: https://chevrotain.io/docs/guide/internals.html#grammar-recording for details", -1, -1, -1, -1, -1, -1);
Object.freeze(kw);
var Aw = {
	...
	optionInternalRecord(e, t) {
		return Mw.call(this, Mb, e, t);
	}
	atLeastOneInternalRecord(e, t) {
		Mw.call(this, Nb, t, e);
	}
	atLeastOneSepFirstInternalRecord(e, t) {
		Mw.call(this, Pb, t, e, Ew);
	}
	manyInternalRecord(e, t) {
		Mw.call(this, K, t, e);
	}
	manySepFirstInternalRecord(e, t) {
		Mw.call(this, Fb, t, e, Ew);
	}
	orInternalRecord(e, t) {
		return Nw.call(this, e, t);
	}
	subruleInternalRecord(e, t, n) {
		if (Fw(t), !e || W(e, "ruleName") === !1) {
			let n = /* @__PURE__ */ Error(`<SUBRULE${Pw(t)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
		...
		return r.definition.push(a), this.outputCst ? Aw : Tw;
	}
	consumeInternalRecord(e, t, n) {
		if (Fw(t), !cS(e)) {
			let n = /* @__PURE__ */ Error(`<CONSUME${Pw(t)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
			throw n.KNOWN_RECORDER_ERROR = !0, n;
		}
...
function Mw(e, t, n, r = !1) {
	...
	return r && (o.separator = t.SEP), W(t, "MAX_LOOKAHEAD") && (o.maxLookahead = t.MAX_LOOKAHEAD), this.recordingProdStack.push(o), a.call(this), i.definition.push(o), this.recordingProdStack.pop(), Tw;
}
k(Mw, "recordProd");
function Nw(e, t) {
	Fw(t);
...
function Fw(e) {
	...
	Idx value must be a none negative value smaller than ${Dw + 1}`);
		throw t.KNOWN_RECORDER_ERROR = !0, t;
	}
}
k(Fw, "assertMethodIdxIsValid");
var Iw = (Ee = class {
	initPerformanceTracer(e) {
		...
		} else this.traceInitMaxIdent = 0, this.traceInitPerf = zw.traceInitPerf;
...
k(Lw, "applyMixins");
var Rw = AS(kS, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(Rw);
...
var Uw = (De = class e {
	...
	performSelfAnalysis() {
		this.TRACE_INIT("performSelfAnalysis", () => {
			...
			if (this.TRACE_INIT("Grammar Resolving", () => {
				r = kC({ rules: Ny(this.gastProductionsCache) }), this.definitionErrors = this.definitionErrors.concat(r);
 ...
 ${t.join("\n-------------------------------\n")}`);
	...
	constructor(e, t) {
		...
		this.skipValidations = W(t, "skipValidations") ? t.skipValidations : zw.skipValidations;
	}
}, k(De, "Parser"), De);
Uw.DEFER_DEFINITION_ERRORS_HANDLING = !1, Lw(Uw, [
	GC,
	iw,
	yw,
	bw,
...
k(Zw, "assocIndexOf");
var Qw = Zw, $w = Array.prototype.splice;
function eT(e) {
	var t = this.__data__, n = Qw(t, e);
	return n < 0 ? !1 : (n == t.length - 1 ? t.pop() : $w.call(t, n, 1), --this.size, !0);
}
k(eT, "listCacheDelete");
var tT = eT;
function nT(e) {
	var t = this.__data__, n = Qw(t, e);
	return n < 0 ? void 0 : t[n][1];
...
k(cT, "ListCache"), cT.prototype.clear = Jw, cT.prototype.delete = tT, cT.prototype.get = rT, cT.prototype.has = aT, cT.prototype.set = sT;
var lT = cT;
function uT() {
...
k(gT, "stackHas");
var _T = gT, vT = typeof global == "object" && global && global.Object === Object && global, yT = typeof self == "object" && self && self.Object === Object && self, bT = vT || yT || Function("return this")(), xT = bT.Symbol, ST = Object.prototype, CT = ST.hasOwnProperty, wT = ST.toString, TT = xT ? xT.toStringTag : void 0;
function ET(e) {
	var t = CT.call(e, TT), n = e[TT];
	try {
		e[TT] = void 0;
		var r = !0;
	} catch {}
	var i = wT.call(e);
	return r && (t ? e[TT] = n : delete e[TT]), i;
}
k(ET, "getRawTag");
var DT = ET, OT = Object.prototype.toString;
function kT(e) {
	return OT.call(e);
}
k(kT, "objectToString");
var AT = kT, jT = "[object Null]", MT = "[object Undefined]", NT = xT ? xT.toStringTag : void 0;
function PT(e) {
	return e == null ? e === void 0 ? MT : jT : NT && NT in Object(e) ? DT(e) : AT(e);
}
k(PT, "baseGetTag");
var FT = PT;
function IT(e) {
...
k(IT, "isObject");
var LT = IT, RT = "[object AsyncFunction]", zT = "[object Function]", BT = "[object GeneratorFunction]", VT = "[object Proxy]";
function HT(e) {
	if (!LT(e)) return !1;
	var t = FT(e);
	return t == zT || t == BT || t == RT || t == VT;
}
k(HT, "isFunction");
var UT = HT, WT = bT["__core-js_shared__"], GT = (function() {
...
k(KT, "isMasked");
var qT = KT, JT = Function.prototype.toString;
function YT(e) {
	if (e != null) {
		try {
			return JT.call(e);
...
k(YT, "toSource");
var XT = YT, ZT = /[\\^$.*+?()[\]{}|]/g, QT = /^\[object .+?Constructor\]$/, $T = Function.prototype, eE = Object.prototype, tE = $T.toString, nE = eE.hasOwnProperty, rE = RegExp("^" + tE.call(nE).replace(ZT, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function iE(e) {
	return !LT(e) || qT(e) ? !1 : (UT(e) ? rE : QT).test(XT(e));
}
k(iE, "baseIsNative");
var aE = iE;
function oE(e, t) {
...
k(cE, "getNative");
var lE = cE, uE = lE(bT, "Map"), dE = lE(Object, "create");
function fE() {
...
k(mE, "hashDelete");
var hE = mE, gE = "__lodash_hash_undefined__", _E = Object.prototype.hasOwnProperty;
function vE(e) {
	var t = this.__data__;
	if (dE) {
		var n = t[e];
...
k(vE, "hashGet");
var yE = vE, bE = Object.prototype.hasOwnProperty;
function xE(e) {
	var t = this.__data__;
	return dE ? t[e] !== void 0 : bE.call(t, e);
}
k(xE, "hashHas");
var SE = xE, CE = "__lodash_hash_undefined__";
function wE(e, t) {
	var n = this.__data__;
	return this.size += +!this.has(e), n[e] = dE && t === void 0 ? CE : t, this;
}
k(wE, "hashSet");
var TE = wE;
function EE(e) {
...
k(EE, "Hash"), EE.prototype.clear = pE, EE.prototype.delete = hE, EE.prototype.get = yE, EE.prototype.has = SE, EE.prototype.set = TE;
var DE = EE;
function OE() {
	this.size = 0, this.__data__ = {
		hash: new DE(),
...
k(HE, "MapCache"), HE.prototype.clear = kE, HE.prototype.delete = FE, HE.prototype.get = LE, HE.prototype.has = zE, HE.prototype.set = VE;
var UE = HE, WE = 200;
function GE(e, t) {
	var n = this.__data__;
	if (n instanceof lT) {
		var r = n.__data__;
		if (!uE || r.length < WE - 1) return r.push([e, t]), this.size = ++n.size, this;
...
k(qE, "Stack"), qE.prototype.clear = dT, qE.prototype.delete = pT, qE.prototype.get = hT, qE.prototype.has = _T, qE.prototype.set = KE;
var JE = qE, YE = "__lodash_hash_undefined__";
function XE(e) {
...
k(eD, "SetCache"), eD.prototype.add = eD.prototype.push = ZE, eD.prototype.has = $E;
var tD = eD;
function nD(e, t) {
	for (var n = -1, r = e == null ? 0 : e.length; ++n < r;) if (t(e[n], n, e)) return !0;
	return !1;
...
function cD(e, t, n, r, i, a) {
	var o = n & oD, s = e.length, c = t.length;
	if (s != c && !(o && c > s)) return !1;
	var l = a.get(e), u = a.get(t);
	if (l && u) return l == t && u == e;
	var d = -1, f = !0, p = n & sD ? new tD() : void 0;
	for (a.set(e, t), a.set(t, e); ++d < s;) {
		var m = e[d], h = t[d];
		if (r) var g = o ? r(h, m, d, t, e, a) : r(m, h, d, e, t, a);
		if (g !== void 0) {
		...
		if (p) {
			if (!rD(t, function(e, t) {
				if (!aD(p, t) && (m === e || i(m, e, n, r, a))) return p.push(t);
			})) {
				f = !1;
				break;
			}
...
k(pD, "setToArray");
var mD = pD, hD = 1, gD = 2, _D = "[object Boolean]", vD = "[object Date]", yD = "[object Error]", bD = "[object Map]", xD = "[object Number]", SD = "[object RegExp]", CD = "[object Set]", wD = "[object String]", TD = "[object Symbol]", ED = "[object ArrayBuffer]", DD = "[object DataView]", OD = xT ? xT.prototype : void 0, kD = OD ? OD.valueOf : void 0;
function AD(e, t, n, r, i, a, o) {
	switch (n) {
		case DD:
			if (e.byteLength != t.byteLength || e.byteOffset != t.byteOffset) return !1;
			e = e.buffer, t = t.buffer;
		case ED: return !(e.byteLength != t.byteLength || !a(new uD(e), new uD(t)));
		case _D:
		case vD:
		case xD: return Xw(+e, +t);
		case yD: return e.name == t.name && e.message == t.message;
		case SD:
		case wD: return e == t + "";
		case bD: var s = fD;
		case CD:
			var c = r & hD;
			if (s || (s = mD), e.size != t.size && !c) return !1;
			var l = o.get(e);
			if (l) return l == t;
			r |= gD, o.set(e, t);
			var u = lD(s(e), s(t), r, i, a, o);
			return o.delete(e), u;
		case TD: if (kD) return kD.call(e) == kD.call(t);
	}
	return !1;
}
k(AD, "equalByTag");
...
k(MD, "arrayPush");
var ND = MD, PD = Array.isArray;
function FD(e, t, n) {
	var r = t(e);
	return PD(e) ? r : ND(r, n(e));
}
k(FD, "baseGetAllKeys");
var ID = FD;
function LD(e, t) {
...
k(zD, "stubArray");
var BD = zD, VD = Object.prototype.propertyIsEnumerable, HD = Object.getOwnPropertySymbols, UD = HD ? function(e) {
	return e == null ? [] : (e = Object(e), RD(HD(e), function(t) {
		return VD.call(e, t);
	}));
} : BD;
function WD(e, t) {
...
k(KD, "isObjectLike");
var qD = KD, JD = "[object Arguments]";
function YD(e) {
	return qD(e) && FT(e) == JD;
}
k(YD, "baseIsArguments");
var XD = YD, ZD = Object.prototype, QD = ZD.hasOwnProperty, $D = ZD.propertyIsEnumerable, eO = XD(/* @__PURE__ */ (function() {
	return arguments;
})()) ? XD : function(e) {
	return qD(e) && QD.call(e, "callee") && !$D.call(e, "callee");
};
function tO() {
	return !1;
}
k(tO, "stubFalse");
var nO = tO, rO = typeof exports == "object" && exports && !exports.nodeType && exports, iO = rO && typeof module == "object" && module && !module.nodeType && module, aO = iO && iO.exports === rO ? bT.Buffer : void 0, oO = (aO ? aO.isBuffer : void 0) || nO, sO = 9007199254740991, cO = /^(?:0|[1-9]\d*)$/;
function lO(e, t) {
	var n = typeof e;
	return t = t == null ? sO : t, !!t && (n == "number" || n != "symbol" && cO.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
k(lO, "isIndex");
var uO = lO, dO = 9007199254740991;
function fO(e) {
	return typeof e == "number" && e > -1 && e % 1 == 0 && e <= dO;
}
k(fO, "isLength");
var pO = fO, mO = "[object Arguments]", hO = "[object Array]", gO = "[object Boolean]", _O = "[object Date]", vO = "[object Error]", yO = "[object Function]", bO = "[object Map]", xO = "[object Number]", SO = "[object Object]", CO = "[object RegExp]", wO = "[object Set]", TO = "[object String]", EO = "[object WeakMap]", DO = "[object ArrayBuffer]", OO = "[object DataView]", kO = "[object Float32Array]", AO = "[object Float64Array]", jO = "[object Int8Array]", MO = "[object Int16Array]", NO = "[object Int32Array]", PO = "[object Uint8Array]", FO = "[object Uint8ClampedArray]", IO = "[object Uint16Array]", LO = "[object Uint32Array]", X = {};
X[kO] = X[AO] = X[jO] = X[MO] = X[NO] = X[PO] = X[FO] = X[IO] = X[LO] = !0, X[mO] = X[hO] = X[DO] = X[gO] = X[OO] = X[_O] = X[vO] = X[yO] = X[bO] = X[xO] = X[SO] = X[CO] = X[wO] = X[TO] = X[EO] = !1;
function RO(e) {
	return qD(e) && pO(e.length) && !!X[FT(e)];
}
k(RO, "baseIsTypedArray");
var zO = RO;
function BO(e) {
	return function(t) {
		return e(t);
...
k(BO, "baseUnary");
var VO = BO, HO = typeof exports == "object" && exports && !exports.nodeType && exports, UO = HO && typeof module == "object" && module && !module.nodeType && module, WO = UO && UO.exports === HO && vT.process, GO = (function() {
	try {
		return UO && UO.require && UO.require("util").types || WO && WO.binding && WO.binding("util");
	} catch {}
})(), KO = GO && GO.isTypedArray, qO = KO ? VO(KO) : zO, JO = Object.prototype.hasOwnProperty;
function YO(e, t) {
	var n = PD(e), r = !n && eO(e), i = !n && !r && oO(e), a = !n && !r && !i && qO(e), o = n || r || i || a, s = o ? GD(e.length, String) : [], c = s.length;
	for (var l in e) (t || JO.call(e, l)) && !(o && (l == "length" || i && (l == "offset" || l == "parent") || a && (l == "buffer" || l == "byteLength" || l == "byteOffset") || uO(l, c))) && s.push(l);
	return s;
}
k(YO, "arrayLikeKeys");
var XO = YO, ZO = Object.prototype;
function QO(e) {
	var t = e && e.constructor;
	return e === (typeof t == "function" && t.prototype || ZO);
}
k(QO, "isPrototype");
var $O = QO;
function ek(e, t) {
...
k(ek, "overArg");
var tk = ek(Object.keys, Object), nk = Object.prototype.hasOwnProperty;
function rk(e) {
	if (!$O(e)) return tk(e);
	var t = [];
	for (var n in Object(e)) nk.call(e, n) && n != "constructor" && t.push(n);
	return t;
}
k(rk, "baseKeys");
var ik = rk;
function ak(e) {
	return e != null && pO(e.length) && !UT(e);
}
k(ak, "isArrayLike");
var ok = ak;
function sk(e) {
	return ok(e) ? XO(e) : ik(e);
}
k(sk, "keys");
var ck = sk;
function lk(e) {
...
k(lk, "getAllKeys");
var uk = lk, dk = 1, fk = Object.prototype.hasOwnProperty;
function pk(e, t, n, r, i, a) {
	var o = n & dk, s = uk(e), c = s.length;
	if (c != uk(t).length && !o) return !1;
	for (var l = c; l--;) {
		var u = s[l];
		if (!(o ? u in t : fk.call(t, u))) return !1;
	}
	var d = a.get(e), f = a.get(t);
	if (d && f) return d == t && f == e;
	var p = !0;
...
k(pk, "equalObjects");
var mk = pk, hk = lE(bT, "DataView"), gk = lE(bT, "Promise"), _k = lE(bT, "Set"), vk = lE(bT, "WeakMap"), yk = "[object Map]", bk = "[object Object]", xk = "[object Promise]", Sk = "[object Set]", Ck = "[object WeakMap]", wk = "[object DataView]", Tk = XT(hk), Ek = XT(uE), Dk = XT(gk), Ok = XT(_k), kk = XT(vk), Ak = FT;
(hk && Ak(new hk(/* @__PURE__ */ new ArrayBuffer(1))) != wk || uE && Ak(new uE()) != yk || gk && Ak(gk.resolve()) != xk || _k && Ak(new _k()) != Sk || vk && Ak(new vk()) != Ck) && (Ak = /* @__PURE__ */ k(function(e) {
	var t = FT(e), n = t == bk ? e.constructor : void 0, r = n ? XT(n) : "";
	if (r) switch (r) {
		case Tk: return wk;
		case Ek: return yk;
		case Dk: return xk;
...
var jk = Ak, Mk = 1, Nk = "[object Arguments]", Pk = "[object Array]", Fk = "[object Object]", Ik = Object.prototype.hasOwnProperty;
function Lk(e, t, n, r, i, a) {
	var o = PD(e), s = PD(t), c = o ? Pk : jk(e), l = s ? Pk : jk(t);
	c = c == Nk ? Fk : c, l = l == Nk ? Fk : l;
	var u = c == Fk, d = l == Fk, f = c == l;
	if (f && oO(e)) {
		if (!oO(t)) return !1;
		o = !0, u = !1;
	}
	if (f && !u) return a || (a = new JE()), o || qO(e) ? lD(e, t, n, r, i, a) : jD(e, t, c, n, r, i, a);
	if (!(n & Mk)) {
		var p = u && Ik.call(e, "__wrapped__"), m = d && Ik.call(t, "__wrapped__");
		if (p || m) {
			var h = p ? e.value() : e, g = m ? t.value() : t;
			return a || (a = new JE()), i(h, g, n, r, a);
		}
	}
	return f ? (a || (a = new JE()), mk(e, t, n, r, i, a)) : !1;
}
k(Lk, "baseIsEqualDeep");
var Rk = Lk;
function zk(e, t, n, r, i) {
	return e === t ? !0 : e == null || t == null || !qD(e) && !qD(t) ? e !== e && t !== t : Rk(e, t, n, r, zk, i);
}
k(zk, "baseIsEqual");
var Bk = zk, Vk = 1, Hk = 2;
function Uk(e, t, n, r) {
	...
	for (; ++i < a;) {
		...
		if (o && s[2]) {
			...
			var d = new JE();
			if (r) var f = r(l, u, c, e, t, d);
			if (!(f === void 0 ? Bk(u, l, Vk | Hk, r, d) : f)) return !1;
		}
	}
	return !0;
}
...
k(Gk, "isStrictComparable");
var Kk = Gk;
function qk(e) {
	for (var t = ck(e), n = t.length; n--;) {
		var r = t[n], i = e[r];
		t[n] = [
			r,
			i,
...
k(Yk, "matchesStrictComparable");
var Xk = Yk;
function Zk(e) {
	var t = Jk(e);
	return t.length == 1 && t[0][2] ? Xk(t[0][0], t[0][1]) : function(n) {
		return n === e || Wk(n, e, t);
	};
}
k(Zk, "baseMatches");
var Qk = Zk, $k = "[object Symbol]";
function eA(e) {
	return typeof e == "symbol" || qD(e) && FT(e) == $k;
}
k(eA, "isSymbol");
var tA = eA, nA = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, rA = /^\w*$/;
function iA(e, t) {
	if (PD(e)) return !1;
	var n = typeof e;
	return n == "number" || n == "symbol" || n == "boolean" || e == null || tA(e) ? !0 : rA.test(e) || !nA.test(e) || t != null && e in Object(t);
}
k(iA, "isKey");
var aA = iA, oA = "Expected a function";
function sA(e, t) {
	if (typeof e != "function" || t != null && typeof t != "function") throw TypeError(oA);
	var n = /* @__PURE__ */ k(function() {
		var r = arguments, i = t ? t.apply(this, r) : r[0], a = n.cache;
		if (a.has(i)) return a.get(i);
		var o = e.apply(this, r);
	...
	return n.cache = new (sA.Cache || UE)(), n;
}
k(sA, "memoize"), sA.Cache = UE;
var cA = sA, lA = 500;
function uA(e) {
	var t = cA(e, function(e) {
		return n.size === lA && n.clear(), e;
	}), n = t.cache;
	return t;
}
k(uA, "memoizeCapped");
var dA = uA, fA = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, pA = /\\(\\)?/g, mA = dA(function(e) {
	var t = [];
	return e.charCodeAt(0) === 46 && t.push(""), e.replace(fA, function(e, n, r, i) {
		t.push(r ? i.replace(pA, "$1") : n || e);
	}), t;
}), hA = Infinity, gA = xT ? xT.prototype : void 0, _A = gA ? gA.toString : void 0;
function vA(e) {
	if (typeof e == "string") return e;
	if (PD(e)) return Kw(e, vA) + "";
	if (tA(e)) return _A ? _A.call(e) : "";
	var t = e + "";
...
var xA = bA;
function SA(e, t) {
	return PD(e) ? e : aA(e, t) ? [e] : mA(xA(e));
}
k(SA, "castPath");
var CA = SA, wA = Infinity;
function TA(e) {
...
function DA(e, t) {
	t = CA(t, e);
	for (var n = 0, r = t.length; e != null && n < r;) e = e[EA(t[n++])];
	return n && n == r ? e : void 0;
}
k(DA, "baseGet");
var OA = DA;
...
function NA(e, t, n) {
	...
	return a || ++r != i ? a : (i = e == null ? 0 : e.length, !!i && pO(i) && uO(o, i) && (PD(e) || eO(e)));
}
k(NA, "hasPath");
var PA = NA;
function FA(e, t) {
	return e != null && PA(e, t, MA);
}
k(FA, "hasIn");
var IA = FA, LA = 1, RA = 2;
function zA(e, t) {
	return aA(e) && Kk(t) ? Xk(EA(e), t) : function(n) {
		var r = AA(n, e);
		return r === void 0 && r === t ? IA(n, e) : Bk(t, r, LA | RA);
	};
}
k(zA, "baseMatchesProperty");
var BA = zA;
function VA(e) {
	return e;
}
...
k(GA, "basePropertyDeep");
var KA = GA;
function qA(e) {
	return aA(e) ? WA(EA(e)) : KA(e);
}
k(qA, "property");
var JA = qA;
function YA(e) {
	return typeof e == "function" ? e : e == null ? HA : typeof e == "object" ? PD(e) ? BA(e[0], e[1]) : Qk(e) : JA(e);
}
k(YA, "baseIteratee");
var XA = YA;
function ZA(e) {
...
var nj = tj(ej);
function rj(e, t) {
	var n = -1, r = ok(e) ? Array(e.length) : [];
	return nj(e, function(e, i, a) {
		r[++n] = t(e, i, a);
	}), r;
}
k(rj, "baseMap");
var ij = rj;
function aj(e, t) {
	return (PD(e) ? Kw : ij)(e, XA(t, 3));
}
k(aj, "map");
var oj = aj;
function sj(e, t) {
	var n = [];
	return nj(e, function(e, r, i) {
		t(e, r, i) && n.push(e);
	}), n;
}
k(sj, "baseFilter");
...
k(dj, "buildATNKey");
var fj = 1, pj = 2, mj = 4, hj = 5, gj = 7, _j = 8, vj = 9, yj = 10, bj = 11, xj = 12, Sj = (ke = class {
	constructor(e) {
		this.target = e;
	}
	isEpsilon() {
...
}, k(ke, "AbstractTransition"), ke), Cj = (Ae = class extends Sj {
	constructor(e, t) {
		super(e), this.tokenType = t;
	}
}, k(Ae, "AtomTransition"), Ae), wj = (je = class extends Sj {
	constructor(e) {
		super(e);
	}
	isEpsilon() {
...
}, k(je, "EpsilonTransition"), je), Tj = (Me = class extends Sj {
	constructor(e, t, n) {
...
function Dj(e, t) {
	let n = t.length;
	for (let r = 0; r < n; r++) {
		let n = t[r], i = Kj(e, n, void 0, { type: pj }), a = Kj(e, n, void 0, { type: gj });
		i.stop = a, e.ruleToStartState.set(n, i), e.ruleToStopState.set(n, a);
	}
}
k(Dj, "createRuleStartAndStopATNStates");
function Oj(e, t, n) {
	return n instanceof q ? Uj(e, t, n.terminalType, n) : n instanceof kb ? Wj(e, t, n) : n instanceof Ib ? Nj(e, t, n) : n instanceof Mb ? Pj(e, t, n) : n instanceof K ? kj(e, t, n) : n instanceof Fb ? Aj(e, t, n) : n instanceof Nb ? jj(e, t, n) : n instanceof Pb ? Mj(e, t, n) : Fj(e, t, n);
}
k(Oj, "atom");
function kj(e, t, n) {
	let r = Kj(e, t, n, { type: hj });
	return zj(e, r), Lj(e, t, n, Bj(e, t, r, n, Fj(e, t, n)));
}
k(kj, "repetition");
function Aj(e, t, n) {
	let r = Kj(e, t, n, { type: hj });
	return zj(e, r), Lj(e, t, n, Bj(e, t, r, n, Fj(e, t, n)), Uj(e, t, n.separator, n));
}
k(Aj, "repetitionSep");
function jj(e, t, n) {
	let r = Kj(e, t, n, { type: mj });
	return zj(e, r), Ij(e, t, n, Bj(e, t, r, n, Fj(e, t, n)));
}
k(jj, "repetitionMandatory");
function Mj(e, t, n) {
	let r = Kj(e, t, n, { type: mj });
	return zj(e, r), Ij(e, t, n, Bj(e, t, r, n, Fj(e, t, n)), Uj(e, t, n.separator, n));
}
k(Mj, "repetitionMandatorySep");
function Nj(e, t, n) {
	let r = Kj(e, t, n, { type: fj });
	return zj(e, r), Bj(e, t, r, n, ...oj(n.definition, (n) => Oj(e, t, n)));
}
k(Nj, "alternation");
function Pj(e, t, n) {
	let r = Kj(e, t, n, { type: fj });
	return zj(e, r), Rj(e, t, n, Bj(e, t, r, n, Fj(e, t, n)));
}
k(Pj, "option");
function Fj(e, t, n) {
	let r = uj(oj(n.definition, (n) => Oj(e, t, n)), (e) => e !== void 0);
	return r.length === 1 ? r[0] : r.length === 0 ? void 0 : Hj(e, r);
}
k(Fj, "block");
function Ij(e, t, n, r, i) {
	let a = r.left, o = r.right, s = Kj(e, t, n, { type: bj });
	zj(e, s);
	let c = Kj(e, t, n, { type: xj });
	return a.loopback = s, c.loopback = s, e.decisionMap[dj(t, i ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", n.idx)] = s, Z(o, s), i === void 0 ? (Z(s, a), Z(s, c)) : (Z(s, c), Z(s, i.left), Z(i.right, a)), {
		left: a,
		right: c
	};
}
...
function Lj(e, t, n, r, i) {
	let a = r.left, o = r.right, s = Kj(e, t, n, { type: yj });
	zj(e, s);
	let c = Kj(e, t, n, { type: xj }), l = Kj(e, t, n, { type: vj });
	return s.loopback = l, c.loopback = l, Z(s, a), Z(s, c), Z(o, l), i === void 0 ? Z(l, s) : (Z(l, c), Z(l, i.left), Z(i.right, a)), e.decisionMap[dj(t, i ? "RepetitionWithSeparator" : "Repetition", n.idx)] = s, {
		left: s,
		right: c
	};
}
...
function Bj(e, t, n, r, ...i) {
	...
	return e.decisionMap[dj(t, Vj(r), r.idx)] = n, o;
}
k(Bj, "makeAlts");
function Vj(e) {
...
function Hj(e, t) {
	...
	for (let r = 0; r < n - 1; r++) {
		...
		let a = i instanceof Tj, o = i, s = t[r + 1].left;
		n.left.type === fj && n.right.type === fj && i !== void 0 && (a && o.followState === n.right || i.target === n.right) ? (a ? o.followState = s : i.target = s, Jj(e, n.right)) : Z(n.right, s);
	}
	let r = t[0], i = t[n - 1];
	return {
		left: r.left,
...
k(Hj, "makeBlock");
function Uj(e, t, n, r) {
	let i = Kj(e, t, r, { type: fj }), a = Kj(e, t, r, { type: fj });
	return qj(i, new Cj(a, n)), {
		left: i,
		right: a
	};
}
k(Uj, "tokenRef");
function Wj(e, t, n) {
	let r = n.referencedRule, i = e.ruleToStartState.get(r), a = Kj(e, t, n, { type: fj }), o = Kj(e, t, n, { type: fj });
	return qj(a, new Tj(i, r, o)), {
		left: a,
		right: o
	};
}
...
var Yj = {}, Xj = (Ne = class {
	...
	get alts() {
		return oj(this.configs, (e) => e.alt);
	}
	get key() {
		let e = "";
...
k(Zj, "getATNConfigKey");
function Qj(e, t, n) {
	for (var r = -1, i = e.length; ++r < i;) {
		var a = e[r], o = t(a);
		if (o != null && (s === void 0 ? o === o && !tA(o) : n(o, s))) var s = o, c = a;
	}
	return c;
}
k(Qj, "baseExtremum");
...
var tM = eM;
function nM(e) {
	return e && e.length ? $j(e, HA, tM) : void 0;
}
k(nM, "min");
var rM = nM, iM = xT ? xT.isConcatSpreadable : void 0;
function aM(e) {
	return PD(e) || eO(e) || !!(iM && e && e[iM]);
}
k(aM, "isFlattenable");
var oM = aM;
function sM(e, t, n, r, i) {
	...
	for (n || (n = oM), i || (i = []); ++a < o;) {
		var s = e[a];
		t > 0 && n(s) ? t > 1 ? sM(s, t - 1, n, r, i) : ND(i, s) : r || (i[i.length] = s);
	}
	return i;
}
k(sM, "baseFlatten");
...
var gM = hM;
function _M(e, t, n) {
	return t === t ? gM(e, t, n) : fM(e, mM, n);
}
k(_M, "baseIndexOf");
var vM = _M;
function yM(e, t) {
	return !!(e != null && e.length) && vM(e, t, 0) > -1;
}
k(yM, "arrayIncludes");
var bM = yM;
function xM(e, t, n) {
...
k(xM, "arrayIncludesWith");
var SM = xM;
function CM() {}
k(CM, "noop");
var wM = CM, TM = _k && 1 / mD(new _k([, -0]))[1] == Infinity ? function(e) {
	return new _k(e);
} : wM, EM = 200;
function DM(e, t, n) {
	var r = -1, i = bM, a = e.length, o = !0, s = [], c = s;
	if (n) o = !1, i = SM;
	else if (a >= EM) {
		var l = t ? null : TM(e);
		if (l) return mD(l);
...
var IM = FM;
function LM(e, t) {
	return (PD(e) ? PM : nj)(e, IM(t));
}
k(LM, "forEach");
var RM = LM, zM = "[object Map]", BM = "[object Set]", VM = Object.prototype.hasOwnProperty;
function HM(e) {
	if (e == null) return !0;
	if (ok(e) && (PD(e) || typeof e == "string" || typeof e.splice == "function" || oO(e) || qO(e) || eO(e))) return !e.length;
	var t = jk(e);
	if (t == zM || t == BM) return !e.size;
	if ($O(e)) return !ik(e).length;
	for (var n in e) if (VM.call(e, n)) return !1;
	return !0;
}
k(HM, "isEmpty");
var UM = HM;
...
var qM = KM;
function JM(e, t, n) {
	var r = PD(e) ? GM : qM, i = arguments.length < 3;
	return r(e, XA(t, 4), n, i, nj);
}
k(JM, "reduce");
var YM = JM;
function XM(e, t) {
...
var ZM = (Pe = class {
...
}, k(Pe, "PredicateSet"), Pe), QM = new ZM(), $M = (Fe = class extends rw {
	constructor(e) {
		var t;
		super(), this.logging = (t = e == null ? void 0 : e.logging) == null ? ((e) => console.log(e)) : t;
	}
	initialize(e) {
		this.atn = Ej(e.rules), this.dfas = tN(this.atn);
	}
	...
	buildLookaheadForAlternation(e) {
		let { prodOccurrence: t, rule: n, hasPredicates: r, dynamicTokensEnabled: i } = e, a = this.dfas, o = this.logging, s = dj(n, "Alternation", t), c = this.atn.decisionMap[s].decision, l = oj(JS({
			maxLookahead: 1,
			occurrence: t,
		...
		if (eN(l, !1) && !i) {
			let e = YM(l, (e, t, n) => (RM(t, (t) => {
				t && (e[t.tokenTypeIdx] = n, RM(t.categoryMatches, (t) => {
					e[t] = n;
				}));
			}), e), {});
			return r ? function(t) {
			...
			let t = new ZM(), n = e === void 0 ? 0 : e.length;
			for (let r = 0; r < n; r++) {
				let n = e == null ? void 0 : e[r].GATE;
				t.set(r, n === void 0 || n.call(this));
			}
			let r = nN.call(this, a, c, t, o);
			return typeof r == "number" ? r : void 0;
		};
		else return function() {
			let e = nN.call(this, a, c, QM, o);
			return typeof e == "number" ? e : void 0;
		};
	}
	buildLookaheadForOptional(e) {
		let { prodOccurrence: t, rule: n, prodType: r, dynamicTokensEnabled: i } = e, a = this.dfas, o = this.logging, s = dj(n, r, t), c = this.atn.decisionMap[s].decision, l = oj(JS({
			maxLookahead: 1,
			occurrence: t,
			prodType: r,
			rule: n
		...
		if (eN(l) && l[0][0] && !i) {
			let e = l[0], t = MM(e);
			if (t.length === 1 && UM(t[0].categoryMatches)) {
				let e = t[0].tokenTypeIdx;
				return function() {
					return this.LA(1).tokenTypeIdx === e;
				};
			} else {
				let e = YM(t, (e, t) => (t !== void 0 && (e[t.tokenTypeIdx] = !0, RM(t.categoryMatches, (t) => {
					e[t] = !0;
				})), e), {});
				return function() {
					return e[this.LA(1).tokenTypeIdx] === !0;
...
function tN(e) {
	...
	for (let r = 0; r < t; r++) n[r] = XM(e.decisionStates[r], r);
	return n;
}
k(tN, "initATNSimulator");
function nN(e, t, n, r) {
	let i = e[t](n), a = i.start;
	return a === void 0 && (a = hN(i, pN(gN(i.atnStartState))), i.start = a), rN.apply(this, [
		i,
		a,
		n,
		r
...
k(nN, "adaptivePredict");
function rN(e, t, n, r) {
	let i = t, a = 1, o = [], s = this.LA(a++);
	for (;;) {
		let t = lN(i, s);
		if (t === void 0 && (t = iN.apply(this, [
			e,
			i,
			s,
			a,
			n,
			r
		])), t === Yj) return cN(o, i, s);
		if (t.isAcceptState === !0) return t.prediction;
		i = t, o.push(s), s = this.LA(a++);
	}
}
k(rN, "performLookahead");
function iN(e, t, n, r, i, a) {
	let o = uN(t.configs, n, i);
	if (o.size === 0) return mN(e, t, n, Yj), Yj;
	let s = pN(o), c = fN(o, i);
	if (c !== void 0) s.isAcceptState = !0, s.prediction = c, s.configs.uniqueAlt = c;
	else if (xN(o)) {
		let t = rM(o.alts);
		s.isAcceptState = !0, s.prediction = t, s.configs.uniqueAlt = t, aN.apply(this, [
			e,
			r,
			o.alts,
			a
	...
	return s = mN(e, t, n, s), s;
}
k(iN, "computeLookaheadTarget");
function aN(e, t, n, r) {
	let i = [];
...
k(aN, "reportLookaheadAmbiguity");
function oN(e) {
	let t = oj(e.prefixPath, (e) => gS(e)).join(", "), n = e.production.idx === 0 ? "" : e.production.idx, r = `Ambiguous Alternatives Detected: <${e.ambiguityIndices.join(", ")}> in <${sN(e.production)}${n}> inside <${e.topLevelRule.name}> Rule,
<${t}> may appears as a prefix path in all these alternatives.
`;
	return r += "See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES\nFor Further details.", r;
}
k(oN, "buildAmbiguityError");
function sN(e) {
	if (e instanceof kb) return "SUBRULE";
	if (e instanceof Mb) return "OPTION";
	if (e instanceof Ib) return "OR";
...
k(sN, "getProductionDslName");
function cN(e, t, n) {
	return {
		actualToken: n,
		possibleTokenTypes: AM(uM(t.configs.elements, (e) => e.state.transitions).filter((e) => e instanceof Cj).map((e) => e.tokenType), (e) => e.tokenTypeIdx),
		tokenPath: e
	};
}
k(cN, "buildAdaptivePredictError");
function lN(e, t) {
	return e.edges[t.tokenTypeIdx];
}
k(lN, "getExistingTargetState");
function uN(e, t, n) {
	let r = new Xj(), i = [];
	for (let a of e.elements) {
		...
		for (let n = 0; n < e; n++) {
			let e = a.state.transitions[n], i = dN(e, t);
			i !== void 0 && r.add({
				state: i,
				alt: a.alt,
				stack: a.stack
	...
	if (i.length === 0 && r.size === 1 && (a = r), a === void 0) {
		a = new Xj();
		for (let e of r.elements) _N(e, a);
	}
	if (i.length > 0 && !yN(a)) for (let e of i) a.add(e);
	return a;
}
k(uN, "computeReachSet");
function dN(e, t) {
	if (e instanceof Cj && jS(t, e.tokenType)) return e.target;
}
k(dN, "getReachableTarget");
function fN(e, t) {
	let n;
...
k(pN, "newDFAState");
function mN(e, t, n, r) {
	return r = hN(e, r), t.edges[n.tokenTypeIdx] = r, r;
}
k(mN, "addDFAEdge");
function hN(e, t) {
	if (t === Yj) return t;
...
k(hN, "addDFAState");
function gN(e) {
	let t = new Xj(), n = e.transitions.length;
	for (let r = 0; r < n; r++) _N({
...
function _N(e, t) {
	...
	for (let i = 0; i < r; i++) {
		let r = n.transitions[i], a = vN(e, r);
		a !== void 0 && _N(a, t);
	}
}
k(_N, "closure");
function vN(e, t) {
	if (t instanceof wj) return {
		state: t.target,
		alt: e.alt,
		stack: e.stack
	};
...
k(vN, "getEpsilonTarget");
function yN(e) {
	for (let t of e.elements) if (t.state.type === gj) return !0;
	return !1;
}
k(yN, "hasConfigInRuleStopState");
function bN(e) {
	for (let t of e.elements) if (t.state.type !== gj) return !1;
	return !0;
}
k(bN, "allConfigsInRuleStopStates");
function xN(e) {
	if (bN(e)) return !0;
	let t = SN(e.elements);
	return CN(t) && !wN(t);
}
k(xN, "hasConflictTerminatingPrediction");
function SN(e) {
	let t = /* @__PURE__ */ new Map();
	for (let n of e) {
		let e = Zj(n, !1), r = t.get(e);
		r === void 0 && (r = {}, t.set(e, r)), r[n.alt] = !0;
	}
	return t;
}
k(SN, "getConflictingAltSets");
function CN(e) {
	for (let t of Array.from(e.values())) if (Object.keys(t).length > 1) return !0;
	return !1;
}
k(CN, "hasConflictingAltSet");
function wN(e) {
	for (let t of Array.from(e.values())) if (Object.keys(t).length === 1) return !0;
	return !1;
}
k(wN, "hasStateAssociatedWithOneAlt"), Vr();
var TN = (Ie = class {
	constructor() {
		this.nodeStack = [];
	}
	...
	buildRootNode(e) {
		return this.rootNode = new AN(e), this.rootNode.root = this.rootNode, this.nodeStack = [this.rootNode], this.rootNode;
	}
	...
	buildLeafNode(e, t) {
		let n = new DN(e.startOffset, e.image.length, ds(e), e.tokenType, !t);
	...
	addHiddenNodes(e) {
		let t = [];
		for (let n of e) {
			let e = new DN(n.startOffset, n.image.length, ds(n), n.tokenType, !0);
...
}, k(Ie, "CstNodeBuilder"), Ie), EN = (Le = class {
	get hidden() {
		return !1;
	}
	get astNode() {
...
}, k(Le, "AbstractCstNode"), Le), DN = (Re = class extends EN {
	get offset() {
		return this._offset;
	}
	get length() {
...
}, k(Re, "LeafCstNodeImpl"), Re), ON = (ze = class extends EN {
	constructor() {
		super(...arguments), this.content = new kN(this);
	}
	get offset() {
		var e, t;
...
}, k(ze, "CompositeCstNodeImpl"), ze), kN = (Be = class e extends Array {
	constructor(t) {
...
}, k(Be, "CstNodeContainer"), Be), AN = (Ve = class extends ON {
	get text() {
...
}, k(Ve, "RootCstNodeImpl"), Ve), jN = Symbol("Datatype");
function MN(e) {
	return e.$type === jN;
}
k(MN, "isDataTypeNode");
var NN = "​", PN = /* @__PURE__ */ k((e) => e.endsWith(NN) ? e : e + NN, "withRuleSuffix"), FN = (He = class {
	constructor(e) {
		var t;
		...
		(t = e.shared.profilers.LangiumProfiler) != null && t.isActive("parsing") ? this.wrapper = new HN(n, {
			...e.parser.ParserConfig,
			skipValidations: r,
			errorMessageProvider: e.parser.ParserErrorMessageProvider
		}, e.shared.profilers.LangiumProfiler.createTask("parsing", e.LanguageMetaData.languageId)) : this.wrapper = new VN(n, {
			...e.parser.ParserConfig,
			skipValidations: r,
			errorMessageProvider: e.parser.ParserErrorMessageProvider
		});
...
}, k(He, "AbstractLangiumParser"), He), IN = (Ue = class extends FN {
	get current() {
		return this.stack[this.stack.length - 1];
	}
	constructor(e) {
		super(e), this.nodeBuilder = new TN(), this.stack = [], this.assignmentMap = /* @__PURE__ */ new Map(), this.operatorPrecedence = /* @__PURE__ */ new Map(), this.linker = e.references.Linker, this.converter = e.parser.ValueConverter, this.astReflection = e.shared.AstReflection;
	}
	rule(e, t) {
		let n = this.computeRuleType(e), r;
		Qa(e) && (r = e.name, this.registerPrecedenceMap(e));
		let i = this.wrapper.DEFINE_RULE(PN(e.name), this.startImplementation(n, r, t).bind(this));
	...
	computeRuleType(e) {
		return Qa(e) ? Oc(e) : e.fragment ? void 0 : Cc(e) ? jN : Oc(e);
	}
	parse(e, t = {}) {
	...
	startImplementation(e, t, n) {
		return (r) => {
			...
			if (i) {
				let n = { $type: e };
				this.stack.push(n), e === jN ? n.value = "" : t !== void 0 && (n.$infixName = t);
			}
	...
	construct() {
		...
		return this.nodeBuilder.construct(e), "$infixName" in e ? this.constructInfix(e, this.operatorPrecedence.get(e.$infixName)) : MN(e) ? this.converter.convert(e.value, e.$cstNode) : (oa(this.astReflection, e), e);
	}
	constructInfix(e, t) {
		let n = e.parts;
...
}, k(Ue, "LangiumParser"), Ue), LN = (We = class {
...
}, k(We, "AbstractParserErrorMessageProvider"), We), RN = (Ge = class extends LN {
...
}, k(Ge, "LangiumParserErrorMessageProvider"), Ge), zN = (Ke = class extends FN {
	constructor() {
	...
	rule(e, t) {
		let n = this.wrapper.DEFINE_RULE(PN(e.name), this.startImplementation(t).bind(this));
...
}, k(Ke, "LangiumCompletionParser"), Ke), BN = {
	recoveryEnabled: !0,
	nodeLocationTracking: "full",
	skipValidations: !0,
	errorMessageProvider: new RN()
}, VN = (qe = class extends Ww {
	constructor(e, t) {
		let n = t && "maxLookahead" in t;
		super(e, {
			...BN,
			lookaheadStrategy: n ? new rw({ maxLookahead: t.maxLookahead }) : new $M({ logging: t.skipValidations ? () => {} : void 0 }),
			...t
		});
	}
	get IS_RECORDING() {
...
}, k(qe, "ChevrotainWrapper"), qe), HN = (Je = class extends VN {
	constructor(e, t, n) {
...
function WN(e, t) {
	...
	for (let t of r) {
		...
		e.parser.rule(t, KN(n, t.definition));
	}
	let i = I(t.rules).filter(Qa).filter((e) => n.has(e));
	for (let t of i) e.parser.rule(t, GN(e, t));
}
k(WN, "buildRules");
function GN(e, t) {
	...
	return (t) => {
		u != null || (u = iP(e, n)), e.parser.subrule(0, u, !1, a, t), e.parser.many(0, { DEF: /* @__PURE__ */ k(() => {
...
function KN(e, t, n = !1) {
	let r;
	if (oo(t)) r = nP(e, t);
	else if (ba(t)) r = qN(e, t);
	else if (Oa(t)) r = KN(e, t.terminal);
	else if (Ra(t)) r = tP(e, t);
	else if (ko(t)) r = JN(e, t);
	else if (Sa(t)) r = ZN(e, t);
	else if ($o(t)) r = QN(e, t);
	else if (Ja(t)) r = $N(e, t);
	else if (Ha(t)) {
		let n = e.consume++;
		r = /* @__PURE__ */ k(() => e.parser.consume(n, kS, t), "method");
	} else throw new As(t.$cstNode, `Unexpected element type: ${t.$type}`);
	return rP(e, n ? void 0 : eP(t), r, t.cardinality);
}
k(KN, "buildElement");
function qN(e, t) {
	let n = Oc(t);
...
function JN(e, t) {
	let n = t.rule.ref;
	if (ma(n)) {
		let r = e.subrule++, i = xo(n) && n.fragment, a = t.arguments.length > 0 ? YN(n, t.arguments) : () => ({}), o;
		return (s) => {
			o != null || (o = iP(e, n)), e.parser.subrule(r, o, i, t, a(s));
		};
	} else if (Vo(n)) {
		let r = e.consume++, i = oP(e, n.name);
...
k(YN, "buildRuleCallPredicate");
function XN(e) {
	if (Ba(e)) {
		let t = XN(e.left), n = XN(e.right);
		return (e) => t(e) || n(e);
	} else if (Ia(e)) {
		let t = XN(e.left), n = XN(e.right);
		return (e) => t(e) && n(e);
...
k(XN, "buildPredicate");
function ZN(e, t) {
	if (t.elements.length === 1) return KN(e, t.elements[0]);
	{
		let n = [];
		for (let r of t.elements) {
			let t = { ALT: KN(e, r, !0) }, i = eP(r);
			i && (t.GATE = XN(i)), n.push(t);
		}
		let r = e.or++;
...
function QN(e, t) {
	...
	})), "alternatives"), o = rP(e, eP(t), a, "*");
	return (t) => {
		o(t), e.parser.isRecording() || e.parser.unorderedGroups.delete(i(r, e.parser));
	};
}
k(QN, "buildUnorderedGroup");
function $N(e, t) {
	let n = t.elements.map((t) => KN(e, t));
...
k(eP, "getGuardCondition");
function tP(e, t, n = t.terminal) {
	if (!n) {
		if (!t.type.ref) throw Error("Could not resolve reference to type: " + t.type.$refText);
		let n = _c(t.type.ref), r = n == null ? void 0 : n.terminal;
		if (!r) throw Error("Could not find name assignment for type: " + Oc(t.type.ref));
		return tP(e, t, r);
	} else if (ko(n) && xo(n.rule.ref)) {
		let r = n.rule.ref, i = e.subrule++, a;
		return (n) => {
			a != null || (a = iP(e, r)), e.parser.subrule(i, a, !1, t, n);
		};
	} else if (ko(n) && Vo(n.rule.ref)) {
		let r = e.consume++, i = oP(e, n.rule.ref.name);
		return () => e.parser.consume(r, i, t);
	} else if (oo(n)) {
		let r = e.consume++, i = oP(e, n.value);
		return () => e.parser.consume(r, i, t);
	} else throw Error("Could not build cross reference parser");
}
k(tP, "buildCrossReference");
function nP(e, t) {
...
k(rP, "wrap");
function iP(e, t) {
	let n = aP(e, t), r = e.parser.getRule(n);
...
k(oP, "getToken");
function sP(e) {
	let t = e.Grammar, n = e.parser.Lexer, r = new zN(e);
	return UN(t, r, n.definition), r.finalize(), r;
}
k(sP, "createCompletionParser");
function cP(e) {
	let t = lP(e);
	return t.finalize(), t;
}
k(cP, "createLangiumParser");
function lP(e) {
	let t = e.Grammar, n = e.parser.Lexer;
	return UN(t, new IN(e), n.definition);
}
k(lP, "prepareLangiumParser");
var uP = (Ye = class {
	constructor() {
		this.diagnostics = [];
	}
	...
	buildTerminalToken(e) {
		...
		return typeof n == "function" && (r.LINE_BREAKS = !0), e.hidden && (r.GROUP = $s(t) ? hS.SKIPPED : "hidden"), r;
	}
	...
	buildKeywordTokens(e, t, n) {
		return e.filter(ma).flatMap((e) => na(e).filter(oo)).distinct((e) => e.value).toArray().sort((e, t) => t.value.length - e.value.length).map((e) => this.buildKeywordToken(e, t, !!(n != null && n.caseInsensitive)));
	}
	...
	findLongerAlt(e, t) {
		return t.reduce((t, n) => {
			...
			return r != null && r.source && tc("^" + r.source + "$", e.value) && t.push(n), t;
		}, []);
	}
}, k(Ye, "DefaultTokenBuilder"), Ye), dP = (Xe = class {
	convert(e, t) {
	...
	runConverter(e, t, n) {
		...
		switch (e.name.toUpperCase()) {
			case "INT": return fP.convertInt(t);
			case "STRING": return fP.convertString(t);
			case "ID": return fP.convertID(t);
		}
		switch ((r = jc(e)) == null ? void 0 : r.toLowerCase()) {
			case "number": return fP.convertNumber(t);
			case "boolean": return fP.convertBoolean(t);
			case "bigint": return fP.convertBigint(t);
			case "date": return fP.convertDate(t);
			default: return t;
		}
	}
}, k(Xe, "DefaultValueConverter"), Xe), fP;
(function(e) {
	function t(e) {
		let t = "";
...
var mP = 0, hP = 10;
function gP() {
	return mP = performance.now(), new Q.CancellationTokenSource();
}
k(gP, "startCancelableOperation");
function _P(e) {
	hP = e;
}
k(_P, "setInterruptionPeriod");
var vP = Symbol("OperationCancelled");
function yP(e) {
	return e === vP;
}
k(yP, "isOperationCancelled");
async function bP(e) {
	if (e === Q.CancellationToken.None) return;
	let t = performance.now();
	if (t - mP >= hP && (mP = t, await pP(), mP = performance.now()), e.isCancellationRequested) throw vP;
}
k(bP, "interruptAndCheck");
var xP = (Ze = class {
	constructor() {
...
}, k(Ze, "Deferred"), Ze), SP = (Qe = class e {
	constructor(e, t, n, r) {
		this._uri = e, this._languageId = t, this._version = n, this._content = r, this._lineOffsets = void 0;
	}
	get uri() {
	...
	update(t, n) {
		for (let n of t) if (e.isIncremental(n)) {
			let e = DP(n.range), t = this.offsetAt(e.start), r = this.offsetAt(e.end);
			this._content = this._content.substring(0, t) + n.text + this._content.substring(r, this._content.length);
			let i = Math.max(e.start.line, 0), a = Math.max(e.end.line, 0), o = this._lineOffsets, s = TP(n.text, !1, t);
	...
	ensureBeforeEOL(e, t) {
		for (; e > t && EP(this._content.charCodeAt(e - 1));) e--;
		return e;
	}
	get lineCount() {
		return this.getLineOffsets().length;
...
function TP(e, t, n = 0) {
	...
	for (let t = 0; t < e.length; t++) {
		...
		EP(i) && (i === 13 && t + 1 < e.length && e.charCodeAt(t + 1) === 10 && t++, r.push(n + t + 1));
	}
	return r;
}
k(TP, "computeLineOffsets");
function EP(e) {
	return e === 13 || e === 10;
}
k(EP, "isEOL");
...
var { URI: AP, Utils: jP } = kP, MP;
(function(e) {
	var t;
	e.basename = jP.basename, e.dirname = jP.dirname, e.extname = jP.extname, e.joinPath = jP.joinPath, e.resolvePath = jP.resolvePath;
	...
	function i(e, t) {
		let r = typeof e == "string" ? AP.parse(e).path : e.path, i = typeof t == "string" ? AP.parse(t).path : t.path, a = r.split("/").filter((e) => e.length > 0), o = i.split("/").filter((e) => e.length > 0);
		if (n) {
			let e = /^[A-Z]:$/;
	...
	function a(e) {
		return AP.parse(e.toString()).toString();
	}
...
var NP = ($e = class {
	...
	findNode(e) {
		...
		if (n) return {
			name: n.name,
			uri: MP.joinPath(AP.parse(t), n.name).toString(),
			element: n.element
		};
	}
	findChildren(e) {
		...
		return n ? Array.from(n.children.values()).map((e) => ({
			name: e.name,
			uri: MP.joinPath(AP.parse(t), e.name).toString(),
			element: e.element
		})) : [];
	}
	all() {
	...
	findAll(e) {
		let t = this.getNode(MP.normalize(e), !1);
...
var PP = (et = class {
	...
	fromTextDocument(e, t, n) {
		var r;
		return t = (r = t) == null ? AP.parse(e.uri) : r, Q.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n);
	}
	fromString(e, t, n) {
	...
	async update(e, t) {
		...
		return i !== o && (e.parseResult = await this.parseAsync(e.uri, o, t), e.parseResult.value.$document = e), e.state = $.Parsed, e;
	}
	parse(e, t, n) {
	...
	createTextDocumentGetter(e, t) {
		...
		return () => {
			var i;
			return (i = r) == null ? r = CP.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, t == null ? "" : t) : i;
		};
	}
}, k(et, "DefaultLangiumDocumentFactory"), et), FP = (tt = class {
	constructor(e) {
		this.documentTrie = new NP(), this.services = e, this.langiumDocumentFactory = e.workspace.LangiumDocumentFactory, this.documentBuilder = () => e.workspace.DocumentBuilder;
	}
	get all() {
...
}, k(tt, "DefaultLangiumDocuments"), tt), IP = Symbol("RefResolving"), LP = (nt = class {
	constructor(e) {
	...
	async link(e, t = Q.CancellationToken.None) {
		...
		if ((n = this.profiler) != null && n.isActive("linking")) {
			...
			n.start();
			try {
				for (let r of ra(e.parseResult.value)) await bP(t), aa(r).forEach((t) => {
		...
		} else for (let n of ra(e.parseResult.value)) await bP(t), aa(n).forEach((t) => this.doLink(t, e));
	}
	doLink(e, t) {
		let n = e.reference;
	...
	buildReference(e, t, n, r) {
		let i = this, a = {
			...
			_ref: void 0,
			get ref() {
				if (F(this._ref)) return this._ref;
				if (Fi(this._nodeDescription)) {
					...
					var n;
					this._ref = IP;
					let r = $i(e).$document, o = i.getLinkedNode({
						reference: a,
						container: e,
						property: t
					});
					if (o.error && r && r.state < $.ComputedScopes) {
						this._ref = void 0;
						return;
					}
					this._ref = (n = o.node) == null ? o.error : n, this._nodeDescription = o.descr, r == null || r.references.push(this);
				} else this._ref === IP && i.throwCyclicReferenceError(e, t, r);
				return F(this._ref) ? this._ref : void 0;
			},
			get $nodeDescription() {
	...
	buildMultiReference(e, t, n, r) {
		let i = this, a = {
			...
			get items() {
				...
				} else this._items === IP && i.throwCyclicReferenceError(e, t, r);
...
var zP = (rt = class {
	getName(e) {
		if (RP(e)) return e.name;
	}
	getNameNode(e) {
		return dc(e.$cstNode, "name");
	}
}, k(rt, "DefaultNameProvider"), rt), BP = (it = class {
	constructor(e) {
	...
	findReferences(e, t) {
		...
		return t.documentUri && (r = r.filter((e) => MP.equals(e.sourceUri, t.documentUri))), n.push(...r), I(n);
	}
	getSelfReferences(e) {
...
}, k(it, "DefaultReferences"), it), VP = (Qt = Symbol.iterator, at = class {
	constructor(e) {
	...
	async collectExportedSymbolsForNode(e, t, n = ta, r = Q.CancellationToken.None) {
		...
		for (let a of n(e)) await bP(r), this.addExportedSymbol(a, i, t);
		return i;
	}
	...
	async collectLocalSymbols(e, t = Q.CancellationToken.None) {
		let n = e.parseResult.value, r = new VP();
		for (let i of na(n)) await bP(t), this.addLocalSymbol(i, e, r);
		return r;
	}
...
}, k(st, "DefaultScopeComputation"), st), WP = (ct = class {
	constructor(e, t, n) {
		var r, i;
...
}, k(ct, "StreamScope"), ct), GP = (lt = class {
	constructor(e, t, n) {
		var r, i;
...
}, k(lt, "MapScope"), lt), KP = (ut = class {
	constructor(e, t, n) {
		var r, i;
		this.elements = new VP(), this.caseInsensitive = (r = n == null ? void 0 : n.caseInsensitive) == null ? !1 : r, this.concatOuterScope = (i = n == null ? void 0 : n.concatOuterScope) == null ? !0 : i;
		for (let t of e) {
			let e = this.caseInsensitive ? t.name.toLowerCase() : t.name;
...
}, k(dt, "DisposableCache"), dt), YP = (ft = class extends JP {
	constructor() {
...
}, k(ft, "SimpleCache"), ft), XP = (pt = class extends JP {
	constructor(e) {
...
}, k(pt, "ContextCache"), pt), ZP = (mt = class extends XP {
	constructor(e, t) {
...
}, k(mt, "DocumentCache"), mt), QP = (ht = class extends YP {
	constructor(e, t) {
...
}, k(ht, "WorkspaceCache"), ht), $P = (gt = class {
	constructor(e) {
		this.reflection = e.shared.AstReflection, this.nameProvider = e.references.NameProvider, this.descriptions = e.workspace.AstNodeDescriptionProvider, this.indexManager = e.shared.workspace.IndexManager, this.globalScopeCache = new QP(e.shared);
	}
	getScope(e) {
...
var nF = (_t = class {
	...
	serialize(e, t) {
		...
		try {
			return this.currentDocument = Qi(e), JSON.stringify(e, a, t == null ? void 0 : t.space);
		} finally {
	...
	replacer(e, t, { refText: n, sourceText: r, textRegions: i, comments: a, uriConverter: o }) {
		if (!this.ignoreProperties.has(e)) if (Ni(t)) {
	...
	linkNode(e, t, n, r, i, a) {
		for (let [r, i] of Object.entries(e)) if (Array.isArray(i)) for (let a = 0; a < i.length; a++) {
			let o = i[a];
			tF(o) ? i[a] = this.reviveReference(e, r, t, o, n) : F(o) && this.linkNode(o, t, n, e, r, a);
		}
		else tF(i) ? e[r] = this.reviveReference(e, r, t, i, n) : F(i) && this.linkNode(i, t, n, e, r);
		let o = e;
	...
	getRefNode(e, t, n) {
		try {
			...
			if (r < 0) {
				let e = n ? n(t) : AP.parse(t), r = this.langiumDocuments.getDocument(e);
				return r ? r.parseResult.value : "Could not find document for URI: " + t;
			}
			let i = n ? n(t.substring(0, r)) : AP.parse(t.substring(0, r)), a = this.langiumDocuments.getDocument(i);
...
}, k(_t, "DefaultJsonSerializer"), _t), rF = (vt = class {
	get map() {
	...
	getServices(e) {
		...
		let i = MP.extname(e), a = MP.basename(e), o = (n = this.fileNameMap.get(a)) == null ? this.fileExtensionMap.get(i) : n;
...
var oF = (yt = class {
	constructor(e) {
		this.entries = new VP(), this.knownCategories = new Set(aF.defaults), this.entriesBefore = [], this.entriesAfter = [], this.reflection = e.shared.AstReflection;
	}
...
}, k(yt, "ValidationRegistry"), yt), sF = Object.freeze({
	validateNode: !0,
	validateChildren: !0
}), cF = (bt = class {
	constructor(e) {
	...
	async validateDocument(e, t = {}, n = Q.CancellationToken.None) {
		...
		if (await bP(n), (!t.categories || t.categories.includes("built-in")) && (this.processLexingErrors(r, i, t), t.stopAfterLexingErrors && i.some((e) => {
			var t;
			return ((t = e.data) == null ? void 0 : t.code) === fF.LexingError;
		}) || (this.processParsingErrors(r, i, t), t.stopAfterParsingErrors && i.some((e) => {
			var t;
			return ((t = e.data) == null ? void 0 : t.code) === fF.ParsingError;
		})) || (this.processLinkingErrors(e, i, t), t.stopAfterLinkingErrors && i.some((e) => {
			var t;
			return ((t = e.data) == null ? void 0 : t.code) === fF.LinkingError;
		})))) return i;
		try {
	...
	async validateAstBefore(e, t, n, r = Q.CancellationToken.None) {
		...
		for (let o of i) {
			var a;
			await bP(r), await o(e, n, (a = t.categories) == null ? [] : a, r);
		}
	}
...
function lF(e) {
	...
	let t;
	return typeof e.property == "string" ? t = dc(e.node.$cstNode, e.property, e.index) : typeof e.keyword == "string" && (t = mc(e.node.$cstNode, e.keyword, e.index)), t != null || (t = e.node.$cstNode), t ? t.range : {
		start: {
			line: 0,
			character: 0
		},
...
k(uF, "toDiagnosticSeverity");
function dF(e) {
	switch (e) {
		case "error": return iF(fF.LexingError);
		case "warning": return iF(fF.LexingWarning);
		case "info": return iF(fF.LexingInfo);
		case "hint": return iF(fF.LexingHint);
		default: throw Error("Invalid diagnostic severity: " + e);
	}
}
k(dF, "toDiagnosticData");
var fF;
(function(e) {
...
var pF = (xt = class {
	...
	createDescription(e, t, n) {
		...
		let a, o = /* @__PURE__ */ k(() => {
			var t, n;
			return (t = a) == null ? a = fs((n = this.nameProvider.getNameNode(e)) == null ? e.$cstNode : n) : t;
		}, "nameSegmentGetter");
		return {
			node: e,
			name: t,
...
}, k(xt, "DefaultAstNodeDescriptionProvider"), xt), mF = (St = class {
	constructor(e) {
	...
	async createDescriptions(e, t = Q.CancellationToken.None) {
		...
		for (let e of ra(r)) await bP(t), aa(e).forEach((e) => {
	...
	createInfoDescriptions(e) {
		...
		for (let e of n) a.push({
			...
			targetPath: e.path,
			segment: o,
			local: MP.equals(e.documentUri, r)
		});
		return a;
	}
}, k(St, "DefaultReferenceDescriptionProvider"), St), hF = (Ct = class {
	constructor() {
...
}, k(Ct, "DefaultAstNodeLocator"), Ct), gF = {};
ln(gF, un(Wr(), 1));
var _F = (wt = class {
	constructor(e) {
		this._ready = new xP(), this.onConfigurationSectionUpdateEmitter = new gF.Emitter(), this.settings = {}, this.workspaceConfig = !1, this.serviceRegistry = e.ServiceRegistry;
	}
	get ready() {
...
}, k(wt, "DefaultConfigurationProvider"), wt), vF = un(Ai(), 1), yF;
(function(e) {
	function t(e) {
...
var bF = (Tt = class {
	...
	async update(e, t, n = Q.CancellationToken.None) {
		...
		this.langiumDocuments.all.filter((e) => !a.has(e.uri.toString()) && this.shouldRelink(e, a)).forEach((e) => this.resetToState(e, $.ComputedScopes)), await this.emitUpdate(i, r), await bP(n);
		let o = this.sortDocuments(this.langiumDocuments.all.filter((e) => {
			var t;
			return e.state < $.Validated || !((t = this.buildState.get(e.uri.toString())) != null && t.completed) || this.resultsAreIncomplete(e, this.updateBuildOptions);
		}).toArray());
	...
	findMissingValidationCategories(e, t) {
		...
		return I(t === void 0 || t.validation === !0 ? o : typeof t.validation == "object" ? (i = t.validation.categories) == null ? o : i : []).filter((e) => !s.has(e)).toArray();
	}
	...
	onUpdate(e) {
		return this.updateListeners.push(e), yF.create(() => {
	...
	async runCancelable(e, t, n, r) {
		for (let i of e) i.state < t && (await bP(n), await r(i), i.state = t, await this.notifyDocumentPhase(i, t, n));
		let i = e.filter((e) => e.state === t);
		await this.notifyBuildPhase(i, t, n), this.currentState = t;
	}
	onBuildPhase(e, t) {
		return this.buildPhaseListeners.add(e, t), yF.create(() => {
			this.buildPhaseListeners.delete(e, t);
		});
	}
	onDocumentPhase(e, t) {
		return this.documentPhaseListeners.add(e, t), yF.create(() => {
			this.documentPhaseListeners.delete(e, t);
		});
	}
	waitUntil(e, t, n) {
		let r;
		return t && "path" in t ? r = t : n = t, n != null || (n = Q.CancellationToken.None), r ? this.awaitDocumentState(e, r, n) : this.awaitBuilderState(e, n);
	}
	awaitDocumentState(e, t, n) {
		let r = this.langiumDocuments.getDocument(t);
		return r ? r.state >= e ? Promise.resolve(t) : n.isCancellationRequested ? Promise.reject(vP) : this.currentState >= e && e > r.state ? Promise.reject(new vF.ResponseError(vF.LSPErrorCodes.RequestFailed, `Document state of ${t.toString()} is ${$[r.state]}, requiring ${$[e]}, but workspace state is already ${$[this.currentState]}. Returning undefined.`)) : new Promise((r, i) => {
			let a = this.onDocumentPhase(e, (e) => {
				MP.equals(e.uri, t) && (a.dispose(), o.dispose(), r(e.uri));
			}), o = n.onCancellationRequested(() => {
				a.dispose(), o.dispose(), i(vP);
			});
		}) : Promise.reject(new vF.ResponseError(vF.LSPErrorCodes.ServerCancelled, `No document found for URI: ${t.toString()}`));
	}
	awaitBuilderState(e, t) {
		return this.currentState >= e ? Promise.resolve() : t.isCancellationRequested ? Promise.reject(vP) : new Promise((n, r) => {
			let i = this.onBuildPhase(e, () => {
				i.dispose(), a.dispose(), n();
			}), a = t.onCancellationRequested(() => {
				i.dispose(), a.dispose(), r(vP);
			});
		});
	}
	...
	async notifyBuildPhase(e, t, n) {
		...
		for (let t of r) await bP(n), await t(e, n);
	}
	shouldLink(e) {
		var t;
	...
	async validate(e, t) {
		...
		o && (o.result != null || (o.result = {}), o.result.validationChecks ? o.result.validationChecks = I(o.result.validationChecks).concat(i.categories).distinct().toArray() : o.result.validationChecks = [...i.categories]);
	}
	getBuildOptions(e) {
		var t, n;
		return (t = (n = this.buildState.get(e.uri.toString())) == null ? void 0 : n.options) == null ? {} : t;
	}
}, k(Tt, "DefaultDocumentBuilder"), Tt), xF = (Et = class {
	constructor(e) {
		this.symbolIndex = /* @__PURE__ */ new Map(), this.symbolByTypeIndex = new XP(), this.referenceIndex = /* @__PURE__ */ new Map(), this.documents = e.workspace.LangiumDocuments, this.serviceRegistry = e.ServiceRegistry, this.astReflection = e.AstReflection;
	}
	findAllReferences(e, t) {
		let n = Qi(e).uri, r = [];
		return this.referenceIndex.forEach((e) => {
			e.forEach((e) => {
				MP.equals(e.targetUri, n) && e.targetPath === t && r.push(e);
			});
		}), I(r);
	}
	allElements(e, t) {
...
}, k(Et, "DefaultIndexManager"), Et), SF = (Dt = class {
	constructor(e) {
		this.initialBuildOptions = {}, this._ready = new xP(), this.serviceRegistry = e.ServiceRegistry, this.langiumDocuments = e.workspace.LangiumDocuments, this.documentBuilder = e.workspace.DocumentBuilder, this.fileSystemProvider = e.workspace.FileSystemProvider, this.mutex = e.workspace.WorkspaceLock;
	}
	get ready() {
		return this._ready.promise;
	}
	...
	async initializeWorkspace(e, t = Q.CancellationToken.None) {
		...
		await bP(t), await this.documentBuilder.build(n, this.initialBuildOptions, t);
	}
	...
	constructor(e) {
		...
		let n = OF(t) ? Object.values(t) : t, r = e.LanguageMetaData.mode === "production";
		this.chevrotainLexer = new hS(n, {
			positionTracking: "full",
			skipValidations: r,
	...
	toTokenTypeDictionary(e) {
		if (OF(e)) return e;
		let t = DF(e) ? Object.values(e.modes).flat() : e, n = {};
...
k(EF, "isTokenTypeArray");
function DF(e) {
	return e && "modes" in e && "defaultMode" in e;
}
k(DF, "isIMultiModeLexerDefinition");
function OF(e) {
	return !EF(e) && !DF(e);
}
k(OF, "isTokenTypeDictionary"), Vr();
function kF(e, t, n) {
	let r, i;
...
k(jF, "getLines");
var MF = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy, NF = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu;
function PF(e) {
	...
	for (let s = 0; s < e.lines.length; s++) {
		...
		if (u = u.substring(0, zF(u)), RF(u, d) >= u.length) {
			if (t.length > 0) {
				let e = j.create(n, r);
				t.push({
					type: "break",
			...
			if (d < u.length) {
				let e = u.substring(d), i = Array.from(e.matchAll(NF));
				t.push(...FF(i, e, n, r + d));
			}
		}
		n++, r = 0;
...
k(VF, "parseJSDocElement");
function HF(e, t) {
	if (t) {
		let n = new eI("", e.range);
		"inlines" in t ? t.inlines.push(n) : t.content.inlines.push(n);
	}
}
k(HF, "appendEmptyLine");
function UF(e) {
	let t = e.tokens[e.index], n = t, r = t, i = [];
	for (; t && t.type !== "break" && t.type !== "tag";) i.push(WF(e)), r = t, t = e.tokens[e.index];
	return new $F(i, M.create(n.range.start, r.range.end));
}
k(UF, "parseJSDocText");
function WF(e) {
	return e.tokens[e.index].type === "inline-tag" ? GF(e, !0) : KF(e);
}
k(WF, "parseJSDocInline");
function GF(e, t) {
	let n = e.tokens[e.index++], r = n.content.substring(1), i = e.tokens[e.index];
	if ((i == null ? void 0 : i.type) === "text") if (t) {
		let i = KF(e);
		return new XF(r, new $F([i], i.range), t, M.create(n.range.start, i.range.end));
	} else {
		let i = UF(e);
		return new XF(r, i, t, M.create(n.range.start, i.range.end));
	}
	else {
		let e = n.range;
...
function KF(e) {
	...
	return new eI(t.content, t.range);
}
k(KF, "parseJSDocLine");
function qF(e) {
	if (!e) return qF({
...
}, k(At, "JSDocCommentImpl"), At), XF = (jt = class {
	constructor(e, t, n, r) {
...
function ZF(e, t, n) {
	if (e === "linkplain" || e === "linkcode" || e === "link") {
		...
		return (e === "linkcode" || e === "link" && n.link === "code") && (o = `\`${o}\``), (r = (i = n.renderLink) == null ? void 0 : i.call(n, t, o)) == null ? QF(t, o) : r;
	}
}
k(ZF, "renderInlineTag");
function QF(e, t) {
	try {
		return AP.parse(e, !0), `[${t}](${e})`;
	} catch {
		return e;
	}
}
k(QF, "renderLinkDefault");
var $F = (Mt = class {
	constructor(e, t) {
...
}, k(Mt, "JSDocTextImpl"), Mt), eI = (Nt = class {
	constructor(e, t) {
...
var nI = (Pt = class {
	...
	getDocumentation(e) {
		...
		if (t && AF(t)) return kF(t).toMarkdown({
...
}, k(Pt, "JSDocDocumentationProvider"), Pt), rI = (Ft = class {
	constructor(e) {
		this.grammarConfig = () => e.parser.GrammarConfig;
	}
	getComment(e) {
		var t;
		return eF(e) ? e.$comment : (t = vs(e.$cstNode, this.grammarConfig().multilineCommentRules)) == null ? void 0 : t.text;
	}
}, k(Ft, "DefaultCommentProvider"), Ft), iI = (It = class {
	constructor(e) {
...
}, k(It, "DefaultAsyncParser"), It), aI = (Lt = class {
	constructor(e) {
	...
	async parse(e, t) {
		let n = await this.acquireParserWorker(t), r = new xP(), i, a = t.onCancellationRequested(() => {
			i = setTimeout(() => {
	...
	async acquireParserWorker(e) {
		...
		return e.onCancellationRequested(() => {
			...
			e >= 0 && this.queue.splice(e, 1), t.reject(vP);
		}), this.queue.push(t), t.promise;
	}
}, k(Lt, "AbstractThreadedAsyncParser"), Lt), oI = (Rt = class {
	get ready() {
		return this._ready;
	}
	get onReady() {
	...
	constructor(e, t, n, r) {
		this.onReadyEmitter = new gF.Emitter(), this.deferred = new xP(), this._ready = !0, this._parsing = !1, this.sendMessage = e, this._terminate = r, t((e) => {
			let t = e;
	...
	terminate() {
		this.deferred.reject(vP), this._terminate();
	}
	lock() {
		this._ready = !1;
	}
	...
	parse(e) {
		...
		return this._parsing = !0, this.deferred = new xP(), this.sendMessage(e), this.deferred.promise;
	}
}, k(Rt, "ParserWorker"), Rt), sI = (zt = class {
	constructor() {
	...
	async performNextOperation() {
		...
		this.done = !1, await Promise.all(e.map(async ({ action: e, deferred: t, cancellationToken: n }) => {
			try {
				...
				yP(e) ? t.resolve(void 0) : t.reject(e);
			}
...
}, k(zt, "DefaultWorkspaceLock"), zt), cI = (Bt = class {
	constructor(e) {
		this.grammarElementIdMap = new HP(), this.tokenTypeIdMap = new HP(), this.grammar = e.Grammar, this.lexer = e.parser.Lexer, this.linker = e.references.Linker;
	}
	dehydrate(e) {
		return {
	...
	dehydrateAstNode(e, t) {
		...
		for (let [r, i] of Object.entries(e)) if (!r.startsWith("$")) if (Array.isArray(i)) {
			let e = [];
			n[r] = e;
			for (let n of i) F(n) ? e.push(this.dehydrateAstNode(n, t)) : Ni(n) ? e.push(this.dehydrateReference(n, t)) : e.push(n);
		} else F(i) ? n[r] = this.dehydrateAstNode(i, t) : Ni(i) ? n[r] = this.dehydrateReference(i, t) : i !== void 0 && (n[r] = i);
		return n;
	}
	...
	createHydrationContext(e) {
		...
		if (e.$cstNode) for (let t of cs(e.$cstNode)) {
			let e;
			"fullText" in t ? (e = new AN(t.fullText), r = e) : "content" in t ? e = new ON() : "tokenType" in t && (e = this.hydrateCstLeafNode(t)), e && (n.set(t, e), e.root = r);
		}
		return {
			astNodes: t,
			cstNodes: n
	...
	hydrateAstNode(e, t) {
		...
		for (let [r, i] of Object.entries(e)) if (!r.startsWith("$")) if (Array.isArray(i)) {
			let e = [];
			n[r] = e;
			for (let a of i) F(a) ? e.push(this.setParent(this.hydrateAstNode(a, t), n)) : Ni(a) ? e.push(this.hydrateReference(a, n, r, t)) : e.push(a);
		} else F(i) ? n[r] = this.setParent(this.hydrateAstNode(i, t), n) : Ni(i) ? n[r] = this.hydrateReference(i, n, r, t) : i !== void 0 && (n[r] = i);
		return n;
	}
	setParent(e, t) {
...
function lI(e) {
	return {
		documentation: {
			CommentProvider: /* @__PURE__ */ k((e) => new rI(e), "CommentProvider"),
			DocumentationProvider: /* @__PURE__ */ k((e) => new nI(e), "DocumentationProvider")
		},
		parser: {
			AsyncParser: /* @__PURE__ */ k((e) => new iI(e), "AsyncParser"),
			GrammarConfig: /* @__PURE__ */ k((e) => Hc(e), "GrammarConfig"),
			LangiumParser: /* @__PURE__ */ k((e) => cP(e), "LangiumParser"),
			CompletionParser: /* @__PURE__ */ k((e) => sP(e), "CompletionParser"),
			ValueConverter: /* @__PURE__ */ k(() => new dP(), "ValueConverter"),
			TokenBuilder: /* @__PURE__ */ k(() => new uP(), "TokenBuilder"),
			Lexer: /* @__PURE__ */ k((e) => new TF(e), "Lexer"),
			ParserErrorMessageProvider: /* @__PURE__ */ k(() => new RN(), "ParserErrorMessageProvider"),
			LexerErrorMessageProvider: /* @__PURE__ */ k(() => new CF(), "LexerErrorMessageProvider")
		},
		workspace: {
			AstNodeLocator: /* @__PURE__ */ k(() => new hF(), "AstNodeLocator"),
			AstNodeDescriptionProvider: /* @__PURE__ */ k((e) => new pF(e), "AstNodeDescriptionProvider"),
			ReferenceDescriptionProvider: /* @__PURE__ */ k((e) => new mF(e), "ReferenceDescriptionProvider")
		},
		references: {
			Linker: /* @__PURE__ */ k((e) => new LP(e), "Linker"),
			NameProvider: /* @__PURE__ */ k(() => new zP(), "NameProvider"),
			ScopeProvider: /* @__PURE__ */ k((e) => new $P(e), "ScopeProvider"),
			ScopeComputation: /* @__PURE__ */ k((e) => new UP(e), "ScopeComputation"),
			References: /* @__PURE__ */ k((e) => new BP(e), "References")
		},
		serializer: {
			Hydrator: /* @__PURE__ */ k((e) => new cI(e), "Hydrator"),
			JsonSerializer: /* @__PURE__ */ k((e) => new nF(e), "JsonSerializer")
		},
		validation: {
			DocumentValidator: /* @__PURE__ */ k((e) => new cF(e), "DocumentValidator"),
			ValidationRegistry: /* @__PURE__ */ k((e) => new oF(e), "ValidationRegistry")
		},
		shared: /* @__PURE__ */ k(() => e.shared, "shared")
	};
}
k(lI, "createDefaultCoreModule");
function uI(e) {
	return {
		ServiceRegistry: /* @__PURE__ */ k((e) => new rF(e), "ServiceRegistry"),
		workspace: {
			LangiumDocuments: /* @__PURE__ */ k((e) => new FP(e), "LangiumDocuments"),
			LangiumDocumentFactory: /* @__PURE__ */ k((e) => new PP(e), "LangiumDocumentFactory"),
			DocumentBuilder: /* @__PURE__ */ k((e) => new bF(e), "DocumentBuilder"),
			IndexManager: /* @__PURE__ */ k((e) => new xF(e), "IndexManager"),
			WorkspaceManager: /* @__PURE__ */ k((e) => new SF(e), "WorkspaceManager"),
			FileSystemProvider: /* @__PURE__ */ k((t) => e.fileSystemProvider(t), "FileSystemProvider"),
			WorkspaceLock: /* @__PURE__ */ k(() => new sI(), "WorkspaceLock"),
			ConfigurationProvider: /* @__PURE__ */ k((e) => new _F(e), "ConfigurationProvider")
		},
		profilers: {}
	};
}
k(uI, "createDefaultSharedCoreModule");
var dI;
(function(e) {
...
var xI = (Vt = class extends uP {
	...
	buildTokens(e, t) {
		...
		if (!EF(n)) throw Error("Invalid tokens built by default builder");
	...
	createIndentationTokenInstance(e, t, n, r) {
		...
		return AS(e, n, r, r + n.length, i, i, 1, n.length);
	}
	getLineNumber(e, t) {
	...
	buildTerminalToken(e) {
		...
		return t.name === n ? this.indentTokenType : t.name === r ? this.dedentTokenType : t.name === i ? DS({
			name: i,
...
}, k(Vt, "IndentationAwareTokenBuilder"), Vt), SI = (Ht = class extends TF {
	constructor(e) {
...
}, DI = { AstReflection: /* @__PURE__ */ k(() => new os(), "AstReflection") };
function OI() {
	let e = fI(uI(TI), DI), t = fI(lI({ shared: e }), EI);
...
function kI(e) {
	...
	return n.shared.workspace.LangiumDocumentFactory.fromModel(r, AP.parse(`memory:/${(t = r.name) == null ? "grammar" : t}.langium`)), r;
}
...
var AI = (Wt = class {
	constructor(e) {
		this.activeCategories = /* @__PURE__ */ new Set(), this.allCategories = /* @__PURE__ */ new Set([
			...
			"parsing",
			"linking"
		]), this.activeCategories = e == null ? new Set(this.allCategories) : e, this.records = new VP();
	}
	isActive(e) {
	...
	constructor(e, t) {
		this.stack = [], this.entries = new VP(), this.addRecord = e, this.identifier = t;
	}
	start() {
...
}, k(Jt, "CommonValueConverter"), Jt), QR = (Yt = class extends uP {
	constructor(e) {
...
//#endregion
export { lI as _, TI as a, _L as b, HR as c, WR as d, GR as f, k as g, JR as h, ZR as i, RR as l, KR as m, XR as n, BR as o, qR as p, zR as r, VR as s, QR as t, UR as u, uI as v, fI as y };
