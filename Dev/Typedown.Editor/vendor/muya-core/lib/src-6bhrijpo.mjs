...
import { B as n, G as r, K as i, V as a, X as o, Y as s, Z as c, et as l, rt as u, z as d } from "./step-DTZmJhUX.mjs";
...
var f = /* @__PURE__ */ t(((e, t) => {
...
})), p = /* @__PURE__ */ e(f(), 1), m = Object.defineProperty, h = (e, t) => m(e, "name", {
	value: t,
	configurable: !0
}), g = (e, t) => {
	...
	trace: /* @__PURE__ */ h((...e) => {}, "trace"),
	debug: /* @__PURE__ */ h((...e) => {}, "debug"),
	info: /* @__PURE__ */ h((...e) => {}, "info"),
	warn: /* @__PURE__ */ h((...e) => {}, "warn"),
	error: /* @__PURE__ */ h((...e) => {}, "error"),
	fatal: /* @__PURE__ */ h((...e) => {}, "fatal")
}, y = /* @__PURE__ */ h(function(e = "fatal") {
	let t = _.fatal;
	typeof e == "string" ? e.toLowerCase() in _ && (t = _[e]) : typeof e == "number" && (t = e), v.trace = () => {}, v.debug = () => {}, v.info = () => {}, v.warn = () => {}, v.error = () => {}, v.fatal = () => {}, t <= _.fatal && (v.fatal = console.error ? console.error.bind(console, b("FATAL"), "color: orange") : console.log.bind(console, "\x1B[35m", b("FATAL"))), t <= _.error && (v.error = console.error ? console.error.bind(console, b("ERROR"), "color: orange") : console.log.bind(console, "\x1B[31m", b("ERROR"))), t <= _.warn && (v.warn = console.warn ? console.warn.bind(console, b("WARN"), "color: orange") : console.log.bind(console, "\x1B[33m", b("WARN"))), t <= _.info && (v.info = console.info ? console.info.bind(console, b("INFO"), "color: lightblue") : console.log.bind(console, "\x1B[34m", b("INFO"))), t <= _.debug && (v.debug = console.debug ? console.debug.bind(console, b("DEBUG"), "color: lightgreen") : console.log.bind(console, "\x1B[32m", b("DEBUG"))), t <= _.trace && (v.trace = console.debug ? console.debug.bind(console, b("TRACE"), "color: lightgreen") : console.log.bind(console, "\x1B[32m", b("TRACE")));
}, "setLogLevel"), b = /* @__PURE__ */ h((e) => `%c${(0, p.default)().format("ss.SSS")} : ${e} : `, "format"), x = {
...
function le(e) {
	return this.select(e == null ? ce : se(typeof e == "function" ? e : k(e)));
}
//#endregion
...
function pe(e) {
	return this.selectAll(e == null ? de : fe(typeof e == "function" ? e : k(e)));
}
//#endregion
...
function ge() {
	return new z(this._enter || this._groups.map(he), this._parents);
}
function A(e, t) {
...
function ve(e, t, n, r, i, a) {
	for (var o = 0, s, c = t.length, l = a.length; o < l; ++o) (s = t[o]) ? (s.__data__ = a[o], r[o] = s) : n[o] = new A(e, a[o]);
	for (; o < c; ++o) (s = t[o]) && (i[o] = s);
}
function ye(e, t, n, r, i, a, o) {
	var s, c, l = /* @__PURE__ */ new Map(), u = t.length, d = a.length, f = Array(u), p;
	for (s = 0; s < u; ++s) (c = t[s]) && (f[s] = p = o.call(c, c.__data__, s, t) + "", l.has(p) ? i[s] = c : l.set(p, c));
	for (s = 0; s < d; ++s) p = o.call(e, a[s], s, a) + "", (c = l.get(p)) ? (r[s] = c, c.__data__ = a[s], l.delete(p)) : n[s] = new A(e, a[s]);
...
function Ce() {
	return new z(this._exit || this._groups.map(he), this._parents);
}
//#endregion
...
function Ge(e, t, n) {
	return arguments.length > 1 ? this.each((t == null ? He : typeof t == "function" ? We : Ue)(e, t, n == null ? "" : n)) : M(this.node(), e);
}
function M(e, t) {
	return e.style.getPropertyValue(t) || j(e).getComputedStyle(e, null).getPropertyValue(t);
}
//#endregion
...
function F(e) {
	this._node = e, this._names = N(e.getAttribute("class") || "");
}
F.prototype = {
	add: function(e) {
...
function I(e, t) {
	for (var n = P(e), r = -1, i = t.length; ++r < i;) n.add(t[r]);
}
function L(e, t) {
	for (var n = P(e), r = -1, i = t.length; ++r < i;) n.remove(t[r]);
}
function Xe(e) {
	return function() {
		I(this, e);
...
function $e(e, t) {
	var n = N(e + "");
	if (arguments.length < 2) {
		for (var r = P(this.node()), i = -1, a = n.length; ++i < a;) if (!r.contains(n[i])) return !1;
		return !0;
	}
...
function B() {
	return new z([[document.documentElement]], At);
}
function jt() {
	return this;
}
...
function Mt(e) {
	return typeof e == "string" ? new z([[document.querySelector(e)]], [document.documentElement]) : new z([[e]], At);
}
//#endregion
...
var Nt = u("start", "end", "cancel", "interrupt"), Pt = [];
...
function Ft(e, t, n) {
	...
	r[t] = n, n.timer = a(o, 0, n.time);
	function o(e) {
		n.state = 1, n.timer.restart(s, n.delay, n.time), n.delay <= e && s(e - n.delay);
	}
	function s(a) {
		var o, u, d, f;
		if (n.state !== 1) return l();
		for (o in r) if (f = r[o], f.name === n.name) {
			if (f.state === 3) return V(s);
			f.state === 4 ? (f.state = 6, f.timer.stop(), f.on.call("interrupt", e, e.__data__, f.index, f.group), delete r[o]) : +o < t && (f.state = 6, f.timer.stop(), f.on.call("cancel", e, e.__data__, f.index, f.group), delete r[o]);
		}
		if (V(function() {
			n.state === 3 && (n.state = 4, n.timer.restart(c, n.delay, n.time), c(a));
		}), n.state = 2, n.on.call("start", e, e.__data__, n.index, n.group), n.state === 2) {
			for (n.state = 3, i = Array(d = n.tween.length), o = 0, u = -1; o < d; ++o) (f = n.tween[o].value.call(e, e.__data__, n.index, n.group)) && (i[++u] = f);
			i.length = u + 1;
		}
	}
	function c(t) {
		for (var r = t < n.duration ? n.ease.call(null, t / n.duration) : (n.timer.restart(l), n.state = 5, 1), a = -1, o = i.length; ++a < o;) i[a].call(e, r);
		n.state === 5 && (n.on.call("end", e, e.__data__, n.index, n.group), l());
	}
	function l() {
...
function Bt(e, t) {
	...
	return this.each((t == null ? Rt : zt)(n, e, t));
}
function K(e, t, n) {
	var r = e._id;
...
function q(e, t) {
	var n;
	return (typeof t == "number" ? o : t instanceof l ? c : (n = l(t)) ? (t = n, c) : s)(e, t);
}
//#endregion
...
function qt(e, t) {
	var n = S(e), r = n === "transform" ? i : q;
	return this.attrTween(e, typeof t == "function" ? (n.local ? Kt : Gt)(n, r, K(this, "attr." + e, t)) : t == null ? (n.local ? Ht : Vt)(n) : (n.local ? Wt : Ut)(n, r, t));
}
//#endregion
...
function Qt(e, t) {
	...
	var r = S(e);
	return this.tween(n, (r.local ? Xt : Zt)(r, t));
}
//#endregion
...
function tn(e) {
	var t = this._id;
	return arguments.length ? this.each((typeof e == "function" ? $t : en)(t, e)) : G(this.node(), t).delay;
}
//#endregion
...
function an(e) {
	var t = this._id;
	return arguments.length ? this.each((typeof e == "function" ? nn : rn)(t, e)) : G(this.node(), t).duration;
}
//#endregion
...
function sn(e) {
	var t = this._id;
	return arguments.length ? this.each(on(t, e)) : G(this.node(), t).ease;
}
//#endregion
...
function ln(e) {
	...
	return this.each(cn(this._id, e));
}
//#endregion
...
function mn(e, t) {
	var n = this._id;
	return arguments.length < 2 ? G(this.node(), n).on.on(e) : this.each(pn(n, e, t));
}
//#endregion
...
function _n(e) {
	...
	typeof e != "function" && (e = D(e));
	for (var r = this._groups, i = r.length, a = Array(i), o = 0; o < i; ++o) for (var s = r[o], c = s.length, l = a[o] = Array(c), u, d, f = 0; f < c; ++f) (u = s[f]) && (d = e.call(u, u.__data__, f, s)) && ("__data__" in u && (d.__data__ = u.__data__), l[f] = d, H(l[f], t, n, f, l, G(u, n)));
	return new Y(a, this._parents, t, n);
}
//#endregion
...
function vn(e) {
	...
	for (var r = this._groups, i = r.length, a = [], o = [], s = 0; s < i; ++s) for (var c = r[s], l = c.length, u, d = 0; d < l; ++d) if (u = c[d]) {
		for (var f = e.call(u, u.__data__, d, c), p, m = G(u, n), h = 0, g = f.length; h < g; ++h) (p = f[h]) && H(p, t, n, h, f, m);
		a.push(f), o.push(u);
	}
	return new Y(a, o, t, n);
}
//#endregion
//#region ../../node_modules/.pnpm/d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/selection.js
var yn = B.prototype.constructor;
function bn() {
...
function xn(e, t) {
	var n, r, i;
	return function() {
		var a = M(this, e), o = (this.style.removeProperty(e), M(this, e));
...
function Cn(e, t, n) {
	var r, i, a;
	return function() {
		var o = M(this, e), s = n(this), c = s + "";
		return s == null && (c = s = (this.style.removeProperty(e), M(this, e))), o === c ? null : o === r && c === i ? a : (i = c, a = t(r = o, s));
	};
}
function wn(e, t) {
	var n, r, i, a = "style." + t, o = "end." + a, s;
	return function() {
		var c = W(this, e), l = c.on, u = c.value[a] == null ? s || (s = J(t)) : void 0;
		(l !== n || i !== u) && (r = (n = l).copy()).on(o, i = u), c.on = r;
	};
}
function Tn(e, t, n) {
	var i = (e += "") == "transform" ? r : q;
	return t == null ? this.styleTween(e, xn(e, i)).on("end.style." + e, J(e)) : typeof t == "function" ? this.styleTween(e, Cn(e, i, K(this, "style." + e, t))).each(wn(this._id, e)) : this.styleTween(e, Sn(e, i, t), n).on("end.style." + e, null);
}
//#endregion
...
function On(e, t, n) {
	...
	if (typeof t != "function") throw Error();
	return this.tween(r, Dn(e, t, n == null ? "" : n));
}
//#endregion
...
function jn(e) {
	return this.tween("text", typeof e == "function" ? An(K(this, "text", e)) : kn(e == null ? "" : e + ""));
}
//#endregion
...
function Pn(e) {
	...
	if (typeof e != "function") throw Error();
	return this.tween(t, Nn(e));
}
//#endregion
//#region ../../node_modules/.pnpm/d3-transition@3.0.1_d3-selection@3.0.0/node_modules/d3-transition/src/transition/transition.js
function Fn() {
	for (var e = this._name, t = this._id, n = X(), r = this._groups, i = r.length, a = 0; a < i; ++a) for (var o = r[a], s = o.length, c, l = 0; l < s; ++l) if (c = o[l]) {
		var u = G(c, t);
		H(c, e, n, l, o, {
	...
	return new Y(r, this._parents, e, n);
}
//#endregion
...
function Rn(e) {
	return B().transition(e);
}
function X() {
	return ++Ln;
}
var Z = B.prototype;
Y.prototype = Rn.prototype = {
	constructor: Y,
	select: _n,
	selectAll: vn,
...
function Hn(e) {
	var t, r;
	e instanceof Y ? (t = e._id, e = e._name) : (t = X(), (r = Bn).time = n(), e = e == null ? null : e + "");
	for (var i = this._groups, a = i.length, o = 0; o < a; ++o) for (var s = i[o], c = s.length, l, u = 0; u < c; ++u) (l = s[u]) && H(l, e, t, u, s, r || Vn(l, t));
	return new Y(i, this._parents, e, t);
}
B.prototype.interrupt = Lt, B.prototype.transition = Hn;
//#endregion
//#region ../../node_modules/.pnpm/d3-brush@3.0.0/node_modules/d3-brush/src/brush.js
var { abs: Un, max: Wn, min: Gn } = Math;
["w", "e"].map(Q), ["n", "s"].map(Q), [
	"n",
	"w",
	"e",
...
var Kn = new $(1, 0, 0);
qn.prototype = $.prototype;
function qn(e) {
	for (; !e.__zoom;) if (!(e = e.parentNode)) return Kn;
	return e.__zoom;
}
//#endregion
export { y as a, v as i, g as n, f as o, h as r, Mt as t };
