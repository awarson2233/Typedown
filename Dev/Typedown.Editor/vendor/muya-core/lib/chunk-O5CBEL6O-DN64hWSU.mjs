...
import { A as i, F as a, b as o, s, z as c } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { a as l } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
...
var u = Object.freeze({
	...
	if (n && r === "") {
		...
		return t && !ee(e, n) ? null : e;
	}
	return null;
}, ee = (e, t) => e ? !!((t && e.prefix === "" || e.prefix) && e.name) : !1;
//#endregion
...
function pe(e, t) {
	...
	o === null ? (d = s === null ? "1em" : s === "auto" ? l : s, u = ce(d, c / l)) : (u = o === "auto" ? c : o, d = s === null ? ce(u, l / c) : s === "auto" ? l : s);
	let p = {}, m = (e, t) => {
		fe(t) || (p[e] = t.toString());
	};
...
var be = (() => {
...
}, xe = /^(?:[ \t]*(?:\n|$))+/, Se = /^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/, Ce = /^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/, C = /^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/, we = /^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/, w = /(?:[*+-]|\d{1,9}[.)])/, Te = /^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/, Ee = x(Te).replace(/bull/g, w).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/\|table/g, "").getRegex(), De = x(Te).replace(/bull/g, w).replace(/blockCode/g, /(?: {4}| {0,3}\t)/).replace(/fences/g, / {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g, / {0,3}>/).replace(/heading/g, / {0,3}#{1,6}/).replace(/html/g, / {0,3}<[^\n>]+>\n/).replace(/table/g, / {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(), T = /^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/, Oe = /^[^\n]+/, E = /(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/, ke = x(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label", E).replace("title", /(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(), Ae = x(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g, w).getRegex(), D = "address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul", O = /<!--(?:-?>|[\s\S]*?(?:-->|$))/, je = x("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))", "i").replace("comment", O).replace("tag", D).replace("attribute", / +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(), Me = x(T).replace("hr", C).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("|table", "").replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", D).getRegex(), k = {
	...
	table: b,
	text: Oe
}, Ne = x("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr", C).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("blockquote", " {0,3}>").replace("code", "(?: {4}| {0,3}	)[^\\n]").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", D).getRegex(), Pe = {
	...k,
	lheading: De,
	table: Ne,
	paragraph: x(T).replace("hr", C).replace("heading", " {0,3}#{1,6}(?:\\s|$)").replace("|lheading", "").replace("table", Ne).replace("blockquote", " {0,3}>").replace("fences", " {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list", " {0,3}(?:[*+-]|1[.)]) ").replace("html", "</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag", D).getRegex()
}, Fe = {
	...k,
...
}, Ie = /^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/, Le = /^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/, Re = /^( {2,}|\\)\n(?!\s*$)/, ze = /^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/, A = /[\p{P}\p{S}]/u, j = /[\s\p{P}\p{S}]/u, Be = /[^\s\p{P}\p{S}]/u, Ve = x(/^((?![*_])punctSpace)/, "u").replace(/punctSpace/g, j).getRegex(), He = /(?!~)[\p{P}\p{S}]/u, Ue = /(?!~)[\s\p{P}\p{S}]/u, We = /(?:[^\s\p{P}\p{S}]|~)/u, Ge = x(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", be ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(), Ke = /^(?:\*+(?:((?!\*)punct)|[^\s*]))|^_+(?:((?!_)punct)|([^\s_]))/, qe = x(Ke, "u").replace(/punct/g, A).getRegex(), Je = x(Ke, "u").replace(/punct/g, He).getRegex(), Ye = "^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)", Xe = x(Ye, "gu").replace(/notPunctSpace/g, Be).replace(/punctSpace/g, j).replace(/punct/g, A).getRegex(), Ze = x(Ye, "gu").replace(/notPunctSpace/g, We).replace(/punctSpace/g, Ue).replace(/punct/g, He).getRegex(), Qe = x("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)", "gu").replace(/notPunctSpace/g, Be).replace(/punctSpace/g, j).replace(/punct/g, A).getRegex(), $e = x(/\\(punct)/, "gu").replace(/punct/g, A).getRegex(), et = x(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme", /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email", /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(), tt = x(O).replace("(?:-->|$)", "-->").getRegex(), nt = x("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment", tt).replace("attribute", /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(), M = /(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+[^`]*?`+(?!`)|[^\[\]\\`])*?/, rt = x(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]*(?:\n[ \t]*)?)(title))?\s*\)/).replace("label", M).replace("href", /<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title", /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(), it = x(/^!?\[(label)\]\[(ref)\]/).replace("label", M).replace("ref", E).getRegex(), at = x(/^!?\[(ref)\](?:\[\])?/).replace("ref", E).getRegex(), ot = x("reflink|nolink(?!\\()", "g").replace("reflink", it).replace("nolink", at).getRegex(), st = /[hH][tT][tT][pP][sS]?|[fF][tT][pP]/, N = {
	_backpedal: b,
	anyPunctuation: $e,
	autolink: et,
	blockSkip: Ge,
	...
	...N,
	link: x(/^!?\[(label)\]\((.*?)\)/).replace("label", M).getRegex(),
	reflink: x(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label", M).getRegex()
}, P = {
	...N,
	emStrongRDelimAst: Ze,
	emStrongLDelim: Je,
	url: x(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol", st).replace("email", /[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),
	_backpedal: /(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,
	del: /^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,
	text: x(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol", st).getRegex()
}, lt = {
	...P,
	br: x(Re).replace("{2,}", "*").getRegex(),
	text: x(P.text).replace("\\b_", "\\b_| {2,}\\n").replace(/\{2,\}/g, "*").getRegex()
}, F = {
	normal: k,
	gfm: Pe,
	pedantic: Fe
...
function L(e, t) {
	if (t) {
		if (S.escapeTest.test(e)) return e.replace(S.escapeReplace, dt);
	} else if (S.escapeTestNoEncode.test(e)) return e.replace(S.escapeReplaceNoEncode, dt);
	return e;
}
function ft(e) {
	try {
...
var z = class {
	constructor(t) {
		e(this, "options", void 0), e(this, "rules", void 0), e(this, "lexer", void 0), this.options = t || y;
	}
	space(e) {
...
${c}` : c;
	...
	table(e) {
		...
		let r = pt(n[1]), i = n[2].replace(this.rules.other.tableAlignChars, "").split("|"), a = (t = n[3]) != null && t.trim() ? n[3].replace(this.rules.other.tableRowBlankLine, "").split("\n") : [], o = {
			type: "table",
			raw: n[0],
			header: [],
			align: [],
		...
		if (r.length === i.length) {
			...
			for (let e of a) o.rows.push(pt(e, o.header.length).map((e, t) => ({
				text: e,
				tokens: this.lexer.inline(e),
				header: !1,
				align: o.align[t]
	...
	link(e) {
		...
		if (t) {
			...
			return n = n.trim(), this.rules.other.startAngleBracket.test(n) && (n = this.options.pedantic && !this.rules.other.endAngleBracket.test(e) ? n.slice(1) : n.slice(1, -1)), ht(t, {
	...
	reflink(e, t) {
		...
		if ((n = this.rules.inline.reflink.exec(e)) || (n = this.rules.inline.nolink.exec(e))) {
			...
			return ht(n, e, n[0], this.lexer, this.rules);
		}
	}
	emStrong(e, t, n = "") {
	...
	constructor(t) {
		e(this, "tokens", void 0), e(this, "options", void 0), e(this, "state", void 0), e(this, "tokenizer", void 0), e(this, "inlineQueue", void 0), this.tokens = [], this.tokens.links = Object.create(null), this.options = t || y, this.options.tokenizer = this.options.tokenizer || new z(), this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = {
			inLink: !1,
			inRawBlock: !1,
			top: !0
		};
	...
	constructor(t) {
		e(this, "options", void 0), e(this, "parser", void 0), this.options = t || y;
	}
	space(e) {
		return "";
	}
	code({ text: e, lang: t, escaped: n }) {
		var r;
		let i = (r = (t || "").match(S.notSpaceStart)) == null ? void 0 : r[0], a = e.replace(S.endingNewline, "") + "\n";
...
`;
	...
	listitem(e) {
		...
		if (e.task) {
			...
			e.loose ? ((n = e.tokens[0]) == null ? void 0 : n.type) === "paragraph" ? (e.tokens[0].text = r + " " + e.tokens[0].text, e.tokens[0].tokens && e.tokens[0].tokens.length > 0 && e.tokens[0].tokens[0].type === "text" && (e.tokens[0].tokens[0].text = r + " " + L(e.tokens[0].tokens[0].text), e.tokens[0].tokens[0].escaped = !0)) : e.tokens.unshift({
				type: "text",
				raw: r + " ",
				text: r + " ",
				escaped: !0
...
`;
	...
	constructor(t) {
		e(this, "options", void 0), e(this, "renderer", void 0), e(this, "textRenderer", void 0), this.options = t || y, this.options.renderer = this.options.renderer || new V(), this.renderer = this.options.renderer, this.renderer.options = this.options, this.renderer.parser = this, this.textRenderer = new H();
	}
	static parse(e, n) {
	...
	constructor(t) {
		e(this, "options", void 0), e(this, "block", void 0), this.options = t || y;
	}
	preprocess(e) {
		return e;
	}
	...
	provideParser() {
		return this.block ? U.parse : U.parseInline;
	}
}, e(_, "passThroughHooks", new Set([
	"preprocess",
	"postprocess",
	"processAllTokens",
	"emStrongMask"
])), e(_, "passThroughHooksRespectAsync", new Set([
	"preprocess",
	"postprocess",
	"processAllTokens"
])), _), G = new class {
	constructor(...t) {
		e(this, "defaults", v()), e(this, "options", this.setOptions), e(this, "parse", this.parseMarkdown(!0)), e(this, "parseInline", this.parseMarkdown(!1)), e(this, "Parser", U), e(this, "Renderer", V), e(this, "TextRenderer", H), e(this, "Lexer", B), e(this, "Tokenizer", z), e(this, "Hooks", W), this.use(...t);
	}
	walkTokens(e, t) {
		let n = [];
	...
	use(...e) {
		...
		return e.forEach((e) => {
			...
			if (e.hooks) {
				let t = this.defaults.hooks || new W();
				for (let n in e.hooks) {
					if (!(n in t)) throw Error(`hook '${n}' does not exist`);
					if (["options", "block"].includes(n)) continue;
					let r = n, i = e.hooks[r], a = t[r];
					W.passThroughHooks.has(n) ? t[r] = (e) => {
						if (this.defaults.async && W.passThroughHooksRespectAsync.has(n)) return (async () => {
	...
	lexer(e, t) {
		return B.lex(e, t == null ? this.defaults : t);
	}
	parser(e, t) {
		return U.parse(e, t == null ? this.defaults : t);
	}
	parseMarkdown(e) {
		return (t, n) => {
			let r = { ...n }, i = {
			...
			if (i.hooks && (i.hooks.options = i, i.hooks.block = e), i.async) return (async () => {
				let n = i.hooks ? await i.hooks.preprocess(t) : t, r = await (i.hooks ? await i.hooks.provideLexer() : e ? B.lex : B.lexInline)(n, i), a = i.hooks ? await i.hooks.processAllTokens(r) : r;
				i.walkTokens && await Promise.all(this.walkTokens(a, i.walkTokens));
				let o = await (i.hooks ? await i.hooks.provideParser() : e ? U.parse : U.parseInline)(a, i);
				return i.hooks ? await i.hooks.postprocess(o) : o;
			})().catch(a);
			try {
				i.hooks && (t = i.hooks.preprocess(t));
				let n = (i.hooks ? i.hooks.provideLexer() : e ? B.lex : B.lexInline)(t, i);
				i.hooks && (n = i.hooks.processAllTokens(n)), i.walkTokens && this.walkTokens(n, i.walkTokens);
				let r = (i.hooks ? i.hooks.provideParser() : e ? U.parse : U.parseInline)(n, i);
...
K.options = K.setOptions = function(e) {
	return G.setOptions(e), K.defaults = G.defaults, ye(K.defaults), K;
}, K.getDefaults = v, K.defaults = y, K.use = function(...e) {
	return G.use(...e), K.defaults = G.defaults, ye(K.defaults), K;
}, K.walkTokens = function(e, t) {
	return G.walkTokens(e, t);
}, K.parseInline = G.parseInline, K.Parser = U, K.parser = U.parse, K.Renderer = V, K.TextRenderer = H, K.Lexer = B, K.lexer = B.lex, K.Tokenizer = z, K.Hooks = W, K.parse = K, K.options, K.setOptions, K.use, K.walkTokens, K.parseInline, U.parse, B.lex;
//#endregion
...
function _t(e) {
	...
	var r = n.reduce(function(e, t) {
		...
		return n ? e.concat(n.map(function(e) {
			var t, n;
			return (n = (t = e.match(/[\t ]/g)) == null ? void 0 : t.length) == null ? 0 : n;
		})) : e;
	}, []);
	if (r.length) {
		var i = RegExp(`
...
var vt = {
	...
	height: 80,
	width: 80
}, q = /* @__PURE__ */ new Map(), yt = /* @__PURE__ */ new Map(), bt = /* @__PURE__ */ n((e) => {
	for (let n of e) {
		if (!n.name) throw Error("Invalid icon loader. Must have a \"name\" property with non-empty string value.");
		if (t.debug("Registering icon pack:", n.name), "loader" in n) yt.set(n.name, n.loader);
		else if ("icons" in n) q.set(n.name, n.icons);
		else throw t.error("Invalid icon loader:", n), Error("Invalid icon loader. Must have either \"icons\" or \"loader\" property.");
	}
}, "registerIconPacks"), xt = /* @__PURE__ */ n(async (e, n) => {
	...
	return o;
}, "getRegisteredIconData"), St = /* @__PURE__ */ n(async (e) => {
	try {
		return await xt(e), !0;
	} catch {
		return !1;
	}
}, "isIconAvailable"), Ct = /* @__PURE__ */ n(async (e, n, r) => {
	let i;
	try {
		i = await xt(e, n == null ? void 0 : n.fallbackPrefix);
	} catch (e) {
		t.error(e), i = vt;
	}
	let a = pe(i, n);
	return c(ve(_e(a.body), {
		...a.attributes,
		...r
	}), o());
}, "getIconSVG");
function wt(e, { markdownAutoWrap: t }) {
	return _t(e.replace(/<br\/>/g, "\n").replace(/\n{2,}/g, "\n"));
}
n(wt, "preprocessMarkdown");
function Tt(e) {
	return e.split(/\\n|\n|<br\s*\/?>/gi).map((e) => {
		var t, n;
		return (t = (n = e.trim().match(/<[^>]+>|[^\s<>]+/g)) == null ? void 0 : n.map((e) => ({
			content: e,
			type: "normal"
		}))) == null ? [] : t;
	});
}
n(Tt, "nonMarkdownToLines");
function Et(e, t = {}) {
	let r = wt(e, t), i = K.lexer(r), a = [[]], o = 0;
	...
	return n(s, "processNode"), i.forEach((e) => {
		if (e.type === "paragraph") {
			var t;
			(t = e.tokens) == null || t.forEach((e) => {
				s(e);
			});
		} else e.type === "html" ? a[o].push({
			content: e.text,
			type: "normal"
		}) : a[o].push({
			content: e.raw,
...
n(Et, "markdownToLines");
function Dt(e) {
	return e ? `<p>${e.replace(/\\n|\n/g, "<br />")}</p>` : "";
}
n(Dt, "nonMarkdownToHTML");
function Ot(e, { markdownAutoWrap: r } = {}) {
	let i = K.lexer(e);
	function a(e) {
		if (e.type === "text") return r === !1 ? e.text.replace(/\n */g, "<br/>").replace(/ /g, "&nbsp;") : e.text.replace(/\n */g, "<br/>");
		if (e.type === "strong") {
			var n;
			return `<strong>${(n = e.tokens) == null ? void 0 : n.map(a).join("")}</strong>`;
		} else if (e.type === "em") {
			var i;
			return `<em>${(i = e.tokens) == null ? void 0 : i.map(a).join("")}</em>`;
		} else if (e.type === "paragraph") {
			var o;
			return `<p>${(o = e.tokens) == null ? void 0 : o.map(a).join("")}</p>`;
		} else if (e.type === "space") return "";
		else if (e.type === "html") return `${e.text}`;
		else if (e.type === "escape") return e.text;
		return t.warn(`Unsupported markdown: ${e.type}`), e.raw;
	}
...
n(kt, "splitTextToChars");
function At(e, t) {
	return J(e, [], kt(t.content), t.type);
}
n(At, "splitWordToFitWidth");
function J(e, t, n, r) {
...
function Y(e, t, n = [], r = []) {
	...
	if (a !== "" && s.push({
		content: a,
		type: "normal"
	}), s.push(o), t(s)) return Y(e, t, n, s);
	if (r.length > 0) n.push(r), e.unshift(o);
	else if (o.content) {
		let [r, i] = At(t, o);
...
n(X, "applyStyle");
var Mt = 16384;
async function Nt(e, t, n, r, l = !1, u = o()) {
	let d = e.append("foreignObject");
	d.attr("width", `${Math.min(10 * n, Mt)}px`), d.attr("height", `${Math.min(10 * n, Mt)}px`);
	...
	h.html(p), X(h, t.labelStyle), h.attr("class", `${m} ${r}`), X(f, t.labelStyle), f.style("display", "table-cell"), f.style("white-space", "nowrap"), f.style("line-height", "1.5"), n !== Infinity && (f.style("max-width", n + "px"), f.style("text-align", "center")), f.attr("xmlns", "http://www.w3.org/1999/xhtml"), l && f.attr("class", "labelBkg");
...
n(Pt, "computeWidthOfText");
function Ft(e, t, n) {
	var r;
	let i = e.append("text"), a = Z(i, 1, t);
	$(a, [{
		content: n,
		type: "normal"
	}]);
	let o = (r = a.node()) == null ? void 0 : r.getBoundingClientRect();
	return o && i.remove(), o;
}
n(Ft, "computeDimensionOfText");
function It(e, t, r, i = !1, a = !1) {
	...
	let u = 0;
	for (let t of r) {
		let r = /* @__PURE__ */ n((t) => Pt(s, o, t) <= e, "checkWidth"), i = r(t) ? [t] : jt(t, r);
...
async function Lt(e, t = {}) {
	...
	e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, (e, r, i) => (n.push((async () => {
		let n = `${r}:${i}`;
		return await St(n) ? await Ct(n, void 0, { class: "label-icon" }) : `<i class='${c(e, t).replace(":", " ")}'></i>`;
	})()), e));
	let r = await Promise.all(n);
	return e.replace(/(fa[bklrs]?):fa-([\w-]+)/g, () => {
		var e;
		return (e = r.shift()) == null ? "" : e;
	});
}
n(Lt, "replaceIconSubstring");
var Rt = /* @__PURE__ */ n(async (e, n = "", { style: a = "", isTitle: o = !1, classes: s = "", useHtmlLabels: c = !0, markdown: u = !0, isNode: d = !0, width: f = 200, addSvgBackground: p = !1 } = {}, m) => {
	if (t.debug("XYZ createText", n, a, o, s, c, d, "addSvgBackground: ", p), c) {
		let t = await Lt(l(u ? Ot(n, m) : Dt(n)), m), r = n.replace(/\\\\/g, "\\");
		return await Nt(e, {
			isNode: d,
			label: i(n) ? r : t,
		...
		let t = l(n.replace(/<br\s*\/?>/g, "<br/>")), i = It(f, e, u ? Et(t.replace("<br>", "<br/>"), m) : Tt(t), n ? p : !1, !d);
		if (d) {
			...
			r(i).select("rect").attr("style", e.replace(/background:/g, "fill:"));
			let t = a.replace(/stroke:[^;]+;?/g, "").replace(/stroke-width:[^;]+;?/g, "").replace(/fill:[^;]+;?/g, "").replace(/color:/g, "fill:");
			r(i).select("text").attr("style", t);
		}
		return o ? r(i).selectAll("tspan.text-outer-tspan").classed("title-row", !0) : r(i).selectAll("tspan.text-outer-tspan").classed("row", !0), i;
	}
}, "createText");
//#endregion
export { vt as a, bt as i, Rt as n, _t as o, Ct as r, Ft as t };
