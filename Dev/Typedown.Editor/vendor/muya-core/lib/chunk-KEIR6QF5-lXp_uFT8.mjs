import { t as e } from "./defineProperty-AldSMFEH.mjs";
...
var fn, pn, mn, hn, M, N, gn, _n, vn, yn, bn, xn, Sn, Cn, wn, Tn, En, Dn, On, kn, An, jn, Mn, Nn, Pn, Fn, In, Ln, Rn, zn, Bn, Vn, Hn, Un, Wn, Gn, Kn, qn, Jn, Yn, Xn, Zn, Qn, $n, er, tr, nr, rr, ir, ar, or, sr, cr, lr, ur, dr, fr, pr, mr, hr, gr, _r, vr, yr, br, xr, Sr, Cr, wr, Tr, Er, Dr, Or, kr, Ar, jr, Mr, Nr, Pr, Fr, Ir, Lr, Rr, zr, P, Br = an({ "../../node_modules/.pnpm/vscode-languageserver-types@3.17.5/node_modules/vscode-languageserver-types/lib/esm/main.js"() {
	...
	(function(e) {
		...
		function n(e) {
			var t;
			let n = e;
			return P.defined(n) && N.is(n.range) && P.string(n.message) && (P.number(n.severity) || P.undefined(n.severity)) && (P.integer(n.code) || P.string(n.code) || P.undefined(n.code)) && (P.undefined(n.codeDescription) || P.string((t = n.codeDescription) == null ? void 0 : t.href)) && (P.string(n.source) || P.undefined(n.source)) && (P.undefined(n.relatedInformation) || P.typedArray(n.relatedInformation, Cn.is));
		}
		A(n, "is"), e.is = n;
	})(Dn || (Dn = {})), (function(e) {
		function t(e, t, ...n) {
		...
		function t(e, t, ...n) {
			let r = { label: e };
			return P.defined(t) && (r.documentation = t), P.defined(n) ? r.parameters = n : r.parameters = [], r;
		}
		A(t, "create"), e.create = t;
	})(ir || (ir = {})), (function(e) {
...
${n}`);
	...
	function D(t, n, m, b) {
			...
			try {
				if (a.Message.isNotification(e) && e.method === l.type.method) {
					...
					if (a.Message.isRequest(i)) {
						let a = b == null ? void 0 : b.connectionStrategy, o = a && a.cancelUndispatched ? a.cancelUndispatched(i, Ce) : void 0;
		...
		function Pe(e) {
			...
			if (l || D) {
				var d;
				let n = (d = e.id) == null ? String(Date.now()) : d, s = x.is(ve.receiver) ? ve.receiver.createCancellationTokenSource(n) : ve.receiver.createCancellationTokenSource(e);
		...
		A(Pe, "handleRequest");
		function Fe(e) {
			if (!Ee()) if (e.id === null) e.error ? S.error(`Received response message without id: Error is: 
${JSON.stringify(e.error, void 0, 4)}`) : S.error("Received response message without id. No further error information provided.");
		...
		function Ie(e) {
			...
			if (n || re) try {
				if (Ue(e), n) if (e.params === void 0) t !== void 0 && t.numberOfParams !== 0 && t.parameterStructures !== a.ParameterStructures.byName && S.error(`Notification ${e.method} defines ${t.numberOfParams} params but received none.`), n();
				else if (Array.isArray(e.params)) {
					let r = e.params;
...
`), k.log(`Received request '${e.method} - (${e.id})'.`, t);
		...
		function Ue(e) {
			if (!(O === p.Off || !k || e.method === _.type.method)) if (de === h.Text) {
				let t;
				(O === p.Verbose || O === p.Compact) && (t = e.params ? `Params: ${Re(e.params)}
		...
		let et = {
			...
			sendRequest: /* @__PURE__ */ A((e, ...t) => {
				...
				return ze(d), typeof ve.sender.enableCancellation == "function" && ve.sender.enableCancellation(d), new Promise(async (e, t) => {
					let i = /* @__PURE__ */ A((t) => {
						e(t), ve.sender.cleanup(l), u == null || u.dispose();
					}, "resolveWithCleanup"), o = /* @__PURE__ */ A((e) => {
						t(e), ve.sender.cleanup(l), u == null || u.dispose();
					}, "rejectWithCleanup"), s = {
						method: r,
						timerStart: Date.now(),
						resolve: i,
...
function ca(e, t, n) {
	...
	for (let [i, a] of Object.entries(e)) if (!i.startsWith("$")) if (Mi(a)) r[i] = ca(a, t, n);
...
function _x(e, t) {
	...
	n("Transform Patterns", () => {
		i = !1, a = U(r, (e) => {
			...
			} else if (ql(t)) return i = !0, { exec: t };
...
function Hx(e, t) {
	...
	else if (zx(e)) return { issue: J.CUSTOM_LINE_BREAK };
	else throw Error("non exhaustive match");
}
...
var tw = (he = class {
	constructor(e) {
		var t;
		this.maxLookahead = (t = e == null ? void 0 : e.maxLookahead) == null ? Lw.maxLookahead : t;
	}
	validate(e) {
...
function sO(e, t) {
	var n = typeof e;
	return t = t == null ? aO : t, !!t && (n == "number" || n != "symbol" && oO.test(e)) && e > -1 && e % 1 == 0 && e < t;
}
A(sO, "isIndex");
...
}), pA = Infinity, mA = yT ? yT.prototype : void 0, hA = mA ? mA.toString : void 0;
function gA(e) {
	if (typeof e == "string") return e;
...
function Nj(e, t, n) {
	...
	return r.length === 1 ? r[0] : r.length === 0 ? void 0 : Bj(e, r);
}
A(Nj, "block");
...
function xM() {}
A(xM, "noop");
var SM = xM, CM = hk && 1 / fD(new hk([, -0]))[1] == Infinity ? function(e) {
	return new hk(e);
} : SM, wM = 200;
function TM(e, t, n) {
...
var YM = (Ne = class {
	...
	buildLookaheadForAlternation(e) {
		...
		if (QM(l, !1) && !i) {
			...
			return r ? function(t) {
				var n;
				let r = this.LA(1), i = e[r.tokenTypeIdx];
				if (t !== void 0 && i !== void 0) {
					let e = (n = t[i]) == null ? void 0 : n.GATE;
...
var jN = "​", MN = /* @__PURE__ */ A((e) => e.endsWith(jN) ? e : e + jN, "withRuleSuffix"), NN = (Ve = class {
	constructor(e) {
		...
		(t = e.shared.profilers.LangiumProfiler) != null && t.isActive("parsing") ? this.wrapper = new BN(n, {
			...e.parser.ParserConfig,
			skipValidations: r,
			errorMessageProvider: e.parser.ParserErrorMessageProvider
		}, e.shared.profilers.LangiumProfiler.createTask("parsing", e.LanguageMetaData.languageId)) : this.wrapper = new zN(n, {
			...e.parser.ParserConfig,
			skipValidations: r,
			errorMessageProvider: e.parser.ParserErrorMessageProvider
		});
	...
	computeRuleType(e) {
		return Qa(e) ? Oc(e) : e.fragment ? void 0 : Cc(e) ? kN : Oc(e);
	}
	parse(e, t = {}) {
...
function UN(e, t) {
	...
	return (t) => {
		u != null || (u = nP(e, n)), e.parser.subrule(0, u, !1, a, t), e.parser.many(0, { DEF: /* @__PURE__ */ A(() => {
...
function KN(e, t) {
	...
	if (ma(n)) {
		...
		return (s) => {
			o != null || (o = nP(e, n)), e.parser.subrule(r, o, i, t, a(s));
		};
	} else if (Vo(n)) {
...
function $N(e, t, n = t.terminal) {
	if (!n) {
		...
		return (n) => {
			a != null || (a = nP(e, r)), e.parser.subrule(i, a, !1, t, n);
		};
...
function tP(e, t, n, r) {
	...
	if (r === "*") {
		...
		} else return (r) => e.parser.atLeastOne(t, { DEF: /* @__PURE__ */ A(() => n(r), "DEF") });
	} else if (r === "?") {
		let t = e.optional++;
...
(function(e) {
	...
	A(r, "equals"), e.equals = r;
	function i(e, t) {
		let r = typeof e == "string" ? OP.parse(e).path : e.path, i = typeof t == "string" ? OP.parse(t).path : t.path, a = r.split("/").filter((e) => e.length > 0), o = i.split("/").filter((e) => e.length > 0);
		if (n) {
			let e = /^[A-Z]:$/;
	...
	A(i, "relative"), e.relative = i;
	function a(e) {
		return OP.parse(e.toString()).toString();
	}
	A(a, "normalize"), e.normalize = a;
	function o(e, t) {
...
var MP = ($e = class {
	...
	fromTextDocument(e, t, n) {
		var r;
		return t = (r = t) == null ? OP.parse(e.uri) : r, Q.CancellationToken.is(n) ? this.createAsync(t, e, n) : this.create(t, e, n);
	}
	fromString(e, t, n) {
	...
	createTextDocumentGetter(e, t) {
		...
		return () => {
			var i;
			return (i = r) == null ? r = xP.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, t == null ? "" : t) : i;
		};
	}
...
var LP = (nt = class {
	...
	constructor(e, t, n) {
		var r, i;
		this.elements = e, this.outerScope = t, this.caseInsensitive = (r = n == null ? void 0 : n.caseInsensitive) != null && r, this.concatOuterScope = (i = n == null ? void 0 : n.concatOuterScope) == null || i;
	}
	getAllElements() {
	...
	constructor(e, t, n) {
		var r, i;
		this.elements = /* @__PURE__ */ new Map(), this.caseInsensitive = (r = n == null ? void 0 : n.caseInsensitive) != null && r, this.concatOuterScope = (i = n == null ? void 0 : n.concatOuterScope) == null || i;
		for (let t of e) {
	...
	constructor(e, t, n) {
		var r, i;
		this.elements = new zP(), this.caseInsensitive = (r = n == null ? void 0 : n.caseInsensitive) != null && r, this.concatOuterScope = (i = n == null ? void 0 : n.concatOuterScope) == null || i;
		for (let t of e) {
			let e = this.caseInsensitive ? t.name.toLowerCase() : t.name;
...
var eF = (gt = class {
	...
	serialize(e, t) {
		let n = t == null ? {} : t, r = t == null ? void 0 : t.replacer, i = /* @__PURE__ */ A((e, t) => this.replacer(e, t, n), "defaultReplacer"), a = r ? (e, t) => r(e, t, i) : i;
		try {
	...
	getServices(e) {
		...
		let i = AP.extname(e), a = AP.basename(e), o = (n = this.fileNameMap.get(a)) == null ? this.fileExtensionMap.get(i) : n;
...
var iF = (vt = class {
	...
	async validateDocument(e, t = {}, n = Q.CancellationToken.None) {
		...
		if (await vP(n), (!t.categories || t.categories.includes("built-in")) && (this.processLexingErrors(r, i, t), t.stopAfterLexingErrors && i.some((e) => {
			var t;
			return ((t = e.data) == null ? void 0 : t.code) === uF.LexingError;
		}) || (this.processParsingErrors(r, i, t), t.stopAfterParsingErrors && i.some((e) => {
			var t;
			return ((t = e.data) == null ? void 0 : t.code) === uF.ParsingError;
		})) || (this.processLinkingErrors(e, i, t), t.stopAfterLinkingErrors && i.some((e) => {
			var t;
			return ((t = e.data) == null ? void 0 : t.code) === uF.LinkingError;
		})))) return i;
		try {
	...
	async validateAstBefore(e, t, n, r = Q.CancellationToken.None) {
		...
		for (let o of i) {
			var a;
			await vP(r), await o(e, n, (a = t.categories) == null ? [] : a, r);
		}
	}
...
var hF = (Ct = class {
	...
	initialize(e) {
		var t, n;
		this.workspaceConfig = (t = (n = e.capabilities.workspace) == null ? void 0 : n.configuration) != null && t;
	}
	async initialized(e) {
...
var vF = (wt = class {
	...
	shouldLink(e) {
		var t;
		return (t = this.getBuildOptions(e).eagerLinking) == null || t;
	}
	shouldValidate(e) {
...
function MF(e) {
	...
	for (let s = 0; s < e.lines.length; s++) {
		...
		if (u = u.substring(0, LF(u)), IF(u, d) >= u.length) {
			if (t.length > 0) {
				let e = M.create(n, r);
				t.push({
					type: "break",
			...
			let e = AF.exec(u);
			if (e) {
				let i = e[0], a = e[1], o = M.create(n, r + d), s = M.create(n, r + d + i.length);
				t.push({
					type: "tag",
					content: a,
					range: N.create(o, s)
			...
			if (d < u.length) {
				let e = u.substring(d), i = Array.from(e.matchAll(jF));
				t.push(...NF(i, e, n, r + d));
			}
		}
		n++, r = 0;
...
function RF(e) {
	var t, n, r, i;
	let a = M.create(e.position.line, e.position.character);
	if (e.tokens.length === 0) return new qF([], N.create(a, a));
	let o = [];
	for (; e.index < e.tokens.length;) {
		let t = zF(e, o[o.length - 1]);
		t && o.push(t);
	}
	let s = (t = (n = o[0]) == null ? void 0 : n.range.start) == null ? a : t, c = (r = (i = o[o.length - 1]) == null ? void 0 : i.range.end) == null ? a : r;
	return new qF(o, N.create(s, c));
}
...
function YF(e, t, n) {
	if (e === "linkplain" || e === "linkcode" || e === "link") {
		...
		return (e === "linkcode" || e === "link" && n.link === "code") && (o = `\`${o}\``), (r = (i = n.renderLink) == null ? void 0 : i.call(n, t, o)) == null ? XF(t, o) : r;
	}
}
...
var eI = (Nt = class {
	...
	getComment(e) {
		var t;
		return QP(e) ? e.$comment : (t = vs(e.$cstNode, this.grammarConfig().multilineCommentRules)) == null ? void 0 : t.text;
	}
...
function gI(e, t) {
	if (t) {
		for (let [n, r] of Object.entries(t)) if (r != null) if (typeof r == "object") {
			let t = e[n];
			typeof t == "object" && t ? e[n] = gI(t, r) : e[n] = gI({}, r);
		} else e[n] = r;
	}
	return e;
}
...
function DI(e) {
	var t;
	let n = EI(), r = n.serializer.JsonSerializer.deserialize(e);
	return n.shared.workspace.LangiumDocumentFactory.fromModel(r, OP.parse(`memory:/${(t = r.name) == null ? "grammar" : t}.langium`)), r;
}
...
var OI = (Ut = class {
	constructor(e) {
		this.activeCategories = /* @__PURE__ */ new Set(), this.allCategories = /* @__PURE__ */ new Set([
			...
			"parsing",
			"linking"
		]), this.activeCategories = e == null ? new Set(this.allCategories) : e, this.records = new zP();
	}
	isActive(e) {
