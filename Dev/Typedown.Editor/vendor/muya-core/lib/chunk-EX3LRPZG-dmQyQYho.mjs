...
import { H as i, K as a, U as o, a as s, s as c, v as l, w as u, x as d, y as f } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { g as p, s as m } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as h } from "./chunk-32BRIVSS-Dezidi9z.mjs";
import { t as g } from "./chunk-XXDRQBXY-6qvi-T3x.mjs";
import { t as _ } from "./chunk-VR4S4FIN-HQ9uQ67o.mjs";
import { r as v } from "./chunk-FWX5IMBZ-Dx6oqe1x.mjs";
...
var x = b, S = "TB", C = "TB", w = "dir", T = "state", E = "root", D = "relation", O = "classDef", k = "style", A = "applyClass", j = "default", M = "divider", N = "fill:none", P = "fill: #333", ee = "c", F = "markdown", te = "normal", I = "rect", L = "rectWithTitle", ne = "stateStart", re = "stateEnd", R = "divider", z = "roundedWithTitle", ie = "note", ae = "noteGroup", B = "statediagram", oe = `${B}-state`, V = "transition", se = "note", ce = `${V} note-edge`, le = `${B}-${se}`, ue = `${B}-cluster`, de = `${B}-cluster-alt`, H = "parent", U = "note", fe = "state", W = "----", pe = `${W}${U}`, G = `${W}${H}`, K = /* @__PURE__ */ t((e, t = C) => {
	...
	draw: /* @__PURE__ */ t(async function(e, t, r, i) {
		...
		u.type = i.type, u.layoutAlgorithm = l, u.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, u.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, d().look === "neo" ? u.markers = ["barbNeo"] : u.markers = ["barb"], u.diagramId = t, await v(u, f);
		try {
			(typeof i.db.getLinks == "function" ? i.db.getLinks() : /* @__PURE__ */ new Map()).forEach((e, t) => {
				var r;
				let i = typeof t == "string" ? t : typeof (t == null ? void 0 : t.id) == "string" ? t.id : "", a = u.nodes.find((e) => e.id === i);
				if (!i) {
					n.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(t));
					return;
				}
				let o = (r = f.node()) == null ? void 0 : r.querySelectorAll("g.node, g.rough-node"), s;
				if (o == null || o.forEach((e) => {
					var t;
					let n = (t = e.textContent) == null ? void 0 : t.trim();
					(e.id === (a == null ? void 0 : a.domId) || n === i) && (s = e);
				}), !s) {
					n.warn("⚠️ Could not find node matching text:", i);
					return;
				}
				let c = s.parentNode;
				if (!c) {
					n.warn("⚠️ Node has no parent, cannot wrap:", i);
					return;
				}
				let l = document.createElementNS("http://www.w3.org/2000/svg", "a"), d = e.url.replace(/^"+|"+$/g, "");
				if (l.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", d), l.setAttribute("target", "_blank"), e.tooltip) {
					let t = e.tooltip.replace(/^"+|"+$/g, "");
					l.setAttribute("title", t), s.setAttribute("title", t);
				}
				c.replaceChild(l, s), l.appendChild(s), n.info("🔗 Wrapped node in <a> tag for:", i, e.url);
			});
		} catch (e) {
			n.error("❌ Error injecting clickable links:", e);
		}
		p.insertTitle(f, "statediagramTitleText", (a = c == null ? void 0 : c.titleTopMargin) == null ? 25 : a, i.db.getDiagramTitle()), _(f, 8, B, (o = c == null ? void 0 : c.useMaxWidth) == null || o);
	}, "draw"),
	getDir: K
			...
			case D:
				{
					...
					let u = s === "neo", f = {
						...
						style: N,
						labelStyle: "",
						label: c.sanitizeText((n = t.description) == null ? "" : n, d()),
						arrowheadStyle: P,
						labelpos: ee,
						labelType: F,
						thickness: te,
...
t(_e, "getClassesFromDbInfo");
function ve(e) {
	var t;
	return (t = e == null ? void 0 : e.styles) == null ? [] : t;
}
t(ve, "getStylesFromDbInfo");
var Z = /* @__PURE__ */ t((e, t, r, i, a, o, s, l) => {
	let u = t.id, f = r.get(u), p = _e(f), m = ve(f), h = d();
	if (n.info("dataFetcher parsedItem", t, f, m), u !== "root") {
		var g;
		let r = I;
		t.start === !0 ? r = ne : t.start === !1 && (r = re), t.type !== j && (r = t.type), q.get(u) || q.set(u, {
			id: u,
			shape: r,
		...
		((g = d.description) == null ? void 0 : g.length) === 1 && d.shape === L && (d.type === "group" ? d.shape = z : d.shape = I), !d.type && t.doc && (n.info("Setting cluster for XCX", u, ge(t)), d.type = "group", d.isGroup = !0, d.dir = ge(t), d.explicitDir = t.doc.some((e) => e.stmt === "dir"), d.shape = t.type === M ? R : z, d.cssClasses = `${d.cssClasses} ${ue} ${o ? de : ""}`);
		let f = {
			labelStyle: "",
			shape: d.shape,
			label: d.description,
		...
		if (f.shape === R && (f.label = ""), e && e.id !== "root" && (n.trace("Setting node ", u, " to be child of its parent ", e.id), f.parentId = e.id), f.centerLabel = !0, t.note) {
			...
			J++, r.id = n, e.parentId = n, X(i, r, l), X(i, e, l), X(i, f, l);
			let o = u, c = e.id;
	...
	BG_FILL: "bgFill",
	STYLECLASS_SEP: ","
}, be = /* @__PURE__ */ t(() => /* @__PURE__ */ new Map(), "newClassesList"), xe = /* @__PURE__ */ t(() => ({
	relations: [],
	states: /* @__PURE__ */ new Map(),
	documents: {}
}), "newDoc"), $ = /* @__PURE__ */ t((e) => JSON.parse(JSON.stringify(e)), "clone"), Se = (y = class {
	constructor(e) {
	...
	addState(e, t = j, r = void 0, i = void 0, a = void 0, o = void 0, s = void 0, l = void 0) {
	...
	setupToolTips(t) {
		...
		r(t).select("svg").selectAll("g.node, g.rough-node").on("mouseover", (t) => {
			...
			n.transition().duration(200).style("opacity", ".9"), n.style("left", window.scrollX + s.left + (s.right - s.left) / 2 + "px").style("top", window.scrollY + s.bottom + "px"), n.html(e.sanitize(o)), a.classed("hover", !0);
		}).on("mouseout", (e) => {
	...
	getDirection() {
		var e, t;
		return (e = (t = this.getDirectionStatement()) == null ? void 0 : t.value) == null ? S : e;
	}
	setDirection(e) {
