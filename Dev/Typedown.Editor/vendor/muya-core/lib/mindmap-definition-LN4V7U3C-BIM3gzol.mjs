...
import { $ as n, b as r, et as i, f as a, k as o, nt as s, x as c, z as l } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
...
import { t as u } from "./chunk-XXDRQBXY-6qvi-T3x.mjs";
import { t as d } from "./chunk-VR4S4FIN-HQ9uQ67o.mjs";
import "./chunk-C7G6YPKG-BGTLz-ew.mjs";
import "./chunk-ZGVPDNZ5-CA-MSk8G.mjs";
import "./chunk-52WLFC77-CEdJfckq.mjs";
import { r as f, t as p } from "./chunk-FWX5IMBZ-Dx6oqe1x.mjs";
...
var S = x, C = 12, w = {
	...
	flattenNodes(t, n) {
		...
		t.isRoot === !0 ? a.push("section-root", "section--1") : t.section !== void 0 && a.push(`section-${t.section}`), t.class && a.push(t.class);
		let o = a.join(" "), s = /* @__PURE__ */ e((e) => {
			var t, n;
		...
		if (n.push(l), t.children) for (let e of t.children) this.flattenNodes(e, n);
	}
	generateEdges(e, t) {
...
}, e(b, "MindmapDB"), b), E = { draw: /* @__PURE__ */ e(async (e, n, i, o) => {
	var s, c, l, m;
	...
	return a;
}, "genSections"), O = /* @__PURE__ */ e((e, t, n) => {
	let r = "";
	for (let i = 0; i < e; i++) r += `
