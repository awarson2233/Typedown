...
import { $ as n, b as r, et as i, f as a, k as o, nt as s, x as c, z as l } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
...
import { t as u } from "./chunk-55IACEB6-DWxyqrIq.mjs";
import { t as d } from "./chunk-2J33WTMH-5W4hnvSY.mjs";
import "./chunk-NZK2D7GU-BP4KY081.mjs";
import "./chunk-3OPIFGDE-Al6MeL3x.mjs";
import "./chunk-KSCS5N6A-Do-wUxiw.mjs";
import { r as f, t as p } from "./chunk-LZXEDZCA-CElJAnI4.mjs";
...
function y(e, t, n) {
	var r, i, a;
	e = e || {};
	let o = (r = (i = e.random) == null ? (a = e.rng) == null ? void 0 : a.call(e) : i) == null ? _() : r;
...
var S = x, C = 12, w = {
	...
	constructor() {
		this.nodes = [], this.count = 0, this.elements = {}, this.getLogger = this.getLogger.bind(this), this.nodeType = w, this.clear(), this.getType = this.getType.bind(this), this.getElementById = this.getElementById.bind(this), this.getParent = this.getParent.bind(this), this.getMindmap = this.getMindmap.bind(this), this.addNode = this.addNode.bind(this), this.decorateNode = this.decorateNode.bind(this);
	}
	clear() {
	...
	addNode(t, n, r, i) {
		var o, s, u, d;
		e.info("addNode", t, n, r, i);
		let f = !1;
		this.nodes.length === 0 ? (this.baseLevel = t, t = 0, f = !0) : this.baseLevel !== void 0 && (t -= this.baseLevel, f = !1);
		let p = c(), m = (o = (s = p.mindmap) == null ? void 0 : s.padding) == null ? a.mindmap.padding : o;
		switch (i) {
		...
		let h = {
			...
			type: i,
			children: [],
			width: (u = (d = p.mindmap) == null ? void 0 : d.maxNodeWidth) == null ? a.mindmap.maxNodeWidth : u,
			padding: m,
			isRoot: f
		}, g = this.getParent(t);
	...
	flattenNodes(e, n) {
		var r;
		let i = c(), a = ["mindmap-node"];
		e.isRoot === !0 ? a.push("section-root", "section--1") : e.section !== void 0 && a.push(`section-${e.section}`), e.class && a.push(e.class);
		let o = a.join(" "), s = /* @__PURE__ */ t((e) => {
			var t, n;
			let r = ((t = (n = i.theme) == null ? void 0 : n.toLowerCase()) == null ? "" : t).includes("redux");
			switch (e) {
				case w.CIRCLE: return "mindmapCircle";
				case w.RECT: return "rect";
				case w.ROUNDED_RECT: return "rounded";
				case w.CLOUD: return "cloud";
				case w.BANG: return "bang";
				case w.HEXAGON: return "hexagon";
				case w.DEFAULT: return r ? "rounded" : "defaultMindmapNode";
				case w.NO_BORDER:
				default: return "rect";
			}
		}, "getShapeFromType"), l = {
		...
		if (n.push(l), e.children) for (let t of e.children) this.flattenNodes(t, n);
	}
	generateEdges(e, t) {
	...
	getData() {
		let t = this.getMindmap(), n = c(), r = o().layout !== void 0, i = n;
		if (r || (i.layout = "cose-bilkent"), !t) return {
			nodes: [],
			edges: [],
			config: i
		};
		...
		let a = [], s = [];
		this.flattenNodes(t, a), this.generateEdges(t, s), e.debug(`getData: processed ${a.length} nodes and ${s.length} edges`);
...
}, t(b, "MindmapDB"), b), E = { draw: /* @__PURE__ */ t(async (t, n, i, o) => {
	var s, c, l, m;
	e.debug("Rendering mindmap diagram\n" + t);
	let h = o.db, g = h.getData(), _ = u(n, g.config.securityLevel);
	if (g.type = o.type, g.layoutAlgorithm = p(g.config.layout, { fallback: "cose-bilkent" }), g.diagramId = n, !h.getMindmap()) return;
	g.nodes.forEach((e) => {
	...
	let { themeVariables: v } = r(), { useGradient: y, gradientStart: b, gradientStop: x } = v;
	if (y && b && x) {
	...
	d(_, (s = (c = g.config.mindmap) == null ? void 0 : c.padding) == null ? a.mindmap.padding : s, "mindmapDiagram", (l = (m = g.config.mindmap) == null ? void 0 : m.useMaxWidth) == null ? a.mindmap.useMaxWidth : l);
}, "draw") }, D = /* @__PURE__ */ t((e) => {
    ...
    [data-look="neo"].mindmap-node.section-${n - 1} rect, [data-look="neo"].mindmap-node.section-${n - 1} path, [data-look="neo"].mindmap-node.section-${n - 1} circle, [data-look="neo"].mindmap-node.section-${n - 1} polygon {
      ...
      stroke-width: ${(o = e.strokeWidth) == null ? 2 : o}px;
    }
    [data-look="neo"].section-edge-${n - 1}{
      stroke: ${t != null && t.includes("redux") || t === "neo-dark" ? e.nodeBorder : e["cScale" + n]};
    }
	...
	return a;
}, "genSections"), O = /* @__PURE__ */ t((e, t, n) => {
	let r = "";
	for (let i = 0; i < e; i++) r += `
