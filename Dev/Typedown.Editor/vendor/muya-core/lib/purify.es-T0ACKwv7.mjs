...
function k(e) {
	...
	for (let r of o(e)) {
		var n = i(r, 2);
		let a = n[0], o = n[1];
		x(e, a) && (v(o) ? t[a] = O(o) : o && typeof o == "object" && o.constructor === Object ? t[a] = k(o) : t[a] = o);
	}
	return t;
}
function fe(e) {
...
function He() {
	...
	let u = e.DOMParser, m = e.trustedTypes, h = c.prototype, ee = A(h, "cloneNode"), ue = A(h, "remove"), de = A(h, "nextSibling"), y = A(h, "childNodes"), b = A(h, "parentNode"), S = A(h, "shadowRoot"), T = A(h, "attributes"), E = s && s.prototype ? A(s.prototype, "nodeType") : null, O = s && s.prototype ? A(s.prototype, "nodeName") : null;
	if (typeof a == "function") {
		let e = n.createElement("template");
		e.content && e.content.ownerDocument && (n = e.content.ownerDocument);
	}
	let N, P = "", Ue, We = !1, Ge = 0, Ke = function() {
		if (Ge > 0) throw w("A configured TRUSTED_TYPES_POLICY callback (createHTML or createScriptURL) must not call DOMPurify.sanitize, as that causes infinite recursion. Do not pass a policy whose callbacks wrap DOMPurify as TRUSTED_TYPES_POLICY; see the \"DOMPurify and Trusted Types\" section of the README.");
	}, F = function(e) {
		Ke(), Ge++;
		try {
		...
		return We || (Ue = Be(m, i), We = !0), Ue;
	}, Ye = n, Xe = Ye.implementation, Ze = Ye.createNodeIterator, Qe = Ye.createDocumentFragment, $e = Ye.getElementsByTagName, et = r.importNode, I = Ve();
	t.isSupported = typeof o == "function" && typeof b == "function" && Xe && Xe.createHTMLDocument !== void 0;
	let tt = Te, nt = Ee, rt = De, it = Oe, at = ke, ot = je, st = Me, ct = Pe, lt = Ae, L = null, ut = D({}, [
		...me,
		...he,
		...ge,
		...ve,
	...
	})), ft = null, pt = null, B = Object.seal(p(null, {
		tagCheck: {
			writable: !0,
			configurable: !1,
			enumerable: !0,
	...
	})), mt = !0, ht = !0, gt = !1, _t = !0, V = !1, H = !0, U = !1, vt = !1, yt = null, bt = null, xt = !1, W = !1, St = !1, Ct = !1, wt = !0, Tt = !1, Et = "user-content-", Dt = !0, Ot = !1, G = {}, K = null, kt = D({}, /* @__PURE__ */ "annotation-xml.audio.colgroup.desc.foreignobject.head.iframe.math.mi.mn.mo.ms.mtext.noembed.noframes.noscript.plaintext.script.selectedcontent.style.svg.template.thead.title.video.xmp".split(".")), At = null, jt = D({}, [
		"audio",
		"video",
		"img",
		"source",
		...
		"style",
		"xmlns"
	]), Pt = "http://www.w3.org/1998/Math/MathML", Ft = "http://www.w3.org/2000/svg", q = "http://www.w3.org/1999/xhtml", J = q, It = !1, Lt = null, Rt = D({}, [
		Pt,
		Ft,
		q
	], ae), zt = d([
		...
		"a",
		"script"
	]), Wt = null, Gt = ["application/xhtml+xml", "text/html"], Y = null, X = null, Kt = n.createElement("form"), qt = function(e) {
		return e instanceof RegExp || e instanceof Function;
	}, Jt = function() {
		let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
		if (X && X === e) return;
		(!e || typeof e != "object") && (e = {}), e = k(e), Wt = Gt.indexOf(e.PARSER_MEDIA_TYPE) === -1 ? "text/html" : e.PARSER_MEDIA_TYPE, Y = Wt === "application/xhtml+xml" ? ae : ie, L = M(e, "ALLOWED_TAGS", ut, { transform: Y }), R = M(e, "ALLOWED_ATTR", dt, { transform: Y }), Lt = M(e, "ALLOWED_NAMESPACES", Rt, { transform: ae }), Mt = M(e, "ADD_URI_SAFE_ATTR", Nt, {
			transform: Y,
			base: Nt
		}), At = M(e, "ADD_DATA_URI_TAGS", jt, {
			transform: Y,
			base: jt
		}), K = M(e, "FORBID_CONTENTS", kt, { transform: Y }), ft = M(e, "FORBID_TAGS", k({}), { transform: Y }), pt = M(e, "FORBID_ATTR", k({}), { transform: Y }), G = x(e, "USE_PROFILES") ? e.USE_PROFILES && typeof e.USE_PROFILES == "object" ? k(e.USE_PROFILES) : e.USE_PROFILES : !1, mt = e.ALLOW_ARIA_ATTR !== !1, ht = e.ALLOW_DATA_ATTR !== !1, gt = e.ALLOW_UNKNOWN_PROTOCOLS || !1, _t = e.ALLOW_SELF_CLOSE_IN_ATTR !== !1, V = e.SAFE_FOR_TEMPLATES || !1, H = e.SAFE_FOR_XML !== !1, U = e.WHOLE_DOCUMENT || !1, W = e.RETURN_DOM || !1, St = e.RETURN_DOM_FRAGMENT || !1, Ct = e.RETURN_TRUSTED_TYPE || !1, xt = e.FORCE_BODY || !1, wt = e.SANITIZE_DOM !== !1, Tt = e.SANITIZE_NAMED_PROPS || !1, Dt = e.KEEP_CONTENT !== !1, Ot = e.IN_PLACE || !1, lt = pe(e.ALLOWED_URI_REGEXP) ? e.ALLOWED_URI_REGEXP : Ae, J = typeof e.NAMESPACE == "string" ? e.NAMESPACE : q, Bt = x(e, "MATHML_TEXT_INTEGRATION_POINTS") && e.MATHML_TEXT_INTEGRATION_POINTS && typeof e.MATHML_TEXT_INTEGRATION_POINTS == "object" ? k(e.MATHML_TEXT_INTEGRATION_POINTS) : D({}, zt), Ht = x(e, "HTML_INTEGRATION_POINTS") && e.HTML_INTEGRATION_POINTS && typeof e.HTML_INTEGRATION_POINTS == "object" ? k(e.HTML_INTEGRATION_POINTS) : D({}, Vt);
		...
		if (z = p(null), x(t, "tagNameCheck") && qt(t.tagNameCheck) && (z.tagNameCheck = t.tagNameCheck), x(t, "attributeNameCheck") && qt(t.attributeNameCheck) && (z.attributeNameCheck = t.attributeNameCheck), x(t, "allowCustomizedBuiltInElements") && typeof t.allowCustomizedBuiltInElements == "boolean" && (z.allowCustomizedBuiltInElements = t.allowCustomizedBuiltInElements), f(z), V && (ht = !1), St && (W = !0), G && (L = D({}, be), R = p(null), G.html === !0 && (D(L, me), D(R, xe)), G.svg === !0 && (D(L, he), D(R, Se), D(R, we)), G.svgFilters === !0 && (D(L, ge), D(R, Se), D(R, we)), G.mathMl === !0 && (D(L, ve), D(R, Ce), D(R, we))), B.tagCheck = null, B.attributeCheck = null, x(e, "ADD_TAGS") && (typeof e.ADD_TAGS == "function" ? B.tagCheck = e.ADD_TAGS : v(e.ADD_TAGS) && (L === ut && (L = k(L)), D(L, e.ADD_TAGS, Y))), x(e, "ADD_ATTR") && (typeof e.ADD_ATTR == "function" ? B.attributeCheck = e.ADD_ATTR : v(e.ADD_ATTR) && (R === dt && (R = k(R)), D(R, e.ADD_ATTR, Y))), x(e, "ADD_URI_SAFE_ATTR") && v(e.ADD_URI_SAFE_ATTR) && D(Mt, e.ADD_URI_SAFE_ATTR, Y), x(e, "FORBID_CONTENTS") && v(e.FORBID_CONTENTS) && (K === kt && (K = k(K)), D(K, e.FORBID_CONTENTS, Y)), x(e, "ADD_FORBID_CONTENTS") && v(e.ADD_FORBID_CONTENTS) && (K === kt && (K = k(K)), D(K, e.ADD_FORBID_CONTENTS, Y)), Dt && (L["#text"] = !0), U && D(L, [
			"html",
			"head",
			"body"
		]), L.table && (D(L, ["tbody"]), delete ft.tbody), e.TRUSTED_TYPES_POLICY) {
		...
		} else e.TRUSTED_TYPES_POLICY === null ? (N = void 0, P = "") : (N === void 0 && (N = Je()), N && typeof P == "string" && (P = F("")));
		d && d(e), X = e;
	}, Yt = D({}, [
		...he,
		...ge,
		..._e
	]), Xt = D({}, [...ve, ...ye]), Zt = function(e, t, n) {
		return t.namespaceURI === q ? e === "svg" : t.namespaceURI === Pt ? e === "svg" && (n === "annotation-xml" || Bt[n]) : !!Yt[e];
	}, Qt = function(e, t, n) {
		return t.namespaceURI === q ? e === "math" : t.namespaceURI === Ft ? e === "math" && Ht[n] : !!Xt[e];
	}, $t = function(e, t, n) {
		return t.namespaceURI === Ft && !Ht[n] || t.namespaceURI === Pt && !Bt[n] ? !1 : !Xt[e] && (Ut[e] || !Yt[e]);
	}, en = function(e) {
		let t = b(e);
		(!t || !t.tagName) && (t = {
			namespaceURI: J,
		...
		return Lt[e.namespaceURI] ? e.namespaceURI === Ft ? Zt(n, t, r) : e.namespaceURI === Pt ? Qt(n, t, r) : e.namespaceURI === q ? $t(n, t, r) : !!(Wt === "application/xhtml+xml" && Lt[e.namespaceURI]) : !1;
	}, Z = function(e) {
		...
		if (n.removeAttribute(e), e === "is") if (W || St) try {
			Z(n);
		} catch {}
		else try {
			n.setAttribute(e, "");
		...
		for (; t.length > 0;) {
			let e = t.pop();
			(E ? E(e) : e.nodeType) === j.element && nn(e);
			let n = y(e);
		...
		if (!t || !t.documentElement) {
			t = Xe.createDocument(J, "template", null);
			try {
				t.documentElement.innerHTML = It ? P : i;
			} catch {}
		}
		let a = t.body || t.documentElement;
		return e && r && a.insertBefore(n.createTextNode(r), a.childNodes[0] || null), J === q ? $e.call(t, U ? "html" : "body")[0] : U ? t.documentElement : a;
	}, sn = function(e) {
		return Ze.call(e.ownerDocument || e, e, l.SHOW_ELEMENT | l.SHOW_COMMENT | l.SHOW_TEXT | l.SHOW_PROCESSING_INSTRUCTION | l.SHOW_CDATA_SECTION, null);
	}, cn = function(e) {
		return e = se(e, tt, " "), e = se(e, nt, " "), e = se(e, rt, " "), e;
	}, ln = function(e) {
		var t;
		e.normalize();
		let n = Ze.call(e.ownerDocument || e, e, l.SHOW_TEXT | l.SHOW_COMMENT | l.SHOW_CDATA_SECTION | l.SHOW_PROCESSING_INSTRUCTION, null), r = n.nextNode();
	...
	let pn = function(e, t) {
		return !!(H && e.hasChildNodes() && !fn(e.firstElementChild) && C(Fe, e.textContent) && C(Fe, e.innerHTML) || H && e.namespaceURI === q && t === "style" && fn(e.firstElementChild) || e.nodeType === j.processingInstruction || H && e.nodeType === j.comment && C(Ie, e.data));
	}, mn = function(e, t) {
		if (!ft[t] && vn(t) && (z.tagNameCheck instanceof RegExp && C(z.tagNameCheck, t) || z.tagNameCheck instanceof Function && z.tagNameCheck(t))) return !1;
		if (Dt && !K[t]) {
			let t = b(e), n = y(e);
			if (n && t) {
				let r = n.length;
				for (let i = r - 1; i >= 0; --i) {
					...
					t.insertBefore(r, de(e));
				}
			}
		}
		return Z(e), !0;
	}, hn = function(e, n) {
		if ($(I.beforeSanitizeElements, e, null), e !== n && b(e) === null) return !0;
		if (un(e)) return Z(e), !0;
		let r = Y(O ? O(e) : e.nodeName);
		if ($(I.uponSanitizeElement, e, {
			tagName: r,
			allowedTags: L
		}), e !== n && b(e) === null) return !0;
		if (pn(e, r)) return Z(e), !0;
		if (ft[r] || !(B.tagCheck instanceof Function && B.tagCheck(r)) && !L[r]) {
			let t = mn(e, r);
			return t === !1 && $(I.afterSanitizeElements, e, null), t;
		}
		if ((E ? E(e) : e.nodeType) === j.element && !en(e) || (r === "noscript" || r === "noembed" || r === "noframes") && C(Le, e.innerHTML)) return Z(e), !0;
		...
		if (pt[t] || H && t === "patchsrc" || H && t === "for" && e !== "label" && e !== "output" || wt && (t === "id" || t === "name") && (r in n || r in Kt)) return !1;
		let i = R[t] || B.attributeCheck instanceof Function && B.attributeCheck(t, e);
		if (!(ht && C(it, t)) && !(mt && C(at, t))) {
			if (!i) {
				if (!(vn(e) && (z.tagNameCheck instanceof RegExp && C(z.tagNameCheck, e) || z.tagNameCheck instanceof Function && z.tagNameCheck(e)) && (z.attributeNameCheck instanceof RegExp && C(z.attributeNameCheck, t) || z.attributeNameCheck instanceof Function && z.attributeNameCheck(t, e)) || t === "is" && z.allowCustomizedBuiltInElements && (z.tagNameCheck instanceof RegExp && C(z.tagNameCheck, r) || z.tagNameCheck instanceof Function && z.tagNameCheck(r)))) return !1;
		...
		try {
			r ? e.setAttributeNS(r, n, i) : e.setAttribute(n, i), un(e) ? Z(e) : ne(t.removed);
		} catch {
			Q(n, e);
		}
	}, xn = function(e) {
		...
		for (; r--;) {
			...
			if (n.attrName = l, n.attrValue = d, n.keepAttr = !0, n.forceKeepAttr = void 0, $(I.uponSanitizeAttribute, e, n), d = n.attrValue, Tt && (l === "id" || l === "name") && ce(d, Et) !== 0 && (Q(o, e), d = Et + d), H && C(/((--!?|])>)|<\/(style|script|title|xmp|textarea|noscript|iframe|noembed|noframes)/i, d)) {
				Q(o, e);
				continue;
			}
		...
		let t = null, n = sn(e);
		for ($(I.beforeSanitizeShadowDOM, e, null); t = n.nextNode();) if ($(I.uponSanitizeShadowNode, t, null), hn(t, e), xn(t), dn(t.content) && Sn(t.content), (E ? E(t) : t.nodeType) === j.element) {
			let e = S(t);
			dn(e) && (Cn(e), Sn(e));
		}
	...
	return t.sanitize = function(e) {
		...
		if (It = !e, It && (e = "<!-->"), typeof e != "string" && !fn(e) && (e = fe(e), typeof e != "string")) throw w("dirty is not a string, aborting");
		if (!t.isSupported) return e;
		vt ? (L = yt, R = bt) : Jt(n), (I.uponSanitizeElement.length > 0 || I.uponSanitizeAttribute.length > 0) && (L = k(L)), I.uponSanitizeAttribute.length > 0 && (R = k(R)), t.removed = [];
		let c = Ot && typeof e != "string" && fn(e);
		if (c) {
			an(e);
			let t = O ? O(e) : e.nodeName;
			if (typeof t == "string") {
				let n = Y(t);
				if (!L[n] || ft[n]) throw tn(e), w("root node is forbidden and cannot be sanitized in-place");
			}
			if (un(e)) throw tn(e), w("root node is clobbered and cannot be sanitized in-place");
			try {
				Cn(e);
			} catch (t) {
				throw tn(e), t;
			}
		} else if (fn(e)) i = on("<!---->"), a = i.ownerDocument.importNode(e, !0), a.nodeType === j.element && a.nodeName === "BODY" || a.nodeName === "HTML" ? i = a : i.appendChild(a), Cn(a);
		else {
			if (!W && !V && !U && e.indexOf("<") === -1) return N && Ct ? F(e) : e;
			if (i = on(e), !i) return W ? null : Ct ? P : "";
		}
		i && xt && Z(i.firstChild);
		let l = c ? e : i, u = sn(l);
		try {
		...
		if (W) {
			if (V && ln(i), St) for (s = Qe.call(i.ownerDocument); i.firstChild;) s.appendChild(i.firstChild);
			else s = i;
			return (R.shadowroot || R.shadowrootmode) && (s = et.call(r, s, !0)), s;
		}
		let d = U ? i.outerHTML : i.innerHTML;
		return U && L["!doctype"] && i.ownerDocument && i.ownerDocument.doctype && i.ownerDocument.doctype.name && C(Ne, i.ownerDocument.doctype.name) && (d = "<!DOCTYPE " + i.ownerDocument.doctype.name + ">\n" + d), V && (d = cn(d)), N && Ct ? F(d) : d;
	}, t.setConfig = function() {
		let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
		Jt(e), vt = !0, yt = L, bt = R;
	}, t.clearConfig = function() {
		X = null, vt = !1, yt = null, bt = null, N = Ue, P = "";
