...
import { t as n } from "./mermaid-parser.core-CsFkPpbd.mjs";
import { i as r, r as i, t as a } from "./src-6bhrijpo.mjs";
import { H as o, J as s, K as c, U as l, a as u, b as d, f, v as p, w as m, x as h, y as g, z as _ } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { c as v, i as y } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as b } from "./chunk-WU5MYG2G-CWOh8Nru.mjs";
import { a as x, i as S, n as C, r as w } from "./chunk-O5CBEL6O-DN64hWSU.mjs";
import { t as T } from "./chunk-4BX2VUAB-CyUC8-vI.mjs";
import { t as E } from "./cytoscape.esm-DwvlyUep.mjs";
...
var D = /* @__PURE__ */ t(((e, t) => {
	...
	L: /* @__PURE__ */ i((e) => `${e},${e / 2} 0,${e} 0,0`, "L"),
	R: /* @__PURE__ */ i((e) => `0,${e / 2} ${e},0 ${e},${e}`, "R"),
	T: /* @__PURE__ */ i((e) => `0,0 ${e},0 ${e / 2},${e}`, "T"),
	B: /* @__PURE__ */ i((e) => `${e / 2},0 ${e},${e} 0,${e}`, "B")
}, N = {
	L: /* @__PURE__ */ i((e, t) => e - t + 2, "L"),
	R: /* @__PURE__ */ i((e, t) => e - 2, "R"),
	T: /* @__PURE__ */ i((e, t) => e - t + 2, "T"),
	B: /* @__PURE__ */ i((e, t) => e - 2, "B")
}, P = /* @__PURE__ */ i(function(e) {
	return F(e) ? e === "L" ? "R" : "L" : e === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), ee = /* @__PURE__ */ i(function(e) {
	let t = e;
	return t === "L" || t === "R" || t === "T" || t === "B";
}, "isArchitectureDirection"), F = /* @__PURE__ */ i(function(e) {
	let t = e;
	return t === "L" || t === "R";
}, "isArchitectureDirectionX"), I = /* @__PURE__ */ i(function(e) {
	let t = e;
	return t === "T" || t === "B";
}, "isArchitectureDirectionY"), L = /* @__PURE__ */ i(function(e, t) {
	let n = F(e) && I(t), r = I(e) && F(t);
	return n || r;
}, "isArchitectureDirectionXY"), R = /* @__PURE__ */ i(function(e) {
	let t = e[0], n = e[1], r = F(t) && I(n), i = I(t) && F(n);
	return r || i;
}, "isArchitecturePairXY"), z = /* @__PURE__ */ i(function(e) {
	return e !== "LL" && e !== "RR" && e !== "TT" && e !== "BB";
}, "isValidArchitectureDirectionPair"), B = /* @__PURE__ */ i(function(e, t) {
	let n = `${e}${t}`;
	return z(n) ? n : void 0;
}, "getArchitectureDirectionPair"), te = /* @__PURE__ */ i(function([e, t], n) {
	let r = n[0], i = n[1];
	return F(r) ? I(i) ? [e + (r === "L" ? -1 : 1), t + (i === "T" ? 1 : -1)] : [e + (r === "L" ? -1 : 1), t] : F(i) ? [e + (i === "L" ? 1 : -1), t + (r === "T" ? 1 : -1)] : [e, t + (r === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), ne = /* @__PURE__ */ i(function(e) {
	return e === "LT" || e === "TL" ? [1, 1] : e === "BL" || e === "LB" ? [1, -1] : e === "BR" || e === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), V = /* @__PURE__ */ i(function(e, t) {
	return L(e, t) ? "bend" : F(e) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), re = /* @__PURE__ */ i(function(e) {
	return e.type === "service";
}, "isArchitectureService"), ie = /* @__PURE__ */ i(function(e) {
	return e.type === "junction";
}, "isArchitectureJunction"), H = /* @__PURE__ */ i((e) => e.data(), "edgeData"), U = /* @__PURE__ */ i((e) => e.data(), "nodeData"), W = f.architecture, ae = (A = class {
	constructor() {
		this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.diagramId = "", this.setAccTitle = l, this.getAccTitle = g, this.setDiagramTitle = c, this.getDiagramTitle = m, this.getAccDescription = p, this.setAccDescription = o, this.clear();
	}
	setDiagramId(e) {
		this.diagramId = e;
	}
	...
	clear() {
		this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.dataStructures = void 0, this.elements = {}, this.diagramId = "", u();
	}
	...
	getDataStructures() {
		if (this.dataStructures === void 0) {
			let e = {}, t = Object.entries(this.nodes).reduce((t, [n, r]) => (t[n] = r.edges.reduce((t, r) => {
				...
				return t;
			}, {}), t), {}), n = Object.keys(t)[0], r = { [n]: 1 }, a = Object.keys(t).reduce((e, t) => t === n ? e : {
				...e,
				[t]: 1
			}, {}), o = /* @__PURE__ */ i((e) => {
				let n = { [e]: [0, 0] }, i = [e];
...
}, i(A, "ArchitectureDB"), A), G = /* @__PURE__ */ i((e, t) => {
	...
	parse: /* @__PURE__ */ i(async (e) => {
		var t;
		let i = await n("architecture", e);
		r.debug(i);
		let a = (t = K.parser) == null ? void 0 : t.yy;
		if (!(a instanceof ae)) throw Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		G(i, a);
	}, "parse")
}, oe = /* @__PURE__ */ i((e) => `
  .edge {
...
`, "getStyles"), q = /* @__PURE__ */ i((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), J = {
...
}, Y = /* @__PURE__ */ i(async function(e, t, n, r) {
	let i = n.getConfigField("padding"), a = n.getConfigField("iconSize"), o = a / 2, s = a / 6, c = s / 2;
	await Promise.all(t.edges().map(async (t) => {
		var a, l;
		let { source: u, sourceDir: d, sourceArrow: f, sourceGroup: p, target: m, targetDir: g, targetArrow: _, targetGroup: y, label: b } = H(t), { x, y: S } = t[0].sourceEndpoint(), { x: w, y: T } = t[0].midpoint(), { x: E, y: D } = t[0].targetEndpoint(), O = i + 4;
		if (p && (F(d) ? x += d === "L" ? -O : O : S += d === "T" ? -O : O + 18), y && (F(g) ? E += g === "L" ? -O : O : D += g === "T" ? -O : O + 18), !p && ((a = n.getNode(u)) == null ? void 0 : a.type) === "junction" && (F(d) ? x += d === "L" ? o : -o : S += d === "T" ? o : -o), !y && ((l = n.getNode(m)) == null ? void 0 : l.type) === "junction" && (F(g) ? E += g === "L" ? o : -o : D += g === "T" ? o : -o), t[0]._private.rscratch) {
			let t = e.insert("g");
			if (t.insert("path").attr("d", `M ${x},${S} L ${w},${T} L${E},${D} `).attr("class", "edge").attr("id", `${r}-${v(u, m, { prefix: "L" })}`), f) {
			...
			if (b) {
				...
				}, h()), r.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), e === "X") r.attr("transform", "translate(" + w + ", " + T + ")");
				else if (e === "Y") r.attr("transform", "translate(" + w + ", " + T + ") rotate(-90)");
				else if (e === "XY") {
					let e = B(d, g);
					if (e && R(e)) {
...
}, "drawEdges"), se = /* @__PURE__ */ i(async function(e, t, n, r) {
...
}, "drawGroups"), X = /* @__PURE__ */ i(async function(e, t, n, r) {
	let i = h();
	for (let o of n) {
		...
		if (o.icon) c.html(`<g>${await w(o.icon, {
			...
			let e = c.append("g").append("foreignObject").attr("width", s).attr("height", s).append("div").attr("class", "node-icon-text").attr("style", `height: ${s}px;`).append("div").html(_(o.iconText, i)), t = (a = parseInt(window.getComputedStyle(e.node(), null).getPropertyValue("font-size").replace(/\D/g, ""))) == null ? 16 : a;
	...
	return 0;
}, "drawServices"), ce = /* @__PURE__ */ i(function(e, t, n, r) {
	n.forEach((n) => {
...
i(pe, "addEdges");
function me(e, t, n) {
	let r = /* @__PURE__ */ i((e, t) => Object.entries(e).reduce((e, [r, i]) => {
...
i(me, "getAlignments");
function he(e, t) {
	let n = [], r = /* @__PURE__ */ i((e) => `${e[0]},${e[1]}`, "posToStr"), a = /* @__PURE__ */ i((e) => e.split(",").map((e) => parseInt(e)), "strToPos");
	return e.forEach((e) => {
		let i = Object.fromEntries(Object.entries(e).map(([e, t]) => [r(t), e])), o = [r([0, 0])], s = {}, c = {
			L: [-1, 0],
			R: [1, 0],
			T: [0, 1],
			B: [0, -1]
...
i(he, "getRelativeConstraints");
function ge(e, t, n, o, s, { spatialMaps: c, groupAlignments: l }) {
	return new Promise((u) => {
		let d = a("body").append("div").attr("id", "cy").attr("style", "display:none"), f = E({
		...
		let p = me(s, c, l), m = he(c, s), h = s.getConfigField("iconSize"), g = s.getConfigField("idealEdgeLengthMultiplier") * h, _ = .5 * h, v = s.getConfigField("edgeElasticity"), y = f.layout({
			name: "fcose",
			quality: "proof",
...
i(ge, "layoutArchitecture");
var _e = {
	parser: K,
	get db() {
		return new ae();
	},
	renderer: { draw: /* @__PURE__ */ i(async (e, t, n, r) => {
		let i = r.db;
		i.setDiagramId(t);
		let a = i.getServices(), o = i.getJunctions(), c = i.getGroups(), l = i.getEdges(), u = i.getDataStructures(), d = b(t), f = d.append("g");
		f.attr("class", "architecture-edges");
		let p = d.append("g");
		p.attr("class", "architecture-services");
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await X(i, p, a, t), ce(i, p, o, t);
		let h = await ge(a, o, c, l, i, u);
		await Y(f, h, i, t), await se(m, h, i, t), de(i, h), s(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
	styles: oe
};
//#endregion
