...
function r(e, t) {
	var r;
	let i = t.hachureAngle + 90, a = t.hachureGap;
	a < 0 && (a = 4 * t.strokeWidth), a = Math.round(Math.max(a, .1));
	let o = 1;
	return t.roughness >= 1 && (((r = t.randomizer) == null ? void 0 : r.next()) || Math.random()) > .7 && (o = a), n(e, a, i, o || 1);
}
var i = class {
	constructor(e) {
		this.helper = e;
...
var Z = "none", Q = class {
	...
	curve(e, t) {
		...
		if (n.fill && n.fill !== Z) if (n.fillStyle === "solid") {
