...
import { H as t, K as n, U as r, a as i, c as a, s as o, v as s, w as c, x as l, y as u } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { p as d } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as f } from "./chunk-VAUOI2AC-DvRR_ttS.mjs";
import { t as p } from "./rough.esm-BqIZv7WF.mjs";
...
var g = h, _ = (m = class {
	...
	let g = r.db.getRoot();
	if (!g) return;
	let _ = l(), { look: b, handDrawnSeed: x, themeVariables: S } = _, C = (i = d(_.fontSize)[0]) == null ? v : i, w = b === "handDrawn", T = (a = g.children) == null ? [] : a, D = (o = (s = _.ishikawa) == null ? void 0 : s.diagramPadding) == null ? 20 : o, A = (c = (u = _.ishikawa) == null ? void 0 : u.useMaxWidth) != null && c, j = f(t), M = j.append("g").attr("class", "ishikawa"), P = w ? p.svg(j.node()) : void 0, F = P ? {
		roughSvg: P,
		seed: x == null ? 0 : x,
