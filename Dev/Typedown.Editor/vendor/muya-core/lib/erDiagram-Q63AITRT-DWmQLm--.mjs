...
import { H as i, K as a, U as o, a as s, rt as c, v as l, w as u, x as d, y as f } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { t as p } from "./channel-CrTnM7c1.mjs";
import { c as m, g as h } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
...
import { r as v, t as y } from "./chunk-FWX5IMBZ-Dx6oqe1x.mjs";
...
var b, x = (function() {
	var t = /* @__PURE__ */ e(function(e, t, n, r) {
		...
		48,
		49
	], H = [1, 93], U = [1, 92], W = [1, 91], G = [19, 58], K = [1, 102], q = [1, 101], J = [
		19,
		58,
		61,
		63
		...
		return {
			...
			performAction: /* @__PURE__ */ e(function(e, t, n, r) {
				switch (n) {
					...
					case 30: return 63;
					case 31: break;
					case 32: return this.popState(), 19;
					case 33: return t.yytext[0];
					case 34: return 20;
					case 35: return 21;
					case 36: return this.begin("style"), 44;
					case 37: return this.popState(), 10;
					case 38: break;
					case 39: return 13;
					case 40: return 42;
					case 41: return 49;
					case 42: return this.begin("style"), 37;
					case 43: return 43;
					case 44: return 66;
					case 45: return 68;
					case 46: return 68;
	...
	return e(X, "Parser"), X.prototype = Y, Y.Parser = X, new X();
})();
x.parser = x;
var S = x, C = (b = class {
	constructor() {
		...
		}, this.setAccTitle = o, this.getAccTitle = f, this.setAccDescription = i, this.getAccDescription = l, this.setDiagramTitle = a, this.getDiagramTitle = u, this.getConfig = /* @__PURE__ */ e(() => d().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	addEntity(e, t = "") {
		var r;
		if (this.entities.has(e)) !((r = this.entities.get(e)) != null && r.alias) && t && (this.entities.get(e).alias = t, n.info(`Add alias '${t}' to entity '${e}'`));
		else {
			var i;
			this.entities.set(e, {
				...
				alias: t,
				shape: "erBox",
				look: (i = d().look) == null ? "default" : i,
				cssClasses: "default",
				cssStyles: [],
				labelType: "markdown"
			}), n.info("Added new entity :", e);
		}
	...
	clear() {
		this.entities = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.relationships = [], s();
	}
	getData() {
		let e = [], t = [], n = d(), r = 0;
...
var T = /* @__PURE__ */ e(async function(e, t, i, a) {
	...
	let { securityLevel: c, er: l, layout: u } = d(), f = a.db.getData(), p = g(t, c);
	f.type = a.type, f.layoutAlgorithm = y(u), f.config.flowchart.nodeSpacing = (l == null ? void 0 : l.nodeSpacing) || 140, f.config.flowchart.rankSpacing = (l == null ? void 0 : l.rankSpacing) || 80, f.direction = a.db.getDirection();
	let { config: m } = f, { look: b } = m;
	b === "neo" ? f.markers = [
		"only_one_neo",
		"zero_or_one_neo",
		"one_or_more_neo",
		...
		"one_or_more",
		"zero_or_more"
	], f.diagramId = t, await v(f, p), f.layoutAlgorithm === "elk" && p.select(".edges").lower();
	let x = p.selectAll("[id*=\"-background\"]");
	Array.from(x).length > 0 && x.each(function() {
		let e = r(this), t = e.attr("id").replace("-background", ""), n = p.select(`#${CSS.escape(t)}`);
		if (!n.empty()) {
			let t = n.attr("transform");
			e.attr("transform", t);
		}
	}), h.insertTitle(p, "erDiagramTitleText", (o = l == null ? void 0 : l.titleTopMargin) == null ? 25 : o, a.db.getDiagramTitle()), _(p, 8, "erDiagram", (s = l == null ? void 0 : l.useMaxWidth) == null || s);
	...
	if (!D.has(t)) return "";
	let a = (r == null ? void 0 : r.length) > 0, o = "";
