...
import { n as r, t as i } from "./src-upoOno_g.mjs";
import { H as a, J as o, K as s, U as c, a as l, b as u, f as d, v as f, w as p, x as m, y as h, z as g } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { c as _, i as v } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
...
import { i as S, r as C, t as w } from "./chunk-HOUHSVGY-2PLbOYM-.mjs";
import { n as T } from "./chunk-Q4XR5HBZ-KP7VNg4F.mjs";
import { t as E } from "./cytoscape.esm-DJ_KYwtv.mjs";
...
var D = /* @__PURE__ */ t(((e, t) => {
					...
					for (var ne = E - 1, V = 0, re = 2 ** -52, ie = 2 ** -966; E > 0;) {
						...
						switch (H++, U) {
							case 1:
								...
								n[E - 2] = 0;
								for (var K = E - 2; K >= H; K--) {
									var oe = r.hypot(this.s[K], G), q = this.s[K] / oe, J = G / oe;
									if (this.s[K] = oe, K !== H && (G = -J * n[K - 1], n[K - 1] = q * n[K - 1]), o) for (var Y = 0; Y < this.n; Y++) oe = q * this.V[Y][K] + J * this.V[Y][E - 1], this.V[Y][E - 1] = -J * this.V[Y][K] + q * this.V[Y][E - 1], this.V[Y][K] = oe;
								}
								break;
							case 2:
								var se = n[H - 1];
								n[H - 1] = 0;
								for (var X = H; X < E; X++) {
									var ce = r.hypot(this.s[X], se), le = this.s[X] / ce, ue = se / ce;
									if (this.s[X] = ce, se = -ue * n[X], n[X] = le * n[X], a) for (var de = 0; de < this.m; de++) ce = le * this.U[de][X] + ue * this.U[de][H - 1], this.U[de][H - 1] = -ue * this.U[de][X] + le * this.U[de][H - 1], this.U[de][X] = ce;
								}
								break;
							case 3:
								var fe = Math.max(Math.max(Math.max(Math.max(Math.abs(this.s[E - 1]), Math.abs(this.s[E - 2])), Math.abs(n[E - 2])), Math.abs(this.s[H])), Math.abs(n[H])), pe = this.s[E - 1] / fe, me = this.s[E - 2] / fe, he = n[E - 2] / fe, ge = this.s[H] / fe, _e = n[H] / fe, ve = ((me + pe) * (me - pe) + he * he) / 2, ye = pe * he * (pe * he), be = 0;
								(function(e, t) {
									return e || t;
								})(ve !== 0, ye !== 0) && (be = Math.sqrt(ve * ve + ye), ve < 0 && (be = -be), be = ye / (ve + be));
								for (var xe = (ge + pe) * (ge - pe) + be, Se = ge * _e, Z = H; Z < E - 1; Z++) {
									var Q = r.hypot(xe, Se), $ = xe / Q, Ce = Se / Q;
									if (Z !== H && (n[Z - 1] = Q), xe = $ * this.s[Z] + Ce * n[Z], n[Z] = $ * n[Z] - Ce * this.s[Z], Se = Ce * this.s[Z + 1], this.s[Z + 1] = $ * this.s[Z + 1], o) for (var we = 0; we < this.n; we++) Q = $ * this.V[we][Z] + Ce * this.V[we][Z + 1], this.V[we][Z + 1] = -Ce * this.V[we][Z] + $ * this.V[we][Z + 1], this.V[we][Z] = Q;
									if (Q = r.hypot(xe, Se), $ = xe / Q, Ce = Se / Q, this.s[Z] = Q, xe = $ * n[Z] + Ce * this.s[Z + 1], this.s[Z + 1] = -Ce * n[Z] + $ * this.s[Z + 1], Se = Ce * n[Z + 1], n[Z + 1] = $ * n[Z + 1], a && Z < this.m - 1) for (var Te = 0; Te < this.m; Te++) Q = $ * this.U[Te][Z] + Ce * this.U[Te][Z + 1], this.U[Te][Z + 1] = -Ce * this.U[Te][Z] + $ * this.U[Te][Z + 1], this.U[Te][Z] = Q;
								}
								n[E - 2] = xe, V += 1;
								break;
							case 4:
					...
					c.handleConstraints = function(e) {
						...
						if (i.ENFORCE_CONSTRAINTS) {
							...
							t.relativePlacementConstraint && (function() {
								...
								try {
									for (var q = te.keys()[Symbol.iterator](), J; !(G = (J = q.next()).done); G = !0) {
										var W = J.value;
										ae(W);
									}
								} catch (e) {
						...
						for (var J = 0; J < d.length; J++) {
							var Y = d[J];
							Y.getChild() == null && Y.setCenter(l[c.get(Y.id)], u[c.get(Y.id)]);
						}
					}, e.exports = c;
				}),
				551: ((t) => {
	...
	L: /* @__PURE__ */ n((e) => `${e},${e / 2} 0,${e} 0,0`, "L"),
	R: /* @__PURE__ */ n((e) => `0,${e / 2} ${e},0 ${e},${e}`, "R"),
	T: /* @__PURE__ */ n((e) => `0,0 ${e},0 ${e / 2},${e}`, "T"),
	B: /* @__PURE__ */ n((e) => `${e / 2},0 ${e},${e} 0,${e}`, "B")
}, N = {
	L: /* @__PURE__ */ n((e, t) => e - t + 2, "L"),
	R: /* @__PURE__ */ n((e, t) => e - 2, "R"),
	T: /* @__PURE__ */ n((e, t) => e - t + 2, "T"),
	B: /* @__PURE__ */ n((e, t) => e - 2, "B")
}, P = /* @__PURE__ */ n(function(e) {
	return F(e) ? e === "L" ? "R" : "L" : e === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), ee = /* @__PURE__ */ n(function(e) {
	let t = e;
	return t === "L" || t === "R" || t === "T" || t === "B";
}, "isArchitectureDirection"), F = /* @__PURE__ */ n(function(e) {
	let t = e;
	return t === "L" || t === "R";
}, "isArchitectureDirectionX"), I = /* @__PURE__ */ n(function(e) {
	let t = e;
	return t === "T" || t === "B";
}, "isArchitectureDirectionY"), L = /* @__PURE__ */ n(function(e, t) {
	let n = F(e) && I(t), r = I(e) && F(t);
	return n || r;
}, "isArchitectureDirectionXY"), R = /* @__PURE__ */ n(function(e) {
	let t = e[0], n = e[1], r = F(t) && I(n), i = I(t) && F(n);
	return r || i;
}, "isArchitecturePairXY"), z = /* @__PURE__ */ n(function(e) {
	return e !== "LL" && e !== "RR" && e !== "TT" && e !== "BB";
}, "isValidArchitectureDirectionPair"), B = /* @__PURE__ */ n(function(e, t) {
	let n = `${e}${t}`;
	return z(n) ? n : void 0;
}, "getArchitectureDirectionPair"), te = /* @__PURE__ */ n(function([e, t], n) {
	let r = n[0], i = n[1];
	return F(r) ? I(i) ? [e + (r === "L" ? -1 : 1), t + (i === "T" ? 1 : -1)] : [e + (r === "L" ? -1 : 1), t] : F(i) ? [e + (i === "L" ? 1 : -1), t + (r === "T" ? 1 : -1)] : [e, t + (r === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), ne = /* @__PURE__ */ n(function(e) {
	return e === "LT" || e === "TL" ? [1, 1] : e === "BL" || e === "LB" ? [1, -1] : e === "BR" || e === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), V = /* @__PURE__ */ n(function(e, t) {
	return L(e, t) ? "bend" : F(e) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), re = /* @__PURE__ */ n(function(e) {
	return e.type === "service";
}, "isArchitectureService"), ie = /* @__PURE__ */ n(function(e) {
	return e.type === "junction";
}, "isArchitectureJunction"), H = /* @__PURE__ */ n((e) => e.data(), "edgeData"), U = /* @__PURE__ */ n((e) => e.data(), "nodeData"), W = d.architecture, ae = (A = class {
	constructor() {
		this.nodes = {}, this.groups = {}, this.edges = [], this.layoutHints = [], this.registeredIds = {}, this.elements = {}, this.diagramId = "", this.setAccTitle = c, this.getAccTitle = h, this.setDiagramTitle = s, this.getDiagramTitle = p, this.getAccDescription = f, this.setAccDescription = a, this.clear();
	}
	setDiagramId(e) {
		this.diagramId = e;
	}
	...
	clear() {
		this.nodes = {}, this.groups = {}, this.edges = [], this.layoutHints = [], this.registeredIds = {}, this.dataStructures = void 0, this.elements = {}, this.diagramId = "", l();
	}
	...
	addLayoutHint(e) {
		...
		e.members.forEach((n) => {
			if (this.registeredIds[n] !== "node") throw Error(`align ${e.direction} references [${n}], which is not a service or junction`);
	...
	getDataStructures() {
		if (this.dataStructures === void 0) {
			let e = {}, t = Object.entries(this.nodes).reduce((t, [n, r]) => (t[n] = r.edges.reduce((t, r) => {
				...
				return t;
			}, {}), t), {}), r = Object.keys(t)[0], i = { [r]: 1 }, a = Object.keys(t).reduce((e, t) => t === r ? e : {
				...e,
				[t]: 1
			}, {}), o = /* @__PURE__ */ n((e) => {
				let n = { [e]: [0, 0] }, r = [e];
...
}, n(A, "ArchitectureDB"), A), G = /* @__PURE__ */ n((e, t) => {
	var n;
	b(e, t), e.groups.map((e) => t.addGroup(e)), e.services.map((e) => t.addService({
		...
		...e,
		type: "junction"
	})), e.edges.map((e) => t.addEdge(e)), (n = e.alignments) == null || n.map((e) => t.addLayoutHint({
		direction: e.direction,
		members: [...e.members]
	}));
}, "populateDb"), K = {
	parser: { yy: void 0 },
	parse: /* @__PURE__ */ n(async (e) => {
		var t;
		let n = await x("architecture", e);
		r.debug(n);
		let i = (t = K.parser) == null ? void 0 : t.yy;
		if (!(i instanceof ae)) throw Error("parser.parser?.yy was not a ArchitectureDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		G(n, i);
	}, "parse")
}, oe = /* @__PURE__ */ n((e) => `
  .edge {
...
n(q, "withSeededRandom");
var J = /* @__PURE__ */ n((e) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${e}</g>`, "wrapIcon"), Y = {
...
}, se = /* @__PURE__ */ n(async function(e, t, n, r) {
	let i = n.getConfigField("padding"), a = n.getConfigField("iconSize"), o = a / 2, s = a / 6, c = s / 2;
	await Promise.all(t.edges().map(async (t) => {
		var a, l;
		let { source: u, sourceDir: d, sourceArrow: f, sourceGroup: p, target: h, targetDir: g, targetArrow: v, targetGroup: y, label: b } = H(t), { x, y: S } = t[0].sourceEndpoint(), { x: C, y: w } = t[0].midpoint(), { x: E, y: D } = t[0].targetEndpoint(), O = i + 4;
		if (p && (F(d) ? x += d === "L" ? -O : O : S += d === "T" ? -O : O + 18), y && (F(g) ? E += g === "L" ? -O : O : D += g === "T" ? -O : O + 18), !p && ((a = n.getNode(u)) == null ? void 0 : a.type) === "junction" && (F(d) ? x += d === "L" ? o : -o : S += d === "T" ? o : -o), !y && ((l = n.getNode(h)) == null ? void 0 : l.type) === "junction" && (F(g) ? E += g === "L" ? o : -o : D += g === "T" ? o : -o), t[0]._private.rscratch) {
			let t = e.insert("g");
			if (t.insert("path").attr("d", `M ${x},${S} L ${C},${w} L${E},${D} `).attr("class", "edge").attr("id", `${r}-${_(u, h, { prefix: "L" })}`), f) {
				let e = F(d) ? N[d](x, s) : x - c, n = I(d) ? N[d](S, s) : S - c;
				t.insert("polygon").attr("points", M[d](s)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (v) {
				let e = F(g) ? N[g](E, s) : E - c, n = I(g) ? N[g](D, s) : D - c;
				t.insert("polygon").attr("points", M[g](s)).attr("transform", `translate(${e},${n})`).attr("class", "arrow");
			}
			if (b) {
				let e = L(d, g) ? "XY" : F(d) ? "X" : "Y", n = 0;
				n = e === "X" ? Math.abs(x - E) : e === "Y" ? Math.abs(S - D) / 1.5 : Math.abs(x - E) / 2;
				let r = t.append("g");
				if (await T(r, b, {
					useHtmlLabels: !1,
					width: n,
					classes: "architecture-service-label"
				}, m()), r.attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle"), e === "X") r.attr("transform", "translate(" + C + ", " + w + ")");
...
}, "drawEdges"), X = /* @__PURE__ */ n(async function(e, t, n, r) {
...
}, "drawGroups"), ce = /* @__PURE__ */ n(async function(e, t, n, r) {
	let i = m();
	for (let o of n) {
		...
		let c = n.append("g");
		if (o.icon) c.html(`<g>${await w(o.icon, {
			height: s,
			width: s,
			fallbackPrefix: Y.prefix
		})}</g>`);
			...
			var a;
			c.html(`<g>${await w("blank", {
				height: s,
				width: s,
				fallbackPrefix: Y.prefix
			})}</g>`);
			let e = c.append("g").append("foreignObject").attr("width", s).attr("height", s).append("div").attr("class", "node-icon-text").attr("style", `height: ${s}px;`).append("div").html(g(o.iconText, i)), t = (a = parseInt(window.getComputedStyle(e.node(), null).getPropertyValue("font-size").replace(/\D/g, ""))) == null ? 16 : a;
	...
	return 0;
}, "drawServices"), le = /* @__PURE__ */ n(function(e, t, n, r) {
	n.forEach((n) => {
...
n(me, "addEdges");
function he(e, t, r, i = []) {
	let a = /* @__PURE__ */ n((e, t) => Object.entries(e).reduce((e, [n, i]) => {
		let a = 0, o = Object.entries(i);
		if (o.length === 1) return e[n] = o[0][1], e;
		for (let i = 0; i < o.length - 1; i++) for (let c = i + 1; c < o.length; c++) {
			var s;
			let [l, u] = o[i], [d, f] = o[c];
			if (((s = r[l]) == null ? void 0 : s[d]) === t) e[n] != null || (e[n] = []), e[n] = [
				...e[n],
				...u,
				...f
			];
			else if (l === "default" || d === "default") e[n] != null || (e[n] = []), e[n] = [
				...e[n],
				...u,
				...f
			];
		...
		return Object.entries(t).forEach(([t, [i, a]]) => {
			...
			n[a] != null || (n[a] = {}), (c = n[a])[u] != null || (c[u] = []), n[a][u].push(t), r[i] != null || (r[i] = {}), (l = r[i])[u] != null || (l[u] = []), r[i][u].push(t);
		}), {
			horiz: Object.values(a(n, "horizontal")).filter((e) => e.length > 1),
			vert: Object.values(a(r, "vertical")).filter((e) => e.length > 1)
		};
	}).reduce(([e, t], { horiz: n, vert: r }) => [[...e, ...n], [...t, ...r]], [[], []]), c = /* @__PURE__ */ new Set();
	i.forEach((e) => e.members.forEach((e) => c.add(e)));
	let l = /* @__PURE__ */ n((e) => e.filter((e) => !e.some((e) => c.has(e))), "dropOverlapping"), u = l(o), d = l(s);
	return i.forEach((e) => {
...
function ge(e, t, r = []) {
	...
	let l = /* @__PURE__ */ n((e) => `${e[0]},${e[1]}`, "posToStr"), u = /* @__PURE__ */ n((e) => e.split(",").map((e) => parseInt(e)), "strToPos");
	return e.forEach((e) => {
		let t = Object.fromEntries(Object.entries(e).map(([e, t]) => [l(t), e])), n = [l([0, 0])], r = {}, s = {
			L: [-1, 0],
			R: [1, 0],
			T: [0, 1],
			B: [0, -1]
...
n(ge, "getRelativeConstraints");
function _e(e, t, a, o, s, { spatialMaps: c, groupAlignments: l }) {
	return new Promise((u) => {
		...
		d.remove(), pe(a, f), ue(e, f, s), de(t, f, s), me(o, f);
		...
		x.one("layoutstop", () => {
			...
			n(e, "getSegmentWeights"), f.startBatch();
			for (let n of Object.values(f.edges())) {
				var t;
				if ((t = n.data) != null && t.call(n)) {
					let { x: t, y: r } = n.source().position(), { x: i, y: a } = n.target().position();
					if (t !== i && r !== a) {
						let t = n.sourceEndpoint(), r = n.targetEndpoint(), { sourceDir: i } = H(n), [a, o] = I(i) ? [t.x, r.y] : [r.x, t.y], { weights: s, distances: c } = e(t, r, a, o);
						n.style("segment-distances", c), n.style("segment-weights", s);
					}
				}
			}
			f.endBatch(), q(b, () => x.run());
		});
		try {
			q(b, () => x.run());
		} catch (e) {
...
n(_e, "layoutArchitecture");
var ve = {
	parser: K,
	get db() {
		return new ae();
	},
	renderer: { draw: /* @__PURE__ */ n(async (e, t, n, r) => {
		let i = r.db;
		i.setDiagramId(t);
		...
		let m = d.append("g");
		m.attr("class", "architecture-groups"), await ce(i, p, a, t), le(i, p, s, t);
		let h = await _e(a, s, c, l, i, u);
		await se(f, h, i, t), await X(m, h, i, t), fe(i, h), o(void 0, d, i.getConfigField("padding"), i.getConfigField("useMaxWidth"));
	}, "draw") },
	styles: oe
};
//#endregion
