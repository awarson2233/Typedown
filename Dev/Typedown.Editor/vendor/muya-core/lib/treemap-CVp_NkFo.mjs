...
function A(e, t, n, r, i, a) {
	for (var o = [], s = t.children, c, l, u = 0, d = 0, f = s.length, p, m, h = t.value, g, _, v, y, b, x, S; u < f;) {
		...
		}), c.dice ? D(c, n, r, i, h ? r += m * g / h : a) : O(c, n, r, h ? n += p * g / h : i, a), h -= g, u = d;
	}
	return o;
}
var j = (function e(t) {
...
function M() {
	var e = j, t = !1, n = 1, r = 1, i = [0], a = w, o = w, s = w, c = w, l = w;
	function u(e) {
		return e.x0 = e.y0 = 0, e.x1 = n, e.y1 = r, e.eachBefore(d), i = [0], t && e.eachBefore(E), e;
	}
	function d(t) {
	...
	return u.round = function(e) {
		...
		return arguments.length ? (o = typeof e == "function" ? e : T(+e), u) : o;
	}, u.paddingRight = function(e) {
		return arguments.length ? (s = typeof e == "function" ? e : T(+e), u) : s;
	}, u.paddingBottom = function(e) {
		return arguments.length ? (c = typeof e == "function" ? e : T(+e), u) : c;
	}, u.paddingLeft = function(e) {
		return arguments.length ? (l = typeof e == "function" ? e : T(+e), u) : l;
	}, u;
}
//#endregion
export { O as a, w as c, x as d, b as f, j as i, T as l, k as n, D as o, h as p, A as r, E as s, M as t, S as u };
