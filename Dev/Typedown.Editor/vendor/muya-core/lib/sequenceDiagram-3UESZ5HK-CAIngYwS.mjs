import { i as e, r as t, t as n } from "./src-6bhrijpo.mjs";
import { A as r, F as i, G as a, H as o, K as s, O as c, U as l, a as u, b as d, c as f, i as p, r as m, s as h, v as g, w as _, x as v, y, z as b } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { g as x, p as S } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as C } from "./dist-8HXMFWtc.mjs";
import { a as w, c as T, i as E, n as D, r as O, s as k } from "./chunk-ND2GUHAM-N7r7v8wk.mjs";
import { t as A } from "./chunk-QZHKN3VN-ttYuVMuw.mjs";
import { n as j, t as M } from "./chunk-XPW4576I-oigDzoPt.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/sequenceDiagram-3UESZ5HK.mjs
var N = C(), P, F = (function() {
	var e = /* @__PURE__ */ t(function(e, t, n, r) {
		...
		64,
		73
	], L = [1, 74], ee = [1, 80], te = [1, 81], R = [1, 82], ne = [1, 83], re = [1, 84], z = [1, 85], B = [1, 86], V = [1, 87], ie = [1, 88], H = [1, 89], U = [1, 90], ae = [1, 91], oe = [1, 92], se = [1, 93], ce = [1, 94], W = [1, 95], le = [1, 96], G = [1, 97], ue = [1, 98], de = [1, 99], fe = [1, 100], pe = [1, 101], me = [1, 102], he = [1, 103], ge = [1, 104], _e = [1, 105], ve = [2, 78], ye = [
		4,
		5,
		17,
		51,
	...
	return t(Ee, "Parser"), Ee.prototype = Te, Te.Parser = Ee, new Ee();
})();
F.parser = F;
var I = F, L = {
	SOLID: 0,
	...
	constructor() {
		...
		})), this.setAccTitle = l, this.setAccDescription = o, this.setDiagramTitle = s, this.getAccTitle = y, this.getAccDescription = g, this.getDiagramTitle = _, this.apply = this.apply.bind(this), this.parseBoxData = this.parseBoxData.bind(this), this.parseMessage = this.parseMessage.bind(this), this.clear(), this.setWrap(v().wrap), this.LINETYPE = L, this.ARROWTYPE = ee, this.PLACEMENT = te;
	}
	addBox(e) {
		var t;
		this.state.records.boxes.push({
			name: e.text,
			wrap: (t = e.wrap) == null ? this.autoWrap() : t,
			fill: e.color,
			actorKeys: []
	...
	addActor(e, t, n, r, i) {
		var a, o, s;
		let c = this.state.records.currentBox, l;
		if (i !== void 0) {
			let e;
			e = i.includes("\n") ? i + "\n" : "{\n" + i + "\n}", l = j(e, { schema: M });
		}
		r = (a = l == null ? void 0 : l.type) == null ? r : a, l != null && l.alias && (!n || n.text === t) && (n = {
			text: l.alias,
			wrap: n == null ? void 0 : n.wrap,
			type: r
		});
		let u = this.state.records.actors.get(e);
		if (u) {
			if (this.state.records.currentBox && u.box && this.state.records.currentBox !== u.box) throw Error(`A same participant should only be defined in one Box: ${u.name} can't be in '${u.box.name}' and in '${this.state.records.currentBox.name}' at the same time.`);
			if (c = u.box ? u.box : this.state.records.currentBox, u.box = c, u && t === u.name && n == null) return;
		}
		if ((n == null ? void 0 : n.text) == null && (n = {
			text: t,
			type: r
			...
			name: t,
			description: n.text,
			wrap: (o = n.wrap) == null ? this.autoWrap() : o,
			prevActor: this.state.records.prevActor,
			links: {},
			properties: {},
			actorCnt: null,
			rectData: null,
			type: (s = r) == null ? "participant" : s
	...
	addMessage(e, t, n, r) {
		...
		this.state.records.messages.push({
			...
			to: t,
			message: n.text,
			wrap: (i = n.wrap) == null ? this.autoWrap() : i,
			answer: r
		});
	}
	addSignal(e, t, n, r, i = !1, a) {
		var o, s;
		if (r === this.LINETYPE.ACTIVE_END && this.activationCount(e == null ? "" : e) < 1) {
		...
		return this.state.records.messages.push({
			...
			from: e,
			to: t,
			message: (o = n == null ? void 0 : n.text) == null ? "" : o,
			wrap: (s = n == null ? void 0 : n.wrap) == null ? this.autoWrap() : s,
			type: r,
			activate: i,
			centralConnection: a == null ? 0 : a
		}), !0;
	}
	hasAtLeastOneBox() {
	...
	autoWrap() {
		var e, t;
		return this.state.records.wrapEnabled === void 0 ? (e = (t = v().sequence) == null ? void 0 : t.wrap) == null ? !1 : e : this.state.records.wrapEnabled;
	}
	clear() {
		this.state.reset(), u();
	}
	...
	parseBoxData(e) {
		var t;
		let n = /^((?:rgba?|hsla?)\s*\(.*\)|\w*)(.*)$/.exec(e), r = n != null && n[1] ? n[1].trim() : "transparent", i = n != null && n[2] ? n[2].trim() : void 0;
		if ((t = window) != null && t.CSS) window.CSS.supports("color", r) || (r = "transparent", i = e.trim());
		else {
	...
	addNote(e, t, n) {
		...
		let a = {
			...
			placement: t,
			message: n.text,
			wrap: (r = n.wrap) == null ? this.autoWrap() : r
		}, o = [].concat(e, e);
...
}, t(P, "SequenceDB"), P), re = /* @__PURE__ */ t((e) => {
	var t, n;
	let r = (t = e.dropShadow) == null ? "none" : t, { look: i } = v();
	return `.actor {
    stroke: ${e.actorBorder};
    fill: ${e.actorBkg};
    stroke-width: ${(n = e.strokeWidth) == null ? 1 : n};
  }
...
`;
}, "getStyles"), z = 36, B = "actor-top", V = "actor-bottom", ie = "actor-box", H = "actor-man", U = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), ae = /* @__PURE__ */ t(function(e, t) {
	let n = w(e, t);
	return d().look === "neo" && n.attr("data-look", "neo"), n;
}, "drawRect"), oe = /* @__PURE__ */ t(function(e, t, n, r, i) {
	...
	if (f.attr("class", "actorPopupMenuPanel" + u), f.attr("x", s.x), f.attr("y", s.height), f.attr("fill", s.fill), f.attr("stroke", s.stroke), f.attr("width", d), f.attr("height", s.height), f.attr("rx", s.rx), f.attr("ry", s.ry), a != null) {
		...
		for (let e in a) {
			...
			m.attr("xlink:href", h), m.attr("target", "_blank"), Ne(r)(e, m, s.x + 10, s.height + p, d, 20, { class: "actor" }, r), p += 30;
		}
	}
	...
	return [r];
}, "drawKatex"), W = /* @__PURE__ */ t(function(e, n) {
	let r = 0, i = 0, a = n.text.split(h.lineBreakRegex), [o, s] = S(n.fontSize), c = [], l = 0, u = /* @__PURE__ */ t(() => n.y, "yfunc");
	...
	return c;
}, "drawText"), le = /* @__PURE__ */ t(function(e, n) {
	function r(e, t, n, r, i) {
		return e + "," + t + " " + (e + n) + "," + t + " " + (e + n) + "," + (t + r - i) + " " + (e + n - i * 1.2) + "," + (t + r) + " " + e + "," + (t + r);
	}
	t(r, "genPoints");
	let i = e.append("polygon");
	return i.attr("points", r(n.x, n.y, n.width, n.height, 7)), i.attr("class", "labelBox"), n.y += n.height / 2, W(e, n), i;
}, "drawLabel"), G = -1, ue = /* @__PURE__ */ t((e, t, n, r) => {
...
}, "fixLifeLineHeights"), de = /* @__PURE__ */ t(function(e, t, n, i, a) {
	var o, s, c;
	let l = i ? t.stopy : t.starty, u = t.x + t.width / 2, d = l + t.height, { look: f, theme: p, themeVariables: m } = n, { bkgColorArray: h, borderColorArray: g } = m, _ = e.append("g").lower();
	var v = _;
	i || (G++, Object.keys(t.links || {}).length && !n.forceMenus && v.attr("onclick", se(`actor${G}_popup`)).attr("cursor", "pointer"), v.append("line").attr("id", "actor" + G).attr("x1", u).attr("y1", d).attr("x2", u).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), v = _.append("g"), t.actorCnt = G, t.links != null && v.attr("id", "root-" + G), f === "neo" && v.attr("data-look", "neo"));
	let y = k();
	var b = "actor";
	(o = t.properties) != null && o.class ? b = t.properties.class : y.fill = "#eaeaea", i ? b += ` ${V}` : b += ` ${B}`, y.x = t.x, y.y = l, y.width = t.width, y.height = t.height, y.class = b, y.rx = 3, y.ry = 3, y.name = t.name, f === "neo" && (y.rx = 6, y.ry = 6);
	let x = ae(v, y), S = (s = a.get(t.name)) == null ? 0 : s;
	if (U.has(p) && (x.style("stroke", g[S % g.length]), x.style("fill", h[S % g.length])), f === "neo" && x.attr("filter", "url(#drop-shadow)"), t.rectData = y, (c = t.properties) != null && c.icon) {
		let e = t.properties.icon.trim();
		e.charAt(0) === "@" ? O(v, y.x + y.width - 20, y.y + 10, e.substr(1)) : E(v, y.x + y.width - 20, y.y + 10, e);
	}
	i || (v.attr("data-et", "participant"), v.attr("data-type", "participant"), v.attr("data-id", t.name)), J(n, r(t.description))(t.description, v, y.x, y.y, y.width, y.height, { class: `actor ${ie}` }, n);
	let C = t.height;
	if (x.node) {
		let e = x.node().getBBox();
		t.height = e.height, C = e.height;
	}
	return C;
}, "drawActorTypeParticipant"), fe = /* @__PURE__ */ t(function(e, t, n, i, a) {
	var o, s, c;
	let l = i ? t.stopy : t.starty, u = t.x + t.width / 2, d = l + t.height, { look: f, theme: p, themeVariables: m } = n, { bkgColorArray: h, borderColorArray: g } = m, _ = e.append("g").lower();
	var v = _;
	i || (G++, Object.keys(t.links || {}).length && !n.forceMenus && v.attr("onclick", se(`actor${G}_popup`)).attr("cursor", "pointer"), v.append("line").attr("id", "actor" + G).attr("x1", u).attr("y1", d).attr("x2", u).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), v = _.append("g"), t.actorCnt = G, t.links != null && v.attr("id", "root-" + G), f === "neo" && v.attr("data-look", "neo"));
	let y = k();
	var b = "actor";
	(o = t.properties) != null && o.class ? b = t.properties.class : y.fill = "#eaeaea", i ? b += ` ${V}` : b += ` ${B}`, y.x = t.x, y.y = l, y.width = t.width, y.height = t.height, y.class = b, y.name = t.name;
	let x = {
		...y,
		x: y.x + -6,
		y: y.y + 6,
	...
	t.rectData = y, f === "neo" && v.attr("filter", "url(#drop-shadow)");
	let w = (s = a.get(t.name)) == null ? 0 : s;
	if (U.has(p) && (S.style("stroke", g[w % g.length]), S.style("fill", h[w % g.length]), C.style("stroke", g[w % g.length]), C.style("fill", h[w % g.length])), (c = t.properties) != null && c.icon) {
		let e = t.properties.icon.trim();
		e.charAt(0) === "@" ? O(v, y.x + y.width - 20, y.y + 10, e.substr(1)) : E(v, y.x + y.width - 20, y.y + 10, e);
	}
	J(n, r(t.description))(t.description, v, y.x - 6, y.y + 6, y.width, y.height, { class: `actor ${ie}` }, n);
	let T = t.height;
	if (S.node) {
		let e = S.node().getBBox();
		t.height = e.height, T = e.height;
	}
	return i || (v.attr("data-et", "participant"), v.attr("data-type", "collections"), v.attr("data-id", t.name)), T;
}, "drawActorTypeCollections"), pe = /* @__PURE__ */ t(function(e, t, n, i, a) {
	var o, s, c;
	let l = i ? t.stopy : t.starty, u = t.x + t.width / 2, d = l + t.height, { look: f, theme: p, themeVariables: m } = n, { bkgColorArray: h, borderColorArray: g } = m, _ = e.append("g").lower(), v = _;
	i || (G++, Object.keys(t.links || {}).length && !n.forceMenus && v.attr("onclick", se(`actor${G}_popup`)).attr("cursor", "pointer"), v.append("line").attr("id", "actor" + G).attr("x1", u).attr("y1", d).attr("x2", u).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), v = _.append("g"), t.actorCnt = G, t.links != null && v.attr("id", "root-" + G), f === "neo" && v.attr("data-look", "neo"));
	let y = k(), b = "actor";
	(o = t.properties) != null && o.class ? b = t.properties.class : y.fill = "#eaeaea", i ? b += ` ${V}` : b += ` ${B}`, v.attr("class", b), y.x = t.x, y.y = l, y.width = t.width, y.height = t.height, y.name = t.name;
	let x = y.height / 2, S = x / (2.5 + y.height / 50), C = v.append("g"), w = v.append("g"), T = `M ${y.x},${y.y + x}
    a ${S},${x} 0 0 0 0,${y.height}
    h ${y.width - 2 * S}
    a ${S},${x} 0 0 0 0,-${y.height}
    Z
  `;
	C.append("path").attr("d", T), w.append("path").attr("d", `M ${y.x},${y.y + x}
      a ${S},${x} 0 0 0 0,${y.height}`), C.attr("transform", `translate(${S}, ${-(y.height / 2)})`), w.attr("transform", `translate(${y.width - S}, ${-y.height / 2})`), t.rectData = y, f === "neo" && C.attr("filter", "url(#drop-shadow)");
	let D = (s = a.get(t.name)) == null ? 0 : s;
	if (U.has(p) && (C.style("stroke", g[D % g.length]), C.style("fill", h[D % g.length]), w.style("stroke", g[D % g.length]), w.style("fill", h[D % g.length])), (c = t.properties) != null && c.icon) {
		let e = t.properties.icon.trim(), n = y.x + y.width - 20, r = y.y + 10;
		e.charAt(0) === "@" ? O(v, n, r, e.substr(1)) : E(v, n, r, e);
	}
	J(n, r(t.description))(t.description, v, y.x, y.y, y.width, y.height, { class: `actor ${ie}` }, n);
	let A = t.height, j = C.select("path:last-child");
	if (j.node()) {
		let e = j.node().getBBox();
		t.height = e.height, A = e.height;
	}
	return i || (v.attr("data-et", "participant"), v.attr("data-type", "queue"), v.attr("data-id", t.name)), A;
}, "drawActorTypeQueue"), me = /* @__PURE__ */ t(function(e, t, n, i, a, o) {
	var s, c, l;
	let u = i ? t.stopy : t.starty, d = t.x + t.width / 2, f = u + 75, { look: p, theme: m, themeVariables: h } = n, { bkgColorArray: g, borderColorArray: _, actorBorder: v, actorBkg: y } = h, b = e.append("g").lower();
	i || (G++, b.append("line").attr("id", "actor" + G).attr("x1", d).attr("y1", f).attr("x2", d).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = G);
	let x = e.append("g"), S = H;
	i ? S += ` ${V}` : S += ` ${B}`, x.attr("class", S), x.attr("name", t.name);
	let C = k();
	C.x = t.x, C.y = u, C.fill = "#eaeaea", C.width = t.width, C.height = t.height, C.class = "actor";
	let w = t.x + t.width / 2, T = u + 32;
	x.append("defs").append("marker").attr("id", a + "-filled-head-control").attr("refX", 11).attr("refY", 5.8).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "172.5").attr("stroke-width", 1.2).append("path").attr("d", "M 14.4 5.6 L 7.2 10.4 L 8.8 5.6 L 7.2 0.8 Z"), x.append("circle").attr("cx", w).attr("cy", T).attr("r", 22).attr("filter", `${p === "neo" ? "url(#drop-shadow)" : ""}`), x.append("line").attr("marker-end", "url(#" + a + "-filled-head-control)").attr("transform", `translate(${w}, ${T - 22})`);
	let E = (s = o.get(t.name)) == null ? 0 : s;
	return U.has(m) ? (x.style("stroke", _[E % _.length]), x.style("fill", g[E % _.length])) : (x.style("stroke", v), x.style("fill", y)), t.height = x.node().getBBox().height + 2 * ((c = n == null || (l = n.sequence) == null ? void 0 : l.labelBoxHeight) == null ? 0 : c), J(n, r(t.description))(t.description, x, C.x, C.y + 22 + (i ? 5 : 12), C.width, C.height, { class: `actor ${H}` }, n), i || (x.attr("data-et", "participant"), x.attr("data-type", "control"), x.attr("data-id", t.name)), t.height;
}, "drawActorTypeControl"), he = /* @__PURE__ */ t(function(e, t, n, i, a) {
	var o, s, c;
	let l = i ? t.stopy : t.starty, u = t.x + t.width / 2, d = l + 75, { look: f, theme: p, themeVariables: m } = n, { bkgColorArray: h, borderColorArray: g } = m, _ = e.append("g").lower(), v = e.append("g"), y = "actor";
	i ? y += ` ${V}` : y += ` ${B}`, v.attr("class", y), v.attr("name", t.name);
	let b = k();
	b.x = t.x, b.y = l, b.fill = "#eaeaea", b.width = t.width, b.height = t.height, b.class = "actor";
	let x = t.x + t.width / 2, S = l + (i ? 10 : 25);
	v.append("circle").attr("cx", x).attr("cy", S).attr("r", 22).attr("width", t.width).attr("height", t.height), v.append("line").attr("x1", x - 22).attr("x2", x + 22).attr("y1", S + 22).attr("y2", S + 22).attr("stroke-width", 2), f === "neo" && v.attr("filter", "url(#drop-shadow)");
	let C = (o = a.get(t.name)) == null ? 0 : o;
	return U.has(p) && (v.style("stroke", g[C % g.length]), v.style("fill", h[C % g.length])), t.height = v.node().getBBox().height + ((s = n == null || (c = n.sequence) == null ? void 0 : c.labelBoxHeight) == null ? 0 : s), i || (G++, _.append("line").attr("id", "actor" + G).attr("x1", u).attr("y1", d).attr("x2", u).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = G), J(n, r(t.description))(t.description, v, b.x, b.y + (i ? 15 : 30), b.width, b.height, { class: `actor ${H}` }, n), i ? v.attr("transform", "translate(0, 22)") : (v.attr("transform", `translate(0, ${22 / 2 - 5})`), v.attr("data-et", "participant"), v.attr("data-type", "entity"), v.attr("data-id", t.name)), t.height;
}, "drawActorTypeEntity"), ge = /* @__PURE__ */ t(function(e, t, n, i, a) {
	var o, s;
	let c = i ? t.stopy : t.starty, l = t.x + t.width / 2, u = c + t.height + 2 * n.boxTextMargin, { theme: d, themeVariables: f, look: p } = n, { bkgColorArray: m, borderColorArray: h, actorBorder: g } = f, _ = e.append("g").lower(), v = _;
	i || (G++, Object.keys(t.links || {}).length && !n.forceMenus && v.attr("onclick", se(`actor${G}_popup`)).attr("cursor", "pointer"), v.append("line").attr("id", "actor" + G).attr("x1", l).attr("y1", u).attr("x2", l).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), v = _.append("g"), t.actorCnt = G, t.links != null && v.attr("id", "root-" + G), p === "neo" && v.attr("data-look", "neo"));
	let y = k(), b = "actor";
	(o = t.properties) != null && o.class ? b = t.properties.class : y.fill = "#eaeaea", i ? b += ` ${V}` : b += ` ${B}`, y.x = t.x, y.y = c, y.width = t.width, y.height = t.height, y.class = b, y.name = t.name, y.x = t.x, y.y = c;
	let x = y.width / 3, S = y.width / 3, C = x / 2, w = C / (2.5 + x / 50), T = v.append("g");
	T.attr("class", b);
	let E = `
  M ${y.x},${y.y + w}
  a ${C},${w} 0 0 0 ${x},0
  ...
  l 0,-${S - 2 * w}
`;
	T.append("path").attr("d", E), p === "neo" && T.attr("filter", "url(#drop-shadow)");
	let D = (s = a.get(t.name)) == null ? 0 : s;
	U.has(d) ? (T.style("stroke", h[D % h.length]), T.style("fill", m[D % h.length])) : T.style("stroke", g), T.attr("transform", `translate(${x}, ${w})`), t.rectData = y, J(n, r(t.description))(t.description, v, y.x, y.y + 35, y.width, y.height, { class: `actor ${ie}` }, n);
	let O = T.select("path:last-child");
	if (O.node()) {
		var A;
		t.height = O.node().getBBox().height + ((A = n.sequence.labelBoxHeight) == null ? 0 : A);
	}
	return i || (v.attr("data-et", "participant"), v.attr("data-type", "database"), v.attr("data-id", t.name)), t.height;
}, "drawActorTypeDatabase"), _e = /* @__PURE__ */ t(function(e, t, n, i, a) {
	var o, s;
	let c = i ? t.stopy : t.starty, l = t.x + t.width / 2, u = c + 80, d = e.append("g").lower(), { look: f, theme: p, themeVariables: m } = n, { bkgColorArray: h, borderColorArray: g, actorBorder: _ } = m;
	i || (G++, d.append("line").attr("id", "actor" + G).attr("x1", l).attr("y1", u).attr("x2", l).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = G);
	let v = e.append("g"), y = H;
	i ? y += ` ${V}` : y += ` ${B}`, v.attr("class", y), v.attr("name", t.name);
	let b = k();
	b.x = t.x, b.y = c, b.fill = "#eaeaea", b.width = t.width, b.height = t.height, b.class = "actor", v.append("line").attr("id", "actor-man-torso" + G).attr("x1", t.x + t.width / 2 - 22 * 2.5).attr("y1", c + 12).attr("x2", t.x + t.width / 2 - 15).attr("y2", c + 12), v.append("line").attr("id", "actor-man-arms" + G).attr("x1", t.x + t.width / 2 - 22 * 2.5).attr("y1", c + 2).attr("x2", t.x + t.width / 2 - 22 * 2.5).attr("y2", c + 22), v.append("circle").attr("cx", t.x + t.width / 2).attr("cy", c + 12).attr("r", 22), f === "neo" && v.attr("filter", "url(#drop-shadow)");
	let x = (o = a.get(t.name)) == null ? 0 : o;
	return U.has(p) ? (v.style("stroke", g[x % g.length]), v.style("fill", h[x % g.length])) : v.style("stroke", _), t.height = v.node().getBBox().height + ((s = n.sequence.labelBoxHeight) == null ? 0 : s), J(n, r(t.description))(t.description, v, b.x, b.y + 15, b.width, b.height, { class: `actor ${H}` }, n), v.attr("transform", "translate(0,21)"), i || (v.attr("data-et", "participant"), v.attr("data-type", "boundary"), v.attr("data-id", t.name)), t.height;
}, "drawActorTypeBoundary"), ve = /* @__PURE__ */ t(function(e, t, n, i, a) {
	var o;
	let s = i ? t.stopy : t.starty, c = t.x + t.width / 2, l = s + 80, { look: u, theme: d, themeVariables: f } = n, { bkgColorArray: p, borderColorArray: m, actorBorder: h } = f, g = e.append("g").lower();
	i || (G++, g.append("line").attr("id", "actor" + G).attr("x1", c).attr("y1", l).attr("x2", c).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = G);
	let _ = e.append("g"), v = H;
	i ? v += ` ${V}` : v += ` ${B}`, _.attr("class", v), _.attr("name", t.name), i || _.attr("data-et", "participant").attr("data-type", "actor").attr("data-id", t.name);
	let y = u === "neo" ? .5 : 1, b = u === "neo" ? s + (1 - y) * 30 : s;
	_.append("line").attr("id", "actor-man-torso" + G).attr("x1", c).attr("y1", b + 25 * y).attr("x2", c).attr("y2", b + 45 * y), _.append("line").attr("id", "actor-man-arms" + G).attr("x1", c - z / 2 * y).attr("y1", b + 33 * y).attr("x2", c + z / 2 * y).attr("y2", b + 33 * y), _.append("line").attr("x1", c - z / 2 * y).attr("y1", b + 60 * y).attr("x2", c).attr("y2", b + 45 * y), _.append("line").attr("x1", c).attr("y1", b + 45 * y).attr("x2", c + (z / 2 - 2) * y).attr("y2", b + 60 * y);
	let x = _.append("circle");
	x.attr("cx", t.x + t.width / 2), x.attr("cy", b + 10 * y), x.attr("r", 15 * y), x.attr("width", t.width * y), x.attr("height", t.height * y), t.height = _.node().getBBox().height;
	let S = k();
	S.x = t.x, S.y = b, S.fill = "#eaeaea", S.width = t.width, S.height = t.height / y, S.class = "actor", S.rx = 3, S.ry = 3;
	let C = (o = a.get(t.name)) == null ? 0 : o;
	return U.has(d) ? (_.style("stroke", m[C % m.length]), _.style("fill", p[C % m.length])) : _.style("stroke", h), J(n, r(t.description))(t.description, _, S.x, b + 35 * y - (u === "neo" ? 10 : 0), S.width, S.height, { class: `actor ${H}` }, n), t.height;
}, "drawActorTypeActor"), ye = /* @__PURE__ */ t(async function(e, t, n, r, i, a, o) {
	let s = o == null ? new Map([...a.db.getActors().values()].map((e, t) => [e.name, t])) : o;
	switch (t.type) {
		case "actor": return await ve(e, t, n, r, s);
		case "participant": return await de(e, t, n, r, s);
		case "boundary": return await _e(e, t, n, r, s);
		case "control": return await me(e, t, n, r, i, s);
		case "entity": return await he(e, t, n, r, s);
		case "database": return await ge(e, t, n, r, s);
		case "collections": return await fe(e, t, n, r, s);
		case "queue": return await pe(e, t, n, r, s);
	}
}, "drawActor"), be = /* @__PURE__ */ t(function(e, t, n) {
	let r = e.append("g");
	we(r, t), t.name && J(n)(t.name, r, t.x, t.y + n.boxTextMargin + (t.textMaxHeight || 0) / 2, t.width, 0, { class: "text" }, n), r.lower();
}, "drawBox"), xe = /* @__PURE__ */ t(function(e) {
	return e.append("g");
}, "anchorElement"), Se = /* @__PURE__ */ t(function(e, t, n, r, i, a, o) {
	var s;
	let { theme: c, themeVariables: l } = r, { bkgColorArray: u, borderColorArray: d, mainBkg: f } = l, p = k(), m = t.anchored, h = t.actor;
	p.x = t.startx, p.y = t.starty, p.class = "activation" + i % 3, p.width = t.stopx - t.startx, p.height = n - t.starty;
	let g = ae(m, p), _ = (s = (o == null ? new Map([...a.db.getActors().values()].map((e, t) => [e.name, t])) : o).get(h)) == null ? 0 : s;
	if (U.has(c)) {
		var v;
		g.style("stroke", d[_ % d.length]), g.style("fill", (v = u[_ % d.length]) == null ? f : v);
	}
}, "drawActivation"), Ce = /* @__PURE__ */ t(async function(e, n, i, a, o) {
	...
	let g = T();
	g.text = i, g.x = n.startx, g.y = n.starty, g.fontFamily = d, g.fontSize = f, g.fontWeight = p, g.anchor = "middle", g.valign = "middle", g.tspan = !1, g.width = Math.max(u == null ? 0 : u, 50), g.height = l + (a.look === "neo" ? 15 : 0) || 20, g.textMargin = c, g.class = "labelText", le(m, g), g = je(), g.text = n.title, g.x = n.startx + u / 2 + (n.stopx - n.startx) / 2, g.y = n.starty + s + c, g.anchor = "middle", g.valign = "middle", g.textMargin = c, g.class = "loopText", g.fontFamily = d, g.fontSize = f, g.fontWeight = p, g.wrap = !0;
	let _ = r(g.text) ? await ce(m, g, n) : W(m, g);
	if (n.sectionTitles !== void 0) {
		for (let [e, t] of Object.entries(n.sectionTitles)) if (t.message) {
			g.text = t.message, g.x = n.startx + (n.stopx - n.startx) / 2, g.y = n.sections[e].y + s + c, g.class = "sectionTitle", g.anchor = "middle", g.valign = "middle", g.tspan = !1, g.fontFamily = d, g.fontSize = f, g.fontWeight = p, g.wrap = n.wrap, r(g.text) ? (n.starty = n.sections[e].y, await ce(m, g, n)) : W(m, g);
...
}, "drawLoop"), we = /* @__PURE__ */ t(function(e, t) {
	D(e, t);
}, "drawBackgroundRect"), K = /* @__PURE__ */ t(function(e, t) {
...
}, "insertComputerIcon"), Te = /* @__PURE__ */ t(function(e, t) {
...
}, "insertClockIcon"), Ee = /* @__PURE__ */ t(function(e, t) {
...
}, "insertArrowHead"), De = /* @__PURE__ */ t(function(e, t) {
...
}, "insertArrowFilledHead"), Oe = /* @__PURE__ */ t(function(e, t) {
...
}, "insertSequenceNumber"), ke = /* @__PURE__ */ t(function(e, t) {
...
}, "insertArrowCrossHead"), Ae = /* @__PURE__ */ t(function(e, t) {
	let { theme: n } = t;
...
}, "insertDropShadow"), je = /* @__PURE__ */ t(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), Me = /* @__PURE__ */ t(function() {
	return {
		x: 0,
		y: 0,
		fill: "#EDF2AE",
...
}, "getNoteRect"), J = /* @__PURE__ */ (function() {
	...
	insertArrowHead: Ee,
	insertArrowFilledHead: De,
	insertSequenceNumber: Oe,
	insertArrowCrossHead: ke,
	insertDatabaseIcon: K,
	...
	updateBounds: /* @__PURE__ */ t(function(e, n, r, i) {
		...
		function s(s) {
			return /* @__PURE__ */ t(function(t) {
				...
				a.updateVal(t, "starty", n - c * X.boxMargin, Math.min), a.updateVal(t, "stopy", i + c * X.boxMargin, Math.max), a.updateVal(Z.data, "startx", e - c * X.boxMargin, Math.min), a.updateVal(Z.data, "stopx", r + c * X.boxMargin, Math.max), s !== "activation" && (a.updateVal(t, "startx", e - c * X.boxMargin, Math.min), a.updateVal(t, "stopx", r + c * X.boxMargin, Math.max), a.updateVal(Z.data, "starty", n - c * X.boxMargin, Math.min), a.updateVal(Z.data, "stopy", i + c * X.boxMargin, Math.max));
			}, "updateItemBounds");
		}
	...
	insert: /* @__PURE__ */ t(function(e, t, n, r) {
		...
		this.updateVal(Z.data, "startx", i, Math.min), this.updateVal(Z.data, "starty", o, Math.min), this.updateVal(Z.data, "stopx", a, Math.max), this.updateVal(Z.data, "stopy", s, Math.max), this.updateBounds(i, o, a, s);
	}, "insert"),
	newActivation: /* @__PURE__ */ t(function(e, t, n) {
		let r = n.get(e.from), i = We(e.from).length || 0, a = r.x + r.width / 2 + (i - 1) * X.activationWidth / 2;
...
}, Pe = /* @__PURE__ */ t(async function(e, t, n) {
	Z.bumpVerticalPos(X.boxMargin), t.height = X.boxMargin, t.starty = Z.getVerticalPos();
	let i = k();
	i.x = t.startx, i.y = t.starty, i.width = t.width || X.width, i.class = "note";
	let a = e.append("g");
	a.attr("data-et", "note"), a.attr("data-id", "i" + n);
	let o = Y.drawRect(a, i), s = T();
	s.x = t.startx, s.y = t.starty, s.width = i.width, s.dy = "1em", s.text = t.message, s.class = "noteText", s.fontFamily = X.noteFontFamily, s.fontSize = X.noteFontSize, s.fontWeight = X.noteFontWeight, s.anchor = X.noteAlign, s.textMargin = X.noteMargin, s.valign = "center";
	let c = r(s.text) ? await ce(a, s) : W(a, s), l = Math.round(c.map((e) => (e._groups || e)[0][0].getBBox().height).reduce((e, t) => e + t));
	o.attr("height", l + 2 * X.noteMargin), t.height += l + 2 * X.noteMargin, Z.bumpVerticalPos(l + 2 * X.noteMargin), t.stopy = t.starty + l + 2 * X.noteMargin, t.stopx = t.startx + i.width, Z.insert(t.startx, t.starty, t.stopx, t.stopy), Z.models.addNote(t);
}, "drawNote"), Fe = /* @__PURE__ */ t(function(e, n, r, i, a, o, s) {
	let c = i.db.getActors(), l = c.get(n.from), u = c.get(n.to), d = r.sequenceVisible, f = l.x + l.width / 2, p = u.x + u.width / 2, m = f <= p, h = nt(n, i), g = e.append("g"), _ = /* @__PURE__ */ t((e, t) => {
		let n = e ? 16.5 : -16.5;
		return t ? -n : n;
	}, "getCircleOffset"), v = /* @__PURE__ */ t((e) => {
...
async function Re(e, t) {
	...
	let { startx: n, stopx: i, message: a } = t, o = h.splitBreaks(a).length, s = r(a), c = s ? await p(a, v()) : x.calculateTextDimensions(a, Q(X));
	if (!s) {
		let e = c.height / o;
	...
	if (n === i) {
		l = Z.getVerticalPos() + u, X.rightAngles || (u += X.boxMargin, l = Z.getVerticalPos() + u), u += 30;
		let e = h.getMax(d / 2, X.width / 2);
		Z.insert(n - e, Z.getVerticalPos() - 10 + u, i + e, Z.getVerticalPos() + 30 + u);
	} else u += X.boxMargin, l = Z.getVerticalPos() + u, Z.insert(n, l - 10, i, l);
	return Z.bumpVerticalPos(u), t.height += u, t.stopy = t.starty + t.height, Z.insert(t.fromBounds, t.starty, t.toBounds, t.stopy), l;
}
t(Re, "boundMessage");
var ze = /* @__PURE__ */ t(async function(e, t, n, i, a, o) {
	let { startx: s, stopx: l, starty: u, message: d, type: f, sequenceIndex: p, sequenceVisible: m } = t, g = x.calculateTextDimensions(d, Q(X)), _ = T();
	_.x = Math.min(s, l), _.y = u + 10, _.width = Math.abs(l - s), _.class = "messageText", _.dy = "1em", _.text = d, _.fontFamily = X.messageFontFamily, _.fontSize = X.messageFontSize, _.fontWeight = X.messageFontWeight, _.anchor = X.messageAlign, _.valign = "center", _.textMargin = X.wrapPadding, _.tspan = !1, r(_.text) ? await ce(e, _, {
		startx: s,
		stopx: l,
		starty: n
	}) : W(e, _);
	let v = g.width, y;
	if (s === l) {
		let r = m || X.showSequenceNumbers, o = nt(a, i), c = rt(a, i), u = s + (r && (o || c) ? 10 : 0);
		y = X.rightAngles ? e.append("path").attr("d", `M  ${u},${n} H ${s + h.getMax(X.width / 2, v / 2)} V ${n + 25} H ${s}`) : e.append("path").attr("d", "M " + u + "," + n + " C " + (u + 60) + "," + (n - 10) + " " + (s + 60) + "," + (n + 30) + " " + s + "," + (n + 20)), et(a, i) && Fe(e, a, t, i, s, l, n);
	} else y = e.append("line"), y.attr("x1", s), y.attr("y1", n), y.attr("x2", l), y.attr("y2", n), et(a, i) && Fe(e, a, t, i, s, l, n);
	...
	if (X.arrowMarkerAbsolute && (b = c(!0)), y.attr("stroke-width", 2), y.attr("stroke", "none"), y.style("fill", "none"), (f === i.db.LINETYPE.SOLID_TOP || f === i.db.LINETYPE.SOLID_TOP_DOTTED) && y.attr("marker-end", "url(" + b + "#" + o + "-solidTopArrowHead)"), (f === i.db.LINETYPE.SOLID_BOTTOM || f === i.db.LINETYPE.SOLID_BOTTOM_DOTTED) && y.attr("marker-end", "url(" + b + "#" + o + "-solidBottomArrowHead)"), (f === i.db.LINETYPE.STICK_TOP || f === i.db.LINETYPE.STICK_TOP_DOTTED) && y.attr("marker-end", "url(" + b + "#" + o + "-stickTopArrowHead)"), (f === i.db.LINETYPE.STICK_BOTTOM || f === i.db.LINETYPE.STICK_BOTTOM_DOTTED) && y.attr("marker-end", "url(" + b + "#" + o + "-stickBottomArrowHead)"), (f === i.db.LINETYPE.SOLID_ARROW_TOP_REVERSE || f === i.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) && y.attr("marker-start", "url(" + b + "#" + o + "-solidBottomArrowHead)"), (f === i.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE || f === i.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED) && y.attr("marker-start", "url(" + b + "#" + o + "-solidTopArrowHead)"), (f === i.db.LINETYPE.STICK_ARROW_TOP_REVERSE || f === i.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED) && y.attr("marker-start", "url(" + b + "#" + o + "-stickBottomArrowHead)"), (f === i.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE || f === i.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED) && y.attr("marker-start", "url(" + b + "#" + o + "-stickTopArrowHead)"), (f === i.db.LINETYPE.SOLID || f === i.db.LINETYPE.DOTTED) && y.attr("marker-end", "url(" + b + "#" + o + "-arrowhead)"), (f === i.db.LINETYPE.BIDIRECTIONAL_SOLID || f === i.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (y.attr("marker-start", "url(" + b + "#" + o + "-arrowhead)"), y.attr("marker-end", "url(" + b + "#" + o + "-arrowhead)")), (f === i.db.LINETYPE.SOLID_POINT || f === i.db.LINETYPE.DOTTED_POINT) && y.attr("marker-end", "url(" + b + "#" + o + "-filled-head)"), (f === i.db.LINETYPE.SOLID_CROSS || f === i.db.LINETYPE.DOTTED_CROSS) && y.attr("marker-end", "url(" + b + "#" + o + "-crosshead)"), m || X.showSequenceNumbers) {
		...
		r ? (s < l ? d = s + 12 : (d = s - 6 + (u ? -5 : 0), d += (a == null ? void 0 : a.centralConnection) === i.db.LINETYPE.CENTRAL_CONNECTION_DUAL || (a == null ? void 0 : a.centralConnection) === i.db.LINETYPE.CENTRAL_CONNECTION_REVERSE ? -7.5 : 0), y.attr("x1", d)) : c ? (l > s ? m = l - 12 : (m = l - 6, d += (a == null ? void 0 : a.centralConnection) === i.db.LINETYPE.CENTRAL_CONNECTION_DUAL || (a == null ? void 0 : a.centralConnection) === i.db.LINETYPE.CENTRAL_CONNECTION_REVERSE ? -7.5 : 0), m += u ? 15 : 0, y.attr("x2", m), y.attr("x1", d)) : y.attr("x1", s + 6);
		let h = 0, g = s === l, _ = s <= l;
...
}, "drawMessage"), Be = /* @__PURE__ */ t(function(e, t, n, r, i, a, o) {
	let s = 0, c = 0, l, u = 0;
	for (let e of r) {
		let r = t.get(e), a = r.box;
		l && l != a && (o || Z.models.addBox(l), c += X.boxMargin + l.margin), a && a != l && (o || (a.x = s + c, a.y = i), c += a.margin), r.width = h.getMax(r.width || X.width, X.width), r.height = h.getMax(r.height || X.height, X.height), r.margin = r.margin || X.actorMargin, u = h.getMax(u, r.height), n.get(r.name) && (c += r.width / 2), r.x = s + c, r.starty = Z.getVerticalPos(), Z.insert(r.x, i, r.x + r.width, r.height), s += r.width + c, r.box && (r.box.width = s + a.margin - r.box.x), c = r.margin, l = r.box, Z.models.addActor(r);
	}
	l && !o && Z.models.addBox(l), Z.bumpVerticalPos(u);
}, "addActorRenderingData"), Ve = /* @__PURE__ */ t(async function(e, t, n, r, i, a, o) {
	if (r) {
		let r = 0;
		Z.bumpVerticalPos(X.boxMargin * 2);
		for (let s of n) {
			let n = t.get(s);
			n.stopy || (n.stopy = Z.getVerticalPos());
			let c = await Y.drawActor(e, n, X, !0, i, a, o);
			r = h.getMax(r, c);
		}
		Z.bumpVerticalPos(r + X.boxMargin);
	} else for (let r of n) {
		let n = t.get(r);
		await Y.drawActor(e, n, X, !1, i, a, o);
	}
}, "drawActors"), He = /* @__PURE__ */ t(function(e, t, n, r) {
	let i = 0, a = 0;
	for (let o of n) {
		let n = t.get(o), s = Ye(n), c = Y.drawPopup(e, n, s, X, X.forceMenus, r);
...
}, "drawActorsPopup"), Ue = /* @__PURE__ */ t(function(e) {
	m(X, e), e.fontFamily && (X.actorFontFamily = X.noteFontFamily = X.messageFontFamily = e.fontFamily), e.fontSize && (X.actorFontSize = X.noteFontSize = X.messageFontSize = e.fontSize), e.fontWeight && (X.actorFontWeight = X.noteFontWeight = X.messageFontWeight = e.fontWeight);
}, "setConf"), We = /* @__PURE__ */ t(function(e) {
	return Z.activations.filter(function(t) {
		return t.actor === e;
	});
}, "actorActivations"), Ge = /* @__PURE__ */ t(function(e, t) {
...
function $(t, n, r, i, a) {
	...
	if (n.id && n.message && t[n.id]) {
		let r = t[n.id].width, a = Q(X);
		n.message = x.wrapLabel(`[${n.message}]`, r - 2 * X.wrapPadding, a), n.width = r, n.wrap = !0;
		let s = x.calculateTextDimensions(n.message, a), c = h.getMax(s.height, X.labelBoxHeight);
		o = i + c, e.debug(`${c} - ${n.message}`);
	}
	a(n), Z.bumpVerticalPos(o);
}
t($, "adjustLoopHeightForWrap");
function Ke(e, n, r, i, a, o, s) {
	function c(t, r) {
		t.x < a.get(e.from).x ? (Z.insert(n.stopx - r, n.starty, n.startx, n.stopy + t.height / 2 + X.noteMargin), n.stopx += r) : (Z.insert(n.startx, n.starty, n.stopx + r, n.stopy + t.height / 2 + X.noteMargin), n.stopx -= r);
	}
	t(c, "receiverAdjustment");
	function l(t, r) {
		t.x < a.get(e.to).x ? (Z.insert(n.startx - r, n.starty, n.stopx, n.stopy + t.height / 2 + X.noteMargin), n.startx += r) : (Z.insert(n.stopx, n.starty, n.startx + r, n.stopy + t.height / 2 + X.noteMargin), n.startx -= r);
	}
	...
	if (o.get(e.to) == i) {
		let t = a.get(e.to);
		c(t, u.includes(t.type) ? z / 2 + 3 : t.width / 2 + 3), t.starty = r - t.height / 2, Z.bumpVerticalPos(t.height / 2);
	} else if (s.get(e.from) == i) {
		let t = a.get(e.from);
		X.mirrorActors && l(t, u.includes(t.type) ? z / 2 : t.width / 2), t.stopy = r - t.height / 2, Z.bumpVerticalPos(t.height / 2);
	} else if (s.get(e.to) == i) {
		let t = a.get(e.to);
		X.mirrorActors && c(t, u.includes(t.type) ? z / 2 + 3 : t.width / 2 + 3), t.stopy = r - t.height / 2, Z.bumpVerticalPos(t.height / 2);
	}
}
t(Ke, "adjustCreatedDestroyedData");
var qe = /* @__PURE__ */ t(async function(r, i, a, o) {
	let { securityLevel: s, sequence: c, look: l } = v();
	X = c;
	let u;
	s === "sandbox" && (u = n("#i" + i));
	let d = n(s === "sandbox" ? u.nodes()[0].contentDocument.body : "body"), p = s === "sandbox" ? u.nodes()[0].contentDocument : document;
	Z.init(), e.debug(o.db);
	let m = s === "sandbox" ? d.select(`[id="${i}"]`) : n(`[id="${i}"]`), h = o.db.getActors(), g = o.db.getCreatedActors(), _ = o.db.getDestroyedActors(), y = o.db.getBoxes(), b = o.db.getActorKeys(), x = o.db.getMessages(), S = o.db.getDiagramTitle(), C = o.db.hasAtLeastOneBox(), w = o.db.hasAtLeastOneBoxWithTitle(), T = await Je(h, x, o);
	if (X.height = await Xe(h, T, y), Y.insertComputerIcon(m, i), Y.insertDatabaseIcon(m, i), Y.insertClockIcon(m, i), C && (Z.bumpVerticalPos(X.boxMargin), w && Z.bumpVerticalPos(y[0].textMaxHeight)), X.hideUnusedParticipants === !0) {
		let e = /* @__PURE__ */ new Set();
		x.forEach((t) => {
			e.add(t.from), e.add(t.to);
		}), b = b.filter((t) => e.has(t));
	}
	let E = new Map(b.map((e, t) => {
		var n, r;
		return [(n = (r = h.get(e)) == null ? void 0 : r.name) == null ? e : n, t];
	}));
	Be(m, h, g, b, 0, x, !1);
	let D = await at(x, h, T, o);
	Y.insertArrowHead(m, i), Y.insertArrowCrossHead(m, i), Y.insertArrowFilledHead(m, i), Y.insertSequenceNumber(m, i), Y.insertSolidTopArrowHead(m, i), Y.insertSolidBottomArrowHead(m, i), Y.insertStickTopArrowHead(m, i), Y.insertStickBottomArrowHead(m, i), l === "neo" && Y.insertDropShadow(m, X);
	function O(e, t) {
		let n = Z.endActivation(e);
		n.starty + 18 > t && (n.starty = t - 6, t += 12), Y.drawActivation(m, n, t, X, We(e.from).length, o, E), Z.insert(n.startx, t - 10, n.stopx, t);
	}
	t(O, "activeEnd");
	let k = 1, A = 1, j = [], M = [], N = 0;
	for (let t of x) {
		...
		switch (t.type) {
			case o.db.LINETYPE.NOTE:
				Z.resetVerticalPos(), r = t.noteModel, await Pe(m, r, t.id);
				break;
			case o.db.LINETYPE.ACTIVE_START:
				Z.newActivation(t, m, h);
				break;
			...
			case o.db.LINETYPE.ACTIVE_END:
				O(t, Z.getVerticalPos());
				break;
			case o.db.LINETYPE.LOOP_START:
				$(D, t, X.boxMargin, X.boxMargin + X.boxTextMargin, (e) => Z.newLoop(e));
				break;
			case o.db.LINETYPE.LOOP_END:
				n = Z.endLoop(), await Y.drawLoop(m, n, "loop", X, t), Z.bumpVerticalPos(n.stopy - Z.getVerticalPos()), Z.models.addLoop(n);
				break;
			case o.db.LINETYPE.RECT_START:
				$(D, t, X.boxMargin, X.boxMargin, (e) => Z.newLoop(void 0, e.message));
				break;
			case o.db.LINETYPE.RECT_END:
				n = Z.endLoop(), M.push(n), Z.models.addLoop(n), Z.bumpVerticalPos(n.stopy - Z.getVerticalPos());
				break;
			case o.db.LINETYPE.OPT_START:
				$(D, t, X.boxMargin, X.boxMargin + X.boxTextMargin, (e) => Z.newLoop(e));
				break;
			case o.db.LINETYPE.OPT_END:
				n = Z.endLoop(), await Y.drawLoop(m, n, "opt", X, t), Z.bumpVerticalPos(n.stopy - Z.getVerticalPos()), Z.models.addLoop(n);
				break;
			case o.db.LINETYPE.ALT_START:
				$(D, t, X.boxMargin, X.boxMargin + X.boxTextMargin, (e) => Z.newLoop(e));
				break;
			case o.db.LINETYPE.ALT_ELSE:
				$(D, t, X.boxMargin + X.boxTextMargin, X.boxMargin, (e) => Z.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.ALT_END:
				n = Z.endLoop(), await Y.drawLoop(m, n, "alt", X, t), Z.bumpVerticalPos(n.stopy - Z.getVerticalPos()), Z.models.addLoop(n);
				break;
			case o.db.LINETYPE.PAR_START:
			case o.db.LINETYPE.PAR_OVER_START:
				$(D, t, X.boxMargin, X.boxMargin + X.boxTextMargin, (e) => Z.newLoop(e)), Z.saveVerticalPos();
				break;
			case o.db.LINETYPE.PAR_AND:
				$(D, t, X.boxMargin + X.boxTextMargin, X.boxMargin, (e) => Z.addSectionToLoop(e));
				break;
			case o.db.LINETYPE.PAR_END:
				n = Z.endLoop(), await Y.drawLoop(m, n, "par", X, t), Z.bumpVerticalPos(n.stopy - Z.getVerticalPos()), Z.models.addLoop(n);
				break;
			case o.db.LINETYPE.AUTONUMBER:
				k = t.message.start || k, A = t.message.step || A, t.message.visible ? o.db.enableSequenceNumbers() : o.db.disableSequenceNumbers();
				break;
			...
			case o.db.LINETYPE.CRITICAL_END:
				n = Z.endLoop(), await Y.drawLoop(m, n, "critical", X, t), Z.bumpVerticalPos(n.stopy - Z.getVerticalPos()), Z.models.addLoop(n);
				break;
			case o.db.LINETYPE.BREAK_START:
				$(D, t, X.boxMargin, X.boxMargin + X.boxTextMargin, (e) => Z.newLoop(e));
				break;
			case o.db.LINETYPE.BREAK_END:
				n = Z.endLoop(), await Y.drawLoop(m, n, "break", X, t), Z.bumpVerticalPos(n.stopy - Z.getVerticalPos()), Z.models.addLoop(n);
				break;
			default: try {
				i = t.msgModel, i.starty = Z.getVerticalPos(), i.sequenceIndex = k, i.sequenceVisible = o.db.showSequenceNumbers(), i.id = t.id, i.from = t.from, i.to = t.to;
				let e = await Re(m, i);
				Ke(t, i, e, N, h, g, _), j.push({
					messageModel: i,
					lineStartY: e,
					msg: t
		...
		].includes(t.type) && (k = Math.round((k + A) * 100) / 100), N++;
	}
	e.debug("createdActors", g), e.debug("destroyedActors", _), await Ve(m, h, b, !1, i, o, E);
	for (let e of j) await ze(m, e.messageModel, e.lineStartY, o, e.msg, i);
	X.mirrorActors && await Ve(m, h, b, !0, i, o, E), M.forEach((e) => Y.drawBackgroundRect(m, e)), ue(m, h, b, X);
	for (let e of Z.models.boxes) {
		e.height = Z.getVerticalPos() - e.y, Z.insert(e.x, e.y, e.x + e.width, e.height);
		let t = X.boxMargin * 2;
		e.startx = e.x - t, e.starty = e.y - t * .25, e.stopx = e.startx + e.width + 2 * t, e.stopy = e.starty + e.height + t * .75, e.stroke = "rgb(0,0,0, 0.5)", Y.drawBox(m, e, X);
	}
	C && Z.bumpVerticalPos(X.boxMargin);
	let P = He(m, h, b, p), { bounds: F } = Z.getBounds();
	...
	let L = I + 2 * X.diagramMarginY;
	X.mirrorActors && (L = L - X.boxMargin + X.bottomMarginAdj);
	let ee = F.stopx - F.startx;
	ee < P.maxWidth && (ee = P.maxWidth);
	let te = ee + 2 * X.diagramMarginX;
	S && m.append("text").text(S).attr("x", (F.stopx - F.startx) / 2 - 2 * X.diagramMarginX).attr("y", -25), f(m, L, te, X.useMaxWidth);
	let R = S ? 40 : 0, ne = h.size && l === "neo" ? 30 : 0;
	m.attr("viewBox", F.startx - X.diagramMarginX + " -" + (X.diagramMarginY + R) + " " + te + " " + (L + R + ne)), e.debug("models:", Z.models);
}, "draw");
async function Je(t, n, i) {
	let a = {};
	for (let e of n) if (t.get(e.to) && t.get(e.from)) {
		let n = t.get(e.to);
		if (e.placement === i.db.PLACEMENT.LEFTOF && !n.prevActor || e.placement === i.db.PLACEMENT.RIGHTOF && !n.nextActor) continue;
		let o = e.placement !== void 0, s = !o, c = o ? Ie(X) : Q(X), l = e.wrap ? x.wrapLabel(e.message, X.width - 2 * X.wrapPadding, c) : e.message, u = (r(l) ? await p(e.message, v()) : x.calculateTextDimensions(l, c)).width + 2 * X.wrapPadding;
		s && e.from === n.nextActor ? a[e.to] = h.getMax(a[e.to] || 0, u) : s && e.from === n.prevActor ? a[e.from] = h.getMax(a[e.from] || 0, u) : s && e.from === e.to ? (a[e.from] = h.getMax(a[e.from] || 0, u / 2), a[e.to] = h.getMax(a[e.to] || 0, u / 2)) : e.placement === i.db.PLACEMENT.RIGHTOF ? a[e.from] = h.getMax(a[e.from] || 0, u) : e.placement === i.db.PLACEMENT.LEFTOF ? a[n.prevActor] = h.getMax(a[n.prevActor] || 0, u) : e.placement === i.db.PLACEMENT.OVER && (n.prevActor && (a[n.prevActor] = h.getMax(a[n.prevActor] || 0, u / 2)), n.nextActor && (a[e.from] = h.getMax(a[e.from] || 0, u / 2)));
	}
	return e.debug("maxMessageWidthPerActor:", a), a;
}
t(Je, "getMaxMessageWidthPerActor");
var Ye = /* @__PURE__ */ t(function(e) {
	let t = 0, n = Le(X);
	for (let r in e.links) {
		let e = x.calculateTextDimensions(r, n).width + 2 * X.wrapPadding + 2 * X.boxMargin;
		t < e && (t = e);
	}
	return t;
...
async function Xe(e, t, n) {
	...
	for (let t of e.keys()) {
		let n = e.get(t);
		n.wrap && (n.description = x.wrapLabel(n.description, X.width - 2 * X.wrapPadding, Le(X)));
		let a = r(n.description) ? await p(n.description, v()) : x.calculateTextDimensions(n.description, Le(X));
		n.width = n.wrap ? X.width : h.getMax(X.width, a.width + 2 * X.wrapPadding), n.height = n.wrap ? h.getMax(a.height, X.height) : X.height, i = h.getMax(i, n.height);
	}
	for (let n in t) {
		let r = e.get(n);
		if (!r) continue;
		...
		if (!i) {
			...
			r.margin = h.getMax(e, X.actorMargin);
			continue;
		}
		let a = t[n] + X.actorMargin - r.width / 2 - i.width / 2;
		r.margin = h.getMax(a, X.actorMargin);
	}
	let a = 0;
	return n.forEach((t) => {
		let n = Q(X), r = t.actorKeys.reduce((t, n) => t += e.get(n).width + (e.get(n).margin || 0), 0), i = X.boxMargin * 8;
		r += i, r -= 2 * X.boxTextMargin, t.wrap && (t.name = x.wrapLabel(t.name, r - 2 * X.wrapPadding, n));
		let o = x.calculateTextDimensions(t.name, n);
		a = h.getMax(o.height, a);
		let s = h.getMax(r, o.width + 2 * X.wrapPadding);
		if (t.margin = X.boxTextMargin, r < s) {
			let e = (s - r) / 2;
			t.margin += e;
		}
	}), n.forEach((e) => e.textMaxHeight = a), h.getMax(i, X.height);
}
t(Xe, "calculateActorMargins");
var Ze = /* @__PURE__ */ t(async function(t, n, i) {
	let a = n.get(t.from), o = n.get(t.to), s = a.x, c = o.x, l = t.wrap && t.message, u = r(t.message) ? await p(t.message, v()) : x.calculateTextDimensions(l ? x.wrapLabel(t.message, X.width, Ie(X)) : t.message, Ie(X)), d = {
		width: l ? X.width : h.getMax(X.width, u.width + 2 * X.noteMargin),
		height: 0,
		startx: a.x,
		stopx: 0,
		starty: 0,
	...
	return t.placement === i.db.PLACEMENT.RIGHTOF ? (d.width = l ? h.getMax(X.width, u.width) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * X.noteMargin), d.startx = s + (a.width + X.actorMargin) / 2) : t.placement === i.db.PLACEMENT.LEFTOF ? (d.width = l ? h.getMax(X.width, u.width + 2 * X.noteMargin) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * X.noteMargin), d.startx = s - d.width + (a.width - X.actorMargin) / 2) : t.to === t.from ? (u = x.calculateTextDimensions(l ? x.wrapLabel(t.message, h.getMax(X.width, a.width), Ie(X)) : t.message, Ie(X)), d.width = l ? h.getMax(X.width, a.width) : h.getMax(a.width, X.width, u.width + 2 * X.noteMargin), d.startx = s + (a.width - d.width) / 2) : (d.width = Math.abs(s + a.width / 2 - (c + o.width / 2)) + X.actorMargin, d.startx = s < c ? s + a.width / 2 - X.actorMargin / 2 : c + o.width / 2 - X.actorMargin / 2), l && (d.message = x.wrapLabel(t.message, d.width - 2 * X.wrapPadding, Ie(X))), e.debug(`NM:[${d.startx},${d.stopx},${d.starty},${d.stopy}:${d.width},${d.height}=${t.message}]`), d;
}, "buildNoteModel"), Qe = 4, $e = 6, et = /* @__PURE__ */ t(function(e, t) {
...
}, "hasCentralConnection"), tt = /* @__PURE__ */ t(function(e, t, n) {
...
}, "calculateCentralConnectionOffset"), nt = /* @__PURE__ */ t(function(e, t) {
...
}, "isReverseArrowType"), rt = /* @__PURE__ */ t(function(e, t) {
	let { BIDIRECTIONAL_SOLID: n, BIDIRECTIONAL_DOTTED: r } = t.db.LINETYPE;
	return [n, r].includes(e.type);
}, "isBidirectionalArrowType"), it = /* @__PURE__ */ t(function(e, n, r) {
	let { look: i } = v();
	if (![
	...
	let [a, o] = Ge(e.from, n), [s, c] = Ge(e.to, n), l = a <= s, u = l ? o : a, d = l ? s : c;
	i === "neo" && (e.type !== r.db.LINETYPE.SOLID_OPEN && (d += l ? -3 : 3), (e.type === r.db.LINETYPE.BIDIRECTIONAL_SOLID || e.type === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) && (u += l ? 3 : -3)), u += tt(e, r, l);
	let f = Math.abs(s - c) > 2, p = /* @__PURE__ */ t((e) => l ? -e : e, "adjustValue");
	e.from === e.to ? d = u : (e.activate && !f && (d += p(X.activationWidth / 2 - 1)), [
		r.db.LINETYPE.SOLID_OPEN,
		r.db.LINETYPE.DOTTED_OPEN,
		r.db.LINETYPE.STICK_TOP,
		r.db.LINETYPE.STICK_BOTTOM,
	...
	e.wrap && e.message && (e.message = x.wrapLabel(e.message, h.getMax(g + 2 * X.wrapPadding, X.width), Q(X)));
	let _ = x.calculateTextDimensions(e.message, Q(X));
	return {
		width: h.getMax(e.wrap ? 0 : _.width + 2 * X.wrapPadding, g + 2 * X.wrapPadding, X.width),
		height: 0,
		startx: u,
		stopx: d,
		starty: 0,
...
}, "buildMessageModel"), at = /* @__PURE__ */ t(async function(t, n, r, i) {
	let a = {}, o = [], s, c, l;
	for (let e of t) {
		switch (e.type) {
			...
			case i.db.LINETYPE.ACTIVE_START:
				{
					let t = n.get(e.from ? e.from : e.to.actor), r = We(e.from ? e.from : e.to.actor).length, i = t.x + t.width / 2 + (r - 1) * X.activationWidth / 2, a = {
						startx: i,
			...
			case i.db.LINETYPE.ACTIVE_END:
				{
					let t = Z.activations.map((e) => e.actor).lastIndexOf(e.from);
					Z.activations.splice(t, 1).splice(0, 1);
				}
				break;
		}
		e.placement === void 0 ? (l = it(e, n, i), e.msgModel = l, l.startx && l.stopx && o.length > 0 && o.forEach((t) => {
			if (s = t, l.startx === l.stopx) {
				let t = n.get(e.from), r = n.get(e.to);
				s.from = h.getMin(t.x - l.width / 2, t.x - t.width / 2, s.from), s.to = h.getMax(r.x + l.width / 2, r.x + t.width / 2, s.to), s.width = h.getMax(s.width, Math.abs(s.to - s.from)) - X.labelBoxWidth;
			} else s.from = h.getMin(l.startx, s.from), s.to = h.getMax(l.stopx, s.to), s.width = h.getMax(s.width, l.width) - X.labelBoxWidth;
		})) : (c = await Ze(e, n, i), e.noteModel = c, o.forEach((e) => {
			s = e, s.from = h.getMin(s.from, c.startx), s.to = h.getMax(s.to, c.startx + c.width), s.width = h.getMax(s.width, Math.abs(s.from - s.to)) - X.labelBoxWidth;
		}));
	}
	return Z.activations = [], e.debug("Loop type widths:", a), a;
