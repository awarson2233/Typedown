...
import { R as r, h as i, p as a, r as o, s } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { _ as c, a as l, c as u, d, f, g as ee, h as te, i as ne, l as re, m as ie, n as ae, o as oe, p as se, r as ce, s as le, t as ue, u as de, v as fe } from "./step-BfRmncvF.mjs";
import { t as pe } from "./dist-Bowt_KoK.mjs";
...
var Ie = pe(), H, Le = {
	...
	curveStepAfter: ue,
	curveStepBefore: ae
}, Re = /\s*(?:(\w+)(?=:):|(\w+))\s*(?:(\w+)|((?:(?!}%{2}).|\r?\n)*))?\s*(?:}%{2})?/gi, ze = /* @__PURE__ */ e(function(e, t) {
...
}, "detectInit"), Be = /* @__PURE__ */ e(function(e, n = null) {
	try {
		let o = RegExp(`[%]{2}(?![{]${Re.source})(?=[}][%]{2}).*
`, "ig");
		e = e.trim().replace(o, "").replace(/'/gm, "\""), t.debug(`Detecting diagram directive${n === null ? "" : " type:" + n} based on the text:${e}`);
		let s, c = [];
		for (; (s = i.exec(e)) !== null;) {
			var r, a;
...
}, "detectDirective"), Ve = /* @__PURE__ */ e(function(e) {
	return e.replace(i, "");
}, "removeDirectives"), He = /* @__PURE__ */ e(function(e, t) {
...
e(Ke, "calcLabelPosition");
var qe = /* @__PURE__ */ e((e, t = 2) => {
	let n = 10 ** t;
...
}, "calculatePoint"), Je = /* @__PURE__ */ e((e, n, r) => {
...
e(Ye, "calcTerminalLabelPosition");
function K(e) {
	let t = "", n = "";
...
var Xe = 0, Ze = /* @__PURE__ */ e(() => (Xe++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + Xe), "generateId");
function Qe(e) {
	let t = "";
...
e(Qe, "makeRandomHex");
var $e = /* @__PURE__ */ e((e) => Qe(e.length), "random"), et = /* @__PURE__ */ e(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), tt = /* @__PURE__ */ e(function(e, t) {
...
}, e(H, "InitIDGenerator"), H), X, at = /* @__PURE__ */ e(function(e) {
...
e(ot, "isDetailedError");
var st = /* @__PURE__ */ e((e, t, n, r) => {
	var i;
	if (!r) return;
...
}, "encodeEntities"), ut = /* @__PURE__ */ e(function(e) {
	return e.replace(/ﬂ°°/g, "&#").replace(/ﬂ°/g, "&").replace(/¶ß/g, ";");
}, "decodeEntities"), dt = /* @__PURE__ */ e((e, t, { counter: n = 0, prefix: r, suffix: i }, a) => a || `${r ? `${r}_` : ""}${e}_${t}_${n}${i ? `_${i}` : ""}`, "getEdgeId");
function ft(e) {
	return e == null ? null : e;
}
e(ft, "handleUndefinedAttr");
function $(e, t) {
