...
import { H as i, K as a, M as o, U as s, a as c, s as l, v as u, w as d, x as f, y as p, z as m } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { c as h, g } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as _ } from "./chunk-FMBD7UC4-DiPYrba8.mjs";
import { t as v } from "./chunk-ND2GUHAM-N7r7v8wk.mjs";
import { t as y } from "./chunk-55IACEB6-DWxyqrIq.mjs";
import { t as b } from "./chunk-2J33WTMH-5W4hnvSY.mjs";
import { r as x, t as S } from "./chunk-LZXEDZCA-CElJAnI4.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/chunk-727SXJPM.mjs
var C, w, T = (function() {
...
var E = T, D = [
...
}, n(C, "ClassMember"), C), k = "classId-", A = 0, j = /* @__PURE__ */ n((e) => l.sanitizeText(e, f()), "sanitizeText"), M = (w = class o {
	constructor() {
		this.relations = [], this.classes = /* @__PURE__ */ new Map(), this.styleClasses = /* @__PURE__ */ new Map(), this.notes = /* @__PURE__ */ new Map(), this.interfaces = [], this.namespaces = /* @__PURE__ */ new Map(), this.namespaceCounter = 0, this.namespaceStack = [], this.diagramId = "", this.functions = [], this.lineType = {
			...
			DEPENDENCY: 3,
			LOLLIPOP: 4
		}, this.setupToolTips = /* @__PURE__ */ n((t) => {
			let n = v();
	...
	setTooltip(e, t) {
		e.split(",").forEach((e) => {
			t !== void 0 && (this.classes.get(e).tooltip = j(t));
		});
	}
	getTooltip(e, t) {
	...
	setLink(e, t, n) {
		...
		e.split(",").forEach((e) => {
			...
			a && (a.link = g.formatUrl(t, r), r.securityLevel === "sandbox" ? a.linkTarget = "_top" : typeof n == "string" ? a.linkTarget = j(n) : a.linkTarget = "_blank");
	...
	linkParentChild(e, t) {
		...
		!n || !r || (n.children.has(t) || n.children.set(t, r), r.parent != null || (r.parent = e));
	}
	addNamespace(e, t) {
	...
	getData() {
		var e, t;
		let n = [], r = [], i = f(), a = (e = (t = i.class) == null ? void 0 : t.hierarchicalNamespaces) == null ? !0 : e;
		for (let e of this.namespaces.values()) {
			var o;
			if (!a && !e.explicit) continue;
			let t = {
				id: e.id,
				label: a ? e.label : e.id,
				isGroup: !0,
				padding: (o = i.class.padding) == null ? 16 : o,
				shape: "rect",
				cssStyles: [],
				look: i.look,
				parentId: a ? e.parent : void 0
			};
			n.push(t);
		}
		for (let e of this.classes.values()) {
			let t = a ? e.parent : this.resolveExplicitAncestor(e.parent), r = {
				...e,
				type: void 0,
				isGroup: !1,
				parentId: t,
		...
		for (let e of this.notes.values()) {
			var s, c;
			let t = a ? e.parent : this.resolveExplicitAncestor(e.parent), o = {
				id: e.id,
				label: e.text,
				isGroup: !1,
				shape: "note",
				padding: (s = i.class.padding) == null ? 6 : s,
				cssStyles: [
					"text-align: left",
					"white-space: nowrap",
			...
			n.push(o);
			let l = (c = this.classes.get(e.class)) == null ? void 0 : c.id;
			if (l) {
				let t = {
					id: `edgeNote${e.index}`,
					start: e.id,
...
}, n(w, "ClassDB"), w), N = /* @__PURE__ */ n((e) => `g.classGroup text {
...
`, "getStyles"), P = {
	...
	draw: /* @__PURE__ */ n(async function(e, n, r, i) {
		...
		let { securityLevel: s, state: c, layout: l } = f();
		i.db.setDiagramId(n);
		let u = i.db.getData(), d = y(n, s);
		u.type = i.type, u.layoutAlgorithm = S(l), u.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, u.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, u.markers = [
			"aggregation",
			"extension",
			"composition",
			"dependency",
			"lollipop"
		], u.diagramId = n, await x(u, d), g.insertTitle(d, "classDiagramTitleText", (a = c == null ? void 0 : c.titleTopMargin) == null ? 25 : a, i.db.getDiagramTitle()), b(d, 8, "classDiagram", (o = c == null ? void 0 : c.useMaxWidth) == null ? !0 : o);
	}, "draw"),
