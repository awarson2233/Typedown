import { C as e, S as t, n, o as r, t as i, u as a, v as o, w as s, x as c } from "./chunk-KEIR6QF5-lXp_uFT8.mjs";
//#region node_modules/@mermaid-js/parser/dist/chunks/mermaid-parser.core/chunk-CQNSW5MT.mjs
var l, u, d = (l = class extends n {
...
}, c(l, "TreeViewValueConverter"), l), f = (u = class extends i {
	constructor() {
		super(["treeView-beta"]);
	}
}, c(u, "TreeViewTokenBuilder"), u), p = { parser: {
	TokenBuilder: /* @__PURE__ */ c(() => new f(), "TokenBuilder"),
	ValueConverter: /* @__PURE__ */ c(() => new d(), "ValueConverter")
} };
function m(n = r) {
	let i = s(e(n), a), c = s(t({ shared: i }), o, p);
	return i.ServiceRegistry.register(c), {
		shared: i,
		TreeView: c
	};
}
c(m, "createTreeViewServices");
//#endregion
