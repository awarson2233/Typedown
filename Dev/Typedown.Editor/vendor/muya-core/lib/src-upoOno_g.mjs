...
import { E as r, a as i, i as a, n as o, o as s, r as c, s as l, t as u, u as d, y as f } from "./timer-o3x2CEnf.mjs";
...
}, "setLogLevel"), v = /* @__PURE__ */ n((e) => `%c${(0, m.default)().format("ss.SSS")} : ${e} : `, "format"), y = {
...
function b(e) {
	var t = e += "", n = t.indexOf(":");
	return n >= 0 && (t = e.slice(0, n)) !== "xmlns" && (e = e.slice(n + 1)), y.hasOwnProperty(t) ? {
		space: y[t],
		local: e
	} : e;
}
...
function se(e) {
	return this.select(e == null ? oe : ae(typeof e == "function" ? e : k(e)));
}
//#endregion
...
function de(e) {
	return this.selectAll(e == null ? le : ue(typeof e == "function" ? e : k(e)));
}
//#endregion
...
function me() {
	return new z(this._enter || this._groups.map(pe), this._parents);
}
function A(e, t) {
...
function xe() {
	return new z(this._exit || this._groups.map(pe), this._parents);
}
//#endregion
...
function Ue(e, t, n) {
	return arguments.length > 1 ? this.each((t == null ? Be : typeof t == "function" ? He : Ve)(e, t, n == null ? "" : n)) : M(this.node(), e);
}
function M(e, t) {
...
function ft(e, t) {
	var n = typeof e == "function" ? e : C(e), r = t == null ? dt : typeof t == "function" ? t : T(t);
	return this.select(function() {
...
function B() {
	return new z([[document.documentElement]], Ot);
}
function kt() {
	return this;
}
...
function At(e) {
	return typeof e == "string" ? new z([[document.querySelector(e)]], [document.documentElement]) : new z([[e]], Ot);
}
//#endregion
...
var jt = r("start", "end", "cancel", "interrupt"), Mt = [];
...
function Nt(e, t, n) {
	...
	function o(a) {
		...
		for (c in r) if (f = r[c], f.name === n.name) {
			if (f.state === 3) return V(o);
			f.state === 4 ? (f.state = 6, f.timer.stop(), f.on.call("interrupt", e, e.__data__, f.index, f.group), delete r[c]) : +c < t && (f.state = 6, f.timer.stop(), f.on.call("cancel", e, e.__data__, f.index, f.group), delete r[c]);
		}
		if (V(function() {
			n.state === 3 && (n.state = 4, n.timer.restart(s, n.delay, n.time), s(a));
		}), n.state = 2, n.on.call("start", e, e.__data__, n.index, n.group), n.state === 2) {
			for (n.state = 3, i = Array(d = n.tween.length), c = 0, u = -1; c < d; ++c) (f = n.tween[c].value.call(e, e.__data__, n.index, n.group)) && (i[++u] = f);
			i.length = u + 1;
		}
	}
	function s(t) {
...
function Rt(e, t) {
	...
	return this.each((t == null ? It : Lt)(n, e, t));
}
function K(e, t, n) {
	var r = e._id;
...
function q(e, t) {
	var n;
	return (typeof t == "number" ? l : t instanceof f ? d : (n = f(t)) ? (t = n, d) : s)(e, t);
}
//#endregion
...
function Gt(e, t) {
	var n = b(e), r = n === "transform" ? i : q;
	return this.attrTween(e, typeof t == "function" ? (n.local ? Wt : Ut)(n, r, K(this, "attr." + e, t)) : t == null ? (n.local ? Bt : zt)(n) : (n.local ? Ht : Vt)(n, r, t));
}
//#endregion
...
function Xt(e, t) {
	...
	var r = b(e);
	return this.tween(n, (r.local ? Jt : Yt)(r, t));
}
//#endregion
...
function $t(e) {
	var t = this._id;
	return arguments.length ? this.each((typeof e == "function" ? Zt : Qt)(t, e)) : G(this.node(), t).delay;
}
//#endregion
...
function nn(e) {
	var t = this._id;
	return arguments.length ? this.each((typeof e == "function" ? en : tn)(t, e)) : G(this.node(), t).duration;
}
//#endregion
...
function an(e) {
	var t = this._id;
	return arguments.length ? this.each(rn(t, e)) : G(this.node(), t).ease;
}
//#endregion
...
function sn(e) {
	...
	return this.each(on(this._id, e));
}
//#endregion
...
function fn(e, t) {
	var n = this._id;
	return arguments.length < 2 ? G(this.node(), n).on.on(e) : this.each(dn(n, e, t));
}
//#endregion
...
function mn() {
	return this.on("end.remove", pn(this._id));
}
//#endregion
...
var _n = B.prototype.constructor;
function vn() {
...
function Cn(e, t, n) {
	var r = (e += "") == "transform" ? a : q;
	return t == null ? this.styleTween(e, yn(e, r)).on("end.style." + e, J(e)) : typeof t == "function" ? this.styleTween(e, xn(e, r, K(this, "style." + e, t))).each(Sn(this._id, e)) : this.styleTween(e, bn(e, r, t), n).on("end.style." + e, null);
}
//#endregion
...
function En(e, t, n) {
	...
	if (typeof t != "function") throw Error();
	return this.tween(r, Tn(e, t, n == null ? "" : n));
}
//#endregion
...
function kn(e) {
	return this.tween("text", typeof e == "function" ? On(K(this, "text", e)) : Dn(e == null ? "" : e + ""));
}
//#endregion
...
function Bn(e) {
	var t, n;
	e instanceof Y ? (t = e._id, e = e._name) : (t = X(), (n = Rn).time = o(), e = e == null ? null : e + "");
	for (var r = this._groups, i = r.length, a = 0; a < i; ++a) for (var s = r[a], c = s.length, l, u = 0; u < c; ++u) (l = s[u]) && H(l, e, t, u, s, n || zn(l, t));
	return new Y(r, this._parents, e, t);
}
B.prototype.interrupt = Ft, B.prototype.transition = Bn;
//#endregion
//#region node_modules/d3-brush/src/brush.js
var { abs: Vn, max: Hn, min: Un } = Math;
["w", "e"].map(Q), ["n", "s"].map(Q), [
	"n",
	"w",
	"e",
...
var Wn = new $(1, 0, 0);
Gn.prototype = $.prototype;
function Gn(e) {
	for (; !e.__zoom;) if (!(e = e.parentNode)) return Wn;
	return e.__zoom;
}
//#endregion
export { p as i, g as n, _ as r, At as t };
