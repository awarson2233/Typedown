...
import { H as i, K as a, M as o, U as s, a as c, s as l, v as u, w as d, x as f, y as p, z as m } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { c as h, g } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as _ } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import { t as v } from "./chunk-32BRIVSS-Dezidi9z.mjs";
import { t as y } from "./chunk-XXDRQBXY-6qvi-T3x.mjs";
import { t as b } from "./chunk-VR4S4FIN-HQ9uQ67o.mjs";
import { r as x, t as S } from "./chunk-FWX5IMBZ-Dx6oqe1x.mjs";
...
var E = T, D = [
...
}, t(C, "ClassMember"), C), k = "classId-", A = 0, j = /* @__PURE__ */ t((e) => l.sanitizeText(e, f()), "sanitizeText"), M = (w = class o {
	constructor() {
	...
	getData() {
		var e, t;
		let n = [], r = [], i = f(), a = (e = (t = i.class) == null ? void 0 : t.hierarchicalNamespaces) == null || e;
...
}, t(w, "ClassDB"), w), N = /* @__PURE__ */ t((e) => `g.classGroup text {
...
`, "getStyles"), P = {
	...
	draw: /* @__PURE__ */ t(async function(e, t, r, i) {
		...
		u.type = i.type, u.layoutAlgorithm = S(l), u.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, u.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, u.markers = [
			...
			"dependency",
			"lollipop"
		], u.diagramId = t, await x(u, d), g.insertTitle(d, "classDiagramTitleText", (a = c == null ? void 0 : c.titleTopMargin) == null ? 25 : a, i.db.getDiagramTitle()), b(d, 8, "classDiagram", (o = c == null ? void 0 : c.useMaxWidth) == null || o);
	}, "draw"),
