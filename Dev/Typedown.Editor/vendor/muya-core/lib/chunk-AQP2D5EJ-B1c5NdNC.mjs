...
import { H as n, K as r, U as i, a, s as o, v as s, w as c, x as l, y as u } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { g as d, s as f } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as p } from "./chunk-55IACEB6-DWxyqrIq.mjs";
import { t as m } from "./chunk-2J33WTMH-5W4hnvSY.mjs";
import { r as h } from "./chunk-LZXEDZCA-CElJAnI4.mjs";
...
var v = _, y = "TB", b = "TB", x = "dir", S = "state", C = "root", w = "relation", T = "classDef", E = "style", D = "applyClass", O = "default", k = "divider", A = "fill:none", j = "fill: #333", M = "c", N = "markdown", P = "normal", F = "rect", I = "rectWithTitle", ee = "stateStart", te = "stateEnd", L = "divider", R = "roundedWithTitle", ne = "note", re = "noteGroup", z = "statediagram", ie = `${z}-state`, B = "transition", ae = "note", oe = `${B} note-edge`, se = `${z}-${ae}`, ce = `${z}-cluster`, le = `${z}-cluster-alt`, V = "parent", H = "note", ue = "state", U = "----", de = `${U}${H}`, W = `${U}${V}`, G = /* @__PURE__ */ t((e, t = b) => {
	...
	draw: /* @__PURE__ */ t(async function(t, n, r, i) {
		...
		let { securityLevel: s, state: c, layout: u } = l();
		i.db.extract(i.db.getRootDocV2());
		let f = i.db.getData(), g = p(n, s);
		f.type = i.type, f.layoutAlgorithm = u, f.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, f.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, l().look === "neo" ? f.markers = ["barbNeo"] : f.markers = ["barb"], f.diagramId = n, await h(f, g);
		try {
			(typeof i.db.getLinks == "function" ? i.db.getLinks() : /* @__PURE__ */ new Map()).forEach((t, n) => {
				var r;
				let i = typeof n == "string" ? n : typeof (n == null ? void 0 : n.id) == "string" ? n.id : "";
				if (!i) {
					e.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(n));
					return;
				}
				let a = (r = g.node()) == null ? void 0 : r.querySelectorAll("g"), o;
				if (a == null || a.forEach((e) => {
					var t;
					((t = e.textContent) == null ? void 0 : t.trim()) === i && (o = e);
				}), !o) {
					e.warn("⚠️ Could not find node matching text:", i);
					return;
				}
				let s = o.parentNode;
				if (!s) {
					e.warn("⚠️ Node has no parent, cannot wrap:", i);
					return;
				}
				let c = document.createElementNS("http://www.w3.org/2000/svg", "a"), l = t.url.replace(/^"+|"+$/g, "");
				if (c.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", l), c.setAttribute("target", "_blank"), t.tooltip) {
					let e = t.tooltip.replace(/^"+|"+$/g, "");
					c.setAttribute("title", e);
				}
				s.replaceChild(c, o), c.appendChild(o), e.info("🔗 Wrapped node in <a> tag for:", i, t.url);
			});
		} catch (t) {
			e.error("❌ Error injecting clickable links:", t);
		}
		d.insertTitle(g, "statediagramTitleText", (a = c == null ? void 0 : c.titleTopMargin) == null ? 25 : a, i.db.getDiagramTitle()), m(g, 8, z, (o = c == null ? void 0 : c.useMaxWidth) == null ? !0 : o);
	}, "draw"),
	getDir: G
}, K = /* @__PURE__ */ new Map(), q = 0;
function J(e = "", t = 0, n = "", r = U) {
	return `${ue}-${e}${n !== null && n.length > 0 ? `${r}${n}` : ""}-${t}`;
}
t(J, "stateDomId");
var pe = /* @__PURE__ */ t((t, n, r, i, a, s, c, u) => {
	e.trace("items", n), n.forEach((e) => {
		switch (e.stmt) {
			...
			case w:
				{
					var n;
					Z(t, e.state1, r, i, a, s, c, u), Z(t, e.state2, r, i, a, s, c, u);
					let d = c === "neo", f = {
						id: "edge" + q,
						start: e.state1.id,
						end: e.state2.id,
						arrowhead: "normal",
						arrowTypeEnd: d ? "arrow_barb_neo" : "arrow_barb",
						style: A,
						labelStyle: "",
						label: o.sanitizeText((n = e.description) == null ? "" : n, l()),
						arrowheadStyle: j,
						labelpos: M,
						labelType: N,
						thickness: P,
...
t(X, "insertOrUpdateNode");
function me(e) {
	var t, n;
	return (t = e == null || (n = e.classes) == null ? void 0 : n.join(" ")) == null ? "" : t;
}
t(me, "getClassesFromDbInfo");
function he(e) {
	var t;
	return (t = e == null ? void 0 : e.styles) == null ? [] : t;
}
t(he, "getStylesFromDbInfo");
var Z = /* @__PURE__ */ t((t, n, r, i, a, s, c, u) => {
	let d = n.id, f = r.get(d), p = me(f), m = he(f), h = l();
	if (e.info("dataFetcher parsedItem", n, f, m), d !== "root") {
		var g;
		let r = F;
		n.start === !0 ? r = ee : n.start === !1 && (r = te), n.type !== O && (r = n.type), K.get(d) || K.set(d, {
			id: d,
			shape: r,
		...
		let l = K.get(d);
		if (n.description) {
			if (Array.isArray(l.description)) l.shape = I, l.description.push(n.description);
			else {
				var _;
				(_ = l.description) != null && _.length && l.description.length > 0 ? (l.shape = I, l.description === d ? l.description = [n.description] : l.description = [l.description, n.description]) : (l.shape = F, l.description = n.description);
			}
			l.description = o.sanitizeTextOrArray(l.description, h);
		}
		((g = l.description) == null ? void 0 : g.length) === 1 && l.shape === I && (l.type === "group" ? l.shape = R : l.shape = F), !l.type && n.doc && (e.info("Setting cluster for XCX", d, Y(n)), l.type = "group", l.isGroup = !0, l.dir = Y(n), l.shape = n.type === k ? L : R, l.cssClasses = `${l.cssClasses} ${ce} ${s ? le : ""}`);
		let f = {
			labelStyle: "",
			shape: l.shape,
			label: l.description,
		...
		if (f.shape === L && (f.label = ""), t && t.id !== "root" && (e.trace("Setting node ", d, " to be child of its parent ", t.id), f.parentId = t.id), f.centerLabel = !0, n.note) {
			var v;
			let e = {
				labelStyle: "",
				shape: ne,
			...
			q++, r.id = t, e.parentId = t, X(i, r, u), X(i, e, u), X(i, f, u);
			let o = d, s = e.id;
	...
	n.doc && (e.trace("Adding nodes children "), pe(n, n.doc, r, i, a, !s, c, u));
	...
	BG_FILL: "bgFill",
	STYLECLASS_SEP: ","
}, _e = /* @__PURE__ */ t(() => /* @__PURE__ */ new Map(), "newClassesList"), ve = /* @__PURE__ */ t(() => ({
	relations: [],
	states: /* @__PURE__ */ new Map(),
	documents: {}
}), "newDoc"), $ = /* @__PURE__ */ t((e) => JSON.parse(JSON.stringify(e)), "clone"), ye = (g = class {
	constructor(e) {
		this.version = e, this.nodes = [], this.edges = [], this.rootDoc = [], this.classes = _e(), this.documents = { root: ve() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.dividerCnt = 0, this.links = /* @__PURE__ */ new Map(), this.getAccTitle = u, this.setAccTitle = i, this.getAccDescription = s, this.setAccDescription = n, this.setDiagramTitle = r, this.getDiagramTitle = c, this.clear(), this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this);
	}
	extract(e) {
		this.clear(!0);
		...
		ge(), Z(void 0, this.getRootDocV2(), t, this.nodes, this.edges, !0, n.look, this.classes);
	...
	docTranslator(e, t, n) {
		...
		if (t.stmt === S && (t.id === Q.START_NODE ? (t.id = e.id + (n ? "_start" : "_end"), t.start = n) : t.id = t.id.trim()), t.stmt !== C && t.stmt !== S || !t.doc) return;
		let r = [], i = [];
		for (let e of t.doc) if (e.type === k) {
			let t = $(e);
			t.doc = $(i), r.push(t), i = [];
		} else i.push(e);
	...
	addState(t, n = O, r = void 0, i = void 0, a = void 0, s = void 0, c = void 0, u = void 0) {
		let d = t == null ? void 0 : t.trim();
		...
		s && (e.info("Setting state classes", d, s), (Array.isArray(s) ? s : [s]).forEach((e) => this.setCssClass(d, e.trim()))), c && (e.info("Setting state styles", d, c), (Array.isArray(c) ? c : [c]).forEach((e) => this.setStyle(d, e.trim()))), u && (e.info("Setting state styles", d, c), (Array.isArray(u) ? u : [u]).forEach((e) => this.setTextStyle(d, e.trim())));
	}
	clear(e) {
		this.nodes = [], this.edges = [], this.documents = { root: ve() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = _e(), e || (this.links = /* @__PURE__ */ new Map(), a());
	}
	getState(e) {
	...
	addDescription(e, t) {
		...
		r == null || (n = r.descriptions) == null || n.push(o.sanitizeText(i, l()));
	}
	cleanupLabel(e) {
	...
	getDirectionStatement() {
		return this.rootDoc.find((e) => e.stmt === x);
	}
	getDirection() {
		var e, t;
		return (e = (t = this.getDirectionStatement()) == null ? void 0 : t.value) == null ? y : e;
	}
	setDirection(e) {
...
//#endregion
export { be as i, v as n, fe as r, ye as t };
