...
import { D as n, H as r, K as i, U as a, a as o, b as s, c, f as l, v as u, w as d, y as f, z as p } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { t as m } from "./linear-CUX0sJcW.mjs";
import { n as h } from "./ordinal-CW5ORdHW.mjs";
import { t as g } from "./range-DO8C-LUz.mjs";
import { v as _ } from "./step-DTZmJhUX.mjs";
import { n as v } from "./init-ZY92GAe7.mjs";
import { i as y } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as b } from "./chunk-WU5MYG2G-CWOh8Nru.mjs";
import { t as x } from "./chunk-O5CBEL6O-DN64hWSU.mjs";
...
//#endregion
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/xychartDiagram-2RQKCTM6.mjs
...
var ce = (O = class {
	...
	getDrawableElement() {
		...
		return t = this.orientation === "horizontal" ? _().y((e) => e[0]).x((e) => e[1])(e) : _().x((e) => e[0]).y((e) => e[1])(e), t ? [{
...
var De = {
	...
	renderer: { draw: /* @__PURE__ */ t((n, r, i, a) => {
		...
		for (let e of _) {
			...
			let n = y(e.groupTexts);
			switch (e.type) {
				case "rect":
					if (n.selectAll("rect").data(e.data).enter().append("rect").attr("x", (e) => e.x).attr("y", (e) => e.y).attr("width", (e) => e.width).attr("height", (e) => e.height).attr("fill", (e) => e.fill).attr("stroke", (e) => e.strokeFill).attr("stroke-width", (e) => e.strokeWidth), l.showDataLabel) {
