...
import { IContentCursor, IRenderCursor } from '../../selection/types';
...
declare class Format extends Content {
    ...
    checkNeedRender(cursor?: IRenderCursor): boolean;
    blurHandler(): void;
    /**
    ...
    protected convertToParagraph(force?: boolean): void;
    backspaceHandler(event: Event): void;
    private _scanBackspaceTokens;
    private _caretOffsetOnInlineImage;
    private _isTrailingInlineImage;
    private _selectInlineImage;
    deleteHandler(event: KeyboardEvent): void;
    protected shiftEnterHandler(event: Event): void;
    enterHandler(event: KeyboardEvent): void;
    getFormatsInRange(cursor?: IContentCursor | null): {
        formats: (import('../../inlineRenderer/types').ImageToken | import('../../inlineRenderer/types').BeginRuleToken | import('../../inlineRenderer/types').ReferenceDefinitionToken | TextToken | import('../../inlineRenderer/types').BacklashToken | import('../../inlineRenderer/types').StrongEmToken | CodeEmojiMathToken | import('../../inlineRenderer/types').DelToken | import('../../inlineRenderer/types').SuperSubScriptToken | import('../../inlineRenderer/types').FootnoteIdentifierToken | import('../../inlineRenderer/types').LinkToken | import('../../inlineRenderer/types').ReferenceLinkToken | import('../../inlineRenderer/types').ReferenceImageToken | import('../../inlineRenderer/types').HTMLEscapeToken | import('../../inlineRenderer/types').AutoLinkExtensionToken | import('../../inlineRenderer/types').AutoLinkToken | import('../../inlineRenderer/types').HTMLTagToken | import('../../inlineRenderer/types').SoftLineBreakToken | import('../../inlineRenderer/types').HardLineBreakToken | import('../../inlineRenderer/types').TailHeaderToken)[];
        tokens: Token[];
        neighbors: (import('../../inlineRenderer/types').ImageToken | import('../../inlineRenderer/types').BeginRuleToken | import('../../inlineRenderer/types').ReferenceDefinitionToken | TextToken | import('../../inlineRenderer/types').BacklashToken | import('../../inlineRenderer/types').StrongEmToken | CodeEmojiMathToken | import('../../inlineRenderer/types').DelToken | import('../../inlineRenderer/types').SuperSubScriptToken | import('../../inlineRenderer/types').FootnoteIdentifierToken | import('../../inlineRenderer/types').LinkToken | import('../../inlineRenderer/types').ReferenceLinkToken | import('../../inlineRenderer/types').ReferenceImageToken | import('../../inlineRenderer/types').HTMLEscapeToken | import('../../inlineRenderer/types').AutoLinkExtensionToken | import('../../inlineRenderer/types').AutoLinkToken | import('../../inlineRenderer/types').HTMLTagToken | import('../../inlineRenderer/types').SoftLineBreakToken | import('../../inlineRenderer/types').HardLineBreakToken | import('../../inlineRenderer/types').TailHeaderToken)[];
    };
