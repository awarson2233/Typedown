...
export type Token = BeginRuleToken | ReferenceDefinitionToken | TextToken | BacklashToken | StrongEmToken | CodeEmojiMathToken | DelToken | SuperSubScriptToken | FootnoteIdentifierToken | ImageToken | LinkToken | ReferenceLinkToken | ReferenceImageToken | HTMLEscapeToken | AutoLinkExtensionToken | AutoLinkToken | HTMLTagToken | SoftLineBreakToken | HardLineBreakToken | TailHeaderToken;
