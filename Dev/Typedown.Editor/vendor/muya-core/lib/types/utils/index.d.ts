...
export declare function firstWordOfInfo(info: string): string;
/**
...
export declare function throttle<TArgs extends unknown[], TReturn>(func: (...args: TArgs) => TReturn, wait?: number): (...args: TArgs) => TReturn | undefined;
...
export declare function hasPick(c: {
    p?: number;
    r?: unknown;
} | null | undefined): boolean;
export declare function getDefer<T>(): IDefer<T>;
export declare function methodMixins(...objects: Record<string, (...args: never[]) => unknown>[]): (constructor: Constructor) => void;
...
export declare function isClipboardEvent(event: Event): event is ClipboardEvent;
...
export declare function isHTMLAnchorElement(value: unknown): value is HTMLAnchorElement;
export {};
