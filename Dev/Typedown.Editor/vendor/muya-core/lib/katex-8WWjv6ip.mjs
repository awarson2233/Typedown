...
var Se = class {
	...
	toNode() {
		...
		return this.italic > 0 && (t = document.createElement("span"), t.style.marginRight = k(this.italic)), this.classes.length > 0 && (t = t || document.createElement("span"), t.className = Ee(this.classes)), Object.keys(this.style).length > 0 && (t = t || document.createElement("span"), Object.assign(t.style, this.style)), t ? (t.appendChild(e), t) : e;
	}
	toMarkup() {
		var e = !1, t = "<span";
...
var on = function(e) {
	...
	return fn(i, (e, t) => {
		...
		var n, r, i = hn(t), a = hn(e), o = i && a ? e.hasClass("mtight") ? (n = en[i]) == null ? void 0 : n[a] : (r = $t[i]) == null ? void 0 : r[a] : null;
		if (o) return Kt(o, c);
	}, { node: u }, d, f), i;
...
var Zn = (e) => {
	...
	if (o) {
		var l, u;
		s = (l = (u = Zn(a)) == null ? void 0 : u.skew) == null ? 0 : l;
	}
	var d = r.label === "\\c", f = d ? a.height + a.depth : Math.min(a.height, t.fontMetrics().xHeight), p;
	if (r.isStretchy) p = Wn(r, t), p = G({
		...
		var m, h;
		r.label === "\\vec" ? (m = Xt("vec", t), h = Yt.vec[1]) : (m = It({
			type: "textord",
			mode: r.mode,
			text: r.label
		}, t, "textord"), m = Be(m), m.italic = 0, h = m.width, d && (f += m.depth)), p = W(["accent-body"], [m]);
		var g = r.label === "\\textcircled";
		g && (p.classes.push("accent-full"), f = a.height);
		var _ = s;
		g || (_ -= h / 2), p.style.left = k(_), r.label === "\\textcircled" && (p.style.top = ".2em"), p = G({
			positionType: "firstBaseline",
			children: [
				{
					type: "elem",
...
var ui = function(t, n) {
	...
	for (i = 0, ae = 0; i < s || ae < ne.length; ++i, ++ae) {
		for (var ue, de = ne[ae], fe = !0; ((pe = de) == null ? void 0 : pe.type) === "separator";) {
			var pe;
			if (fe || (ie = W(["arraycolsep"], []), ie.style.width = k(n.fontMetrics().doubleRuleSep), re.push(ie)), de.separator === "|" || de.separator === ":") {
				var me = de.separator === "|" ? "solid" : "dashed", he = W(["vertical-separator"], [], n);
				he.style.height = k(v), he.style.borderRightWidth = k(u), he.style.borderRightStyle = me, he.style.margin = "0 " + k(-u / 2);
				var ge = v - te;
				ge && (he.style.verticalAlign = k(-ge)), re.push(he);
		...
		if (!(i >= s)) {
			...
			if (i > 0 || t.hskipBeforeAndAfter) {
				var ve, ye;
				_e = (ve = (ye = de) == null ? void 0 : ye.pregap) == null ? f : ve, _e !== 0 && (ie = W(["arraycolsep"], []), ie.style.width = k(_e), re.push(ie));
			}
			var be = [];
			for (r = 0; r < a; ++r) {
				var xe = c[r], Se = xe.cells[i];
				if (Se) {
					var Ce = xe.pos - te;
			...
			var we = G({
				positionType: "individualShift",
				children: be
			}), Te = W(["col-align-" + (((ue = de) == null ? void 0 : ue.align) || "c")], [we]);
			if (re.push(Te), i < s - 1 || t.hskipBeforeAndAfter) {
				var Ee, De;
				_e = (Ee = (De = de) == null ? void 0 : De.postgap) == null ? f : Ee, _e !== 0 && (ie = W(["arraycolsep"], []), ie.style.width = k(_e), re.push(ie));
			}
		}
	}
	var Oe = W(["mtable"], re);
	if (l.length > 0) {
		for (var ke = Vt("hline", n, u), Ae = Vt("hdashline", n, u), je = [{
			type: "elem",
			elem: Oe,
			shift: 0
		}]; l.length > 0;) {
			var Me = l.pop(), Ne = Me.pos - te;
			Me.isDashed ? je.push({
				type: "elem",
				elem: Ae,
				shift: Ne
	...
	if (oe.length === 0) return W(["mord"], [Oe], n);
	var Pe = W(["tag"], [G({
		positionType: "individualShift",
		children: oe
	})], n);
	...
	if (e.cols && e.cols.length > 0) {
		...
		for (var v = g; v < _; v++) {
			var y = p[v];
			y.type === "align" ? (f += di[y.align], h && (m += "none "), h = !0) : y.type === "separator" && h && (m += y.separator === "|" ? "solid " : "dashed ", h = !1);
		}
...
var Ei = (e, t, n, r, i, a, o) => {
	...
	var g = 0, _ = 0;
	if ((c instanceof Ie || a.name === "\\oiint" || a.name === "\\oiiint") && !a.suppressBaseShift) {
		var v;
		g = (c.height - c.depth) / 2 - t.fontMetrics().axisHeight, _ = (v = c.italic) == null ? 0 : v;
	}
	return i ? Ei(c, n, r, t, o, _, g) : (g && (c.style.position = "relative", c.style.top = k(g)), c);
}, ki = (e, t) => {
	var n;
...
an({
	...
	htmlBuilder(e, t) {
		...
		if (l) {
			...
			if (o instanceof Ie || b) {
				var x;
				y = k(-((x = o.italic) == null ? 0 : x));
			}
		}
		var S;
		if (s && l) {
			d = Math.max(d, g, s.depth + .25 * u.xHeight), f = Math.max(f, u.sub2);
			var C = 4 * u.defaultRuleThickness;
			if (d - s.depth - (l.height - f) < C) {
				f = C - (d - s.depth) + l.height;
				var w = .8 * u.xHeight - (d - s.depth);
				w > 0 && (d += w, f -= w);
			}
			S = G({
				positionType: "individualShift",
		...
		} else if (l) f = Math.max(f, u.sub1, l.height - .8 * u.xHeight), S = G({
			positionType: "shift",
			positionData: f,
			children: [{
				type: "elem",
		...
		else if (s) d = Math.max(d, g, s.depth + .25 * u.xHeight), S = G({
			positionType: "shift",
			positionData: -d,
			children: [{
				type: "elem",
		...
		return W([hn(o, "right") || "mord"], [o, W(["msupsub"], [S])], t);
	},
	mathmlBuilder(e, t) {
		var n = !1, r, i;
