import { T as e } from "./chunk-KEIR6QF5-lXp_uFT8.mjs";
import { n as t } from "./chunk-Y2CYZVJY-i11wjrBe.mjs";
import { n, t as r } from "./src-upoOno_g.mjs";
import { H as i, K as a, U as o, Y as s, a as c, b as l, f as u, v as d, w as f, x as p, y as m, z as h } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { _ as g, i as _, t as ee } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as te } from "./chunk-JWPE2WC7-PoIEzJPT.mjs";
import { n as ne } from "./mermaid-parser.core-Dnt89Q92.mjs";
//#region node_modules/mermaid/dist/chunks/mermaid.core/diagram-FQU43EPY.mjs
var v = "position frame", y = "frame positioned", b = "position relation", x = "relation positioned", re = /* @__PURE__ */ t(function(e) {
	n.debug("options str", e);
}, "setOptions"), ie = /* @__PURE__ */ t(function() {
	return {};
}, "getOptions"), ae = /* @__PURE__ */ t(function() {
	oe(), c();
}, "clear");
function oe() {
	S = {};
...
t(oe, "reset");
var se = u.eventmodeling, ce = /* @__PURE__ */ t(() => _({
	...se,
	...l().eventmodeling
}), "getConfig"), S = {};
function C() {
	...
	switch (e.modelEntityType) {
		...
		case "command":
			...
			return {
				...
				stroke: (u = t.emCommandStroke) == null ? "#679ac3" : u
			};
		case "evt":
		case "event":
			var d, f;
...
t(M, "calculateEntityVisualProps");
function N(e, t, r) {
	var i;
	let a = l(), o = h((i = O(e.entityIdentifier)) == null ? "" : i, a), s, c = {
		fontSize: 16,
		fontWeight: 700,
		fontFamily: "\"trebuchet ms\", verdana, arial, sans-serif",
		joinWith: "<br/>"
	}, u = `<b>${g(o, r.textMaxWidth, c)}</b>`;
	if (e.dataInlineValue && (s = e.dataInlineValue, s = s.substring(s.indexOf("{") + 1), s = s.substring(0, s.lastIndexOf("}") - 1), s = h(s, a), s = g(s, r.textMaxWidth, c), s = s.replaceAll(" ", "&nbsp;")), e.dataReference) {
		let n = t.find((t) => {
			var n;
			return t.name === ((n = e.dataReference) == null ? void 0 : n.$refText);
		});
		n && (s = n.dataBlockValue, s = s.substring(s.indexOf("{\n") + 2), s = s.substring(0, s.lastIndexOf("}") - 1), s = h(s, a), s = g(s, r.textMaxWidth, c), s = s.replaceAll(" ", "&nbsp;"), s += "<br/>");
	}
	let d = s !== void 0;
	d && (u += `<br/><br/><code style="text-align: left; display: block;max-width:${r.textMaxWidth}px">${s}</code>`);
	let f = {
		fontSize: c.fontSize,
		fontWeight: c.fontWeight,
		fontFamily: c.fontFamily
	}, p = ee(u, f), m = d ? p.width / 3 : p.width, _ = {
		content: u,
		width: m,
		height: p.height
	};
	return n.debug(`[${e.name}] ${e.entityIdentifier} text`, _), _;
}
t(N, "calculateTextProps");
function P(e, t) {
...
var J = {
	...
	getDiagramProps: E,
	getState: C
}, fe = { parse: /* @__PURE__ */ t(async (e) => {
	let t = await ne("eventmodeling", e);
	n.debug(t), J.setAst(t), te(t, J);
}, "parse") }, Y = p(), pe = Y == null ? void 0 : Y.eventmodeling;
function X(e, t) {
	return (n) => {
...
var me = {
	parser: fe,
	db: J,
	renderer: { draw: /* @__PURE__ */ t(function(e, t, i, a) {
		var o, c;
		if (n.debug("in eventmodeling renderer", e + "\n", "id:", t, i), !pe) throw Error("EventModeling config not found");
		let l = a.db, { themeVariables: u, eventmodeling: d } = p(), f = r(`[id="${t}"]`), m = l.getDiagramProps(), h = l.getState(), g = `em-arrowhead-${t}`, _ = (o = u.emArrowhead) == null ? "#000000" : o;
		h.sortedSwimlanesArray.forEach($(f, h.maxR, m, u)), h.boxes.forEach(X(f, m)), h.relations.forEach(Q(f, m, g, u)), f.append("defs").append("marker").attr("id", g).attr("markerWidth", "10").attr("markerHeight", "7").attr("refX", "10").attr("refY", "3.5").attr("orient", "auto").append("polygon").attr("points", "0 0, 10 3.5, 0 7").attr("fill", _), s(void 0, f, (c = d == null ? void 0 : d.padding) == null ? 30 : c, d == null ? void 0 : d.useMaxWidth);
	}, "draw") },
