import { i as e, t } from "./es/index.js";
import { i as n, o as r, r as i, t as a } from "./src-6bhrijpo.mjs";
import { H as o, K as s, U as c, a as l, c as u, s as d, v as f, w as p, x as m, y as h } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { t as g } from "./linear-CUX0sJcW.mjs";
import { E as _, M as v, O as y, S as b, _ as x, b as S, f as C, g as w, h as T, j as E, k as D, m as O, n as k, r as A, v as j, w as M, y as ee } from "./time-B5whK2tv.mjs";
import { W as te } from "./step-DTZmJhUX.mjs";
import { g as ne } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as re } from "./dist-8HXMFWtc.mjs";
...
function ue(e, t) {
	var n = [], r = null, i = null, a = 6, o = 6, s = 3, c = typeof window < "u" && window.devicePixelRatio > 1 ? 0 : .5, l = e === N || e === I ? -1 : 1, u = e === I || e === P ? "x" : "y", d = e === N || e === F ? ae : oe;
	function f(f) {
		var p = r == null ? t.ticks ? t.ticks.apply(t, n) : t.domain() : r, m = i == null ? t.tickFormat ? t.tickFormat.apply(t, n) : ie : i, h = Math.max(a, 0) + s, g = t.range(), _ = +g[0] + c, v = +g[g.length - 1] + c, y = (t.bandwidth ? ce : se)(t.copy(), c), b = f.selection ? f.selection() : f, x = b.selectAll(".domain").data([null]), S = b.selectAll(".tick").data(p, t).order(), C = S.exit(), w = S.enter().append("g").attr("class", "tick"), T = S.select("line"), E = S.select("text");
		x = x.merge(x.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), S = S.merge(w), T = T.merge(w.append("line").attr("stroke", "currentColor").attr(u + "2", l * a)), E = E.merge(w.append("text").attr("fill", "currentColor").attr(u, l * h).attr("dy", e === N ? "0em" : e === F ? "0.71em" : "0.32em")), f !== b && (x = x.transition(f), S = S.transition(f), T = T.transition(f), E = E.transition(f), C = C.transition(f).attr("opacity", L).attr("transform", function(e) {
			return isFinite(e = y(e)) ? d(e + c) : this.getAttribute("transform");
		}), w.attr("opacity", L).attr("transform", function(e) {
			var t = this.parentNode.__axis;
			return d((t && isFinite(t = t(e)) ? t : y(e)) + c);
		})), C.remove(), x.attr("d", e === I || e === P ? o ? "M" + l * o + "," + _ + "H" + c + "V" + v + "H" + l * o : "M" + c + "," + _ + "V" + v : o ? "M" + _ + "," + l * o + "V" + c + "H" + v + "V" + l * o : "M" + _ + "," + c + "H" + v), S.attr("opacity", 1).attr("transform", function(e) {
			return d(y(e) + c);
		}), T.attr(u + "2", l * a), E.attr(u, l * h).text(m), b.filter(le).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", e === P ? "start" : e === I ? "end" : "middle"), b.each(function() {
			this.__axis = y;
		});
	}
...
var pe = /* @__PURE__ */ t(((e, t) => {
...
})), _e = re(), R = /* @__PURE__ */ e(r(), 1), ve = /* @__PURE__ */ e(pe(), 1), ye = /* @__PURE__ */ e(me(), 1), be = /* @__PURE__ */ e(he(), 1), xe = /* @__PURE__ */ e(ge(), 1), Se = (function() {
	var e = /* @__PURE__ */ i(function(e, t, n, r) {
		...
		38,
		40
	], n = [1, 26], r = [1, 27], a = [1, 28], o = [1, 29], s = [1, 30], c = [1, 31], l = [1, 32], u = [1, 33], d = [1, 34], f = [1, 9], p = [1, 10], m = [1, 11], h = [1, 12], g = [1, 13], _ = [1, 14], v = [1, 15], y = [1, 16], b = [1, 19], x = [1, 20], S = [1, 21], C = [1, 22], w = [1, 23], T = [1, 25], E = [1, 35], D = {
	...
	return i(O, "Parser"), O.prototype = D, D.Parser = O, new O();
})();
Se.parser = Se;
var Ce = Se;
R.default.extend(ve.default), R.default.extend(ye.default), R.default.extend(be.default);
var we = {
	friday: 5,
	saturday: 6
}, z = "", Te = "", Ee = void 0, De = "", B = [], V = [], Oe = /* @__PURE__ */ new Map(), ke = [], H = [], U = "", Ae = "", je = [
	"active",
	"done",
	"crit",
	"milestone",
	"vert"
], Me = [], W = "", G = !1, Ne = !1, Pe = "sunday", K = "saturday", q = 0, Fe = /* @__PURE__ */ i(function() {
	ke = [], H = [], U = "", Me = [], mt = 0, _t = void 0, Y = void 0, X = [], z = "", Te = "", Ae = "", Ee = void 0, De = "", B = [], V = [], G = !1, Ne = !1, q = 0, Oe = /* @__PURE__ */ new Map(), W = "", l(), Pe = "sunday", K = "saturday";
}, "clear"), Ie = /* @__PURE__ */ i(function(e) {
	W = e;
}, "setDiagramId"), Le = /* @__PURE__ */ i(function(e) {
	Te = e;
}, "setAxisFormat"), Re = /* @__PURE__ */ i(function() {
	return Te;
}, "getAxisFormat"), ze = /* @__PURE__ */ i(function(e) {
	Ee = e;
}, "setTickInterval"), Be = /* @__PURE__ */ i(function() {
	return Ee;
}, "getTickInterval"), Ve = /* @__PURE__ */ i(function(e) {
	De = e;
}, "setTodayMarker"), He = /* @__PURE__ */ i(function() {
	return De;
}, "getTodayMarker"), Ue = /* @__PURE__ */ i(function(e) {
	z = e;
}, "setDateFormat"), We = /* @__PURE__ */ i(function() {
	G = !0;
}, "enableInclusiveEndDates"), Ge = /* @__PURE__ */ i(function() {
	return G;
}, "endDatesAreInclusive"), Ke = /* @__PURE__ */ i(function() {
	Ne = !0;
}, "enableTopAxis"), qe = /* @__PURE__ */ i(function() {
	return Ne;
}, "topAxisEnabled"), Je = /* @__PURE__ */ i(function(e) {
	Ae = e;
}, "setDisplayMode"), Ye = /* @__PURE__ */ i(function() {
	return Ae;
}, "getDisplayMode"), Xe = /* @__PURE__ */ i(function() {
	return z;
}, "getDateFormat"), Ze = /* @__PURE__ */ i(function(e) {
	B = e.toLowerCase().split(/[\s,]+/);
}, "setIncludes"), Qe = /* @__PURE__ */ i(function() {
	return B;
}, "getIncludes"), $e = /* @__PURE__ */ i(function(e) {
	V = e.toLowerCase().split(/[\s,]+/);
}, "setExcludes"), et = /* @__PURE__ */ i(function() {
	return V;
}, "getExcludes"), tt = /* @__PURE__ */ i(function() {
	return Oe;
}, "getLinks"), nt = /* @__PURE__ */ i(function(e) {
	U = e, ke.push(e);
}, "addSection"), rt = /* @__PURE__ */ i(function() {
	return ke;
}, "getSections"), it = /* @__PURE__ */ i(function() {
	let e = xt(), t = 0;
	for (; !e && t < 10;) e = xt(), t++;
	return H = X, H;
}, "getTasks"), at = /* @__PURE__ */ i(function(e, t, n, r) {
	let i = e.format(t.trim()), a = e.format("YYYY-MM-DD");
	return r.includes(i) || r.includes(a) ? !1 : n.includes("weekends") && (e.isoWeekday() === we[K] || e.isoWeekday() === we[K] + 1) || n.includes(e.format("dddd").toLowerCase()) ? !0 : n.includes(i) || n.includes(a);
}, "isInvalidDate"), ot = /* @__PURE__ */ i(function(e) {
	Pe = e;
}, "setWeekday"), st = /* @__PURE__ */ i(function() {
	return Pe;
}, "getWeekday"), ct = /* @__PURE__ */ i(function(e) {
	K = e;
}, "setWeekend"), lt = /* @__PURE__ */ i(function(e, t, n, r) {
	if (!n.length || e.manualEndTime) return;
	let i;
	i = e.startTime instanceof Date ? (0, R.default)(e.startTime) : (0, R.default)(e.startTime, t, !0), i = i.add(1, "d");
	let a;
	a = e.endTime instanceof Date ? (0, R.default)(e.endTime) : (0, R.default)(e.endTime, t, !0);
	let [o, s] = ut(i, a, t, n, r);
	e.endTime = o.toDate(), e.renderEndTime = s;
}, "checkTaskDates"), ut = /* @__PURE__ */ i(function(e, t, n, r, i) {
	let a = !1, o = null, s = t.add(1e4, "d");
	for (; e <= t;) {
		if (a || (o = t.toDate()), a = at(e, n, r, i), a && (t = t.add(1, "d"), t > s)) throw Error("Failed to find a valid date that was not excluded by `excludes` after 10,000 iterations.");
		e = e.add(1, "d");
	}
	return [t, o];
}, "fixTaskDates"), dt = /* @__PURE__ */ i(function(e, t, r) {
	if (r = r.trim(), (/* @__PURE__ */ i((e) => {
		let t = e.trim();
		return t === "x" || t === "X";
	...
	let a = (0, R.default)(n, t.trim(), !0);
	if (a.isValid()) return r && (a = a.add(1, "d")), a.toDate();
	let o = (0, R.default)(e), [s, c] = ft(n);
	if (!Number.isNaN(s)) {
		let e = o.add(s, c);
		e.isValid() && (o = e);
	}
	return o.toDate();
}, "getEndDate"), mt = 0, J = /* @__PURE__ */ i(function(e) {
	return e === void 0 ? (mt += 1, "task" + mt) : e;
}, "parseId"), ht = /* @__PURE__ */ i(function(e, t) {
	let n;
	...
	switch (r.length) {
		case 1:
			i.id = J(), i.startTime = e.endTime, a = r[0];
			break;
		case 2:
			i.id = J(), i.startTime = dt(void 0, z, r[0]), a = r[1];
			break;
		case 3:
			i.id = J(r[0]), i.startTime = dt(void 0, z, r[1]), a = r[2];
			break;
		default:
	}
	return a && (i.endTime = pt(i.startTime, z, a, G), i.manualEndTime = (0, R.default)(a, "YYYY-MM-DD", !0).isValid(), lt(i, z, V, B)), i;
}, "compileData"), gt = /* @__PURE__ */ i(function(e, t) {
	let n;
	n = t.substr(0, 1) === ":" ? t.substr(1, t.length) : t;
	let r = n.split(","), i = {};
	Dt(r, i, je);
	...
	return i;
}, "parseData"), _t, Y, X = [], vt = {}, yt = /* @__PURE__ */ i(function(e, t) {
	let n = {
		section: U,
		type: U,
		processed: !1,
	...
	n.raw.startTime = r.startTime, n.raw.endTime = r.endTime, n.id = r.id, n.prevTaskId = Y, n.active = r.active, n.done = r.done, n.crit = r.crit, n.milestone = r.milestone, n.vert = r.vert, n.order = q, q++;
	let i = X.push(n);
	Y = n.id, vt[n.id] = i - 1;
}, "addTask"), Z = /* @__PURE__ */ i(function(e) {
	let t = vt[e];
	return X[t];
}, "findTaskById"), bt = /* @__PURE__ */ i(function(e, t) {
	let n = {
		section: U,
		type: U,
		description: e,
	...
	n.startTime = r.startTime, n.endTime = r.endTime, n.id = r.id, n.active = r.active, n.done = r.done, n.crit = r.crit, n.milestone = r.milestone, n.vert = r.vert, _t = n, H.push(n);
}, "addTaskOrg"), xt = /* @__PURE__ */ i(function() {
	let e = /* @__PURE__ */ i(function(e) {
		let t = X[e], n = "";
		switch (X[e].raw.startTime.type) {
			case "prevTaskEnd":
				...
				break;
			case "getStartDate":
				n = dt(void 0, z, X[e].raw.startTime.startData), n && (X[e].startTime = n);
				break;
		}
		return X[e].startTime && (X[e].endTime = pt(X[e].startTime, z, X[e].raw.endTime.data, G), X[e].endTime && (X[e].processed = !0, X[e].manualEndTime = (0, R.default)(X[e].raw.endTime.data, "YYYY-MM-DD", !0).isValid(), lt(X[e], z, V, B))), X[e].processed;
	}, "compileTask"), t = !0;
	for (let [n, r] of X.entries()) e(n), t = t && r.processed;
	return t;
}, "compileTasks"), St = /* @__PURE__ */ i(function(e, t) {
	let n = t;
	m().securityLevel !== "loose" && (n = (0, _e.sanitizeUrl)(t)), e.split(",").forEach(function(e) {
		Z(e) !== void 0 && (Tt(e, () => {
			window.open(n, "_self");
		}), Oe.set(e, n));
	}), Ct(e, "clickable");
}, "setLink"), Ct = /* @__PURE__ */ i(function(e, t) {
	e.split(",").forEach(function(e) {
		let n = Z(e);
		n !== void 0 && n.classes.push(t);
	});
}, "setClass"), wt = /* @__PURE__ */ i(function(e, t, n) {
	...
	r.length === 0 && r.push(e), Z(e) !== void 0 && Tt(e, () => {
		ne.runFunc(t, ...r);
	});
}, "setClickFun"), Tt = /* @__PURE__ */ i(function(e, t) {
	Me.push(function() {
		let n = W ? `${W}-${e}` : e, r = document.querySelector(`[id="${n}"]`);
		r !== null && r.addEventListener("click", function() {
			t();
		});
	}, function() {
		let n = W ? `${W}-${e}` : e, r = document.querySelector(`[id="${n}-text"]`);
		r !== null && r.addEventListener("click", function() {
			t();
		});
	});
}, "pushFun"), Et = {
	getConfig: /* @__PURE__ */ i(() => m().gantt, "getConfig"),
	clear: Fe,
	setDateFormat: Ue,
	getDateFormat: Xe,
	enableInclusiveEndDates: We,
	...
	setExcludes: $e,
	getExcludes: et,
	setClickEvent: /* @__PURE__ */ i(function(e, t, n) {
		e.split(",").forEach(function(e) {
			wt(e, t, n);
		}), Ct(e, "clickable");
	}, "setClickEvent"),
	setLink: St,
	getLinks: tt,
	bindFunctions: /* @__PURE__ */ i(function(e) {
...
i(Dt, "getTaskTags"), R.default.extend(xe.default);
var Ot = /* @__PURE__ */ i(function() {
	...
	return i;
}, "getMaxIntersections"), Q, $ = 1e4, jt = {
	parser: Ce,
	db: Et,
	renderer: {
		setConf: Ot,
		draw: /* @__PURE__ */ i(function(e, t, r, o) {
			let s = m().gantt;
			o.db.setDiagramId(t);
			let c = m().securityLevel, l;
			c === "sandbox" && (l = a("#i" + t));
			let f = a(c === "sandbox" ? l.nodes()[0].contentDocument.body : "body"), p = c === "sandbox" ? l.nodes()[0].contentDocument : document, h = p.getElementById(t);
			Q = h.parentElement.offsetWidth, Q === void 0 && (Q = 1200), s.useWidth !== void 0 && (Q = s.useWidth);
			let x = o.db.getTasks(), S = [];
			for (let e of x) S.push(e.type);
			S = L(S);
			let w = {}, T = 2 * s.topPadding;
			if (o.db.getDisplayMode() === "compact" || s.displayMode === "compact") {
				let e = {};
				for (let t of x) e[t.section] === void 0 ? e[t.section] = [t] : e[t.section].push(t);
				let t = 0;
				for (let n of Object.keys(e)) {
					let r = At(e[n], t) + 1;
					t += r, T += r * (s.barHeight + s.barGap), w[n] = r;
				}
			} else {
				T += x.length * (s.barHeight + s.barGap);
				for (let e of S) w[e] = x.filter((t) => t.type === e).length;
			}
			h.setAttribute("viewBox", "0 0 " + Q + " " + T);
			let O = f.select(`[id="${t}"]`), j = k().domain([E(x, function(e) {
				return e.startTime;
			}), v(x, function(e) {
				return e.endTime;
			...
			i(ee, "taskCompare"), x.sort(ee), ne(x, Q, T), u(O, T, Q, s.useMaxWidth), O.append("text").text(o.db.getDiagramTitle()).attr("x", Q / 2).attr("y", s.titleTopMargin).attr("class", "titleText");
			function ne(e, t, n) {
				let r = s.barHeight, i = r + s.barGap, a = s.topPadding, c = s.leftPadding, l = g().domain([0, S.length]).range(["#00B9FA", "#F95002"]).interpolate(te);
				ie(i, a, c, t, n, e, o.db.getExcludes(), o.db.getIncludes()), P(c, a, t, n), re(e, i, a, c, r, l, t, n), F(i, a, c, r, l), I(c, a, t, n);
			}
			i(ne, "makeGantt");
			function re(e, n, r, i, c, l, u) {
				e.sort((e, t) => e.vert === t.vert ? 0 : e.vert ? 1 : -1);
				let d = [...new Set(e.map((e) => e.order))].map((t) => e.find((e) => e.order === t));
				O.append("g").selectAll("rect").data(d).enter().append("rect").attr("x", 0).attr("y", function(e, t) {
					return t = e.order, t * n + r - 2;
				}).attr("width", function() {
					return u - s.rightPadding / 2;
				}).attr("height", n).attr("class", function(e) {
					for (let [t, n] of S.entries()) if (e.type === n) return "section section" + t % s.numberSectionStyles;
					return "section section0";
				}).enter();
				let f = O.append("g").selectAll("rect").data(e).enter(), p = o.db.getLinks();
				if (f.append("rect").attr("id", function(e) {
					return t + "-" + e.id;
				}).attr("rx", 3).attr("ry", 3).attr("x", function(e) {
					return e.milestone ? j(e.startTime) + i + .5 * (j(e.endTime) - j(e.startTime)) - .5 * c : j(e.startTime) + i;
				}).attr("y", function(e, t) {
					return t = e.order, e.vert ? s.gridLineStartPadding : t * n + r;
				}).attr("width", function(e) {
					return e.milestone ? c : e.vert ? .08 * c : j(e.renderEndTime || e.endTime) - j(e.startTime);
				}).attr("height", function(e) {
					return e.vert ? x.length * (s.barHeight + s.barGap) + s.barHeight * 2 : c;
				}).attr("transform-origin", function(e, t) {
					return t = e.order, (j(e.startTime) + i + .5 * (j(e.endTime) - j(e.startTime))).toString() + "px " + (t * n + r + .5 * c).toString() + "px";
				}).attr("class", function(e) {
					let t = "";
					e.classes.length > 0 && (t = e.classes.join(" "));
					let n = 0;
					for (let [t, r] of S.entries()) e.type === r && (n = t % s.numberSectionStyles);
					let r = "";
					...
					let t = j(e.startTime), n = j(e.renderEndTime || e.endTime);
					if (e.milestone && (t += .5 * (j(e.endTime) - j(e.startTime)) - .5 * c, n = t + c), e.vert) return j(e.startTime) + i;
					let r = this.getBBox().width;
					return r > n - t ? n + r + 1.5 * s.leftPadding > u ? t + i - 5 : n + i + 5 : (n - t) / 2 + t + i;
				}).attr("y", function(e, t) {
					return e.vert ? s.gridLineStartPadding + x.length * (s.barHeight + s.barGap) + 60 : (t = e.order, t * n + s.barHeight / 2 + (s.fontSize / 2 - 2) + r);
				}).attr("text-height", c).attr("class", function(e) {
					let t = j(e.startTime), n = j(e.endTime);
					e.milestone && (n = t + c);
					let r = this.getBBox().width, i = "";
					e.classes.length > 0 && (i = e.classes.join(" "));
					let a = 0;
					for (let [t, n] of S.entries()) e.type === n && (a = t % s.numberSectionStyles);
					let o = "";
					return e.active && (o = e.crit ? "activeCritText" + a : "activeText" + a), e.done ? o = e.crit ? o + " doneCritText" + a : o + " doneText" + a : e.crit && (o = o + " critText" + a), e.milestone && (o += " milestoneText"), e.vert && (o += " vertText"), r > n - t ? n + r + 1.5 * s.leftPadding > u ? i + " taskTextOutsideLeft taskTextOutside" + a + " " + o : i + " taskTextOutsideRight taskTextOutside" + a + " " + o + " width-" + r : i + " taskText taskText" + a + " " + o + " width-" + r;
					...
					f.filter(function(e) {
						...
						o.setAttribute("xlink:href", p.get(e.id)), o.setAttribute("target", "_top"), a.appendChild(o), o.appendChild(r), o.appendChild(i);
					});
				}
			}
			i(re, "drawRects");
			function ie(e, r, i, a, c, l, u, d) {
				if (u.length === 0 && d.length === 0) return;
				let f, p;
				for (let { startTime: e, endTime: t } of l) (f === void 0 || e < f) && (f = e), (p === void 0 || t > p) && (p = t);
				if (!f || !p) return;
				if ((0, R.default)(p).diff((0, R.default)(f), "year") > 5) {
					n.warn("The difference between the min and max time is more than 5 years. This will cause performance issues. Skipping drawing exclude days.");
					return;
				}
				let m = o.db.getDateFormat(), h = [], g = null, _ = (0, R.default)(f);
				for (; _.valueOf() <= p;) o.db.isInvalidDate(_, m, u, d) ? g ? g.end = _ : g = {
					start: _,
					end: _
				} : g && (h.push(g), g = null), _ = _.add(1, "d");
				O.append("g").selectAll("rect").data(h).enter().append("rect").attr("id", (e) => t + "-exclude-" + e.start.format("YYYY-MM-DD")).attr("x", (e) => j(e.start.startOf("day")) + i).attr("y", s.gridLineStartPadding).attr("width", (e) => j(e.end.endOf("day")) - j(e.start.startOf("day"))).attr("height", c - r - s.gridLineStartPadding).attr("transform-origin", function(t, n) {
					return (j(t.start) + i + .5 * (j(t.end) - j(t.start))).toString() + "px " + (n * e + .5 * c).toString() + "px";
				}).attr("class", "exclude-range");
			}
			i(ie, "drawExcludeDays");
			function N(e, t, n, r) {
				if (n <= 0 || e > t) return Infinity;
				let i = t - e, a = R.default.duration({ [r == null ? "day" : r]: n }).asMilliseconds();
				return a <= 0 ? Infinity : Math.ceil(i / a);
			}
			i(N, "getEstimatedTickCount");
			function P(e, t, r, i) {
				let a = o.db.getDateFormat(), c = o.db.getAxisFormat(), l;
				if (c) l = c;
				else if (a === "D") l = "%d";
				else {
					var u;
					l = (u = s.axisFormat) == null ? "%Y-%m-%d" : u;
				}
				let d = fe(j).tickSize(-i + t + s.gridLineStartPadding).tickFormat(A(l)), f = /^([1-9]\d*)(millisecond|second|minute|hour|day|week|month)$/.exec(o.db.getTickInterval() || s.tickInterval);
				if (f !== null) {
					let e = parseInt(f[1], 10);
					if (isNaN(e) || e <= 0) n.warn(`Invalid tick interval value: "${f[1]}". Skipping custom tick interval.`);
					else {
						let t = f[2], r = o.db.getWeekday() || s.weekday, i = j.domain(), a = i[0], c = i[1], l = N(a, c, e, t);
						if (l > $) n.warn(`The tick interval "${e}${t}" would generate ${l} ticks, which exceeds the maximum allowed (${$}). This may indicate an invalid date or time range. Skipping custom tick interval.`);
						else switch (t) {
							case "millisecond":
								d.ticks(D.every(e));
								break;
				...
				if (O.append("g").attr("class", "grid").attr("transform", "translate(" + e + ", " + (i - 50) + ")").call(d).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em"), o.db.topAxisEnabled() || s.topAxis) {
					let r = de(j).tickSize(-i + t + s.gridLineStartPadding).tickFormat(A(l));
					if (f !== null) {
						let e = parseInt(f[1], 10);
						if (isNaN(e) || e <= 0) n.warn(`Invalid tick interval value: "${f[1]}". Skipping custom tick interval.`);
						else {
							let t = f[2], n = o.db.getWeekday() || s.weekday, i = j.domain(), a = i[0], c = i[1];
							if (N(a, c, e, t) <= $) switch (t) {
								case "millisecond":
									r.ticks(D.every(e));
									break;
								case "second":
					...
					O.append("g").attr("class", "grid").attr("transform", "translate(" + e + ", " + t + ")").call(r).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10);
				}
			}
			i(P, "makeGrid");
			function F(e, t) {
				let n = 0, r = Object.keys(w).map((e) => [e, w[e]]);
				O.append("g").selectAll("text").data(r).enter().append(function(e) {
					let t = e[0].split(d.lineBreakRegex), n = -(t.length - 1) / 2, r = p.createElementNS("http://www.w3.org/2000/svg", "text");
					r.setAttribute("dy", n + "em");
					for (let [e, n] of t.entries()) {
						let t = p.createElementNS("http://www.w3.org/2000/svg", "tspan");
				...
				}).attr("font-size", s.sectionFontSize).attr("class", function(e) {
					for (let [t, n] of S.entries()) if (e[0] === n) return "sectionTitle sectionTitle" + t % s.numberSectionStyles;
					return "sectionTitle";
				});
			}
			i(F, "vertLabels");
			function I(e, t, n, r) {
				...
				if (i === "off") return;
				let a = O.append("g").attr("class", "today"), c = /* @__PURE__ */ new Date(), l = a.append("line");
				l.attr("x1", j(c) + e).attr("x2", j(c) + e).attr("y1", s.titleTopMargin).attr("y2", r - s.titleTopMargin).attr("class", "today"), i !== "" && l.attr("style", i.replace(/,/g, ";"));
			}
			i(I, "drawToday");
			function L(e) {
				let t = {}, n = [];
