...
import { G as i, H as a, K as o, U as s, a as c, d as l, k as u, rt as d, s as f, v as p, w as m, x as h, y as g } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { t as _ } from "./channel-CrTnM7c1.mjs";
import { c as v, g as ee } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as te } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import { t as ne } from "./chunk-32BRIVSS-Dezidi9z.mjs";
import { t as y } from "./chunk-XXDRQBXY-6qvi-T3x.mjs";
import { t as b } from "./chunk-VR4S4FIN-HQ9uQ67o.mjs";
import { o as x } from "./chunk-ZGVPDNZ5-CA-MSk8G.mjs";
import { r as S, t as C } from "./chunk-FWX5IMBZ-Dx6oqe1x.mjs";
import { n as w, t as T } from "./chunk-ZIRB5QZD-BdqCGXAd.mjs";
//#region node_modules/mermaid/dist/chunks/mermaid.core/chunk-PUDLZKDR.mjs
var E, D = "flowchart-", O = (E = class {
	constructor() {
		this.vertexCounter = 0, this.config = h(), this.diagramId = "", this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = !0, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = s, this.setAccDescription = a, this.setDiagramTitle = o, this.getAccTitle = g, this.getAccDescription = p, this.getDiagramTitle = m, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = { firstGraph: this.firstGraph.bind(this) }, this.clear(), this.setGen("gen-2");
	}
	sanitizeText(e) {
	...
	addVertex(e, t, r, i, a, o, s = {}, c) {
		...
		if (f === void 0 && (t === void 0 && r === void 0 && i != null && n.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), f = {
			id: e,
			labelType: "text",
			domId: D + e + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(e, f)), this.vertexCounter++, t === void 0 ? f.text === void 0 && (f.text = e) : (this.config = h(), d = this.sanitizeText(t.text.trim()), f.labelType = t.type, d.startsWith("\"") && d.endsWith("\"") && (d = d.substring(1, d.length - 1)), f.text = d), r !== void 0 && (f.type = r), i != null && i.forEach((e) => {
			f.styles.push(e);
		}), a != null && a.forEach((e) => {
			f.classes.push(e);
			...
			if (l.shape) {
				...
				if (!x(l.shape)) throw Error(`No such shape: ${l.shape}.`);
			...
			if (l != null && l.form && (f.form = l == null ? void 0 : l.form), l != null && l.pos && (f.pos = l == null ? void 0 : l.pos), l != null && l.img) {
				var m;
				f.img = l == null ? void 0 : l.img, !((m = l.label) != null && m.trim()) && f.text === e && (f.text = "");
			}
	...
	addSingleLink(e, t, r, i) {
		...
		if (s !== void 0 && (o.text = this.sanitizeText(s.text.trim()), o.text.startsWith("\"") && o.text.endsWith("\"") && (o.text = o.text.substring(1, o.text.length - 1)), o.labelType = this.sanitizeNodeLabelType(s.type)), r !== void 0 && (o.type = r.type, o.stroke = r.stroke, o.length = r.length > 10 ? 10 : r.length), i && !this.edges.some((e) => e.id === i)) o.id = i, o.isUserDefinedId = !0;
			...
			e.length === 0 ? o.id = v(o.start, o.end, {
				counter: 0,
				prefix: "L"
			}) : o.id = v(o.start, o.end, {
				counter: e.length + 1,
				prefix: "L"
			});
		}
		if (this.edges.length < ((a = this.config.maxEdges) == null ? 500 : a)) n.info("Pushing edge..."), this.edges.push(o);
...
You have to call mermaid.initialize.`);
	...
	setLink(e, t, n) {
		e.split(",").forEach((e) => {
			...
			r !== void 0 && (r.link = ee.formatUrl(t, this.config), r.linkTarget = n);
	...
	clear(e = "gen-2") {
		this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.diagramId = "", this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = !0, this.version = e, this.config = h(), c();
	}
	setGen(e) {
	...
	addSubGraph(e, r, i) {
		var a, o, s, c;
		let l = e.text.trim(), u = i.text;
		e === i && /\s/.exec(i.text) && (l = void 0);
		let d = (/* @__PURE__ */ t((e) => {
			let t = {
				boolean: {},
				number: {},
		...
		}, "uniq"))(r.flat()), f = d.nodeList, p = d.dir, m = p !== void 0, g = (a = h().flowchart) == null ? {} : a, _ = p == null ? g.inheritDir ? (o = (s = this.getDirection()) == null ? h().direction : s) == null ? void 0 : o : void 0 : p;
		if (this.version === "gen-1") for (let e = 0; e < f.length; e++) f[e] = this.lookUpDomId(f[e]);
		l = (c = l) == null ? "subGraph" + this.subCount : c, u = u || "", u = this.sanitizeText(u), this.subCount += 1;
		let v = {
			id: l,
			nodes: f,
			title: u.trim(),
		...
		return n.info("Adding", v.id, v.nodes, v.dir), v.nodes = this.makeUniq(v, this.subGraphs).nodes, this.subGraphs.push(v), this.subGraphLookup.set(l, v), l;
	}
	getPosForId(e) {
	...
	addNodeFromVertex(e, t, n, r, i, a) {
		var o;
		let s = n.get(e.id), c = (o = r.get(e.id)) != null && o, l = this.findNode(t, e.id);
	...
	getData() {
		let e = h(), t = [], n = [], r = this.getSubGraphs(), i = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map();
	...
	draw: /* @__PURE__ */ t(async function(e, t, r, i, a) {
		var o, s;
		n.info("REF0:"), n.info("Drawing state diagram (v2)", t);
		let { securityLevel: c, flowchart: l, layout: u } = h();
		i.db.setDiagramId(t), n.debug("Before getData: ");
		let d = i.db.getData();
		n.debug("Data: ", d);
		let f = y(t, c), p = i.db.getDirection();
		d.type = i.type, d.layoutAlgorithm = C(u), d.layoutAlgorithm === "dagre" && u === "elk" && n.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), d.direction = p, d.nodeSpacing = (l == null ? void 0 : l.nodeSpacing) || 50, d.rankSpacing = (l == null ? void 0 : l.rankSpacing) || 50, d.markers = [
			"point",
			"circle",
			"cross"
		], d.diagramId = t, n.debug("REF1:", d), await S(d, f, a);
		let m = (o = (s = d.config.flowchart) == null ? void 0 : s.diagramPadding) == null ? 8 : o;
		ee.insertTitle(f, "flowchartTitleText", (l == null ? void 0 : l.titleTopMargin) || 0, i.db.getDiagramTitle()), b(f, m, "flowchart", (l == null ? void 0 : l.useMaxWidth) || !1);
	}, "draw")
}, ie = (function() {
...
var k = oe, A = /* @__PURE__ */ t((e, t) => {
	let n = _;
	return d(n(e, "r"), n(e, "g"), n(e, "b"), t);
}, "fade"), j = /* @__PURE__ */ t((e) => {
	var t, n;
	return `.label {
  ...
  ${te()}
`;
}, "getStyles"), M = /* @__PURE__ */ t(({ defaultLayout: e, styles: n = j } = {}) => ({
	parser: k,
	get db() {
		return new O();
	},
	...
	init: /* @__PURE__ */ t((t) => {
		...
		let a = (n = (r = u().layout) == null ? e : r) == null ? t.layout : n;
		a && i({ layout: a }), t.flowchart.arrowMarkerAbsolute = t.arrowMarkerAbsolute, i({ flowchart: { arrowMarkerAbsolute: t.arrowMarkerAbsolute } });
	}, "init")
