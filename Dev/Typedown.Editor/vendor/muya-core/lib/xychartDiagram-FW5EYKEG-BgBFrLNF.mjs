...
import { D as n, H as r, K as i, U as a, a as o, b as s, c, f as l, v as u, w as d, y as f, z as p } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { t as m } from "./linear-DYBBcbeN.mjs";
import { n as h } from "./ordinal-CbbzlgrI.mjs";
import { t as g } from "./range-DkqLe_eX.mjs";
import { n as _ } from "./init-Buj1GKRa.mjs";
import { t as v } from "./line-BiBUgSr7.mjs";
import { i as y } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as b } from "./chunk-VAUOI2AC-DvRR_ttS.mjs";
import "./chunk-HOUHSVGY-2PLbOYM-.mjs";
import { t as x } from "./chunk-Q4XR5HBZ-KP7VNg4F.mjs";
...
var L = (C = class {
	...
	getMaxDimension(e, t) {
		...
		for (let i of e) {
			let e = x(r, 1, i), a = e ? e.width : i.length * t, o = e ? e.height : t;
...
}, e(j, "Orchestrator"), j), pe = (M = class {
	static build(e, t, n, r) {
		return new fe(e, t, n, r).getDrawableElement();
	}
}, e(M, "XYChartBuilder"), M), z = 0, me, B = q(), V = K(), H = J(), U = V.plotColorPalette.split(",").map((e) => e.trim()), W = !1, G = !1;
function K() {
	let e = n(), t = s();
	return y(e.xyChart, t.themeVariables.xyChart);
}
e(K, "getChartDefaultThemeConfig");
function q() {
	let e = s();
	return y(l.xyChart, e.xyChart);
}
e(q, "getChartDefaultConfig");
function J() {
	return {
		yAxis: {
			type: "linear",
...
e(xe, "setYAxisRangeFromPlotData");
function Z(e) {
	let t = [];
	...
	if (F(H.xAxis) && e.length > H.xAxis.categories.length && (e = e.slice(0, H.xAxis.categories.length)), G || xe(e), F(H.xAxis) && (t = H.xAxis.categories.map((t, n) => [t, e[n]])), I(H.xAxis)) {
...
e(Z, "transformDataWithoutCategory");
function Q(e) {
	return U[e === 0 ? 0 : e % U.length];
}
e(Q, "getPlotColorFromPalette");
function Se(e, t) {
	let n = t.map((e) => e.value), r = t.map((e) => e.label ? Y(e.label) : ""), i = Z(n), a = r.some((e) => e !== "");
	H.plots.push({
		type: "line",
		strokeFill: Q(z),
		strokeWidth: 2,
...
function $() {
	...
	return H.title = d(), pe.build(B, H, V, me);
}
e($, "getDrawableElem");
function we() {
	return V;
}
e(we, "getChartThemeConfig");
function Te() {
	return B;
}
e(Te, "getChartConfig");
...
var De = {
	...
	db: {
		...
		clear: /* @__PURE__ */ e(function() {
			o(), z = 0, B = q(), H = J(), V = K(), U = V.plotColorPalette.split(",").map((e) => e.trim()), W = !1, G = !1;
		}, "clear"),
		setAccTitle: a,
		getAccTitle: f,
		setDiagramTitle: i,
		...
		for (let t of _) {
			...
			switch (t.type) {
				...
				case "text":
					...
					break;
				case "path":
					n.selectAll("path").data(t.data).enter().append("path").attr("d", (e) => e.path).attr("fill", (e) => e.fill ? e.fill : "none").attr("stroke", (e) => e.strokeFill).attr("stroke-width", (e) => e.strokeWidth);
					break;
			}
		}
	}, "draw") }
