...
import { A as r, B as i, M as a, T as o, b as s, g as c, x as l, z as u } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { a as d, r as f, u as p } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as m } from "./chunk-HOUHSVGY-2PLbOYM-.mjs";
import { n as h } from "./chunk-Q4XR5HBZ-KP7VNg4F.mjs";
import { n as g, t as _ } from "./chunk-OGEWGWER-Cn1Z4hFw.mjs";
import { a as v, i as y, r as b, t as x } from "./chunk-C7G6YPKG-BGTLz-ew.mjs";
import { t as S } from "./rough.esm-BqIZv7WF.mjs";
...
var C = /* @__PURE__ */ e(async (e, t, r) => {
	...
	s = r || "node default";
	let m = e.insert("g").attr("class", s).attr("id", t.domId || t.id), g = m.insert("g").attr("class", "label").attr("style", p(t.labelStyle)), v;
	v = t.label === void 0 ? "" : typeof t.label == "string" ? t.label : t.label[0];
	let y = !!t.icon || !!t.img, b = t.labelType === "markdown", x = await h(g, u(d(v), l()), {
		useHtmlLabels: f,
...
}, "labelHelper"), w = /* @__PURE__ */ e(async (e, t, r) => {
	var i, a;
	let s = (i = r.useHtmlLabels) == null ? o(l()) : i, c = e.insert("g").attr("class", "label").attr("style", r.labelStyle || ""), f = await h(c, u(d(t), l()), {
		useHtmlLabels: s,
		width: r.width || ((a = l()) == null || (a = a.flowchart) == null ? void 0 : a.wrappingWidth),
		style: r.labelStyle,
		addSvgBackground: !!r.icon || !!r.img
	}), p = f.getBBox(), m = r.padding / 2;
	if (o(l())) {
...
function A(t) {
	...
	r.setAttribute("d", i);
	let a = n.find((e) => e.getAttribute("fill") !== "none"), o = n.find((e) => e.getAttribute("stroke") !== "none"), s = /* @__PURE__ */ e((e, t) => {
		var n;
...
var j = /* @__PURE__ */ e((e, t) => {
...
}, "intersectRect"), M = /* @__PURE__ */ e(async (e, t, n, r = !1, i = !1) => {
	let a = t || "";
	...
	t,
	"Z"
].join(" "), "createRoundedRectPathD"), P = /* @__PURE__ */ e(async (e, r) => {
	var i;
	let a = l(), { themeVariables: o, handDrawnSeed: s } = a, { clusterBkg: u, clusterBorder: d } = o, f = d, { labelStyles: p, nodeStyles: m, borderStyles: g, backgroundStyles: _ } = y(r), b = e.insert("g").attr("class", "cluster swimlane " + (r.cssClasses || "")).attr("id", r.id).attr("data-id", r.id).attr("data-et", "cluster").attr("data-look", r.look), x = c(a.flowchart.htmlLabels), C = r.direction === "LR", w = b.insert("g").attr("class", "cluster-label swimlane-label"), T = await h(w, r.label, {
		style: r.labelStyle,
		useHtmlLabels: x,
		isNode: !0,
		width: r.width
	...
	let D = (i = r.padding) == null ? 0 : i, O = r.width <= E.width + D ? E.width + D : r.width;
	r.width <= E.width + D ? r.diff = (O - r.width) / 2 - D : r.diff = -D;
	let k = r.height, A = r.y - k / 2, M = r.y + k / 2, N = r.x - O / 2, P = r.swimlaneContentTop === void 0 ? A + k / 3 : r.swimlaneContentTop, F = C ? 4 : 0, I = E.height + 2 * F, L, R;
	if (C) {
		let e = Math.max(I, E.height + 2 * F), t = N + e, n = Math.max(0, O - e);
		if (r.look === "handDrawn") {
			let i = S.svg(b), a = v(r, {
				roughness: .7,
				fill: u,
				...
				stroke: f,
				seed: s
			}), c = i.rectangle(N, A, e, k, a);
			L = b.insert(() => c, ":first-child");
			let l = i.rectangle(t, A, n, k, o);
			R = b.insert(() => l, ":first-child"), L.select("path:nth-child(2)").attr("style", g.join(";")), L.select("path").attr("style", _.join(";").replace("fill", "stroke"));
		} else L = b.insert("rect", ":first-child"), R = b.insert("rect", ":first-child"), L.attr("class", "swimlane-title").attr("style", m).attr("x", N).attr("y", A).attr("width", e).attr("height", k).attr("fill", u).attr("stroke", f), R.attr("class", "swimlane-body").attr("style", m).attr("x", t).attr("y", A).attr("width", n).attr("height", k).attr("fill", "none").attr("stroke", f);
		let i = N + e / 2, a = r.y;
		w.attr("transform", `translate(${i}, ${a}) rotate(-90) translate(${-E.width / 2}, ${-E.height / 2})`);
	} else {
		let e = Math.max(0, P - A), t = Math.min(I, e), n = A + t, i = Math.max(0, M - n), a = r.x - O / 2;
		if (r.look === "handDrawn") {
			let e = S.svg(b), o = v(r, {
				roughness: .7,
				fill: u,
				...
				stroke: f,
				seed: s
			}), l = e.rectangle(a, A, O, t, o);
			L = b.insert(() => l, ":first-child");
			let d = e.rectangle(a, n, O, i, c);
			R = b.insert(() => d, ":first-child"), L.select("path:nth-child(2)").attr("style", g.join(";")), L.select("path").attr("style", _.join(";").replace("fill", "stroke"));
		} else L = b.insert("rect", ":first-child"), R = b.insert("rect", ":first-child"), L.attr("class", "swimlane-title").attr("style", m).attr("x", a).attr("y", A).attr("width", O).attr("height", t).attr("fill", u).attr("stroke", f), R.attr("class", "swimlane-body").attr("style", m).attr("x", a).attr("y", n).attr("width", O).attr("height", i).attr("fill", "none").attr("stroke", f);
		let o = r.x - E.width / 2, c = A + (t - E.height) / 2;
		w.attr("transform", `translate(${o}, ${c})`);
	}
	if (t.trace("Swimlane data ", r, JSON.stringify(r)), p) {
		let e = w.select("span");
		e && e.attr("style", p);
	}
...
}, "swimlane"), F = /* @__PURE__ */ e(async (e, r) => {
	t.info("Creating subgraph rect for ", r.id, r);
	let i = l(), { themeVariables: a, handDrawnSeed: s } = i, { clusterBkg: c, clusterBorder: u } = a, { labelStyles: d, nodeStyles: f, borderStyles: p, backgroundStyles: m } = y(r), _ = e.insert("g").attr("class", "cluster " + r.cssClasses).attr("id", r.domId).attr("data-look", r.look), b = o(i), x = _.insert("g").attr("class", "cluster-label "), C;
	C = r.labelType === "markdown" ? await h(x, r.label, {
		style: r.labelStyle,
		useHtmlLabels: b,
		isNode: !0,
		width: r.width
	...
	t.trace("Data ", r, JSON.stringify(r));
	let k;
	if (r.look === "handDrawn") {
		let e = S.svg(_), n = v(r, {
			roughness: .7,
			...
			fillWeight: 3,
			seed: s
		}), i = e.path(N(D, O, T, E, 0), n);
		k = _.insert(() => (t.debug("Rough node insert CXC", i), i), ":first-child"), k.select("path:nth-child(2)").attr("style", p.join(";")), k.select("path").attr("style", m.join(";").replace("fill", "stroke"));
	...
	kanbanSection: /* @__PURE__ */ e(async (e, r) => {
		t.info("Creating subgraph rect for ", r.id, r);
		let i = l(), { themeVariables: a, handDrawnSeed: s } = i, { clusterBkg: c, clusterBorder: u } = a, { labelStyles: d, nodeStyles: f, borderStyles: p, backgroundStyles: m } = y(r), _ = e.insert("g").attr("class", "cluster " + r.cssClasses).attr("id", r.domId).attr("data-look", r.look), b = o(i), x = _.insert("g").attr("class", "cluster-label "), C = await h(x, r.label, {
			style: r.labelStyle,
			useHtmlLabels: b,
			isNode: !0,
			width: r.width
	...
	swimlane: P
}, L = /* @__PURE__ */ new Map(), R = /* @__PURE__ */ e(async (e, t) => {
	let n = await I[t.shape || "rect"](e, t);
	return L.set(t.id, n), n;
}, "insertCluster"), z = /* @__PURE__ */ e(() => {
	L = /* @__PURE__ */ new Map();
}, "clear");
function B(e, t) {
...
function ie(e, n) {
	...
	let i = E(n), a = i;
	i || (a = "anchor");
	let o = e.insert("g").attr("class", a).attr("id", n.domId || n.id), { cssStyles: s } = n, c = S.svg(o), l = v(n, {
		fill: "black",
		stroke: "none",
		fillStyle: "solid"
	});
...
e(ae, "generateArcPoints");
function q(e, t, n) {
	let [r, i] = [t, n].sort((e, t) => t - e);
	return i * (1 - Math.sqrt(1 - (e / r / 2) ** 2));
}
e(q, "calculateArcSagitta");
async function J(t, n) {
	var r;
	let { labelStyles: i, nodeStyles: a } = y(n);
	n.labelStyle = i;
	let o = (r = n.padding) == null ? 0 : r, s = n.look === "neo" ? 16 : o, c = n.look === "neo" ? 12 : o, l = /* @__PURE__ */ e((e) => e + c, "calcTotalHeight"), u = /* @__PURE__ */ e((e) => {
		let t = e / 2;
		return [t / (2.5 + e / 50), t];
	}, "calcEllipseRadius"), { shapeSvg: d, bbox: f } = await C(t, n, E(n)), p = l(n != null && n.height ? n == null ? void 0 : n.height : f.height), [m, h] = u(p), g = q(p, m, h), _ = (n != null && n.width ? n == null ? void 0 : n.width : f.width) + s * 2 + g - g, b = p, { cssStyles: x } = n, w = [
		{
			x: _ / 2,
			y: -b / 2
		},
		...
		...ae(-_ / 2, -b / 2, -_ / 2, b / 2, m, h, !1),
		{
			x: _ / 2,
			y: b / 2
		},
		...ae(_ / 2, b / 2, _ / 2, -b / 2, m, h, !0)
	], O = S.svg(d), k = v(n, {});
...
async function se(e, t) {
	...
	t.labelStyle = a;
	let s = (n = t.padding) == null ? 0 : n, c = t.look === "neo" ? 28 : s, l = t.look === "neo" ? 24 : s, { shapeSvg: u, bbox: d } = await C(e, t, E(t)), f = ((r = t == null ? void 0 : t.width) == null ? d.width : r) + (t.look === "neo" ? c * 2 : c + oe), p = ((i = t == null ? void 0 : t.height) == null ? d.height : i) + (t.look === "neo" ? l * 2 : l), m = f, h = -p, g = [
		{
			x: 0 + oe,
			y: h
		},
...
async function X(e, n, r) {
	...
	n.labelStyle = a;
	let { shapeSvg: s, bbox: c, halfPadding: l } = await C(e, n, E(n)), u = (i = r == null ? void 0 : r.padding) == null ? l : i, d = n.look === "neo" ? c.width / 2 + 32 : c.width / 2 + u, f, { cssStyles: m } = n;
	if (n.look === "handDrawn") {
	...
	return T(n, f), n.calcIntersect = function(e, t) {
		...
		return t.info("Circle intersect", n, d, e), K.circle(n, d, e);
	}, s;
}
e(X, "circle");
function Z(e) {
...
function le(e, n) {
	...
	let s = e.insert("g").attr("class", E(n)).attr("id", (r = n.domId) == null ? n.id : r), c = Math.max(30, (i = n == null ? void 0 : n.width) == null ? 0 : i), { cssStyles: l } = n, u = S.svg(s), d = v(n, {});
	n.look !== "handDrawn" && (d.roughness = 0, d.fillStyle = "solid");
	let f = u.circle(0, 0, c * 2, d), p = Z(c), m = u.path(p, d), h = s.insert(() => f, ":first-child");
	return h.insert(() => m), h.attr("class", "outer-path"), l && n.look !== "handDrawn" && h.selectAll("path").attr("style", l), o && n.look !== "handDrawn" && h.selectAll("path").attr("style", o), T(n, h), n.intersect = function(e) {
...
async function de(e, t) {
	...
	let { shapeSvg: l, bbox: u, label: d } = await C(e, t, E(t)), f = t.look === "neo" ? 18 : (n = t.padding) == null ? 0 : n, p = t.look === "neo" ? 12 : (r = t.padding) == null ? 0 : r, m = u.width + f, h = u.height + p, g = Math.max(5, h * .1), { cssStyles: _ } = t, b = [
		...ue(m / 2, -h / 2, g, 30, -90, 0),
		{
			x: -m / 2 - g,
			y: g
		},
		...ue(m / 2 + g * 2, -g, g, 20, -180, -270),
		...ue(m / 2 + g * 2, g, g, 20, -90, -180),
		{
			x: -m / 2 - g,
			y: -h / 2
		},
		...ue(m / 2, h / 2, g, 20, 0, 90)
	], x = [
		{
			x: m / 2,
			y: -h / 2 - g
		...
		...ue(m / 2, -h / 2, g, 20, -90, 0),
		{
			x: -m / 2 - g,
			y: -g
		},
		...ue(m / 2 + m * .1, -g, g, 20, -180, -270),
		...ue(m / 2 + m * .1, g, g, 20, -90, -180),
		{
			x: -m / 2 - g,
			y: h / 2
		},
...
async function pe(e, t) {
	...
	let { shapeSvg: u, bbox: d, label: f } = await C(e, t, E(t)), p = t.look === "neo" ? 18 : (n = t.padding) == null ? 0 : n, m = t.look === "neo" ? 12 : (r = t.padding) == null ? 0 : r, h = d.width + (t.look === "neo" ? p * 2 : p), g = d.height + (t.look === "neo" ? m * 2 : m), _ = Math.max(5, g * .1), { cssStyles: b } = t, x = [
		...fe(h / 2, -g / 2, _, 20, -90, 0),
		{
			x: h / 2 + _,
			y: -_
		},
		...fe(h / 2 + _ * 2, -_, _, 20, -180, -270),
		...fe(h / 2 + _ * 2, _, _, 20, -90, -180),
		{
			x: h / 2 + _,
			y: g / 2
		},
		...fe(h / 2, g / 2, _, 20, 0, 90)
	], w = [
		{
			x: -h / 2,
			y: -g / 2 - _
...
async function he(e, t) {
	...
	return N.attr("class", "basic label-container outer-path"), h && t.look !== "handDrawn" && N.selectChildren("path").attr("style", h), o && t.look !== "handDrawn" && N.selectChildren("path").attr("style", o), N.attr("transform", `translate(${-f / 2}, ${-p / 2})`), T(t, N), t.intersect = function(e) {
		return K.polygon(t, A, e);
	}, u;
}
e(he, "curvedTrapezoid");
var ge = /* @__PURE__ */ e((e, t, n, r, i, a) => [
	`M${e},${t + a}`,
	`a${i},${a} 0,0,0 ${n},0`,
	`a${i},${a} 0,0,0 ${-n},0`,
	`l0,${r}`,
	`a${i},${a} 0,0,0 ${n},0`,
	`l0,${-r}`
].join(" "), "createCylinderPathD"), _e = /* @__PURE__ */ e((e, t, n, r, i, a) => [
	`M${e},${t + a}`,
	`M${e + n},${t + a}`,
	`a${i},${a} 0,0,0 ${-n},0`,
	`l0,${r}`,
	`a${i},${a} 0,0,0 ${n},0`,
	`l0,${-r}`
].join(" "), "createOuterCylinderPathD"), ve = /* @__PURE__ */ e((e, t, n, r, i, a) => [`M${e - n / 2},${-r / 2}`, `a${i},${a} 0,0,0 ${n},0`].join(" "), "createInnerCylinderPathD"), ye = 8, be = 8;
async function xe(e, t) {
	...
	if (t.look === "handDrawn") {
		let e = S.svg(h), n = _e(0, 0, b, D, x, w), r = ve(0, w, b, D, x, w), i = v(t, {}), a = e.path(n, i), o = e.path(r, v(t, { fill: "none" }));
		O = h.insert(() => o, ":first-child"), O = h.insert(() => a, ":first-child"), O.attr("class", "basic label-container"), k && O.attr("style", k);
	} else {
		let e = ge(0, 0, b, D, x, w);
	...
	return O.attr("label-offset-y", w), O.attr("transform", `translate(${-b / 2}, ${-(D / 2 + w)})`), T(t, O), _.attr("transform", `translate(${-(g.width / 2) - (g.x - ((r = g.left) == null ? 0 : r))}, ${-(g.height / 2) + ((i = t.padding) == null ? 0 : i) / 1.5 - (g.y - ((a = g.top) == null ? 0 : a))})`), t.intersect = function(e) {
		var n, r, i, a, o;
		let s = K.rect(t, e), c = s.x - ((n = t.x) == null ? 0 : n);
...
async function Ce(e, t) {
	var n, r, i;
	let { cssClasses: a, labelPaddingX: o, labelPaddingY: s, padding: c, width: l, height: u } = t, d = await Se(e, t, {
		rx: 0,
		ry: 0,
		classes: a == null ? "" : a,
...
e(we, "dividedRectangle");
async function Te(e, n) {
	var r;
	let { labelStyles: i, nodeStyles: a } = y(n), o = n.look === "neo" ? 12 : 5;
	n.labelStyle = i;
	let s = (r = n.padding) == null ? 0 : r, c = n.look === "neo" ? 16 : s, { shapeSvg: l, bbox: u } = await C(e, n, E(n)), d = (n != null && n.width ? (n == null ? void 0 : n.width) / 2 : u.width / 2) + (c == null ? 0 : c), f = d - o, m, { cssStyles: h } = n;
	if (n.look === "handDrawn") {
		var g, _;
		let e = S.svg(l), t = v(n, {
			roughness: .2,
	...
	return T(n, m), n.intersect = function(e) {
		return t.info("DoubleCircle intersect", n, d, e), K.circle(n, d, e);
	}, l;
}
e(Te, "doublecircle");
function Ee(e, n, { config: { themeVariables: r } }) {
	var i;
	let { labelStyles: a, nodeStyles: o } = y(n);
	n.label = "", n.labelStyle = a;
	let s = e.insert("g").attr("class", E(n)).attr("id", (i = n.domId) == null ? n.id : i), { cssStyles: c } = n, l = S.svg(s), { nodeBorder: u } = r, d = v(n, { fillStyle: "solid" });
	n.look !== "handDrawn" && (d.roughness = 0);
	let f = l.circle(0, 0, 14, d), p = s.insert(() => f, ":first-child");
	return p.selectAll("path").attr("style", `fill: ${u} !important;`), c && c.length > 0 && n.look !== "handDrawn" && p.selectAll("path").attr("style", c), o && n.look !== "handDrawn" && p.selectAll("path").attr("style", o), T(n, p), n.intersect = function(e) {
...
async function ke(e, n) {
	...
	if (n.width || n.height) {
		var d, f;
		n.height = (d = n == null ? void 0 : n.height) == null ? 0 : d, n.height < De && (n.height = De), n.width = ((f = n == null ? void 0 : n.width) == null ? 0 : f) - u - u / 2, n.width < Oe && (n.width = Oe);
	}
	let { shapeSvg: p, bbox: m, label: h } = await C(e, n, E(n)), g = (n != null && n.width ? n == null ? void 0 : n.width : m.width) + (u == null ? 0 : u), _ = n != null && n.height ? n == null ? void 0 : n.height : g + m.height, b = _, x = [
		{
			x: 0,
			y: -_
		},
	...
	return w && n.look !== "handDrawn" && M.selectChildren("path").attr("style", w), c && n.look !== "handDrawn" && M.selectChildren("path").attr("style", c), n.width = g, n.height = _, T(n, M), h.attr("transform", `translate(${-m.width / 2 - (m.x - ((i = m.left) == null ? 0 : i))}, ${-_ / 2 + ((a = n.padding) == null ? 0 : a) / 2 + (m.y - ((o = m.top) == null ? 0 : o))})`), n.intersect = function(e) {
		return t.info("Triangle intersect", n, x, e), K.polygon(n, x, e);
	}, p;
}
e(ke, "flippedTriangle");
function Ae(e, t, { dir: n, config: { state: r, themeVariables: i } }) {
	var a, o, s, c;
...
async function je(e, n) {
	...
	let { shapeSvg: d, bbox: f } = await C(e, n, E(n)), p = (n != null && n.width ? n == null ? void 0 : n.width : Math.max(15, f.width)) + s * 2, m = (n != null && n.height ? n == null ? void 0 : n.height : Math.max(10, f.height)) + c * 2, h = m / 2, { cssStyles: g } = n, _ = S.svg(d), b = v(n, {});
	...
	return A.attr("class", "basic label-container outer-path"), g && n.look !== "handDrawn" && A.selectChildren("path").attr("style", g), o && n.look !== "handDrawn" && A.selectChildren("path").attr("style", o), T(n, A), n.intersect = function(e) {
...
e(je, "halfRoundedRectangle");
var Me = /* @__PURE__ */ e((e, t, n, r, i) => [
	`M${e + i},${t}`,
	`L${e + n - i},${t}`,
	`L${e + n},${t - r / 2}`,
	`L${e + n - i},${t - r}`,
...
async function Ne(e, t) {
	...
	if (t.look === "handDrawn") {
		let e = S.svg(f), n = v(t, {}), r = Me(0, 0, g, m, h), i = e.path(r, n);
...
async function Pe(e, n) {
	...
	let { labelStyles: a, nodeStyles: o } = y(n);
	n.label = "", n.labelStyle = a;
	let { shapeSvg: s } = await C(e, n, E(n)), c = Math.max(30, (r = n == null ? void 0 : n.width) == null ? 0 : r), l = Math.max(30, (i = n == null ? void 0 : n.height) == null ? 0 : i), { cssStyles: u } = n, d = S.svg(s), f = v(n, {});
	...
	return g.attr("class", "basic label-container outer-path"), u && n.look !== "handDrawn" && g.selectChildren("path").attr("style", u), o && n.look !== "handDrawn" && g.selectChildren("path").attr("style", o), g.attr("transform", `translate(${-c / 2}, ${-l / 2})`), T(n, g), n.intersect = function(e) {
		return t.info("Pill intersect", n, { points: p }), K.polygon(n, p, e);
	}, s;
}
e(Pe, "hourglass");
async function Fe(e, n, { config: { themeVariables: r, flowchart: i } }) {
	...
	let { shapeSvg: p, bbox: h, label: g } = await C(e, n, "icon-shape default"), _ = n.pos === "t", b = d, w = d, { nodeBorder: E } = r, { stylesMap: D } = x(n), O = -w / 2, k = -b / 2, A = n.label ? 8 : 0, j = S.svg(p), M = v(n, {
		stroke: "none",
		fill: "none"
	});
	n.look !== "handDrawn" && (M.roughness = 0, M.fillStyle = "solid");
	let N = j.rectangle(O, k, w, b, M), P = Math.max(w, h.width), F = b + h.height + A, I = j.rectangle(-P / 2, -F / 2, P, F, {
		...M,
		fill: "transparent",
		stroke: "none"
	...
	if (n.icon) {
		var z;
		let e = p.append("g");
		e.html(`<g>${await m(n.icon, {
			height: d,
			width: d,
			fallbackPrefix: ""
		})}</g>`);
		let t = e.node().getBBox(), r = t.width, i = t.height, a = t.x, o = t.y;
		e.attr("transform", `translate(${-r / 2 - a},${_ ? h.height / 2 + A / 2 - i / 2 - o : -h.height / 2 - A / 2 - i / 2 - o})`), e.attr("style", `color: ${(z = D.get("stroke")) == null ? E : z};`);
	}
	return g.attr("transform", `translate(${-h.width / 2 - (h.x - ((s = h.left) == null ? 0 : s))},${_ ? -F / 2 : F / 2 - h.height})`), L.attr("transform", `translate(0,${_ ? h.height / 2 + A / 2 : -h.height / 2 - A / 2})`), T(n, R), n.intersect = function(e) {
		var r, i, a;
...
async function Ie(e, n, { config: { themeVariables: r, flowchart: i } }) {
	...
	let { shapeSvg: h, bbox: g, label: _ } = await C(e, n, "icon-shape default"), b = n.label ? 8 : 0, w = n.pos === "t", { nodeBorder: E, mainBkg: D } = r, { stylesMap: O } = x(n), k = S.svg(h), A = v(n, {});
	n.look !== "handDrawn" && (A.roughness = 0, A.fillStyle = "solid");
	let j = O.get("fill");
	A.stroke = j == null ? D : j;
	let M = h.append("g");
	n.icon && M.html(`<g>${await m(n.icon, {
		height: f,
		width: f,
		fallbackPrefix: ""
	})}</g>`);
	let N = M.node().getBBox(), P = N.width, F = N.height, I = N.x, L = N.y, R = Math.max(P, F) * Math.SQRT2 + 40, z = k.circle(0, 0, R, A), B = Math.max(R, g.width), V = R + g.height + b, H = k.rectangle(-B / 2, -V / 2, B, V, {
		...
		fill: "transparent",
		stroke: "none"
	}), U = h.insert(() => z, ":first-child"), W = h.insert(() => H);
	return M.attr("transform", `translate(${-P / 2 - I},${w ? g.height / 2 + b / 2 - F / 2 - L : -g.height / 2 - b / 2 - F / 2 - L})`), M.attr("style", `color: ${(s = O.get("stroke")) == null ? E : s};`), _.attr("transform", `translate(${-g.width / 2 - (g.x - ((c = g.left) == null ? 0 : c))},${w ? -V / 2 : V / 2 - g.height})`), U.attr("transform", `translate(0,${w ? g.height / 2 + b / 2 : -g.height / 2 - b / 2})`), T(n, W), n.intersect = function(e) {
...
async function Le(e, n, { config: { themeVariables: r, flowchart: i } }) {
	...
	let l = (a = n.assetHeight) == null ? 48 : a, u = (o = n.assetWidth) == null ? 48 : o, d = Math.max(l, u), f = i == null ? void 0 : i.wrappingWidth;
	n.width = Math.max(d, f == null ? 0 : f);
	let { shapeSvg: p, bbox: h, halfPadding: g, label: _ } = await C(e, n, "icon-shape default"), b = n.pos === "t", w = d + g * 2, E = d + g * 2, { nodeBorder: D, mainBkg: O } = r, { stylesMap: k } = x(n), A = -E / 2, j = -w / 2, M = n.label ? 8 : 0, P = S.svg(p), F = v(n, {});
	n.look !== "handDrawn" && (F.roughness = 0, F.fillStyle = "solid");
	let I = k.get("fill");
	F.stroke = I == null ? O : I;
	let L = P.path(N(A, j, E, w, 5), F), R = Math.max(E, h.width), z = w + h.height + M, B = P.rectangle(-R / 2, -z / 2, R, z, {
		...F,
		fill: "transparent",
		stroke: "none"
	...
	if (n.icon) {
		...
		let t = e.node().getBBox(), r = t.width, i = t.height, a = t.x, o = t.y;
		e.attr("transform", `translate(${-r / 2 - a},${b ? h.height / 2 + M / 2 - i / 2 - o : -h.height / 2 - M / 2 - i / 2 - o})`), e.attr("style", `color: ${(U = k.get("stroke")) == null ? D : U};`);
	}
	return _.attr("transform", `translate(${-h.width / 2 - (h.x - ((s = h.left) == null ? 0 : s))},${b ? -z / 2 : z / 2 - h.height})`), V.attr("transform", `translate(0,${b ? h.height / 2 + M / 2 : -h.height / 2 - M / 2})`), T(n, H), n.intersect = function(e) {
		var r, i, a;
		if (t.info("iconSquare intersect", n, e), !n.label) return K.rect(n, e);
		let o = (r = n.x) == null ? 0 : r, s = (i = n.y) == null ? 0 : i, c = (a = n.height) == null ? 0 : a, l = [];
		return l = b ? [
...
async function Re(e, n, { config: { themeVariables: r, flowchart: i } }) {
	...
	let I = k.get("fill");
	F.stroke = I == null ? O : I;
	let L = P.path(N(A, j, E, w, .1), F), R = Math.max(E, h.width), z = w + h.height + M, B = P.rectangle(-R / 2, -z / 2, R, z, {
		...F,
		fill: "transparent",
		stroke: "none"
...
e(Re, "iconSquare");
async function ze(e, n, { config: { flowchart: r } }) {
	var i, a, o, s;
	let c = new Image();
	...
	let { shapeSvg: g, bbox: _, label: b } = await C(e, n, "image-shape default"), x = n.pos === "t", w = -m / 2, E = -h / 2, D = n.label ? 8 : 0, O = S.svg(g), k = v(n, {});
	n.look !== "handDrawn" && (k.roughness = 0, k.fillStyle = "solid");
	...
	return b.attr("transform", `translate(${-_.width / 2 - (_.x - ((s = _.left) == null ? 0 : s))},${x ? -h / 2 - _.height / 2 - D / 2 : h / 2 - _.height / 2 + D / 2})`), P.attr("transform", `translate(0,${x ? _.height / 2 + D / 2 : -_.height / 2 - D / 2})`), T(n, F), n.intersect = function(e) {
		var r, i, a;
		if (t.info("iconSquare intersect", n, e), !n.label) return K.rect(n, e);
		let o = (r = n.x) == null ? 0 : r, s = (i = n.y) == null ? 0 : i, c = (a = n.height) == null ? 0 : a, l = [];
		return l = x ? [
...
function We(e, n) {
	...
	let c = e.insert("g").attr("class", E(n)).attr("id", (r = n.domId) == null ? n.id : r), { cssStyles: l } = n, u = Math.max(35, (i = n == null ? void 0 : n.width) == null ? 0 : i), d = Math.max(35, (a = n == null ? void 0 : n.height) == null ? 0 : a), f = [
		{
			x: u,
			y: 0
		},
	...
	return _.attr("class", "outer-path"), l && n.look !== "handDrawn" && _.selectAll("path").attr("style", l), s && n.look !== "handDrawn" && _.selectAll("path").attr("style", s), _.attr("transform", `translate(-${u / 2},${-d})`), T(n, _), n.intersect = function(e) {
		return t.info("lightningBolt intersect", n, e), K.polygon(n, f, e);
	}, c;
}
e(We, "lightningBolt");
...
async function Xe(e, t) {
	...
	if (t.width || t.height) {
		...
		t.width = ((d = t.width) == null ? 0 : d) - c, t.width < Ye && (t.width = Ye);
		let n = e / 2 / (2.5 + e / 50);
		t.height = ((f = t.height) == null ? 0 : f) - l - n * 3, t.height < Je && (t.height = Je);
	}
...
async function nt(e, t) {
	...
	if (t.look === "handDrawn") {
		let e = S.svg(o), n = v(t, {}), r = tt(0, 0, c), i = e.path(r, n);
...
async function it(e, r) {
	...
	let c = e.insert("g").attr("class", s).attr("id", r.domId || r.id), u = c.insert("g"), d = c.insert("g").attr("class", "label").attr("style", a), f = r.description, p = r.label, m = await M(d, p, r.labelStyle, !0, !0), h = {
		width: 0,
		height: 0
	};
	if (o(l())) {
	...
	if (r.look === "handDrawn") {
		let e = S.svg(c), n = v(r, {}), i = e.path(N(O, k, E, D, r.rx || 0), n), a = e.line(-h.width / 2 - w, -h.height / 2 - w + _.height + w, h.width / 2 + w, -h.height / 2 - w + _.height + w, n);
...
async function st(e, t) {
	...
	let { labelStyles: c, nodeStyles: l } = y(t);
	t.labelStyle = c;
	let u = t.look === "neo" ? 16 : (n = t.padding) == null ? 0 : n, d = t.look === "neo" ? 12 : (r = t.padding) == null ? 0 : r, { shapeSvg: f, bbox: m, label: h } = await C(e, t, E(t)), g = ((i = t == null ? void 0 : t.width) == null ? m.width : i) + u * 2 + (t.look === "neo" ? ot : ot * 2), _ = ((a = t == null ? void 0 : t.height) == null ? m.height : a) + d * 2, b = g - ot, x = _, w = ot - g / 2, D = -_ / 2, { cssStyles: O } = t, k = S.svg(f), A = v(t, {});
	t.look !== "handDrawn" && (A.roughness = 0, A.fillStyle = "solid");
	let j = [
		{
			x: w,
	...
	return N.attr("class", "basic label-container outer-path").attr("style", p(O)), l && t.look !== "handDrawn" && N.selectAll("path").attr("style", l), O && t.look !== "handDrawn" && N.selectAll("path").attr("style", l), h.attr("transform", `translate(${ot / 2 - m.width / 2 - (m.x - ((o = m.left) == null ? 0 : o))}, ${-(m.height / 2) - (m.y - ((s = m.top) == null ? 0 : s))})`), T(t, N), t.intersect = function(e) {
		return K.rect(t, e);
	}, f;
}
e(st, "shadedProcess");
...
function ft(e, t, { config: { themeVariables: n } }) {
	...
	return T(t, w), t.intersect = function(e) {
		var n;
		return K.circle(t, ((n = t.width) == null ? 0 : n) / 2, e);
	}, m;
}
e(ft, "stateEnd");
function pt(e, t, { config: { themeVariables: n } }) {
	...
	return T(t, c), t.intersect = function(e) {
		var n;
		return K.circle(t, ((n = t.width) == null ? 7 : n) / 2, e);
	}, s;
}
e(pt, "stateStart");
var mt = 8;
async function ht(e, t) {
	...
	let { labelStyles: a, nodeStyles: o } = y(t);
	t.labelStyle = a;
	let s = (n = t == null ? void 0 : t.padding) == null ? 8 : n, c = t.look === "neo" ? 28 : s, l = t.look === "neo" ? 12 : s, { shapeSvg: u, bbox: d } = await C(e, t, E(t)), f = ((r = t == null ? void 0 : t.width) == null ? d.width : r) + 2 * mt + c, m = ((i = t == null ? void 0 : t.height) == null ? d.height : i) + l, h = f - 2 * mt, g = m, _ = -f / 2, b = -m / 2, x = [
		{
			x: 0,
			y: 0
		},
	...
	if (t.look === "handDrawn") {
		let e = S.svg(u), n = v(t, {}), r = e.rectangle(_, b, h + 16, g, n), i = e.line(_ + mt, b, _ + mt, b + g, n), a = e.line(_ + mt + h, b, _ + mt + h, b + g, n);
...
async function _t(e, t) {
	...
	if (t.width || t.height) {
		var c, l;
		t.height = Math.max(((c = t == null ? void 0 : t.height) == null ? 0 : c) - s * 2, 10), t.width = Math.max(((l = t == null ? void 0 : t.width) == null ? 0 : l) - o * 2 - gt * (t.height + s * 2), 10);
	}
	let { shapeSvg: u, bbox: d } = await C(e, t, E(t)), f = (t != null && t.height ? t == null ? void 0 : t.height : d.height) + s * 2, p = gt * f, m = gt * f, h = (t != null && t.width ? t == null ? void 0 : t.width : d.width) + o * 2 + p - p, g = f, _ = -h / 2, b = -g / 2, { cssStyles: x } = t, w = S.svg(u), O = v(t, {}), k = [
		{
			x: _ - p / 2,
			y: b
		},
...
async function Tt(e, t) {
	...
	if (t.width || t.height) {
		...
		t.height = ((u = t.height) == null ? 0 : u) - c, t.height < Ct && (t.height = Ct);
		let n = e / 2 / (2.5 + e / 50);
		t.width = ((d = t.width) == null ? 0 : d) - c - n * 3, t.width < wt && (t.width = wt);
	}
	...
	if (t.look === "handDrawn") {
		let e = S.svg(f), n = xt(0, 0, x, g, b, _), r = St(0, 0, x, g, b, _), i = e.path(n, v(t, {})), a = e.path(r, v(t, { fill: "none" }));
		D = f.insert(() => a, ":first-child"), D = f.insert(() => i, ":first-child"), D.attr("class", "basic label-container"), w && D.attr("style", w);
	} else {
		let e = bt(0, 0, x, g, b, _);
	...
	return D.attr("label-offset-x", b), D.attr("transform", `translate(${-x / 2}, ${g / 2} )`), h.attr("transform", `translate(${-(m.width / 2) - b - (m.x - ((r = m.left) == null ? 0 : r))}, ${-(m.height / 2) - (m.y - ((i = m.top) == null ? 0 : i))})`), T(t, D), t.intersect = function(e) {
		var n, r, i, a, o;
		let s = K.rect(t, e), c = s.y - ((n = t.y) == null ? 0 : n);
...
async function At(e, n) {
	...
	if (n.width || n.height) {
		var m, h;
		n.width = (((m = n == null ? void 0 : n.width) == null ? 0 : m) - p) / 2, n.width < kt && (n.width = kt), n.height = (h = n == null ? void 0 : n.height) == null ? 0 : h, n.height < Ot && (n.height = Ot);
	}
	let { shapeSvg: g, bbox: _, label: b } = await C(e, n, E(n)), x = c((i = l().flowchart) == null ? void 0 : i.htmlLabels), w = (n != null && n.width ? n == null ? void 0 : n.width : _.width) + p, O = n != null && n.height ? n == null ? void 0 : n.height : w + _.height, k = O, A = [
		{
			x: 0,
			y: 0
		},
	...
	return j && n.look !== "handDrawn" && I.selectChildren("path").attr("style", j), d && n.look !== "handDrawn" && I.selectChildren("path").attr("style", d), n.width = w, n.height = O, T(n, I), b.attr("transform", `translate(${-_.width / 2 - (_.x - ((a = _.left) == null ? 0 : a))}, ${O / 2 - (_.height + ((o = n.padding) == null ? 0 : o) / (x ? 2 : 1) - (_.y - ((s = _.top) == null ? 0 : s)))})`), n.intersect = function(e) {
		return t.info("Triangle intersect", n, A, e), K.polygon(n, A, e);
	}, g;
}
e(At, "triangle");
...
async function It(e, t) {
	...
	let M = E(t);
	M || (M = "node default");
	let N = e.insert("g").attr("class", M).attr("id", t.domId || t.id), P = await Lt(N, (l = t.label) == null ? "" : l, x, 0, 0, ["name"], O);
	P.height += w;
	let F = 0, I = [], L = [], R = 0, z = 0, B = 0, V = 0, H = !0, U = !0;
	for (let e of d.attributes) {
		let t = await Lt(N, e.type, x, 0, F, ["attribute-type"], O);
		R = Math.max(R, t.width + C);
		let n = await Lt(N, e.name, x, 0, F, ["attribute-name"], O);
		z = Math.max(z, n.width + C);
		let r = await Lt(N, e.keys.join(), x, 0, F, ["attribute-keys"], O);
		B = Math.max(B, r.width + C);
		let i = await Lt(N, e.comment, x, 0, F, ["attribute-comment"], O);
	...
	let te = R + z + B + V, G = S.svg(N), ne = v(t, {});
	t.look !== "handDrawn" && (ne.roughness = 0, ne.fillStyle = "solid");
	let re = 0;
	L.length > 0 && (re = L.reduce((e, t) => {
		var n;
		return e + ((n = t == null ? void 0 : t.rowHeight) == null ? 0 : n);
	}, 0));
	let ie = Math.max(ee.width + C * 2, (t == null ? void 0 : t.width) || 0, te), ae = Math.max(((u = re) == null ? 0 : u) + P.height, (t == null ? void 0 : t.height) || 0), q = -ie / 2, J = -ae / 2;
	if (N.selectAll("g:not(:first-child)").each((e, t, r) => {
		...
		i.attr("transform", `translate(${q + C / 2 + o}, ${s + J + P.height + w / 2})`);
	}), N.select(".name").attr("transform", "translate(" + -P.width / 2 + ", " + (J + w / 2) + ")"), p != null && Pt.has(p)) {
		var Y;
		let e = (Y = d.colorIndex) == null ? 0 : Y;
		N.attr("data-color-id", `color-${e % b.length}`);
	}
	let oe = G.rectangle(q, J, ie, ae, ne), se = N.insert(() => oe, ":first-child").attr("class", "outer-path").attr("style", D.join(""));
	I.push(0);
	for (let [e, t] of L.entries()) {
		let n = (e + 1) % 2 == 0 && t.yOffset !== 0, r = G.rectangle(q, P.height + J + (t == null ? void 0 : t.yOffset), ie, t == null ? void 0 : t.rowHeight, {
			...ne,
			fill: n ? h : g,
			stroke: _
		});
	...
	let ce = 1e-4, X = Rt(q, P.height + J, ie + q, P.height + J, ce), Z = G.polygon(X.map((e) => [e.x, e.y]), ne);
	if (N.insert(() => Z).attr("class", "divider"), X = Rt(R + q, P.height + J, R + q, ae + J, ce), Z = G.polygon(X.map((e) => [e.x, e.y]), ne), N.insert(() => Z).attr("class", "divider"), H) {
		let e = R + z + q;
		X = Rt(e, P.height + J, e, ae + J, ce), Z = G.polygon(X.map((e) => [e.x, e.y]), ne), N.insert(() => Z).attr("class", "divider");
	}
	if (U) {
		let e = R + z + B + q;
		X = Rt(e, P.height + J, e, ae + J, ce), Z = G.polygon(X.map((e) => [e.x, e.y]), ne), N.insert(() => Z).attr("class", "divider");
	...
	for (let e of I) {
		let t = P.height + J + e;
		X = Rt(q, t, ie + q, t, ce), Z = G.polygon(X.map((e) => [e.x, e.y]), ne), N.insert(() => Z).attr("class", "divider");
	}
	if (T(t, se), k && t.look !== "handDrawn") if (p != null && Ft.has(p)) N.selectAll("path").attr("style", k);
	else {
		var le;
...
e(It, "erBox");
async function Lt(e, t, r, i = 0, o = 0, s = [], l = "") {
...
e(Rt, "lineToPolygon");
async function zt(e, t, n, r, i = ((e) => (e = n.class.padding) == null ? 12 : e)()) {
...
e(zt, "textHelper");
async function Bt(t, a, o, l = []) {
	var u;
	let p = t.insert("g").attr("class", "label").attr("style", l.join("; ")), m = s(), g = "useHtmlLabels" in a ? a.useHtmlLabels : (u = c(m.htmlLabels)) == null || u, _ = "";
	_ = "text" in a ? a.text : a.label, !g && _.startsWith("\\") && (_ = _.substring(1)), r(_) && (g = !0);
	let v = await h(p, i(d(_)), {
		width: f(_, m) + 50,
		classes: "markdown-node-label",
		useHtmlLabels: g
	}, m), y, b = 1;
	if (g) {
		let t = v.children[0], r = n(v);
		b = t.innerHTML.split("<br>").length, t.innerHTML.includes("</math>") && (b += t.innerHTML.split("<mrow>").length - 1);
		let i = t.getElementsByTagName("img");
		if (i) {
			let t = _.replace(/<img[^>]*>/g, "").trim() === "";
			await Promise.all([...i].map((n) => new Promise((r) => {
				function i() {
					if (n.style.display = "flex", n.style.flexDirection = "column", t) {
						var e, i;
						let t = (e = (i = m.fontSize) == null ? void 0 : i.toString()) == null ? window.getComputedStyle(document.body).fontSize : e, r = parseInt(t, 10) * 5 + "px";
		...
		y = t.getBoundingClientRect(), r.attr("width", y.width), r.attr("height", y.height);
	} else {
...
async function Vt(e, t) {
	...
	let g = l(), { themeVariables: _ } = g, { useGradient: b } = _, x = (r = g.class.padding) == null ? 12 : r, C = x, w = (i = (a = t.useHtmlLabels) == null ? c(g.htmlLabels) : a) == null || i, E = t;
	E.annotations = (o = E.annotations) == null ? [] : o, E.members = (s = E.members) == null ? [] : s, E.methods = (u = E.methods) == null ? [] : u;
	let { shapeSvg: D, bbox: O } = await zt(e, t, g, w, C), { labelStyles: k, nodeStyles: A } = y(t);
...
async function Ht(e, t) {
	...
	x = p ? await Ut(b, `&lt;&lt;${d.type}&gt;&gt;`, 0, t.labelStyle) : await Ut(b, "&lt;&lt;Element&gt;&gt;", 0, t.labelStyle);
	let C = x, w = await Ut(b, d.name, C, t.labelStyle + "; font-weight: bold;");
	if (C += w + 20, p) {
		let e = await Ut(b, `${d.requirementId ? `ID: ${d.requirementId}` : ""}`, C, t.labelStyle);
		C += e;
		let n = await Ut(b, `${d.text ? `Text: ${d.text}` : ""}`, C, t.labelStyle);
		C += n;
		let r = await Ut(b, `${d.risk ? `Risk: ${d.risk}` : ""}`, C, t.labelStyle);
		C += r, await Ut(b, `${d.verifyMethod ? `Verification: ${d.verifyMethod}` : ""}`, C, t.labelStyle);
	} else {
		let e = await Ut(b, `${f.type ? `Type: ${f.type}` : ""}`, C, t.labelStyle);
		C += e, await Ut(b, `${f.docRef ? `Doc Ref: ${f.docRef}` : ""}`, C, t.labelStyle);
	}
...
async function Ut(e, t, r, a = "") {
	var o;
	if (t === "") return 0;
	let s = e.insert("g").attr("class", "label").attr("style", a), c = l(), u = (o = c.htmlLabels) == null || o, p = await h(s, i(d(t)), {
		width: f(t, c) + 50,
		classes: "markdown-node-label",
		useHtmlLabels: u,
		style: a
	...
	return s.attr("transform", `translate(${-m.width / 2},${-m.height / 2 + r})`), m.height;
}
e(Ut, "addText");
var Wt = /* @__PURE__ */ e((e) => {
	switch (e) {
...
async function Gt(e, t, { config: n }) {
	var r, i;
	let { labelStyles: a, nodeStyles: o } = y(t);
	t.labelStyle = a || "";
	let s = t.width;
	...
	if (t.look === "handDrawn") {
		...
		if (e) {
			...
			t.attr("x1", n).attr("y1", r).attr("x2", n).attr("y2", i).attr("stroke-width", "4").attr("stroke", Wt(e));
		}
	}
...
e(Jt, "defaultMindmapNode");
async function Yt(e, t) {
	var n;
	return X(e, t, { padding: (n = t.padding) == null ? 0 : n });
}
e(Yt, "mindmapCircle");
var Xt = [
	{
...
async function en(e, t, n) {
	...
	let a = t.shape ? Zt[t.shape] : void 0;
	...
	return r.attr("data-look", p(t.look)), t.tooltip && i.attr("title", t.tooltip), $t.set(t.id, r), t.haveCallback && r.attr("class", r.attr("class") + " clickable"), r;
}
e(en, "insertNode");
var tn = /* @__PURE__ */ e((e, t) => {
	$t.set(t.id, e);
}, "setNodeElem"), nn = /* @__PURE__ */ e(() => {
	$t.clear();
}, "clear"), rn = /* @__PURE__ */ e((e) => {
	let n = $t.get(e.id);
...
//#endregion
export { en as a, rn as c, R as i, tn as l, nn as n, Qt as o, M as r, C as s, z as t, T as u };
