...
import { H as r, K as i, U as a, a as o, b as s, v as c, w as l, x as u, y as d } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { g as f } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
...
import { t as p } from "./chunk-XXDRQBXY-6qvi-T3x.mjs";
import { t as m } from "./chunk-VR4S4FIN-HQ9uQ67o.mjs";
import "./chunk-C7G6YPKG-BGTLz-ew.mjs";
import "./chunk-ZGVPDNZ5-CA-MSk8G.mjs";
import "./chunk-52WLFC77-CEdJfckq.mjs";
import { r as h, t as g } from "./chunk-FWX5IMBZ-Dx6oqe1x.mjs";
...
var w = /* @__PURE__ */ e(async function(e, t, r, i) {
	...
	let { securityLevel: l, state: d, layout: _, look: v } = u(), y = i.db.getData(), b = p(t, l);
	y.type = i.type, y.layoutAlgorithm = g(_), y.nodeSpacing = (a = d == null ? void 0 : d.nodeSpacing) == null ? 50 : a, y.rankSpacing = (o = d == null ? void 0 : d.rankSpacing) == null ? 50 : o, y.markers = v === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], y.diagramId = t, await h(y, b), f.insertTitle(b, "requirementDiagramTitleText", (s = d == null ? void 0 : d.titleTopMargin) == null ? 25 : s, i.db.getDiagramTitle()), m(b, 8, "requirementDiagram", (c = d == null ? void 0 : d.useMaxWidth) == null || c);
}, "draw"), T = {
	parser: y,
	get db() {
		return new b();
