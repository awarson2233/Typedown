...
import { H as n, J as r, K as i, U as a, a as o, d as s, s as c, v as l, w as u, x as d, y as f } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { n as p } from "./ordinal-CW5ORdHW.mjs";
import { t as m } from "./colors-DFBw_t9n.mjs";
...
function ee() {
	...
	function m() {
		...
		return h(e), y(e), b(e), x(e), P(e), N(e), e;
	}
	m.update = function(e) {
		return N(e), e;
	}, m.nodeId = function(e) {
	...
	function P(e) {
		let n = C(e);
		o = Math.min(a, (r - t) / (g(n, (e) => e.length) - 1)), ee(n);
		for (let e = 0; e < p; ++e) {
	...
	function L(e, n) {
		...
		z(e, a.y0 - o, i - 1, n), R(e, a.y1 + o, i + 1, n), z(e, r, e.length - 1, n), R(e, t, 0, n);
	}
	function R(e, t, n, r) {
		for (; n < e.length; ++n) {
	...
	function B({ sourceLinks: e, targetLinks: t }) {
		if (u === void 0) {
...
var P = Math.PI, F = 2 * P, I = 1e-6, L = F - I;
function R() {
...
R.prototype = z.prototype = {
	...
	arc: function(e, t, n, r, i, a) {
		...
		this._x1 === null ? this._ += "M" + c + "," + l : (Math.abs(this._x1 - c) > I || Math.abs(this._y1 - l) > I) && (this._ += "L" + c + "," + l), n && (d < 0 && (d = d % F + F), d > L ? this._ += "A" + n + "," + n + ",0,1," + u + "," + (e - o) + "," + (t - s) + "A" + n + "," + n + ",0,1," + u + "," + (this._x1 = c) + "," + (this._y1 = l) : d > I && (this._ += "A" + n + "," + n + ",0," + +(d >= P) + "," + u + "," + (this._x1 = e + n * Math.cos(i)) + "," + (this._y1 = t + n * Math.sin(i))));
	},
...
function re(e) {
	var t = te, n = ne, r = V, i = H, a = null;
	function o() {
		var o, s = U.call(arguments), c = t.apply(this, s), l = n.apply(this, s);
		if (a || (a = o = z()), e(a, +r.apply(this, (s[0] = c, s)), +i.apply(this, s), +r.apply(this, (s[0] = l, s)), +i.apply(this, s)), o) return a = null, o + "" || null;
	}
	return o.source = function(e) {
		...
		return arguments.length ? (r = typeof e == "function" ? e : B(+e), o) : r;
	}, o.y = function(e) {
		return arguments.length ? (i = typeof e == "function" ? e : B(+e), o) : i;
	}, o.context = function(e) {
		return arguments.length ? (a = e == null ? null : e, o) : a;
	}, o;
}
...
function oe() {
	return ie().source(G).target(ae);
}
//#endregion
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/sankeyDiagram-5OEKKPKP.mjs
...
Y.parser = Y;
var X = Y, Z = [], Q = [], $ = /* @__PURE__ */ new Map(), se = /* @__PURE__ */ e(() => {
	Z = [], Q = [], $ = /* @__PURE__ */ new Map(), o();
}, "clear"), ce = (K = class {
	constructor(e, t, n = 0) {
		this.source = e, this.target = t, this.value = n;
	}
}, e(K, "SankeyLink"), K), le = /* @__PURE__ */ e((e, t, n) => {
	Z.push(new ce(e, t, n));
}, "addLink"), ue = (q = class {
	constructor(e) {
		this.ID = e;
	...
	getNodes: /* @__PURE__ */ e(() => Q, "getNodes"),
	getLinks: /* @__PURE__ */ e(() => Z, "getLinks"),
	getGraph: /* @__PURE__ */ e(() => ({
		nodes: Q.map((e) => ({ id: e.ID })),
		links: Z.map((e) => ({
			source: e.source.ID,
			target: e.target.ID,
			value: e.value
	...
	findOrCreateNode: /* @__PURE__ */ e((e) => {
		...
		let t = $.get(e);
		return t === void 0 && (t = new ue(e), $.set(e, t), Q.push(t)), t;
	}, "findOrCreateNode"),
	getAccTitle: f,
	setAccTitle: a,
	getAccDescription: l,
	...
	for (let a of e) {
		var r;
		let e = (r = a.value) == null ? 0 : r;
		if (e > t) {
			var i;
			t = e, n = (i = a.layer) == null ? 0 : i;
		}
	}
	return n;
}, "findCentralNodeLayer"), he = { draw: /* @__PURE__ */ e(function(n, i, a, o) {
	var c, l, u, f, m, g, _, v, y, b, x, S, C, w, T;
	let { securityLevel: E, sankey: D } = d(), O = s.sankey, k;
	E === "sandbox" && (k = t("#i" + i));
	let A = t(E === "sandbox" ? k.nodes()[0].contentDocument.body : "body"), j = E === "sandbox" ? A.select(`[id="${i}"]`) : t(`[id="${i}"]`), M = (c = D == null ? void 0 : D.width) == null ? O.width : c, N = (l = D == null ? void 0 : D.height) == null ? O.width : l, P = (u = D == null ? void 0 : D.useMaxWidth) == null ? O.useMaxWidth : u, F = (f = D == null ? void 0 : D.nodeAlignment) == null ? O.nodeAlignment : f, I = (m = D == null ? void 0 : D.prefix) == null ? O.prefix : m, L = (g = D == null ? void 0 : D.suffix) == null ? O.suffix : g, R = (_ = D == null ? void 0 : D.showValues) == null ? O.showValues : _, z = (v = (y = D == null ? void 0 : D.nodeWidth) == null ? O.nodeWidth : y) == null ? 10 : v, B = (b = (x = D == null ? void 0 : D.nodePadding) == null ? O.nodePadding : x) == null ? 12 : b, V = (S = (C = D == null ? void 0 : D.labelStyle) == null ? O.labelStyle : C) == null ? "legacy" : S, H = (w = D == null ? void 0 : D.nodeColors) == null ? {} : w, U = o.db.getGraph(), te = pe[F];
	ee().nodeId((e) => e.id).nodeWidth(z).nodePadding(B + (R ? 15 : 0)).nodeAlign(te).extent([[0, 0], [M, N]])(U);
	let ne = me(U.nodes), re = p(h), W = /* @__PURE__ */ e((e) => {
		var t;
		return (t = H[e]) == null ? re(e) : t;
	}, "getNodeColor");
	j.append("g").attr("class", "nodes").selectAll(".node").data(U.nodes).join("g").attr("class", "node").attr("id", (e) => (e.uid = fe.next("node-")).id).attr("transform", function(e) {
		return "translate(" + e.x0 + "," + e.y0 + ")";
	}).attr("x", (e) => e.x0).attr("y", (e) => e.y0).append("rect").attr("height", (e) => e.y1 - e.y0).attr("width", (e) => e.x1 - e.x0).attr("fill", (e) => W(e.id));
	let ie = /* @__PURE__ */ e(({ id: e, value: t }) => R ? `${e}
${I}${Math.round(t * 100) / 100}${L}` : e, "getText"), G = /* @__PURE__ */ e((e) => {
		if (V === "outlined") {
			var t;
			return ((t = e.layer) == null ? 0 : t) < ne ? {
				x: e.x0 - 6,
				anchor: "end"
			} : {
				x: e.x1 + 6,
	...
	}, "getLabelPosition"), ae = j.append("g").attr("class", "node-labels").attr("font-size", 14), K = /* @__PURE__ */ e((e) => ae.selectAll(e ? `.${e}` : "text").data(U.nodes).join("text").attr("class", e == null ? null : e).attr("x", (e) => G(e).x).attr("y", (e) => (e.y1 + e.y0) / 2).attr("dy", `${R ? "0" : "0.35"}em`).attr("text-anchor", (e) => G(e).anchor).text(ie), "appendLabel");
	V === "outlined" ? (K("sankey-label-bg"), K("sankey-label-fg")) : K();
	let q = j.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", .5).selectAll(".link").data(U.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), J = (T = D == null ? void 0 : D.linkColor) == null ? "gradient" : T;
	if (J === "gradient") {
		let e = q.append("linearGradient").attr("id", (e) => (e.uid = fe.next("linearGradient-")).id).attr("gradientUnits", "userSpaceOnUse").attr("x1", (e) => e.source.x1).attr("x2", (e) => e.target.x0);
		e.append("stop").attr("offset", "0%").attr("stop-color", (e) => W(e.source.id)), e.append("stop").attr("offset", "100%").attr("stop-color", (e) => W(e.target.id));
	}
	let Y;
	switch (J) {
		case "gradient":
			Y = /* @__PURE__ */ e((e) => e.uid, "coloring");
			break;
		case "source":
			Y = /* @__PURE__ */ e((e) => W(e.source.id), "coloring");
			break;
		case "target":
			Y = /* @__PURE__ */ e((e) => W(e.target.id), "coloring");
			break;
		default: Y = J;
	}
	q.append("path").attr("d", oe()).attr("stroke", Y).attr("stroke-width", (e) => Math.max(1, e.width)), r(void 0, j, 0, P);
