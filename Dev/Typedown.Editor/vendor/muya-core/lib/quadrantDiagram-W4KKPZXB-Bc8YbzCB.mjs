...
import { D as r, H as i, K as a, U as o, a as s, c, f as l, v as u, w as d, x as f, y as p, z as m } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { t as h } from "./linear-CUX0sJcW.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/quadrantDiagram-W4KKPZXB.mjs
var g, _, v = (function() {
	...
	return t(me, "Parser"), me.prototype = pe, pe.Parser = me, new me();
})();
v.parser = v;
var y = v, b = r(), x = (g = class {
	...
	getDefaultConfig() {
		var e, t, n, r, i, a, o, s, c, u, d, f, p, m, h, g, _, v;
		return {
			showXAxis: !0,
			showYAxis: !0,
			showTitle: !0,
			chartHeight: ((e = l.quadrantChart) == null ? void 0 : e.chartWidth) || 500,
			chartWidth: ((t = l.quadrantChart) == null ? void 0 : t.chartHeight) || 500,
			titlePadding: ((n = l.quadrantChart) == null ? void 0 : n.titlePadding) || 10,
			titleFontSize: ((r = l.quadrantChart) == null ? void 0 : r.titleFontSize) || 20,
			quadrantPadding: ((i = l.quadrantChart) == null ? void 0 : i.quadrantPadding) || 5,
			xAxisLabelPadding: ((a = l.quadrantChart) == null ? void 0 : a.xAxisLabelPadding) || 5,
			yAxisLabelPadding: ((o = l.quadrantChart) == null ? void 0 : o.yAxisLabelPadding) || 5,
			xAxisLabelFontSize: ((s = l.quadrantChart) == null ? void 0 : s.xAxisLabelFontSize) || 16,
			yAxisLabelFontSize: ((c = l.quadrantChart) == null ? void 0 : c.yAxisLabelFontSize) || 16,
			quadrantLabelFontSize: ((u = l.quadrantChart) == null ? void 0 : u.quadrantLabelFontSize) || 16,
			quadrantTextTopPadding: ((d = l.quadrantChart) == null ? void 0 : d.quadrantTextTopPadding) || 5,
			pointTextPadding: ((f = l.quadrantChart) == null ? void 0 : f.pointTextPadding) || 5,
			pointLabelFontSize: ((p = l.quadrantChart) == null ? void 0 : p.pointLabelFontSize) || 12,
			pointRadius: ((m = l.quadrantChart) == null ? void 0 : m.pointRadius) || 5,
			xAxisPosition: ((h = l.quadrantChart) == null ? void 0 : h.xAxisPosition) || "top",
			yAxisPosition: ((g = l.quadrantChart) == null ? void 0 : g.yAxisPosition) || "left",
			quadrantInternalBorderStrokeWidth: ((_ = l.quadrantChart) == null ? void 0 : _.quadrantInternalBorderStrokeWidth) || 1,
			quadrantExternalBorderStrokeWidth: ((v = l.quadrantChart) == null ? void 0 : v.quadrantExternalBorderStrokeWidth) || 2
		};
	}
	...
	getQuadrantPoints(e) {
		...
		return this.data.points.map((e) => {
			var t, n, r, i;
			let a = this.classes.get(e.className);
			return a && (e = {
				...a,
				...e
			}), {
				x: o(e.x),
				y: s(e.y),
				fill: (t = e.color) == null ? this.themeConfig.quadrantPointFill : t,
				radius: (n = e.radius) == null ? this.config.pointRadius : n,
				text: {
					text: e.text,
				...
				strokeColor: (r = e.strokeColor) == null ? this.themeConfig.quadrantPointFill : r,
				strokeWidth: (i = e.strokeWidth) == null ? "0px" : i
			};
		});
	}
	getBorders(e) {
...
var O = new x();
function k(e) {
	O.setData({ quadrant1Text: D(e.text) });
}
t(k, "setQuadrant1Text");
function A(e) {
	O.setData({ quadrant2Text: D(e.text) });
}
t(A, "setQuadrant2Text");
function j(e) {
	O.setData({ quadrant3Text: D(e.text) });
}
t(j, "setQuadrant3Text");
function M(e) {
	O.setData({ quadrant4Text: D(e.text) });
}
t(M, "setQuadrant4Text");
function N(e) {
	O.setData({ xAxisLeftText: D(e.text) });
}
t(N, "setXAxisLeftText");
function P(e) {
	O.setData({ xAxisRightText: D(e.text) });
}
t(P, "setXAxisRightText");
function F(e) {
	O.setData({ yAxisTopText: D(e.text) });
}
t(F, "setYAxisTopText");
function I(e) {
	O.setData({ yAxisBottomText: D(e.text) });
}
t(I, "setYAxisBottomText");
function L(e) {
	let t = {};
	for (let n of e) {
...
t(z, "addClass");
function B(e) {
	O.setConfig({ chartWidth: e });
}
t(B, "setWidth");
function V(e) {
	O.setConfig({ chartHeight: e });
}
t(V, "setHeight");
function ee() {
	let { themeVariables: e, quadrantChart: t } = f();
	return t && O.setConfig(t), O.setThemeConfig({
	...
	}), O.setData({ titleText: d() }), O.build();
}
t(ee, "getQuadrantData");
var te = {
	parser: y,
	db: {
		setWidth: B,
	...
	renderer: { draw: /* @__PURE__ */ t((r, i, a, o) => {
		...
		t(_, "getTransformation");
		let v = f();
		e.debug("Rendering quadrant chart\n" + r);
		let y = v.securityLevel, b;
		y === "sandbox" && (b = n("#i" + i));
		let x = n(y === "sandbox" ? b.nodes()[0].contentDocument.body : "body").select(`[id="${i}"]`), S = x.append("g").attr("class", "main"), C = (s = (l = v.quadrantChart) == null ? void 0 : l.chartWidth) == null ? 500 : s, w = (u = (d = v.quadrantChart) == null ? void 0 : d.chartHeight) == null ? 500 : u;
		c(x, w, C, (p = (m = v.quadrantChart) == null ? void 0 : m.useMaxWidth) == null ? !0 : p), x.attr("viewBox", "0 0 " + C + " " + w), o.db.setHeight(w), o.db.setWidth(C);
		let T = o.db.getQuadrantData(), E = S.append("g").attr("class", "quadrants"), D = S.append("g").attr("class", "border"), O = S.append("g").attr("class", "data-points"), k = S.append("g").attr("class", "labels"), A = S.append("g").attr("class", "title");
		T.title && A.append("text").attr("x", 0).attr("y", 0).attr("fill", T.title.fill).attr("font-size", T.title.fontSize).attr("dominant-baseline", h(T.title.horizontalPos)).attr("text-anchor", g(T.title.verticalPos)).attr("transform", _(T.title)).text(T.title.text), T.borderLines && D.selectAll("line").data(T.borderLines).enter().append("line").attr("x1", (e) => e.x1).attr("y1", (e) => e.y1).attr("x2", (e) => e.x2).attr("y2", (e) => e.y2).style("stroke", (e) => e.strokeFill).style("stroke-width", (e) => e.strokeWidth);
		let j = E.selectAll("g.quadrant").data(T.quadrants).enter().append("g").attr("class", "quadrant");
		j.append("rect").attr("x", (e) => e.x).attr("y", (e) => e.y).attr("width", (e) => e.width).attr("height", (e) => e.height).attr("fill", (e) => e.fill), j.append("text").attr("x", 0).attr("y", 0).attr("fill", (e) => e.text.fill).attr("font-size", (e) => e.text.fontSize).attr("dominant-baseline", (e) => h(e.text.horizontalPos)).attr("text-anchor", (e) => g(e.text.verticalPos)).attr("transform", (e) => _(e.text)).text((e) => e.text.text), k.selectAll("g.label").data(T.axisLabels).enter().append("g").attr("class", "label").append("text").attr("x", 0).attr("y", 0).text((e) => e.text).attr("fill", (e) => e.fill).attr("font-size", (e) => e.fontSize).attr("dominant-baseline", (e) => h(e.horizontalPos)).attr("text-anchor", (e) => g(e.verticalPos)).attr("transform", (e) => _(e));
		let M = O.selectAll("g.data-point").data(T.points).enter().append("g").attr("class", "data-point");
		M.append("circle").attr("cx", (e) => e.x).attr("cy", (e) => e.y).attr("r", (e) => e.radius).attr("fill", (e) => e.fill).attr("stroke", (e) => e.strokeColor).attr("stroke-width", (e) => e.strokeWidth), M.append("text").attr("x", 0).attr("y", 0).text((e) => e.text.text).attr("fill", (e) => e.text.fill).attr("font-size", (e) => e.text.fontSize).attr("dominant-baseline", (e) => h(e.text.horizontalPos)).attr("text-anchor", (e) => g(e.text.verticalPos)).attr("transform", (e) => _(e.text));
	}, "draw") },
