...
import { O as r, T as i, a, b as o, c as s, rt as c, s as l, x as u, z as d } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { t as f } from "./channel-CrTnM7c1.mjs";
import { _ as p } from "./step-BfRmncvF.mjs";
import { t as m } from "./line-BiBUgSr7.mjs";
import { A as h, B as g, C as _, D as v, E as y, F as b, G as x, H as S, I as C, L as w, M as T, N as E, O as D, P as O, R as k, T as A, U as j, V as ee, W as te, a as ne, b as re, g as M, j as ie, k as ae, l as oe, v as se, w as ce, z as le } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import "./chunk-HOUHSVGY-2PLbOYM-.mjs";
import { n as ue } from "./chunk-Q4XR5HBZ-KP7VNg4F.mjs";
import { t as de } from "./chunk-5VM5RSS4-TqxtqrwE.mjs";
import { n as fe, t as N } from "./chunk-7BUUIJ7U-Cnx5Zlja.mjs";
import { n as pe, t as me } from "./chunk-OGEWGWER-Cn1Z4hFw.mjs";
import { t as he } from "./graphlib-B6n0CQ68.mjs";
		...
		parse: /* @__PURE__ */ e(function(t) {
			...
			for (var S, C, w, T, E, D = {}, O, k, A, j;;) {
				if (w = r[r.length - 1], this.defaultActions[w] ? T = this.defaultActions[w] : (S == null && (S = x()), T = s[w] && s[w][S]), T === void 0 || !T.length || !T[0]) {
					...
					ee = h.showPosition ? "Parse error on line " + (l + 1) + ":\n" + h.showPosition() + "\nExpecting " + j.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : "Parse error on line " + (l + 1) + ": Unexpected " + (S == p ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(ee, {
						text: h.match,
...
P.parser = P;
var Ce = P, F = /* @__PURE__ */ new Map(), we = [], Te = /* @__PURE__ */ new Map(), Ee = "color", De = "fill", Oe = "bgFill", ke = ",", I = /* @__PURE__ */ new Map(), Ae = "", je = /* @__PURE__ */ e((e) => l.sanitizeText(e, u()), "sanitizeText"), Me = /* @__PURE__ */ e(function(e, t = "") {
	let n = I.get(e);
	n || (n = {
		id: e,
		styles: [],
		textStyles: []
	}, I.set(e, n)), t != null && t.split(ke).forEach((e) => {
...
}, "addStyleClass"), Ne = /* @__PURE__ */ e(function(e, t = "") {
	let n = F.get(e);
	t != null && (n.styles = t.split(ke));
}, "addStyle2Node"), Pe = /* @__PURE__ */ e(function(e, t) {
...
}, "setCssClass"), Fe = /* @__PURE__ */ e((e, n) => {
	var r;
	let i = e.flat(), a = [], o = i.find((e) => (e == null ? void 0 : e.type) === "column-setting"), s = (r = o == null ? void 0 : o.columns) == null ? -1 : r;
	for (let e of i) {
		if (typeof s == "number" && s > 0 && e.type !== "column-setting" && typeof e.widthInColumns == "number" && e.widthInColumns > s && t.warn(`Block ${e.id} width ${e.widthInColumns} exceeds configured column width ${s}`), e.label && (e.label = je(e.label)), e.type === "classDef") {
			Me(e.id, e.css);
			continue;
		}
		if (e.type === "applyClass") {
			var c;
			Pe(e.id, (c = e == null ? void 0 : e.styleClass) == null ? "" : c);
			continue;
		}
		if (e.type === "applyStyles") {
			e != null && e.stylesStr && Ne(e.id, e == null ? void 0 : e.stylesStr);
			continue;
		}
		if (e.type === "column-setting") {
			var l;
			n.columns = (l = e.columns) == null ? -1 : l;
		} else if (e.type === "edge") {
			var u;
			let t = ((u = Te.get(e.id)) == null ? 0 : u) + 1;
			...
			if (t === void 0 ? F.set(e.id, e) : (e.type !== "na" && (t.type = e.type), e.label !== e.id && (t.label = e.label)), e.children && Fe(e.children, e), e.type === "space") {
				...
				for (let n = 0; n < t; n++) {
					let t = _e(e);
					t.id = t.id + "-" + n, F.set(t.id, t), a.push(t);
				}
...
e(Ve, "edgeStrToEdgeStartData");
function He(e) {
	return e.includes("==") ? "thick" : "normal";
}
e(He, "edgeStrToThickness");
function Ue(e) {
	return e.includes(".-") ? "dotted" : "solid";
}
e(Ue, "edgeStrToPattern");
var We = 0, Ge = {
	getConfig: /* @__PURE__ */ e(() => o().block, "getConfig"),
	typeStr2Type: Re,
	edgeTypeStr2Type: ze,
	...
	getBlocksFlat: /* @__PURE__ */ e(() => [...F.values()], "getBlocksFlat"),
	getBlocks: /* @__PURE__ */ e(() => Ie || [], "getBlocks"),
	getEdges: /* @__PURE__ */ e(() => we, "getEdges"),
	setHierarchy: /* @__PURE__ */ e((e) => {
		L.children = e, Fe(e, L), Ie = L.children;
	}, "setHierarchy"),
	getBlock: /* @__PURE__ */ e((e) => F.get(e), "getBlock"),
	...
	clear: Le,
	generateId: /* @__PURE__ */ e(() => (We++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + We), "generateId"),
	setDiagramId: /* @__PURE__ */ e((e) => {
		Ae = e;
	}, "setDiagramId"),
	getDiagramId: /* @__PURE__ */ e(() => Ae, "getDiagramId")
}, R = /* @__PURE__ */ e((e, t) => {
	let n = f;
	return c(n(e, "r"), n(e, "g"), n(e, "b"), t);
}, "fade"), Ke = /* @__PURE__ */ e((e) => `.label {
  ...
  ${de()}
`, "getStyles"), qe = /* @__PURE__ */ e((e, t, n, r) => {
	t.forEach((t) => {
		Je[t](e, n, r);
	});
}, "insertMarkers"), Je = {
...
var Xe = /* @__PURE__ */ e((e) => {
	...
	for (let o of e.children) {
		...
		if (t.debug("getMaxChildSize abc95 child:", o.id, "width:", e, "height:", s, "x:", c, "y:", l, o.type), o.type === "space") continue;
		let u = e / ((a = o.widthInColumns) == null ? 1 : a);
		u > n && (n = u), s > r && (r = s);
	}
	return {
		width: n,
...
function B(e, n, r = 0, i = 0, a = 8) {
	var o, s, c, l, u, d, f;
	t.debug("setBlockSizes abc95 (start)", e.id, e == null || (o = e.size) == null ? void 0 : o.x, "block width =", e == null ? void 0 : e.size, "siblingWidth", r), !(e == null || (s = e.size) == null) && s.width || (e.size = {
		width: r,
		height: i,
		x: 0,
		y: 0
	...
	if (((c = e.children) == null ? void 0 : c.length) > 0) {
		var h, g, _;
		for (let t of e.children) B(t, n, 0, 0, a);
		let o = Xe(e);
		p = o.width, m = o.height, t.debug("setBlockSizes abc95 maxWidth of", e.id, ":s children is ", p, m);
		for (let n of e.children) if (n.size) {
			var v, y;
			t.debug(`abc95 Setting size of children of ${e.id} id=${n.id} ${p} ${m} ${JSON.stringify(n.size)}`), n.size.width = p * ((v = n.widthInColumns) == null ? 1 : v) + a * (((y = n.widthInColumns) == null ? 1 : y) - 1), n.size.height = m, n.size.x = 0, n.size.y = 0, t.debug(`abc95 updating size of ${e.id} children child:${n.id} maxWidth:${p} maxHeight:${m}`);
		}
		for (let t of e.children) B(t, n, p, m, a);
		let s = (h = e.columns) == null ? -1 : h, c = 0;
		for (let t of e.children) {
			var b;
			c += (b = t.widthInColumns) == null ? 1 : b;
		}
		let l = e.children.length;
		s > 0 && s < c && (l = s);
		let u = Math.ceil(c / l), d = l * (p + a) + a, f = u * (m + a) + a;
		if (d < r) {
			t.debug(`Detected to small sibling: abc95 ${e.id} siblingWidth ${r} siblingHeight ${i} width ${d}`), d = r, f = i;
			let n = (r - l * a - a) / l, o = (i - u * a - a) / u;
			t.debug("Size indata abc88", e.id, "childWidth", n, "maxWidth", p), t.debug("Size indata abc88", e.id, "childHeight", o, "maxHeight", m), t.debug("Size indata abc88 xSize", l, "padding", a);
			for (let t of e.children) t.size && (t.size.width = n, t.size.height = o, t.size.x = 0, t.size.y = 0);
		}
		if (t.debug(`abc95 (finale calc) ${e.id} xSize ${l} ySize ${u} columns ${s}${e.children.length} width=${Math.max(d, ((g = e.size) == null ? void 0 : g.width) || 0)}`), d < ((e == null || (_ = e.size) == null ? void 0 : _.width) || 0)) {
			var x;
			d = (e == null || (x = e.size) == null ? void 0 : x.width) || 0;
			let n = s > 0 ? Math.min(e.children.length, s) : e.children.length;
			if (n > 0) {
				var S;
				let r = (d - n * a - a) / n;
				t.debug("abc95 (growing to fit) width", e.id, d, (S = e.size) == null ? void 0 : S.width, r);
	...
	t.debug("setBlockSizes abc94 (done)", e.id, e == null || (l = e.size) == null ? void 0 : l.x, e == null || (u = e.size) == null ? void 0 : u.width, e == null || (d = e.size) == null ? void 0 : d.y, e == null || (f = e.size) == null ? void 0 : f.height);
}
e(B, "setBlockSizes");
function V(e, n, r = 8) {
	var i, a, o, s, c, l, u;
	t.debug(`abc85 layout blocks (=>layoutBlocks) ${e.id} x: ${e == null || (i = e.size) == null ? void 0 : i.x} y: ${e == null || (a = e.size) == null ? void 0 : a.y} width: ${e == null || (o = e.size) == null ? void 0 : o.width}`);
	let d = (s = e.columns) == null ? -1 : s;
	if (t.debug("layoutBlocks columns abc95", e.id, "=>", d, e), e.children && e.children.length > 0) {
		var f, p, m, h, g, _;
		let i = (f = e == null || (p = e.children[0]) == null || (p = p.size) == null ? void 0 : p.width) == null ? 0 : f, a = e.children.length * i + (e.children.length - 1) * r;
		...
		let o = /* @__PURE__ */ new Map();
		{
			...
			for (let n of e.children) {
				var v, y;
				if (!n.size) continue;
				let { py: e } = z(d, t), r = (v = o.get(e)) == null ? 0 : v;
				n.size.height > r && o.set(e, n.size.height);
				let i = (y = n == null ? void 0 : n.widthInColumns) == null ? 1 : y;
				d > 0 && (i = Math.min(i, d - t % d)), t += i;
			}
		}
		let s = /* @__PURE__ */ new Map();
		{
			...
			for (let n of t) {
				var b;
				s.set(n, e), e += ((b = o.get(n)) == null ? 0 : b) + r;
			}
		}
		let c = 0;
		t.debug("abc91 block?.size?.x", e.id, e == null || (m = e.size) == null ? void 0 : m.x);
		let l = !(e == null || (h = e.size) == null) && h.x ? (e == null || (g = e.size) == null ? void 0 : g.x) + (-(e == null || (_ = e.size) == null ? void 0 : _.width) / 2 || 0) : -r, u = 0;
		for (let i of e.children) {
			var x, S, C;
			let a = e;
			if (!i.size) continue;
			let { width: f, height: p } = i.size, { px: m, py: h } = z(d, c);
			if (h != u) {
				var w, T, E;
				u = h, l = !(e == null || (w = e.size) == null) && w.x ? (e == null || (T = e.size) == null ? void 0 : T.x) + (-(e == null || (E = e.size) == null ? void 0 : E.width) / 2 || 0) : -r, t.debug("New row in layout for block", e.id, " and child ", i.id, u);
			}
			if (t.debug(`abc89 layout blocks (child) id: ${i.id} Pos: ${c} (px, py) ${m},${h} (${a == null || (x = a.size) == null ? void 0 : x.x},${a == null || (S = a.size) == null ? void 0 : S.y}) parent: ${a.id} width: ${f}${r}`), a.size) {
				var D, O, k, A;
				let e = f / 2;
				i.size.x = l + r + e, t.debug(`abc91 layout blocks (calc) px, pyid:${i.id} startingPos=X${l} new startingPosX${i.size.x} ${e} padding=${r} width=${f} halfWidth=${e} => x:${i.size.x} y:${i.size.y} ${i.widthInColumns} (width * (child?.w || 1)) / 2 ${f * ((D = i == null ? void 0 : i.widthInColumns) == null ? 1 : D) / 2}`), l = i.size.x + e;
				let n = (O = s.get(h)) == null ? 0 : O, c = (k = o.get(h)) == null ? p : k;
				i.size.y = a.size.y - a.size.height / 2 + n + c / 2 + r, t.debug(`abc88 layout blocks (calc) px, pyid:${i.id}startingPosX${l}${r}${e}=>x:${i.size.x}y:${i.size.y}${i.widthInColumns}(width * (child?.w || 1)) / 2${f * ((A = i == null ? void 0 : i.widthInColumns) == null ? 1 : A) / 2}`);
			}
			i.children && V(i, n, r);
			let g = (C = i == null ? void 0 : i.widthInColumns) == null ? 1 : C;
			d > 0 && (g = Math.min(g, d - c % d)), c += g, t.debug("abc88 columnsPos", i, c);
		}
	}
	t.debug(`layout blocks (<==layoutBlocks) ${e.id} x: ${e == null || (c = e.size) == null ? void 0 : c.x} y: ${e == null || (l = e.size) == null ? void 0 : l.y} width: ${e == null || (u = e.size) == null ? void 0 : u.width}`);
}
e(V, "layoutBlocks");
...
function Ze(e) {
	var n, r;
	let i = e.getBlock("root");
	if (!i) return;
	let a = (n = (r = u()) == null || (r = r.block) == null ? void 0 : r.padding) == null ? 8 : n;
	B(i, e, 0, 0, a), V(i, e, a), t.debug("getBlocks", JSON.stringify(i, null, 2));
	let { minX: o, minY: s, maxX: c, maxY: l } = H(i), d = l - s;
	return {
		x: o,
		y: s,
		width: c - o,
...
e(Ze, "layout");
var U = /* @__PURE__ */ e(async (e, t, n, r = !1, a = !1) => {
	let o = t || "";
...
}, "createLabel"), Qe = /* @__PURE__ */ e((e, t, n, r, i) => {
...
}, "addEdgeMarker"), tt = {}, W = {}, nt = /* @__PURE__ */ e(async (e, t) => {
	...
	s.attr("transform", N(f, a)), tt[t.id] = o, t.width = d.width, t.height = d.height;
	let p;
	if (t.startLabelLeft) {
...
var rt = /* @__PURE__ */ e((e, n) => {
	t.debug("Moving label abc88 ", e.id, e.label, tt[e.id], n);
	let r = n.updatedPath ? n.updatedPath : n.originalPath, { subGraphTitleTotalMargin: i } = pe(u());
	if (e.label) {
		let a = tt[e.id], o = e.x, s = e.y;
		if (r) {
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
...
}, "intersection"), ot = /* @__PURE__ */ e((e, n) => {
...
}, "cutPathAtIntersect"), st = /* @__PURE__ */ e(function(e, n, i, a, o, s, c) {
	let l = i.points;
	t.debug("abc88 InsertEdge: edge=", i, "e=", n);
	let d = !1, f = s.node(n.v);
	var h = s.node(n.w);
	h != null && h.intersect && f != null && f.intersect && (l = l.slice(1, i.points.length - 1), l.unshift(f.intersect(l[0])), l.push(h.intersect(l[l.length - 1]))), i.toCluster && (t.debug("to cluster abc88", a[i.toCluster]), l = ot(i.points, a[i.toCluster].node), d = !0), i.fromCluster && (t.debug("from cluster abc88", a[i.fromCluster]), l = ot(l.reverse(), a[i.fromCluster].node).reverse(), d = !0);
	...
	let S = e.append("path").attr("d", b(g)).attr("id", i.id).attr("class", " " + x + (i.classes ? " " + i.classes : "")).attr("style", i.style), C = "";
	(u().flowchart.arrowMarkerAbsolute || u().state.arrowMarkerAbsolute) && (C = r(!0)), Qe(S, i, C, c, o);
	let w = {};
	return d && (w.updatedPath = l), w.originalPath = i.points, w;
}, "insertEdge"), ct = /* @__PURE__ */ e((e) => {
	...
	return t;
}, "expandAndDeduplicateDirections"), lt = /* @__PURE__ */ e((e, t, n, r) => {
	let i = ct(e), a = t.height + 2 * n.padding, o = a / 2, s = r == null ? t.width + 2 * o + n.padding : r, c = n.padding / 2;
...
e(ft, "intersectEllipse");
var pt = ft;
function mt(e, t, n) {
	return pt(e, t, t, n);
}
e(mt, "intersectCircle");
var ht = mt;
function gt(e, t, n, r) {
...
var xt = /* @__PURE__ */ e(async (e, n) => {
	n.useHtmlLabels || i(u()) || (n.centerLabel = !0);
	let { shapeSvg: r, bbox: a, halfPadding: o } = await q(e, n, "node " + n.classes, !0);
...
}, "note"), St = /* @__PURE__ */ e((e) => e ? " " + e : "", "formatClass"), X = /* @__PURE__ */ e((e, t) => `${t || "node default"}${St(e.classes)} ${St(e.class)}`, "getClassesFromNode"), Ct = /* @__PURE__ */ e(async (e, n) => {
...
}, "choice"), Tt = /* @__PURE__ */ e(async (e, t) => {
...
}, "hexagon"), Et = /* @__PURE__ */ e(async (e, t) => {
	var n;
	let { shapeSvg: r, bbox: i } = await q(e, t, void 0, !0), a = i.height + 2 * t.padding, o = a / 2, s = i.width + 2 * o + t.padding, c = t.positioned && ((n = t.widthInColumns) == null ? 1 : n) > 1 && t.width > s ? t.width : s, l = lt(t.directions, i, t, c), u = Y(r, c, a, l);
	return u.attr("style", t.style), J(t, u), t.intersect = function(e) {
		return K.polygon(t, l, e);
	}, r;
}, "block_arrow"), Dt = /* @__PURE__ */ e(async (e, t) => {
...
}, "rect_left_inv_arrow"), Ot = /* @__PURE__ */ e(async (e, t) => {
...
}, "lean_right"), kt = /* @__PURE__ */ e(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: 2 * a / 6,
			y: 0
...
}, "lean_left"), At = /* @__PURE__ */ e(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: -2 * a / 6,
			y: 0
...
}, "trapezoid"), jt = /* @__PURE__ */ e(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: a / 6,
			y: 0
...
}, "inv_trapezoid"), Mt = /* @__PURE__ */ e(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: 0,
			y: 0
...
}, "rect_right_inv_arrow"), Nt = /* @__PURE__ */ e(async (e, t) => {
...
}, "cylinder"), Pt = /* @__PURE__ */ e(async (e, n) => {
...
var Lt = /* @__PURE__ */ e(async (e, r) => {
	let a;
	a = r.classes ? "node " + r.classes : "node default";
	let o = e.insert("g").attr("class", a).attr("id", r.domId || r.id), s = o.insert("rect", ":first-child"), c = o.insert("line"), l = o.insert("g").attr("class", "label"), d = r.labelText.flat ? r.labelText.flat() : r.labelText, f = "";
	f = typeof d == "object" ? d[0] : d, t.info("Label text abc79", f, d, typeof d == "object");
...
}, "rectWithTitle"), Rt = /* @__PURE__ */ e(async (e, t) => {
...
}, "stadium"), zt = /* @__PURE__ */ e(async (e, n) => {
...
}, "circle"), Bt = /* @__PURE__ */ e(async (e, n) => {
...
}, "doublecircle"), Vt = /* @__PURE__ */ e(async (e, t) => {
	let { shapeSvg: n, bbox: r } = await q(e, t, X(t, void 0), !0), i = r.width + t.padding, a = r.height + t.padding, o = [
		{
			x: 0,
			y: 0
	...
	if (t.link) {
		let a;
		u().securityLevel === "sandbox" ? a = "_top" : t.linkTarget && (a = t.linkTarget || "_blank"), r = e.insert("svg:a").attr("xlink:href", t.link).attr("target", a), i = await Wt[t.shape](r, t, n);
...
function qt(e, t, n = !1) {
	...
	let _ = oe((i = d == null ? void 0 : d.styles) == null ? [] : i), v = d.label, y = (a = d.size) == null ? {
		width: 0,
		height: 0,
		x: 0,
		y: 0
...
e(qt, "getNodeFromBlock");
async function Jt(e, t, n) {
	let r = qt(t, n, !1);
	if (r.type === "group") return;
	let i = await Gt(e, r, { config: o() }), a = i.node().getBBox(), s = n.getBlock(r.id);
	s.size = {
		width: a.width,
		height: a.height,
		x: 0,
...
e(Jt, "calculateBlockSize");
async function Yt(e, t, n) {
	let r = qt(t, n, !0);
	n.getBlock(r.id).type !== "space" && (await Gt(e, r, { config: o() }), t.intersect = r == null ? void 0 : r.intersect, Kt(r));
}
e(Yt, "insertBlockPositioned");
...
var $t = {
	...
	db: Ge,
	renderer: {
		draw: /* @__PURE__ */ e(async function(e, r, i, a) {
			...
			await Xt(_, m, u);
			let v = Ze(u);
			if (await Zt(_, m, u), await Qt(_, g, h, u, r), v) {
				let e = v, n = Math.max(1, Math.round(.125 * (e.width / e.height))), r = e.height + n + 10, i = e.width + 10, { useMaxWidth: a } = l;
				s(p, r, i, !!a), t.debug("Here Bounds", v, e), p.attr("viewBox", `${e.x - 5} ${e.y - 5} ${e.width + 10} ${e.height + 10}`);
			}
		}, "draw"),
