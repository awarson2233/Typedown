import { a as e, f as t, i as n, v as r } from "./linear-CUX0sJcW.mjs";
import { n as i } from "./init-ZY92GAe7.mjs";
...
var c = /* @__PURE__ */ new Date(), l = /* @__PURE__ */ new Date();
function u(e, t, n, r) {
	function i(t) {
	...
	}), n && (i.count = (t, r) => (c.setTime(+t), l.setTime(+r), e(c), e(l), Math.floor(n(c, l))), i.every = (e) => (e = Math.floor(e), !isFinite(e) || !(e > 0) ? null : e > 1 ? i.filter(r ? (t) => r(t) % e === 0 : (t) => i.count(0, t) % e === 0) : i)), i;
}
//#endregion
...
d.every = (e) => (e = Math.floor(e), !isFinite(e) || !(e > 0) ? null : e > 1 ? u((t) => {
...
var f = 1e3, p = f * 60, m = p * 60, h = m * 24, g = h * 7, _ = h * 30, v = h * 365, y = u((e) => {
...
var S = u((e) => {
	e.setTime(e - e.getMilliseconds() - e.getSeconds() * f - e.getMinutes() * p);
}, (e, t) => {
	e.setTime(+e + t * m);
}, (e, t) => (t - e) / m, (e) => e.getHours());
S.range;
var C = u((e) => {
	e.setUTCMinutes(0, 0, 0);
}, (e, t) => {
	e.setTime(+e + t * m);
}, (e, t) => (t - e) / m, (e) => e.getUTCHours());
C.range;
//#endregion
//#region ../../node_modules/.pnpm/d3-time@3.1.0/node_modules/d3-time/src/day.js
var w = u((e) => e.setHours(0, 0, 0, 0), (e, t) => e.setDate(e.getDate() + t), (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * p) / h, (e) => e.getDate() - 1);
w.range;
var T = u((e) => {
	e.setUTCHours(0, 0, 0, 0);
}, (e, t) => {
	e.setUTCDate(e.getUTCDate() + t);
}, (e, t) => (t - e) / h, (e) => e.getUTCDate() - 1);
T.range;
var E = u((e) => {
	e.setUTCHours(0, 0, 0, 0);
}, (e, t) => {
	e.setUTCDate(e.getUTCDate() + t);
}, (e, t) => (t - e) / h, (e) => Math.floor(e / h));
E.range;
//#endregion
...
function D(e) {
	...
	}, (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * p) / g);
}
var O = D(0), k = D(1), A = D(2), j = D(3), M = D(4), N = D(5), P = D(6);
O.range, k.range, A.range, j.range, M.range, N.range, P.range;
function F(e) {
	return u((t) => {
...
var I = F(0), L = F(1), ee = F(2), te = F(3), R = F(4), ne = F(5), re = F(6);
I.range, L.range, ee.range, te.range, R.range, ne.range, re.range;
//#endregion
...
V.every = (e) => !isFinite(e = Math.floor(e)) || !(e > 0) ? null : u((t) => {
...
H.every = (e) => !isFinite(e = Math.floor(e)) || !(e > 0) ? null : u((t) => {
...
function U(e, n, i, a, o, s) {
	...
	function u(n, i, a) {
		let o = Math.abs(i - n) / a, s = r(([, , e]) => e).right(c, o);
		if (s === c.length) return e.every(t(n / v, i / v, a));
		if (s === 0) return d.every(Math.max(t(n, i, a), 1));
		let [l, u] = c[o / c[s - 1][2] < c[s][2] / o ? s - 1 : s];
		return l.every(u);
	}
	return [l, u];
}
var [ie, ae] = U(H, B, I, E, C, x), [oe, se] = U(V, z, O, w, S, b);
//#endregion
...
function ce(e) {
	var t = e.dateTime, n = e.date, r = e.time, i = e.periods, a = e.days, o = e.shortDays, s = e.months, c = e.shortMonths, l = Y(i), u = X(i), d = Y(a), f = X(a), p = Y(o), m = X(o), h = Y(s), g = X(s), _ = Y(c), v = X(c), y = {
		a: I,
		A: ee,
		b: te,
		B: R,
	...
	function C(e, t) {
		return function(n) {
			var r = K(1900, void 0, 1), i = E(r, e, n += "", 0), a, o;
			if (i != n.length) return null;
			if ("Q" in r) return new Date(r.Q);
			if ("s" in r) return new Date(r.s * 1e3 + ("L" in r ? r.L : 0));
			if (t && !("Z" in r) && (r.Z = 0), "p" in r && (r.H = r.H % 12 + r.p * 12), r.m === void 0 && (r.m = "q" in r ? r.q : 0), "V" in r) {
				if (r.V < 1 || r.V > 53) return null;
				"w" in r || (r.w = 1), "Z" in r ? (a = G(K(r.y, 0, 1)), o = a.getUTCDay(), a = o > 4 || o === 0 ? L.ceil(a) : L(a), a = T.offset(a, (r.V - 1) * 7), r.y = a.getUTCFullYear(), r.m = a.getUTCMonth(), r.d = a.getUTCDate() + (r.w + 6) % 7) : (a = W(K(r.y, 0, 1)), o = a.getDay(), a = o > 4 || o === 0 ? k.ceil(a) : k(a), a = w.offset(a, (r.V - 1) * 7), r.y = a.getFullYear(), r.m = a.getMonth(), r.d = a.getDate() + (r.w + 6) % 7);
...
function Ge(e, t) {
	return e = We(e), J(M.count(V(e), e) + (V(e).getDay() === 4), t, 2);
}
function Ke(e) {
	return e.getDay();
}
function qe(e, t) {
	return J(k.count(V(e) - 1, e), t, 2);
}
function Je(e, t) {
	return J(e.getFullYear() % 100, t, 2);
}
function Ye(e, t) {
	return e = We(e), J(e.getFullYear() % 100, t, 2);
}
function Xe(e, t) {
...
function Ze(e, t) {
	var n = e.getDay();
	return e = n >= 4 || n === 0 ? M(e) : M.ceil(e), J(e.getFullYear() % 1e4, t, 4);
}
function Qe(e) {
...
function dt(e, t) {
	return e = ut(e), J(R.count(H(e), e) + (H(e).getUTCDay() === 4), t, 2);
}
function ft(e) {
	return e.getUTCDay();
}
function pt(e, t) {
	return J(L.count(H(e) - 1, e), t, 2);
}
function mt(e, t) {
	return J(e.getUTCFullYear() % 100, t, 2);
}
function ht(e, t) {
	return e = ut(e), J(e.getUTCFullYear() % 100, t, 2);
}
function gt(e, t) {
...
function _t(e, t) {
	var n = e.getUTCDay();
	return e = n >= 4 || n === 0 ? R(e) : R.ceil(e), J(e.getUTCFullYear() % 1e4, t, 4);
}
function vt() {
	return "+0000";
}
...
function Tt(e) {
	return Z = ce(e), Q = Z.format, St = Z.parse, Ct = Z.utcFormat, wt = Z.utcParse, Z;
}
//#endregion
...
function $(t, r, i, a, o, c, l, u, d, f) {
	var p = n(), m = p.invert, h = p.domain, g = f(".%L"), _ = f(":%S"), v = f("%I:%M"), y = f("%I %p"), b = f("%a %d"), x = f("%b %d"), S = f("%B"), C = f("%Y");
	function w(e) {
		return (d(e) < e ? g : u(e) < e ? _ : l(e) < e ? v : c(e) < e ? y : a(e) < e ? o(e) < e ? b : x : i(e) < e ? S : C)(e);
	}
	return p.invert = function(e) {
		return new Date(m(e));
	}, p.domain = function(e) {
		return arguments.length ? h(Array.from(e, Dt)) : h().map(Et);
	}, p.ticks = function(e) {
		var n = h();
		return t(n[0], n[n.length - 1], e == null ? 10 : e);
	}, p.tickFormat = function(e, t) {
		return t == null ? w : f(t);
	}, p.nice = function(e) {
		var t = h();
		return (!e || typeof e.range != "function") && (e = r(t[0], t[t.length - 1], e == null ? 10 : e)), e ? h(s(t, e)) : p;
	}, p.copy = function() {
		return e(p, $(t, r, i, a, o, c, l, u, d, f));
	}, p;
}
function Ot() {
	return i.apply($(oe, se, V, z, O, w, S, b, y, Q).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}
//#endregion
export { s as A, T as C, x as D, b as E, a as M, y as O, w as S, C as T, O as _, Ct as a, j as b, ae as c, H as d, z as f, P as g, k as h, St as i, o as j, d as k, ie as l, N as m, Ot as n, wt as o, B as p, Q as r, ce as s, $ as t, V as u, M as v, S as w, I as x, A as y };
