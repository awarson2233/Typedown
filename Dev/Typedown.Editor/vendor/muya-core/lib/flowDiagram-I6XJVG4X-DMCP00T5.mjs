...
import { G as i, H as a, K as o, U as s, a as c, d as l, rt as u, s as d, v as f, w as p, x as m, y as h } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { t as g } from "./channel-CU6vqdKT.mjs";
import { c as _, g as v } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import "./chunk-O5CBEL6O-DN64hWSU.mjs";
import { t as ee } from "./chunk-FMBD7UC4-DiPYrba8.mjs";
import "./chunk-BSJP7CBP-CmHmwk33.mjs";
import "./chunk-L5ZTLDWV-EfUVro68.mjs";
import { t as te } from "./chunk-ND2GUHAM-N7r7v8wk.mjs";
import { t as ne } from "./chunk-55IACEB6-DWxyqrIq.mjs";
import { t as y } from "./chunk-2J33WTMH-5W4hnvSY.mjs";
import "./chunk-NZK2D7GU-BP4KY081.mjs";
import { o as b } from "./chunk-3OPIFGDE-Al6MeL3x.mjs";
import "./chunk-KSCS5N6A-Do-wUxiw.mjs";
import { r as x, t as S } from "./chunk-LZXEDZCA-CElJAnI4.mjs";
import { n as C, t as w } from "./chunk-XPW4576I-oigDzoPt.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/flowDiagram-I6XJVG4X.mjs
var T, E = "flowchart-", D = (T = class {
	constructor() {
	...
	addVertex(e, n, r, i, a, o, s = {}, c) {
		...
		if (u) {
			let e = l;
			(e == null ? void 0 : e.animate) !== void 0 && (u.animate = e.animate), (e == null ? void 0 : e.animation) !== void 0 && (u.animation = e.animation), (e == null ? void 0 : e.curve) !== void 0 && (u.interpolate = e.curve);
			return;
		}
		let d, f = this.vertices.get(e);
		if (f === void 0 && (n === void 0 && r === void 0 && i != null && t.warn(`Style applied to unknown node "${e}". This may indicate a typo. The node will be created automatically.`), f = {
			id: e,
			labelType: "text",
			domId: E + e + "-" + this.vertexCounter,
			styles: [],
			classes: []
		}, this.vertices.set(e, f)), this.vertexCounter++, n === void 0 ? f.text === void 0 && (f.text = e) : (this.config = m(), d = this.sanitizeText(n.text.trim()), f.labelType = n.type, d.startsWith("\"") && d.endsWith("\"") && (d = d.substring(1, d.length - 1)), f.text = d), r !== void 0 && (f.type = r), i != null && i.forEach((e) => {
			f.styles.push(e);
		}), a != null && a.forEach((e) => {
			f.classes.push(e);
			...
			if (l.shape) {
				...
				if (!b(l.shape)) throw Error(`No such shape: ${l.shape}.`);
				f.type = l == null ? void 0 : l.shape;
			}
			if (l != null && l.label && (f.text = l == null ? void 0 : l.label, f.labelType = this.sanitizeNodeLabelType(l == null ? void 0 : l.labelType)), l != null && l.icon) {
				var p;
				f.icon = l == null ? void 0 : l.icon, !((p = l.label) != null && p.trim()) && f.text === e && (f.text = "");
			}
			if (l != null && l.form && (f.form = l == null ? void 0 : l.form), l != null && l.pos && (f.pos = l == null ? void 0 : l.pos), l != null && l.img) {
				var h;
				f.img = l == null ? void 0 : l.img, !((h = l.label) != null && h.trim()) && f.text === e && (f.text = "");
			}
			l != null && l.constraint && (f.constraint = l.constraint), l.w && (f.assetWidth = Number(l.w)), l.h && (f.assetHeight = Number(l.h));
		}
	}
	addSingleLink(e, n, r, i) {
		...
		t.info("abc78 Got edge...", o);
		let s = r.text;
		if (s !== void 0 && (o.text = this.sanitizeText(s.text.trim()), o.text.startsWith("\"") && o.text.endsWith("\"") && (o.text = o.text.substring(1, o.text.length - 1)), o.labelType = this.sanitizeNodeLabelType(s.type)), r !== void 0 && (o.type = r.type, o.stroke = r.stroke, o.length = r.length > 10 ? 10 : r.length), i && !this.edges.some((e) => e.id === i)) o.id = i, o.isUserDefinedId = !0;
		else {
			let e = this.edges.filter((e) => e.start === o.start && e.end === o.end);
			e.length === 0 ? o.id = _(o.start, o.end, {
				counter: 0,
				prefix: "L"
			}) : o.id = _(o.start, o.end, {
				counter: e.length + 1,
				prefix: "L"
			});
		}
		if (this.edges.length < ((a = this.config.maxEdges) == null ? 500 : a)) t.info("Pushing edge..."), this.edges.push(o);
...
You have to call mermaid.initialize.`);
	...
	updateLink(e, t) {
		e.forEach((e) => {
			...
			if (e === "default") this.edges.defaultStyle = t;
			else {
				var n, r, i;
				if (this.edges[e].style = t, ((n = (r = this.edges[e]) == null || (r = r.style) == null ? void 0 : r.length) == null ? 0 : n) > 0 && !(!((i = this.edges[e]) == null || (i = i.style) == null) && i.some((e) => e == null ? void 0 : e.startsWith("fill")))) {
					var a;
					(a = this.edges[e]) == null || (a = a.style) == null || a.push("fill:none");
				}
			}
		});
	}
	addClass(e, t) {
		...
		e.split(",").forEach((e) => {
			...
			t === void 0 && (t = {
				...
				styles: [],
				textStyles: []
			}, this.classes.set(e, t)), n != null && n.forEach((e) => {
				if (/color/.exec(e)) {
	...
	setupToolTips(t) {
		...
		r(t).select("svg").selectAll("g.node").on("mouseover", (t) => {
			var i;
			let a = r(t.currentTarget), o = a.attr("title");
			if (o === null) return;
			let s = (i = t.currentTarget) == null ? void 0 : i.getBoundingClientRect();
			n.transition().duration(200).style("opacity", ".9"), n.text(a.attr("title")).style("left", window.scrollX + s.left + (s.right - s.left) / 2 + "px").style("top", window.scrollY + s.bottom + "px"), n.html(e.sanitize(o)), a.classed("hover", !0);
		}).on("mouseout", (e) => {
	...
	addSubGraph(e, r, i) {
		var a, o, s, c, l;
		let u = e.text.trim(), d = i.text;
		e === i && /\s/.exec(i.text) && (u = void 0);
		let f = (/* @__PURE__ */ n((e) => {
			let t = {
				boolean: {},
				number: {},
		...
		}, "uniq"))(r.flat()), p = f.nodeList, h = f.dir, g = (a = m().flowchart) == null ? {} : a;
		if (h = (o = h) == null ? g.inheritDir ? (s = (c = this.getDirection()) == null ? m().direction : c) == null ? void 0 : s : void 0 : o, this.version === "gen-1") for (let e = 0; e < p.length; e++) p[e] = this.lookUpDomId(p[e]);
		u = (l = u) == null ? "subGraph" + this.subCount : l, d = d || "", d = this.sanitizeText(d), this.subCount += 1;
		let _ = {
			id: u,
			nodes: p,
			title: d.trim(),
			classes: [],
			dir: h,
			labelType: this.sanitizeNodeLabelType(i == null ? void 0 : i.type)
		};
		return t.info("Adding", _.id, _.nodes, _.dir), _.nodes = this.makeUniq(_, this.subGraphs).nodes, this.subGraphs.push(_), this.subGraphLookup.set(u, _), u;
	}
	getPosForId(e) {
	...
	addNodeFromVertex(e, t, n, r, i, a) {
		var o;
		let s = n.get(e.id), c = (o = r.get(e.id)) == null ? !1 : o, l = this.findNode(t, e.id);
		if (l) l.cssStyles = e.styles, l.cssCompiledStyles = this.getCompiledStyles(e.classes), l.cssClasses = e.classes.join(" ");
			...
			let n = {
				...
				labelStyle: "",
				parentId: s,
				padding: ((u = i.flowchart) == null ? void 0 : u.padding) || 8,
				cssStyles: e.styles,
	...
	getCompiledStyles(e) {
		...
		for (let i of e) {
			...
			if (e != null && e.styles) {
				var n;
				t = [...t, ...(n = e.styles) == null ? [] : n].map((e) => e.trim());
			}
			if (e != null && e.textStyles) {
				var r;
				t = [...t, ...(r = e.textStyles) == null ? [] : r].map((e) => e.trim());
			}
		}
		return t;
	}
	getData() {
		let e = m(), t = [], n = [], r = this.getSubGraphs(), i = /* @__PURE__ */ new Map(), a = /* @__PURE__ */ new Map();
		...
		return o.forEach((t, r) => {
			var i, a, s;
			let { arrowTypeStart: c, arrowTypeEnd: l } = this.destructEdgeType(t.type), u = [...(i = o.defaultStyle) == null ? [] : i];
			...
			let d = {
				...
				type: (a = t.type) == null ? "normal" : a,
				label: t.text,
				labelType: t.labelType,
				labelpos: "c",
				thickness: t.stroke,
				minlen: t.length,
				classes: (t == null ? void 0 : t.stroke) === "invisible" ? "" : "edge-thickness-normal edge-pattern-solid flowchart-link",
				arrowTypeStart: (t == null ? void 0 : t.stroke) === "invisible" || (t == null ? void 0 : t.type) === "arrow_open" ? "none" : c,
				arrowTypeEnd: (t == null ? void 0 : t.stroke) === "invisible" || (t == null ? void 0 : t.type) === "arrow_open" ? "none" : l,
				...
				curve: t.interpolate || this.edges.defaultInterpolate || ((s = e.flowchart) == null ? void 0 : s.curve)
			};
			n.push(d);
		}), {
			nodes: t,
	...
	draw: /* @__PURE__ */ n(async function(e, n, r, i) {
		var a, o;
		t.info("REF0:"), t.info("Drawing state diagram (v2)", n);
		let { securityLevel: s, flowchart: c, layout: l } = m();
		i.db.setDiagramId(n), t.debug("Before getData: ");
		let u = i.db.getData();
		t.debug("Data: ", u);
		let d = ne(n, s), f = i.db.getDirection();
		u.type = i.type, u.layoutAlgorithm = S(l), u.layoutAlgorithm === "dagre" && l === "elk" && t.warn("flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."), u.direction = f, u.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, u.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, u.markers = [
			"point",
			"circle",
			"cross"
		], u.diagramId = n, t.debug("REF1:", u), await x(u, d);
		let p = (a = (o = u.config.flowchart) == null ? void 0 : o.diagramPadding) == null ? 8 : a;
		v.insertTitle(d, "flowchartTitleText", (c == null ? void 0 : c.titleTopMargin) || 0, i.db.getDiagramTitle()), y(d, p, "flowchart", (c == null ? void 0 : c.useMaxWidth) || !1);
	}, "draw")
}, k = (function() {
	var e = /* @__PURE__ */ n(function(e, t, n, r) {
		...
		124,
		125
	], o = [2, 2], s = [1, 13], c = [1, 14], l = [1, 15], u = [1, 16], d = [1, 23], f = [1, 25], p = [1, 26], m = [1, 27], h = [1, 50], g = [1, 49], _ = [1, 29], v = [1, 30], ee = [1, 31], te = [1, 32], ne = [1, 33], y = [1, 45], b = [1, 47], x = [1, 43], S = [1, 48], C = [1, 44], w = [1, 51], T = [1, 46], E = [1, 52], D = [1, 53], O = [1, 34], k = [1, 35], re = [1, 36], ie = [1, 37], ae = [1, 38], A = [1, 58], j = [
		1,
		8,
		9,
		10,
		...
		77,
		78
	], se = [1, 79], ce = [1, 92], le = [1, 97], ue = [1, 96], de = [1, 93], fe = [1, 89], pe = [1, 95], me = [1, 91], he = [1, 98], ge = [1, 94], _e = [1, 99], ve = [1, 90], ye = [
		8,
		9,
		10,
		11,
		...
		115,
		116
	], Se = [1, 122], Ce = [1, 123], we = [1, 125], Te = [1, 124], Ee = [
		44,
		60,
		62,
		74,
		...
		115,
		116
	], De = [1, 134], Oe = [1, 148], ke = [1, 149], Ae = [1, 150], je = [1, 151], Me = [1, 136], Ne = [1, 138], Pe = [1, 142], Fe = [1, 143], Ie = [1, 144], Le = [1, 145], Re = [1, 146], ze = [1, 147], Be = [1, 152], Ve = [1, 153], He = [1, 132], Ue = [1, 133], We = [1, 140], Ge = [1, 135], Ke = [1, 139], qe = [1, 137], Je = [
		8,
		9,
		10,
		11,
		...
		115,
		116
	], z = [1, 177], B = [1, 173], V = [1, 174], H = [1, 178], U = [1, 175], W = [1, 176], Ze = [
		77,
		116,
		119
	], G = [
		...
		117,
		118
	], K = [1, 248], q = [1, 246], J = [1, 250], Y = [1, 244], X = [1, 245], Z = [1, 247], et = [1, 249], Q = [1, 251], tt = [1, 269], nt = [
		8,
		9,
		11,
		106
		...
		parse: /* @__PURE__ */ n(function(e) {
			...
			for (var y, b, x, S, C, w = {}, T, E, D, O;;) {
				if (x = r[r.length - 1], this.defaultActions[x] ? S = this.defaultActions[x] : (y == null && (y = ne()), S = s[x] && s[x][y]), S === void 0 || !S.length || !S[0]) {
					var k = "";
					for (T in O = [], s[x]) this.terminals_[T] && T > f && O.push("'" + this.terminals_[T] + "'");
					k = h.showPosition ? "Parse error on line " + (l + 1) + ":\n" + h.showPosition() + "\nExpecting " + O.join(", ") + ", got '" + (this.terminals_[y] || y) + "'" : "Parse error on line " + (l + 1) + ": Unexpected " + (y == p ? "end of input" : "'" + (this.terminals_[y] || y) + "'"), this.parseError(k, {
						text: h.match,
				...
				switch (S[0]) {
					case 1:
						r.push(y), a.push(h.yytext), o.push(h.yylloc), r.push(S[1]), y = null, b ? (y = b, b = null) : (u = h.yyleng, c = h.yytext, l = h.yylineno, v = h.yylloc, d > 0 && d--);
						break;
					case 2:
...
k.parser = k;
var re = k, ie = Object.assign({}, re);
ie.parse = (e) => {
	let t = e.replace(/}\s*\n/g, "}\n");
	return re.parse(t);
};
var ae = ie, A = /* @__PURE__ */ n((e, t) => {
	let n = g;
  ...
  .node path {
    fill: ${e.mainBkg};
    stroke: ${e.nodeBorder};
    stroke-width: ${(t = e.strokeWidth) == null ? 1 : t}px;
  }
  ...
  .edgePath .path {
    stroke: ${e.lineColor};
    stroke-width: ${(n = e.strokeWidth) == null ? 2 : n}px;
  }
...
`;
	...
	init: /* @__PURE__ */ n((e) => {
		e.flowchart || (e.flowchart = {}), e.layout && i({ layout: e.layout }), e.flowchart.arrowMarkerAbsolute = e.arrowMarkerAbsolute, i({ flowchart: { arrowMarkerAbsolute: e.arrowMarkerAbsolute } });
	}, "init")
};
//#endregion
export { j as diagram };
