...
import { i as t, r as n } from "./src-6bhrijpo.mjs";
import { D as r, H as i, K as a, U as o, a as s, b as c, c as l, v as u, w as d, x as f, y as p } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { i as m } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as h } from "./chunk-WU5MYG2G-CWOh8Nru.mjs";
import { t as g } from "./chunk-4BX2VUAB-CyUC8-vI.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/wardleyDiagram-YWT4CUSO.mjs
var _, v = /* @__PURE__ */ n((e, t) => {
	let n = e <= 1 ? e * 100 : e;
	if (n < 0 || n > 100) throw Error(`${t} must be between 0-1 (decimal) or 0-100 (percentage). Received: ${e}`);
	return n;
}, "toPercent"), y = /* @__PURE__ */ n((e, t, n) => ({
	x: v(t, `${n} evolution`),
	y: v(e, `${n} visibility`)
}), "toCoordinates"), b = /* @__PURE__ */ n((e) => {
	if (e) {
		if (e === "+<>") return "bidirectional";
		if (e === "+<") return "backward";
		if (e === "+>") return "forward";
	}
}, "getFlowFromPort"), x = /* @__PURE__ */ n((e) => {
...
}, "extractFlowFromArrow"), S = /* @__PURE__ */ n((e, t) => {
	if (g(e, t), e.size && t.setSize(e.size.width, e.size.height), e.evolution) {
	...
	parse: /* @__PURE__ */ n(async (n) => {
		var r;
		let i = await e("wardley", n);
		t.debug(i);
		let a = (r = C.parser) == null ? void 0 : r.yy;
		if (!a || typeof a.addNode != "function") throw Error("parser.parser?.yy was not a WardleyDB. This is due to a bug within Mermaid, please report this issue at https://github.com/mermaid-js/mermaid/issues.");
		S(i, a);
	}, "parse")
}, w = new (_ = class {
	constructor() {
...
n(M, "addDeaccelerator");
function N(e, t) {
	w.setAnnotationsBox(e, t);
}
n(N, "setAnnotationsBox");
function P(e, t) {
	w.setSize(e, t);
}
n(P, "setSize");
...
var H = {
	...
	var e, t, n, r, i, a, o, s, c, l, u, d, p, m, h, g, _, v, y, b, x, S, C, w, T, E, D, O, k;
	let { themeVariables: A } = f();
	return {
...
}, "getTheme"), G = /* @__PURE__ */ n(() => {
	var e, t, n, r, i, a, o, s, c;
	let l = f()["wardley-beta"];
	return {
	...
	parser: C,
	db: H,
	renderer: { draw: /* @__PURE__ */ n((e, r, i, a) => {
		var o, s, c, u, d, f;
		t.debug("Rendering Wardley map\n" + e);
		let p = G(), m = W(), g = p.nodeRadius * 1.6, _ = a.db, v = _.getWardleyData(), y = _.getDiagramTitle(), b = (o = (s = v.size) == null ? void 0 : s.width) == null ? p.width : o, x = (c = (u = v.size) == null ? void 0 : u.height) == null ? p.height : c, S = h(r);
		S.selectAll("*").remove(), l(S, x, b, p.useMaxWidth), S.attr("viewBox", `0 0 ${b} ${x}`);
		let C = S.append("g").attr("class", "wardley-map"), w = S.append("defs");
		w.append("marker").attr("id", `arrow-${r}`).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerWidth", 6).attr("markerHeight", 6).attr("orient", "auto-start-reverse").append("path").attr("d", "M 0 0 L 10 5 L 0 10 z").attr("fill", m.evolutionStroke).attr("stroke", "none"), w.append("marker").attr("id", `link-arrow-end-${r}`).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerWidth", 5).attr("markerHeight", 5).attr("orient", "auto").append("path").attr("d", "M 0 0 L 10 5 L 0 10 z").attr("fill", m.linkStroke).attr("stroke", "none"), w.append("marker").attr("id", `link-arrow-start-${r}`).attr("viewBox", "0 0 10 10").attr("refX", 1).attr("refY", 5).attr("markerWidth", 5).attr("markerHeight", 5).attr("orient", "auto").append("path").attr("d", "M 10 0 L 0 5 L 10 10 z").attr("fill", m.linkStroke).attr("stroke", "none"), C.append("rect").attr("class", "wardley-background").attr("width", b).attr("height", x).attr("fill", m.backgroundColor);
		...
		let D = /* @__PURE__ */ n((e) => p.padding + e / 100 * T, "projectX"), O = /* @__PURE__ */ n((e) => x - p.padding - e / 100 * E, "projectY"), k = C.append("g").attr("class", "wardley-axes");
		...
		if (v.nodes.forEach((e) => {
			...
			v.pipelines.forEach((n) => {
				...
				if (n.componentIds.forEach((e) => {
					...
					s && (s.x = (i + a) / 2, s.y = r - g / 6), e.append("rect").attr("class", "wardley-pipeline-box").attr("x", i - 15).attr("y", r).attr("width", a - i + 30).attr("height", t).attr("fill", "none").attr("stroke", m.axisColor).attr("stroke-width", 1.5).attr("rx", 4).attr("ry", 4);
				}
			});
		}
		...
		L.selectAll("line").data(R).enter().append("line").attr("class", "wardley-trend").attr("x1", (e) => e.origin.x).attr("y1", (e) => e.origin.y).attr("x2", (e) => e.adjustedX2).attr("y2", (e) => e.adjustedY2).attr("stroke", m.evolutionStroke).attr("stroke-width", 1).attr("stroke-dasharray", "4 4").attr("marker-end", `url(#arrow-${r})`);
	...
	styles: /* @__PURE__ */ n(({ wardley: e } = {}) => {
		let t = m(m(r(), c().themeVariables).wardley, e);
		return `
  .wardley-background {
