...
import { H as i, K as a, U as o, a as s, rt as c, v as l, w as u, x as d, y as f } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { t as p } from "./channel-CU6vqdKT.mjs";
import { c as m, g as h } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import "./chunk-O5CBEL6O-DN64hWSU.mjs";
import "./chunk-BSJP7CBP-CmHmwk33.mjs";
import "./chunk-L5ZTLDWV-EfUVro68.mjs";
import { t as g } from "./chunk-55IACEB6-DWxyqrIq.mjs";
import { t as _ } from "./chunk-2J33WTMH-5W4hnvSY.mjs";
import "./chunk-NZK2D7GU-BP4KY081.mjs";
import "./chunk-3OPIFGDE-Al6MeL3x.mjs";
import "./chunk-KSCS5N6A-Do-wUxiw.mjs";
import { r as v, t as y } from "./chunk-LZXEDZCA-CElJAnI4.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/erDiagram-TEJ5UH35.mjs
var b, x = (function() {
...
var S = x, C = (b = class {
	constructor() {
		...
		}, this.setAccTitle = o, this.getAccTitle = f, this.setAccDescription = i, this.getAccDescription = l, this.setDiagramTitle = a, this.getDiagramTitle = u, this.getConfig = /* @__PURE__ */ n(() => d().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	addEntity(t, n = "") {
		var r;
		if (this.entities.has(t)) !((r = this.entities.get(t)) != null && r.alias) && n && (this.entities.get(t).alias = n, e.info(`Add alias '${n}' to entity '${t}'`));
		else {
			var i;
			this.entities.set(t, {
...
t(w, { draw: () => T });
var T = /* @__PURE__ */ n(async function(t, n, i, a) {
	var o, s;
	e.info("REF0:"), e.info("Drawing er diagram (unified)", n);
	let { securityLevel: c, er: l, layout: u } = d(), f = a.db.getData(), p = g(n, c);
	...
	b === "neo" ? f.markers = [
		...
		"one_or_more",
		"zero_or_more"
	], f.diagramId = n, await v(f, p), f.layoutAlgorithm === "elk" && p.select(".edges").lower();
	...
	}), h.insertTitle(p, "erDiagramTitleText", (o = l == null ? void 0 : l.titleTopMargin) == null ? 25 : o, a.db.getDiagramTitle()), _(p, 8, "erDiagram", (s = l == null ? void 0 : l.useMaxWidth) == null ? !0 : s);
}, "draw"), E = /* @__PURE__ */ n((e, t) => {
	let n = p;
	return c(n(e, "r"), n(e, "g"), n(e, "b"), t);
}, "fade"), D = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), O = /* @__PURE__ */ n((e) => {
