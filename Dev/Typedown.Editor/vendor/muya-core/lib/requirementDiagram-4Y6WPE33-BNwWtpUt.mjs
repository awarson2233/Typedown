import { i as e, n as t, r as n } from "./src-6bhrijpo.mjs";
import { H as r, K as i, U as a, a as o, b as s, v as c, w as l, x as u, y as d } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { g as f } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
...
import { r as h, t as g } from "./chunk-LZXEDZCA-CElJAnI4.mjs";
//#region ../../node_modules/.pnpm/mermaid@11.15.0/node_modules/mermaid/dist/chunks/mermaid.core/requirementDiagram-4Y6WPE33.mjs
var _, v = (function() {
...
var y = v, b = (_ = class {
	constructor() {
		this.relations = [], this.latestRequirement = this.getInitialRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.latestElement = this.getInitialElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.direction = "TB", this.RequirementType = {
			...
			REFINES: "refines",
			TRACES: "traces"
		}, this.setAccTitle = a, this.getAccTitle = d, this.setAccDescription = r, this.getAccDescription = c, this.setDiagramTitle = i, this.getDiagramTitle = l, this.getConfig = /* @__PURE__ */ n(() => u().requirement, "getConfig"), this.clear(), this.setDirection = this.setDirection.bind(this), this.addRequirement = this.addRequirement.bind(this), this.setNewReqId = this.setNewReqId.bind(this), this.setNewReqRisk = this.setNewReqRisk.bind(this), this.setNewReqText = this.setNewReqText.bind(this), this.setNewReqVerifyMethod = this.setNewReqVerifyMethod.bind(this), this.addElement = this.addElement.bind(this), this.setNewElementType = this.setNewElementType.bind(this), this.setNewElementDocRef = this.setNewElementDocRef.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setCssStyle = this.setCssStyle.bind(this), this.setClass = this.setClass.bind(this), this.defineClass = this.defineClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
	}
	getDirection() {
	...
	setCssStyle(e, t) {
		for (let r of e) {
			var n;
			let e = (n = this.requirements.get(r)) == null ? this.elements.get(r) : n;
			if (!t || !e) return;
	...
	setClass(e, t) {
		for (let i of e) {
			var n;
			let e = (n = this.requirements.get(i)) == null ? this.elements.get(i) : n;
			if (e) for (let n of t) {
				var r;
				e.classes.push(n);
				let t = (r = this.classes.get(n)) == null ? void 0 : r.styles;
	...
	getData() {
		...
		for (let t of this.relations) {
			var r, i, a, o, s, c;
			let l = 0, u = t.type === this.Relationships.CONTAINS, d = {
				id: `${t.src}-${t.dst}-${l}`,
				start: (r = (i = this.requirements.get(t.src)) == null ? void 0 : i.name) == null ? (a = this.elements.get(t.src)) == null ? void 0 : a.name : r,
				end: (o = (s = this.requirements.get(t.dst)) == null ? void 0 : s.name) == null ? (c = this.elements.get(t.dst)) == null ? void 0 : c.name : o,
				label: `&lt;&lt;${t.type}&gt;&gt;`,
				classes: "relationshipLine",
				style: ["fill:none", u ? "" : "stroke-dasharray: 10,7"],
				labelpos: "c",
				thickness: "normal",
				type: "normal",
				pattern: u ? "normal" : "dashed",
				arrowTypeStart: u ? "requirement_contains" : "",
				arrowTypeEnd: u ? "" : "requirement_arrow",
				look: e.look,
				labelType: "markdown"
			};
			n.push(d), l++;
...
}, n(_, "RequirementDB"), _), x = /* @__PURE__ */ n((e) => {
  ...
  .labelBkg {
    background-color: ${r == null ? e.edgeLabelBackground : r};
  }

`;
}, "getStyles"), C = {};
t(C, { draw: () => w });
var w = /* @__PURE__ */ n(async function(t, n, r, i) {
	var a, o, s, c;
	e.info("REF0:"), e.info("Drawing requirement diagram (unified)", n);
	let { securityLevel: l, state: d, layout: _, look: v } = u(), y = i.db.getData(), b = p(n, l);
	y.type = i.type, y.layoutAlgorithm = g(_), y.nodeSpacing = (a = d == null ? void 0 : d.nodeSpacing) == null ? 50 : a, y.rankSpacing = (o = d == null ? void 0 : d.rankSpacing) == null ? 50 : o, y.markers = v === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], y.diagramId = n, await h(y, b), f.insertTitle(b, "requirementDiagramTitleText", (s = d == null ? void 0 : d.titleTopMargin) == null ? 25 : s, i.db.getDiagramTitle()), m(b, 8, "requirementDiagram", (c = d == null ? void 0 : d.useMaxWidth) == null ? !0 : c);
}, "draw"), T = {
	parser: y,
	get db() {
		return new b();
