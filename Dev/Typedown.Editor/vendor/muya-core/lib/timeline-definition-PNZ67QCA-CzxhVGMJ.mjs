import { i as e, n as t, r as n, t as r } from "./src-6bhrijpo.mjs";
import { $ as i, J as a, a as o, b as s, et as c, nt as l, o as u, x as d } from "./chunk-CSCIHK7Q-Z5WIAYJZ.mjs";
import { t as f } from "./arc-B_f9jrW3.mjs";
import { p } from "./chunk-5ZQYHXKU-LWon6y9A.mjs";
import { t as m } from "./chunk-WU5MYG2G-CWOh8Nru.mjs";
...
var v = "", y = 0, b = "LR", x = [], S = [], C = [], w = /* @__PURE__ */ n(() => u, "getCommonDb"), T = /* @__PURE__ */ n(function() {
	x.length = 0, S.length = 0, v = "", C.length = 0, b = "LR", o();
}, "clear"), E = /* @__PURE__ */ n(function(e) {
	b = e;
}, "setDirection"), D = /* @__PURE__ */ n(function() {
	return b;
}, "getDirection"), O = /* @__PURE__ */ n(function(e) {
	v = e, x.push(e);
}, "addSection"), k = /* @__PURE__ */ n(function() {
	return x;
}, "getSections"), A = /* @__PURE__ */ n(function() {
	let e = P(), t = 0;
	for (; !e && t < 100;) e = P(), t++;
	return S.push(...C), S;
}, "getTasks"), j = /* @__PURE__ */ n(function(e, t, n) {
	let r = {
		id: y++,
		section: v,
		type: v,
	...
	C.push(r);
}, "addTask"), M = /* @__PURE__ */ n(function(e) {
	C.find((e) => e.id === y - 1).events.push(e);
}, "addEvent"), N = /* @__PURE__ */ n(function(e) {
	let t = {
		section: v,
		type: v,
		description: e,
	...
	S.push(t);
}, "addTaskOrg"), P = /* @__PURE__ */ n(function() {
	let e = /* @__PURE__ */ n(function(e) {
		return C[e].processed;
	}, "compileTask"), t = !0;
	for (let [n, r] of C.entries()) e(n), t = t && r.processed;
	return t;
}, "compileTasks"), F = {
	clear: T,
	getCommonDb: w,
...
}, "drawRect"), R = /* @__PURE__ */ n(function(e, t) {
	...
	return n(s, "ambivalent"), t.score > 3 ? a(i) : t.score < 3 ? o(i) : s(i), r;
}, "drawFace"), z = /* @__PURE__ */ n(function(e, t) {
...
}, "drawCircle"), B = /* @__PURE__ */ n(function(e, t) {
...
}, "drawText"), V = /* @__PURE__ */ n(function(e, t) {
	function r(e, t, n, r, i) {
		return e + "," + t + " " + (e + n) + "," + t + " " + (e + n) + "," + (t + r - i) + " " + (e + n - i * 1.2) + "," + (t + r) + " " + e + "," + (t + r);
	}
	n(r, "genPoints");
	let i = e.append("polygon");
	i.attr("points", r(t.x, t.y, 50, 20, 7)), i.attr("class", "labelBox"), t.y += t.labelMargin, t.x += .5 * t.labelMargin, B(e, t);
}, "drawLabel"), H = /* @__PURE__ */ n(function(e, t, n) {
...
}, "drawSection"), U = -1, ee = /* @__PURE__ */ n(function(e, t, n, r) {
...
}, "drawTask"), te = /* @__PURE__ */ n(function(e, t) {
	L(e, {
		x: t.startx,
		y: t.starty,
...
}, "drawBackgroundRect"), ne = /* @__PURE__ */ n(function() {
	return {
		x: 0,
		y: 0,
		fill: void 0,
...
}, "getTextObj"), W = /* @__PURE__ */ n(function() {
	return {
		x: 0,
		y: 0,
		width: 100,
	...
	function r(e, n, r, a, o, s, c, l) {
		let u = n.append("switch"), d = u.append("foreignObject").attr("x", r).attr("y", a).attr("width", o).attr("height", s).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
		d.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(e), t(e, u, r, a, o, s, c, l), i(d, c);
	}
	n(r, "byFo");
	function i(e, t) {
		for (let n in t) n in t && e.attr(n, t[n]);
	}
	return n(i, "_setTextAttrs"), function(n) {
		return n.textPlacement === "fo" ? r : n.textPlacement === "old" ? e : t;
	};
})(), re = /* @__PURE__ */ n(function(e, t) {
...
n(K, "wrap");
var ie = /* @__PURE__ */ n(function(e, t, n, i, a, o = !1) {
	var s, c, l;
	let { theme: u, look: d } = i, f = u == null ? void 0 : u.includes("redux"), p = n % ((s = i == null || (c = i.themeVariables) == null ? void 0 : c.THEME_COLOR_LIMIT) == null ? 12 : s) - 1, m = e.append("g");
	t.section = p, m.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + p));
	let h = m.append("g"), g = m.append("g"), _ = g.append("text").text(t.descr).attr("dy", "1em").attr("alignment-baseline", "middle").attr("dominant-baseline", "middle").attr("text-anchor", "middle").call(K, t.width).node().getBBox(), v = (l = i.fontSize) != null && l.replace ? i.fontSize.replace("px", "") : i.fontSize;
	if (t.height = _.height + v * 1.1 * .5 + t.padding, t.height = Math.max(t.height, t.maxHeight), t.width += 2 * t.padding, g.attr("transform", "translate(" + t.width / 2 + ", " + t.padding / 2 + ")"), f && g.attr("transform", `translate(${t.width / 2}, ${o ? t.padding / 2 + 3 : t.padding})`), oe(h, t, p, a, i), d === "neo" && (m.attr("data-look", "neo"), f)) {
		var y, b, x;
		let t = u.includes("dark"), n = r((y = (b = e.node()) == null ? void 0 : b.ownerSVGElement) == null ? e.node() : y), i = (x = n.attr("id")) == null ? "" : x, a = i ? `${i}-drop-shadow` : "drop-shadow";
		if (n.select(`#${a}`).empty()) {
			let e = n.select("defs");
	...
	return t;
}, "drawNode"), ae = /* @__PURE__ */ n(function(e, t, n) {
	var r;
...
}, "getVirtualNodeHeight"), oe = /* @__PURE__ */ n(function(e, t, n, r, i) {
...
}, se = /* @__PURE__ */ n(function(t, n, i, o) {
	var s, c, l, u, f, p;
	let m = d(), { look: h, theme: g, themeVariables: _ } = m, { useGradient: v, gradientStart: y, gradientStop: b } = _, x = (s = (c = m.timeline) == null ? void 0 : c.leftMargin) == null ? 50 : s;
	e.debug("timeline", o.db);
	let S = m.securityLevel, C;
	S === "sandbox" && (C = r("#i" + n));
	let w = r(S === "sandbox" ? C.nodes()[0].contentDocument.body : "body").select("#" + n);
	w.append("g");
	let T = o.db.getTasks(), E = o.db.getCommonDb().getDiagramTitle();
	e.debug("task", T), q.initGraphics(w, n);
	let D = o.db.getSections();
	e.debug("sections", D);
	...
	D.forEach(function(t) {
		...
		e.debug("sectionHeight before draw", r), O = Math.max(O, r + 20);
	});
	let I = 0, L = 0;
	e.debug("tasks.length", T.length);
	for (let [t, n] of T.entries()) {
		...
		e.debug("taskHeight before draw", i), k = Math.max(k, i + 20), I = Math.max(I, n.events.length);
		let a = 0;
	...
	e.debug("maxSectionHeight before draw", O), e.debug("maxTaskHeight before draw", k), D && D.length > 0 ? D.forEach((t) => {
		let r = T.filter((e) => e.section === t), i = {
			number: P,
			descr: t,
			section: P,
		...
		e.debug("sectionNode output", o), a.attr("transform", `translate(${M}, ${j})`), N += O + 50, r.length > 0 && J(w, r, P, M, N, k, m, I, L, O, !1, n), M += 200 * Math.max(r.length, 1), N = j, P++;
	}) : (F = !1, J(w, T, P, M, N, k, m, I, L, O, !0, n));
	let R = w.node().getBBox();
	if (e.debug("bounds", R), E && w.append("text").text(E).attr("x", h === "neo" ? R.x * 2 + x : R.width / 2 - x).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), A = F ? O + k + 150 : k + 100, w.append("g").attr("class", "lineWrapper").append("line").attr("x1", x).attr("y1", A).attr("x2", R.width + 3 * x).attr("y2", A).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", `url(#${n}-arrowhead)`), h === "neo" && v && g !== "neutral") {
	...
	a(void 0, w, (l = (u = m.timeline) == null ? void 0 : u.padding) == null ? 50 : l, (f = (p = m.timeline) == null ? void 0 : p.useMaxWidth) == null ? !1 : f);
}, "draw"), J = /* @__PURE__ */ n(function(t, n, r, i, a, o, s, c, l, u, d, f) {
	for (let c of n) {
		var p;
		let n = {
			descr: c.task,
		...
		e.debug("taskNode", n);
		let u = t.append("g").attr("class", "taskWrapper"), m = q.drawNode(u, n, r, s, f).height;
		if (e.debug("taskHeight after draw", m), u.attr("transform", `translate(${i}, ${a})`), o = Math.max(o, m), c.events) {
			let e = t.append("g").attr("class", "lineWrapper"), n = o;
			a += 100, n += ce(t, c.events, r, i, a, s, f), a -= 100, e.append("line").attr("x1", i + 190 / 2).attr("y1", a + o).attr("x2", i + 190 / 2).attr("y2", a + o + 100 + l + 100).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", `url(#${f}-arrowhead)`).attr("stroke-dasharray", "5,5");
		}
		i += 200, d && !((p = s.timeline) != null && p.disableMulticolor) && r++;
	}
	a -= 10;
}, "drawTasks"), ce = /* @__PURE__ */ n(function(t, n, r, i, a, o, s) {
	let c = 0, l = a;
	a += 100;
	for (let l of n) {
		let n = {
		...
		e.debug("eventNode", n);
		let u = t.append("g").attr("class", "eventWrapper"), d = q.drawNode(u, n, r, o, s, !0).height;
		c += d, u.attr("transform", `translate(${i}, ${a})`), a = a + 10 + d;
	}
	return a = l, c;
}, "drawEvents"), le = {
	setConf: /* @__PURE__ */ n(() => {}, "setConf"),
	draw: se
}, Y = 200, X = 5, ue = Y + X * 2, Z = Y + 100, de = Z + X * 2, Q = 10, fe = 0, pe = 20, me = 20, he = 30, ge = 50, _e = /* @__PURE__ */ n(function(t, n, r, i) {
	var o, s, c, l, u, f, h;
	let g = d(), _ = (o = (s = g.timeline) == null ? void 0 : s.leftMargin) == null ? 50 : o;
	e.debug("timeline", i.db);
	let v = m(n);
	v.append("g");
	let y = i.db.getTasks(), b = i.db.getCommonDb().getDiagramTitle();
	e.debug("task", y), q.initGraphics(v);
	let x = i.db.getSections();
	e.debug("sections", x);
	...
	x.forEach(function(t) {
		...
		e.debug("sectionHeight before draw", r), S = Math.max(S, r);
	});
	let F = 0;
	...
	for (let [t, n] of y.entries()) {
		...
		e.debug("taskHeight before draw", i), C = Math.max(C, i);
		let a = 0;
		for (let e of n.events) {
			let t = {
				descr: e,
	...
	e.debug("maxSectionHeight before draw", S), e.debug("maxTaskHeight before draw", C);
	let I = Math.max(C, F) + he;
	M ? x.forEach((t) => {
		let n = y.filter((e) => e.section === t), r = {
			number: j,
			descr: t,
			section: j,
			width: P,
	...
	if (e.debug("bounds", L), b) {
		...
		e.debug("bounds after title", L);
	}
	let [z] = p(g.fontSize), B = (z == null ? 16 : z) * 2, V = (z == null ? 16 : z) * .5 + 20, H = v.append("g").attr("class", "lineWrapper");
	H.append("line").attr("x1", N).attr("y1", E - B).attr("x2", N).attr("y2", L.y + L.height + V).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), H.lower(), a(void 0, v, (l = (u = g.timeline) == null ? void 0 : u.padding) == null ? 50 : l, (f = (h = g.timeline) == null ? void 0 : h.useMaxWidth) == null ? !1 : f);
}, "draw"), $ = /* @__PURE__ */ n(function(t, n, r, i, a, o, s, c, l) {
	for (let d of n) {
		var u;
		let n = {
			descr: d.task,
		...
		e.debug("taskNode", n);
		let f = t.append("g").attr("class", "taskWrapper"), p = q.drawNode(f, n, r, s), m = p.height;
		e.debug("taskHeight after draw", m);
		let h = i - me - p.width;
		if (f.attr("transform", `translate(${h}, ${a})`), o = Math.max(o, m), d.events && d.events.length > 0) {
			let e = a, n = i + ge;
			ve(t, d.events, r, i, n, e, s);
		}
		a += c, l && !((u = s.timeline) != null && u.disableMulticolor) && r++;
	}
}, "drawTasks"), ve = /* @__PURE__ */ n(function(t, n, r, i, a, o, s) {
	let c = o;
	for (let o of n) {
		let n = {
			descr: o,
		...
		e.debug("eventNode", n);
		let l = t.append("g").attr("class", "eventWrapper"), u = q.drawNode(l, n, r, s).height;
	...
	var t, n, r;
	let { theme: i } = s(), a = i == null ? void 0 : i.includes("dark"), o = i == null ? void 0 : i.includes("color"), c = (t = (n = e.svgId) == null ? void 0 : n.replace(/^#/, "")) == null ? "" : t, l = c ? `url(#${c}-drop-shadow)` : (r = e.dropShadow) == null ? "none" : r, u = "";
	for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) {
		var d, f;
		let n = `${17 - 3 * t}`, r = o ? e.borderColorArray[t] : e.mainBkg, i = o ? e.borderColorArray[t] : e.nodeBorder;
		u += `
    .section-${t - 1} rect,
    .section-${t - 1} path,
    .section-${t - 1} circle {
      fill: ${a && o ? e.mainBkg : r};
      stroke: ${i};
	...
	return u;
}, "genReduxSections"), xe = /* @__PURE__ */ n((e) => {
	let t = "";
	...
	styles: /* @__PURE__ */ n((e) => {
		var t, n;
		let { theme: r } = s(), i = r == null ? void 0 : r.includes("redux"), a = r === "neutral", o = (t = (n = e.svgId) == null ? void 0 : n.replace(/^#/, "")) == null ? "" : t, c = "";
		if (e.useGradient && o && e.THEME_COLOR_LIMIT && !a) for (let t = 0; t < e.THEME_COLOR_LIMIT; t++) c += `
