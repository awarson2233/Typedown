...
function r() {
	var e;
	return !!((e = n()) != null && e.mermaidCaptureSizes);
}
...
function a(e, t) {
	...
	let a = n();
	if (!a) return;
	let o = t.node(), s = (r = o && "ownerSVGElement" in o ? o.ownerSVGElement : null) == null ? o : r, c = (i = s == null ? void 0 : s.id) == null ? "(unknown)" : i;
	a.mermaidCapturedSizes != null || (a.mermaidCapturedSizes = []);
	let l = {
		svgId: c,
		sizes: e
	};
	a.mermaidCapturedSizes.push(l), a.mermaidLastCapturedSizes = l;
}
...
function o(e, n) {
	...
	for (let e of n.nodes) {
		...
		e.isGroup || r.push({
			id: e.id,
			width: (o = e.width) == null ? 0 : o,
			height: (s = e.height) == null ? 0 : s
		});
	}
	r.length !== 0 && a({
		metadata: {
