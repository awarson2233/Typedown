...
import { A as r, F as i, G as a, H as o, K as s, O as c, U as l, a as u, b as d, c as f, i as p, r as m, s as h, v as g, w as _, x as v, y, z as b } from "./chunk-WYO6CB5R-_U4dPty4.mjs";
import { g as x, p as S } from "./chunk-ICXQ74PX-5xZ0PKaW.mjs";
import { t as C } from "./dist-Bowt_KoK.mjs";
import { a as w, c as T, i as E, n as D, r as O, s as k } from "./chunk-32BRIVSS-Dezidi9z.mjs";
import { t as A } from "./chunk-2Q5K7J3B-BkgA88te.mjs";
import { n as j, t as M } from "./chunk-ZIRB5QZD-BdqCGXAd.mjs";
...
var I = F, ee = {
	...
	autoWrap() {
		var e, t;
		return this.state.records.wrapEnabled === void 0 ? (e = (t = v().sequence) == null ? void 0 : t.wrap) != null && e : this.state.records.wrapEnabled;
	}
	clear() {
		this.state.reset(), u();
	}
...
`;
	...
	let r = 0, i = 0, a = n.text.split(h.lineBreakRegex), [o, s] = S(n.fontSize), c = [], l = 0, u = /* @__PURE__ */ e(() => n.y, "yfunc");
	if (n.valign !== void 0 && n.textMargin !== void 0 && n.textMargin > 0) switch (n.valign) {
		...
		case "bottom":
		case "end":
			u = /* @__PURE__ */ e(() => Math.round(n.y + (r + i + 2 * n.textMargin) - n.textMargin), "yfunc");
			break;
	}
	...
	var v = _;
	i || (K++, Object.keys(t.links || {}).length && !n.forceMenus && v.attr("onclick", oe(`actor${K}_popup`)).attr("cursor", "pointer"), v.append("line").attr("id", "actor" + K).attr("x1", u).attr("y1", d).attr("x2", u).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), v = _.append("g"), t.actorCnt = K, t.links != null && v.attr("id", "root-" + K), f === "neo" && v.attr("data-look", "neo"));
	let y = k();
	var b = "actor";
	...
	let x = W(v, y), S = (s = a.get(t.name)) == null ? 0 : s;
	...
	i || (v.attr("data-et", "participant"), v.attr("data-type", "participant"), v.attr("data-id", t.name)), Y(n, r(t.description))(t.description, v, y.x, y.y, y.width, y.height, { class: `actor ${ie}` }, n);
	let C = t.height;
	if (x.node) {
	...
	Y(n, r(t.description))(t.description, v, y.x - 6, y.y + 6, y.width, y.height, { class: `actor ${ie}` }, n);
	let T = t.height;
	if (S.node) {
  ...
  `;
	...
	Y(n, r(t.description))(t.description, v, y.x, y.y, y.width, y.height, { class: `actor ${ie}` }, n);
	...
	i || (K++, b.append("line").attr("id", "actor" + K).attr("x1", d).attr("y1", f).attr("x2", d).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = K);
	...
	return U.has(p) && (v.style("stroke", g[C % g.length]), v.style("fill", h[C % g.length])), t.height = v.node().getBBox().height + ((s = n == null || (c = n.sequence) == null ? void 0 : c.labelBoxHeight) == null ? 0 : s), i || (K++, _.append("line").attr("id", "actor" + K).attr("x1", u).attr("y1", d).attr("x2", u).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = K), Y(n, r(t.description))(t.description, v, b.x, b.y + (i ? 15 : 30), b.width, b.height, { class: `actor ${H}` }, n), i ? v.attr("transform", "translate(0, 22)") : (v.attr("transform", `translate(0, ${22 / 2 - 5})`), v.attr("data-et", "participant"), v.attr("data-type", "entity"), v.attr("data-id", t.name)), t.height;
	...
	i || (K++, Object.keys(t.links || {}).length && !n.forceMenus && v.attr("onclick", oe(`actor${K}_popup`)).attr("cursor", "pointer"), v.append("line").attr("id", "actor" + K).attr("x1", l).attr("y1", u).attr("x2", l).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), v = _.append("g"), t.actorCnt = K, t.links != null && v.attr("id", "root-" + K), p === "neo" && v.attr("data-look", "neo"));
	let y = k(), b = "actor";
...
`;
	...
	let D = (s = a.get(t.name)) == null ? 0 : s;
	U.has(d) ? (T.style("stroke", h[D % h.length]), T.style("fill", m[D % h.length])) : T.style("stroke", g), T.attr("transform", `translate(${x}, ${w})`), t.rectData = y, Y(n, r(t.description))(t.description, v, y.x, y.y + 35, y.width, y.height, { class: `actor ${ie}` }, n);
	...
	i || (K++, d.append("line").attr("id", "actor" + K).attr("x1", l).attr("y1", u).attr("x2", l).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = K);
	let v = e.append("g"), y = H;
	i ? y += ` ${V}` : y += ` ${B}`, v.attr("class", y), v.attr("name", t.name);
	let b = k();
	b.x = t.x, b.y = c, b.fill = "#eaeaea", b.width = t.width, b.height = t.height, b.class = "actor", v.append("line").attr("id", "actor-man-torso" + K).attr("x1", t.x + t.width / 2 - 22 * 2.5).attr("y1", c + 12).attr("x2", t.x + t.width / 2 - 15).attr("y2", c + 12), v.append("line").attr("id", "actor-man-arms" + K).attr("x1", t.x + t.width / 2 - 22 * 2.5).attr("y1", c + 2).attr("x2", t.x + t.width / 2 - 22 * 2.5).attr("y2", c + 22), v.append("circle").attr("cx", t.x + t.width / 2).attr("cy", c + 12).attr("r", 22), f === "neo" && v.attr("filter", "url(#drop-shadow)");
	let x = (o = a.get(t.name)) == null ? 0 : o;
	return U.has(p) ? (v.style("stroke", g[x % g.length]), v.style("fill", h[x % g.length])) : v.style("stroke", _), t.height = v.node().getBBox().height + ((s = n.sequence.labelBoxHeight) == null ? 0 : s), Y(n, r(t.description))(t.description, v, b.x, b.y + 15, b.width, b.height, { class: `actor ${H}` }, n), v.attr("transform", "translate(0,21)"), i || (v.attr("data-et", "participant"), v.attr("data-type", "boundary"), v.attr("data-id", t.name)), t.height;
	...
	i || (K++, g.append("line").attr("id", "actor" + K).attr("x1", c).attr("y1", l).attr("x2", c).attr("y2", 2e3).attr("class", "actor-line 200").attr("stroke-width", "0.5px").attr("stroke", "#999").attr("name", t.name).attr("data-et", "life-line").attr("data-id", t.name), t.actorCnt = K);
	...
	_.append("line").attr("id", "actor-man-torso" + K).attr("x1", c).attr("y1", b + 25 * y).attr("x2", c).attr("y2", b + 45 * y), _.append("line").attr("id", "actor-man-arms" + K).attr("x1", c - z / 2 * y).attr("y1", b + 33 * y).attr("x2", c + z / 2 * y).attr("y2", b + 33 * y), _.append("line").attr("x1", c - z / 2 * y).attr("y1", b + 60 * y).attr("x2", c).attr("y2", b + 45 * y), _.append("line").attr("x1", c).attr("y1", b + 45 * y).attr("x2", c + (z / 2 - 2) * y).attr("y2", b + 60 * y);
	...
	let C = (o = a.get(t.name)) == null ? 0 : o;
	return U.has(d) ? (_.style("stroke", m[C % m.length]), _.style("fill", p[C % m.length])) : _.style("stroke", h), Y(n, r(t.description))(t.description, _, S.x, b + 35 * y - (u === "neo" ? 10 : 0), S.width, S.height, { class: `actor ${H}` }, n), t.height;
	...
	let g = W(m, p), _ = (s = (o == null ? new Map([...a.db.getActors().values()].map((e, t) => [e.name, t])) : o).get(h)) == null ? 0 : s;
	if (U.has(c)) {
		var v;
...
async function Re(e, t) {
	...
	let { startx: n, stopx: i, message: a } = t, o = h.splitBreaks(a).length, s = r(a), c = s ? await p(a, v()) : x.calculateTextDimensions(a, Fe(Z));
	if (!s) {
		let e = c.height / o;
...
var ze = /* @__PURE__ */ e(async function(e, t, n, i, a, o) {
	let { startx: s, stopx: l, starty: u, message: d, type: f, sequenceIndex: p, sequenceVisible: m } = t, g = x.calculateTextDimensions(d, Fe(Z)), _ = T();
...
function $(e, n, r, i, a) {
	...
	if (n.id && n.message && e[n.id]) {
		...
		n.message = x.wrapLabel(`[${n.message}]`, r - 2 * Z.wrapPadding, a), n.width = r, n.wrap = !0;
		let s = x.calculateTextDimensions(n.message, a), c = h.getMax(s.height, Z.labelBoxHeight);
...
var qe = /* @__PURE__ */ e(async function(r, i, a, o) {
	...
	let D = new Map(x.map((e, t) => {
		var n, r;
		return [(n = (r = g.get(e)) == null ? void 0 : r.name) == null ? e : n, t];
	}));
	Be(h, g, _, x, 0, S, !1);
		...
		switch (e.type) {
			...
			case o.db.LINETYPE.RECT_START:
				$(O, e, Z.boxMargin, Z.boxMargin, (e) => {
					let t = e.message;
					t || (t = (u == null ? void 0 : u.rectBkgColor) || (u == null ? void 0 : u.actorBkg) || "rgba(128, 128, 128, 0.5)"), Q.newLoop(void 0, t);
				});
				break;
...
async function Je(e, n, i) {
	...
	for (let t of n) if (e.get(t.to) && e.get(t.from)) {
		...
		let o = t.placement !== void 0, s = !o, c = o ? Ie(Z) : Fe(Z), l = t.wrap ? x.wrapLabel(t.message, Z.width - 2 * Z.wrapPadding, c) : t.message, u = (r(l) ? await p(t.message, v()) : x.calculateTextDimensions(l, c)).width + 2 * Z.wrapPadding;
...
var Ye = /* @__PURE__ */ e(function(e) {
	...
	for (let r in e.links) {
		let e = x.calculateTextDimensions(r, n).width + 2 * Z.wrapPadding + 2 * Z.boxMargin;
		t < e && (t = e);
	}
	return t;
...
async function Xe(e, t, n) {
	...
	for (let t of e.keys()) {
		let n = e.get(t);
		n.wrap && (n.description = x.wrapLabel(n.description, Z.width - 2 * Z.wrapPadding, Le(Z)));
		let a = r(n.description) ? await p(n.description, v()) : x.calculateTextDimensions(n.description, Le(Z));
	...
	return n.forEach((t) => {
		...
		r += i, r -= 2 * Z.boxTextMargin, t.wrap && (t.name = x.wrapLabel(t.name, r - 2 * Z.wrapPadding, n));
...
var Ze = /* @__PURE__ */ e(async function(e, n, i) {
	let a = n.get(e.from), o = n.get(e.to), s = a.x, c = o.x, l = e.wrap && e.message, u = r(e.message) ? await p(e.message, v()) : x.calculateTextDimensions(l ? x.wrapLabel(e.message, Z.width, Ie(Z)) : e.message, Ie(Z)), d = {
	...
	return e.placement === i.db.PLACEMENT.RIGHTOF ? (d.width = l ? h.getMax(Z.width, u.width) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s + (a.width + Z.actorMargin) / 2) : e.placement === i.db.PLACEMENT.LEFTOF ? (d.width = l ? h.getMax(Z.width, u.width + 2 * Z.noteMargin) : h.getMax(a.width / 2 + o.width / 2, u.width + 2 * Z.noteMargin), d.startx = s - d.width + (a.width - Z.actorMargin) / 2) : e.to === e.from ? (u = x.calculateTextDimensions(l ? x.wrapLabel(e.message, h.getMax(Z.width, a.width), Ie(Z)) : e.message, Ie(Z)), d.width = l ? h.getMax(Z.width, a.width) : h.getMax(a.width, Z.width, u.width + 2 * Z.noteMargin), d.startx = s + (a.width - d.width) / 2) : (d.width = Math.abs(s + a.width / 2 - (c + o.width / 2)) + Z.actorMargin, d.startx = s < c ? s + a.width / 2 - Z.actorMargin / 2 : c + o.width / 2 - Z.actorMargin / 2), l && (d.message = x.wrapLabel(e.message, d.width - 2 * Z.wrapPadding, Ie(Z))), t.debug(`NM:[${d.startx},${d.stopx},${d.starty},${d.stopy}:${d.width},${d.height}=${e.message}]`), d;
	...
	t.wrap && t.message && (t.message = x.wrapLabel(t.message, h.getMax(g + 2 * Z.wrapPadding, Z.width), Fe(Z)));
	let _ = x.calculateTextDimensions(t.message, Fe(Z));
	return {
