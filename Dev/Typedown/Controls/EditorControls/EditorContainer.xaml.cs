...
namespace Typedown.Controls
{
    public sealed partial class EditorContainer : UserControl
    {
        ...
        {
            this.GetService<IMarkdownEditor>().PostMessage("OnScroll", new { ScrollX = HorizontalScrollBar.Value, ScrollY = VerticalScrollBar.Value });
        }
        ...
        private async void OnDrop(object sender, DragEventArgs e)
        {
            if (e.DataView.Contains(StandardDataFormats.StorageItems))
            {
                ...
                {
                    this.GetService<IMarkdownEditor>().PostMessage("InsertImage", new { src = item.Path });
                }
            }
        }
        ...
        {
            if (e.KeyModifiers.HasFlag(global::Windows.System.VirtualKeyModifiers.Control))
            {
