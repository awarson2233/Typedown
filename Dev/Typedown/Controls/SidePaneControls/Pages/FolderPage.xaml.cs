...
namespace Typedown.Controls.SidePanelControls.Pages
{
    public sealed partial class FolderPage : Page, INotifyPropertyChanged
    {
        ...
        private async void OnNewFolderClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                await AppContentDialog.Create(Locale.GetDialogString("CreateFolderErrorTitle"), ex.Message, Locale.GetDialogString("Ok")).ShowAsync((XamlRoot)ViewModel.ViewRoot);
            }
        }
        ...
        private static void OnTreeViewItemPointerPressed(object sender, global::Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
        ...
        private async void OnTreeViewItemPointerReleased(object sender, global::Windows.UI.Xaml.Input.PointerRoutedEventArgs e)
        {
            try
            {
                var kind = e.GetCurrentPoint(sender as UIElement).Properties.PointerUpdateKind;
                if (kind == global::Windows.UI.Input.PointerUpdateKind.LeftButtonReleased &&
