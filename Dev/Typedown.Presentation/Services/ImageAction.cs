...
namespace Typedown.Presentation.Services
{
    public class ImageAction
    {
        ...
        public string GetDefaultDestFolder(InsertImageSource source)
        {
            ...
            {
                InsertImageSource.Clipboard => Settings.InsertClipboardImageAction == InsertImageAction.CopyToPath ? Settings.InsertClipboardImageCopyPath : Settings.DefaultImageBasePath,
                InsertImageSource.Local => Settings.InsertLocalImageAction == InsertImageAction.CopyToPath ? Settings.InsertLocalImageCopyPath : Settings.DefaultImageBasePath,
                InsertImageSource.Web => Settings.InsertWebImageAction == InsertImageAction.CopyToPath ? Settings.InsertWebImageCopyPath : Settings.DefaultImageBasePath,
