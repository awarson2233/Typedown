...
namespace Typedown.XamlUI
{
    public partial class Window
    {
        ...
        public static DependencyProperty OwnerProperty { get; } = DependencyProperty.Register(nameof(Owner), typeof(long), typeof(Window), new(0L, OnDependencyPropertyChanged));

        public nint Owner { get => (nint)(long)GetValue(OwnerProperty); set => SetValue(OwnerProperty, (long)value); }
